...
1. Aşağıdakilerden hangisi posthümanizmi hazırlayan koşullardan biri **değildir** ?
    ...
    > 5-) Postkolonyalizm
    > 6-) Ekoeleştiri
    > 7-) Kırınımsal Metodoloji
    > 8-) Yeni Maddecilik'tir.
...
1. "Bilişsel becerileri düşünülerek insandan daha aşağı ve değersiz konuma itilen hayvanları, elementleri, mikropları kapsayan insandışı varlıklarla aramızda hiyerarşik bir ilişki olduğunu söylemek, insan ile insandışı varlıklar arasındaki ortak yaşam gerçeklerini yadsımak olur. Bu yadsıma, insanı her şeyin üstünde bir varlık olarak kabul eden türcü ve indirgemeci bir yaklaşım olan ... demektir."<br />Yukarıda boş bırakılan yere aşağıdakilerden hangisi gelmelidir?
    ...
    > **Açıklama:** Bilişsel becerileri düşünülerek insandan daha aşağı ve değersiz konuma itilen hayvanları,
    > elementleri, mikropları kapsayan insandışı varlıklarla aramızda hiyerarşik bir ilişki olduğunu söylemek, insan ile insandışı varlıklar arasındaki ortak yaşam gerçeklerini yadsımak olur. Bu yadsıma, insanı her şeyin üstünde bir varlık olarak kabul eden türcü ve indirgemeci bir yaklaşım olan antroposantrizm yani insanmerkezcilik demektir. Yanıt A'dır.
...
1. Holosen Yok Oluşu ya da Antroposen Yok Oluşu olarak da bilinen Altıncı Kitlesel Yok Oluş hangi döneme denk gelmektedir?
    ...
    > göre (2009), yaklaşık yüz bin yıl önce insanlığın yaygın göçleriyle başlayan ancak on bin yıl önce etkileri geri dönülmez şekilde hızlanan bu Yok Oluş çağında, her yıl her bin türden
    > birinin nesli tükenmektedir. İnsan varoluşundan önceki dönemde gerçekleşen her bir milyon türden birinin neslinin tükenmesiyle kıyaslandığında, bu oranın insanlığın gezegen üzerindeki faaliyetleriyle doğrudan ilişkili olduğu görülmektedir. Yanıt C'dir.
...
1. Posthümanizmi hazırlayan koşullar arasında yer alan ve çevre ile kültür arasındaki ilişkileri<br />kültürel ve edebî metinlerde inceleyen akım aşağıdakilerden hangisidir?
    ...
    > **Açıklama:** Ekoeleştiri: Çevre ile kültür arasındaki ilişkileri kültürel ve edebî metinlerde inceleyen bir akım ekoeleştiri, gezegenimizde bozulan ve bozulmaya devam eden dengeleri toplumsal, siyasal ve kültürel bağlamlarda inceler. Canlı ve cansız varlıkların çevreleriyle
...
1. Biyoteknoloji alanında grafik tasarımcıları kamuoyunun algısını şekillendirmede, katılımı artırmada ve bilinçli söylemi kolaylaştırmada önemli bir etkiye sahiptir. Bu etkiyle birlikte estetik kaygıların ötesine geçen bir dizi sorumluluk da gelir. Aşağıdakilerden hangisi bu sorumluluklardan biri değildir?
    ...
    > **Açıklama:** Biyoteknoloji alanında grafik tasarımcıları kamuoyunun algısını şekillendirmede, katılımı artırmada ve bilinçli söylemi kolaylaştırmada önemli bir etkiye sahiptir. Bu etkiyle birlikte estetik kaygıların ötesine geçen bir dizi sorumluluk da gelir:
    > • Doğruluk ve Netlik: Tasarımcıların karmaşık bilimsel kavramları farklı kitlelerin erişebileceği ve doğru bir şekilde temsil etme görevi vardır. Net, bilgilendirici görseller biyoteknolojinin gizemini çözmeye yardımcı olup ve bireyleri bilinçli kararlar verme konusunda güçlendirecektir.
    > • Etik Çerçeveleme: Tasarımcılar görsel temsillerinin etik sonuçlarını dikkate almalıdır. Tasarımcılar, biyoteknolojik gelişmeleri dengeli ve etik bir şekilde sunarak anlamlı bir diyalog geliştirebilir ve potansiyel yanlış yorumlamaları veya yanlış anlamaları azaltabilecektir.
    > • Şeffaflık: Veri gizliliği ve biyoetik konusundaki endişelerin damgasını vurduğu bir çağda tasarımcılar, iletişim çabalarında şeffaflığa ve açıklamaya öncelik vermelidir. Bağlam sağlamak ve biyoteknolojik yenilikleri çevreleyen belirsizlikleri kabul etmek güven ve güvenilirlik oluşturabilmektir.
    > • Kültürel Duyarlılık: Biyoteknoloji çeşitli kültürel ve etik çerçeveler içerisinde faaliyet göstermektedir. Tasarımcılar kültürel nüanslara duyarlı olmalı ve görsellerinde tek merkezli bakış açılarını empoze etmekten kaçınmalıdır. Farklı kültürel geçmişlere sahip paydaşlarla iş birliği yapmak, tasarım anlatımlarını zenginleştirip kapsayıcılığı teşvik edecektir.
    > • Çevre Bilinci: Biyoteknolojik gelişmeler ekosistemleri ve biyolojik çeşitliliği etkileme potansiyeline sahiptir. Tasarımcılar sürdürülebilir uygulamaları savunmalı ve görsellerinde biyoteknolojinin çevresel etkilerini vurgulamalıdır.
...
1. Aşağıdakilerden hangisi grafik tasarımcıların sorumluluklarından değildir?
    ...
    > **Açıklama:** Grafik Tasarımcıların Sorumlulukları
    > Biyoteknoloji alanında grafik tasarımcıları kamuoyunun algısını şekillendirmede, katılımı artırmada ve bilinçli söylemi kolaylaştırmada önemli bir etkiye sahiptir. Bu etkiyle birlikte estetik kaygıların ötesine geçen bir dizi sorumluluk da gelir:
    > • Doğruluk ve Netlik: Tasarımcıların karmaşık bilimsel kavramları farklı kitlelerin erişebileceği ve doğru bir şekilde temsil etme görevi vardır. Net, bilgilendirici görseller biyoteknolojinin gizemini çözmeye yardımcı olup ve bireyleri bilinçli kararlar verme konusunda güçlendirecektir.
    > • Etik Çerçeveleme: Tasarımcılar görsel temsillerinin etik sonuçlarını dikkate almalıdır. Tasarımcılar, biyoteknolojik gelişmeleri dengeli ve etik bir şekilde sunarak anlamlı bir diyalog geliştirebilir ve potansiyel yanlış yorumlamaları veya yanlış anlamaları azaltabilecektir.
    > • Şeffaflık: Veri gizliliği ve biyoetik konusundaki endişelerin damgasını vurduğu bir çağda tasarımcılar, iletişim çabalarında şeffaflığa ve açıklamaya öncelik vermelidir. Bağlam sağlamak ve biyoteknolojik yenilikleri çevreleyen belirsizlikleri kabul etmek güven ve güvenilirlik oluşturabilmektir.
    > • Kültürel Duyarlılık: Biyoteknoloji çeşitli kültürel ve etik çerçeveler içerisinde faaliyet göstermektedir. Tasarımcılar kültürel nüanslara duyarlı olmalı ve görsellerinde tek merkezli bakış açılarını empoze etmekten kaçınmalıdır. Farklı kültürel geçmişlere sahip paydaşlarla iş birliği yapmak, tasarım anlatımlarını zenginleştirip kapsayıcılığı teşvik edecektir.
...
1. İnsanı merkezden çıkartıp bir bütünün parçası olarak gören, evrende değişimin gerçekleşmesinde insan ve diğer varlıkların farklı olmadığı bir bakış açısını tanımlayan kavram aşağıdakilerden hangisidir?
    ...
    > **Açıklama:** Posthümanizm: İnsanı merkezden çıkartıp bir bütünün parçası olarak gören, evrende değişimin
...
1. Aşağıdakilerden hangisi posthümanizmi tarif eden temel kavramlardan biri değildir?
    ...
    > **Açıklama:** Posthümanizmi tarif eden temel kavramlar: insanmerkezcilik karşıtlığı (antiantroposantrizm), transhümanizm, antropoteknoloji, çeşitlilik, sanal gerçeklik- simülasyon, biyopolitika
...
1. Aşağıdakilerden hangisi yapay zekâ algoritmaları görsel kültürü etkiledikçe tasarımcılar için ortaya çıkan sorunlardan biridir?
    ...
    > **Açıklama:** Yapay zekâ algoritmaları görsel kültürü etkiledikçe özgünlük ve
    > aidiyet soruları ortaya çıkmaktadır. Tasarımcılar,
    > bir araç olarak yapay zekâdan yararlanmak ile çalışmalarının bütünlüğünü ve benzersizliğini korumak
    > arasındaki dengeyi sağlamak zorundadır.
...
1. Multimedya içeriğinin kullanılabilirliğini ve erişilebilirliğini geliştirmesini sağlayarak aşağıdaki eşleştirmelerden hangileri arasında denge kurmak önemlidir?
    ...
    - C-) Estetik çekicilik ve işlevsellik
    - D-) İhtiyaç ve estetik
    - E-) Tasarım ve tüketim

    > **Açıklama:** Tasarımcılar; videolar, resimler, animasyonlar ve etkileşimli özellikler gibi multimedya ögelerini birleştirerek kullanıcılarda daha derin bir yankı uyandıran sürükleyici ve akılda
    > kalıcı deneyimler yaratabilmektedirler. Ancak multimedya içeriğinin kullanılabilirliği ve erişilebilirliği geliştirmesini sağlayarak estetik çekicilik ile işlevsellik arasında bir denge kurmak önemlidir.
    > Tasarımcılar, multimedyanın gücünden yararlanarak kullanıcıları cezbeden, bilgilendiren ve ilham
...
1. Biyosanat ve grafik tasarımdaki en önemli zorluklardan biri ........ ile bilimsel ........ arasında bir<br />denge bulmaktır. Boş kalan yerlere uygun seçenek aşağıdakilerden hangisinde doğru verilmiştir?
    ...
    > **Açıklama:** Biyosanat ve grafik tasarımdaki en önemli zorluklardan biri estetik ile bilimsel doğruluk arasında bir
    > denge bulmaktır
...
1. Aşağıdakilerden hangisi multimedya öğelerinin özelliklerinden biri değildir?
    ...
    > daha ilgi çekici ve akılda kalıcı hâle getirme konusunda belirgin bir beceriye sahiptir. Metin tabanlı
    > içeriğin aksine multimedya, karmaşık fikirleri hızlı
    > ve verimli bir şekilde iletebilir, farklı öğrenme stillerine ve tercihlerine hitap edebilir. Örneğin, iyi
...
1. Biyoteknoloji etiği açısından grafik tasarımcıların çeşitli sorumlulukları bulunmaktadır. Bilgilendirici görsellerle biyoteknolojinin gizemini çözmeye yardımcı olmak ve bireyleri bilinçli kararlar verme konusunda güçlendirmek, hangi sorumluluk kapsamında ele alınır?
    ...
    > **Açıklama:** Biyoteknoloji alanında grafik tasarımcıları kamuoyunun algısını şekillendirmede, katılımı artırmada ve bilinçli söylemi kolaylaştırmada önemli bir etkiye sahiptir. Bu etkiyle birlikte estetik kaygıların ötesine geçen bir dizi sorumluluk da gelir:
    > **• Doğruluk ve Netlik:** Tasarımcıların karmaşık bilimsel kavramları farklı kitlelerin erişebileceği ve doğru bir şekilde temsil etme görevi vardır. Net, bilgilendirici görseller biyoteknolojinin gizemini çözmeye yardımcı olup ve bireyleri bilinçli kararlar verme konusunda güçlendirecektir.
...
1. Sinema ve kamera teknolojilerinin, tüfek nişangâhları ile birlikte dünyayı algılama ve anlama biçimlerimizi şekillendirdiğini söyleyen kişi aşağıdakilerden hangisidir?
    ...
    > **Açıklama:** Paul Virilio’nun (1989) sinemanın teknolojik
    > evrimi ve toplumsal etkileri üzerine yaptığı çalışmalar, sinemanın sadece bir sanat formu değil,
    > aynı zamanda modern toplumların algısal ve bilgi
    > alanlarını dönüştürme gücüne sahip bir teknoloji
    > olduğunu vurgular. Virilio’ya (1989) göre, sinema ve kamera teknolojileri, tüfek nişangâhları ile
    > birlikte dünyayı algılama ve anlama biçimlerimizi
    > şekillendirir. Bu birleşim, görsel medyanın sadece
    > sanatsal bir ifade aracı olmanın ötesinde, aynı zamanda bilgi ve güç araçları olarak işlev gördüğünü
    > gösterir.
...
1. Aşağıdakilerden hangisi Posthümanist ögeler taşıyan filmlerden George A. Miller tarafından çekilen dört filmlik bir seri olan Mad Max filmlerinden değildir?
    ...
    > **Açıklama:** Mad Max serisinde yer alan filmler ve yılları:
    > • Mad Max - 1979
...
1. Aşağıdakilerden hangisi yapay zekada tahmini düzenlemenin açıklamasıdır?
    ...
    > **Açıklama:** Tahmini Düzenleme: Yapay zekâ, daha önce başarılı olmuş filmleri analiz edebilir ve tempolama,
    > sahne uzunluğu ve geçişler konusunda önerilerde bulunarak filmin genel kalitesini artırabilir.
...
1. Vitruvius’a göre, andığımız türde orantı kurguları müziğin ve gök kürelerin ahengini sağlamakla kalmıyor, insan bedeninin, savaş makinelerinin ve gemilerin de güzel, işlevli ve sağlam olmasını mümkün kılıyordu. ,<br />Aşağıdaki seçeneklerden hangisinde insan bedeninin boyu 1 birim kabul edildiğinde kafa, ayak ve göğüs genişliği oranları doğru verilmiştir?
    ...
    > **Açıklama:** Örneğin, insan bedeninin boyu 1 birim ise el
    > ve kafa 1/10, ayak 1/6, göğüs genişliği 1/4 oranlarındaydı.
...
1. Aşağıdakilerden hangisi dirimselcilik (Vitalizm) açıklamasıdır?
    ...
    > **Açıklama:** Dirimselcilik (Vitalizm), canlıların cansız şeylerden (örneğin makinelerden) farklı ilkelere,
    > örneğin ‘canlı maddeye’, bir tür üretken güce ya da canlılara has bir organizasyon tarzına dayandıklarını öne süren bir açıklama desenidir.
...
1. Canlıların ve diğer doğal süreçlerin, birbirinden ayrık parçalardan oluşan makinelere<br />benzer şekilde açıklanabileceği düşüncesi aşağıdakilerden hangisidir?
    ...
    > **Açıklama:** Mekanizm, canlıların ve diğer doğal süreçlerin,
    > birbirinden ayrık parçalardan oluşan makinelere
    > benzer şekilde açıklanabileceği düşüncesidir.
...
1. Bir süreci (makine, kurum, sistem, program vb.) olabilecek en verimli<br />hâline getirmeye yönelik matematik ve mühendislik yöntemlerine işaret eden terim aşağıdakilerden hangisidir?
    ...
    > **Açıklama:** Optimizasyon kelimesi, bir süreci (makine, kurum, sistem, program vb.) olabilecek en verimli
    > hâline getirmeye yönelik matematik ve mühendislik yöntemlerine işaret eder.
...
1. Doğanın bir makine metaforu içinden anlaşılması hangi yüzyıldan itibaren yaygın bir düşünceydi?
    ...
    > insan ve hayvan bedenleri de birer makine olarak
    > anlaşılmak istenmişti.
...
1. ‘Biyoteknik’ kavramını ortaya atan kişi aşağıdakilerden hangisidir?
    ...
    > **Açıklama:** 1930’larda ‘biyoteknik’ kavramını ortaya atan Frederick Kiesler’e
    > göre insan mekânı ile ‘ortak bir faaliyet’ içindeydi ve insan ile kabuğu, tıpkı bir yumuşakça gibi,
    > birlikte gelişip biçimleniyordu.
...
1. Mimarlıkta postmodernizm hangi yıllar arasında etkili olmuştur?
    ...
    > **Açıklama:** Mimarlıkta postmodernizm, modernist mimarlık ve şehirciliğin kültürel tarihleri göz ardı eden
    > tekdüzeliğine dönük bir eleştiri ve alternatif arayışı olarak 1960-1990 arasında etkili olmuştur.
    > Postmodern mimarlığı çoğunlukla tarihsel ve
    > kültürel atıflar karakterize eder.
...
1. 1950’li yıllardan itibaren robot teknolojisi ile ilgili aşağıdakilerden hangisi söylenebilir?
    ...
    > **Açıklama:** Otomasyon Dönemi: 1950’li yıllardan itibaren robot teknolojisi, üretim süreçlerinde
    > otomasyon sağlayacak makineler geliştirmeye odaklandı. Bu dönemdeki robotlar,
...
1. Aşağıdakilerden hangisi Telepatların özelliklerin biri değildir?
    ...
    > • Zihinsel İletişim: Telepatlar, sözlü veya yazılı
    > iletişim olmaksızın başkalarının düşüncelerini doğrudan algılayabilir veya onlarla düşünce yoluyla iletişim kurabilirler.
    > • Duygusal Algı: Bazı telepatlar, başkalarının
    > duygularını hissetme yeteneğine de sahiptir.
    > • Zihin Kontrolü: Bazı kurgusal anlatılarda
    > telepatlar, başkalarının zihinlerini kontrol
    > ederek onların düşüncelerini, hislerini veya
    > davranışlarını etkileyebilirler.
    > • Bilgi Aktarımı: Telepatlar, karmaşık bilgileri
    > veya hatıraları başkalarının zihnine doğrudan
    > aktarabilirler
...
1. Aşağıdakilerden hangisi kullanıcıları fiziksel dünyadan soyutlayarak bilgisayar tarafından oluşturulmuş, üç boyutlu, etkileşimli bir ortama geçmelerini sağlayan bir teknolojidir?
    ...
    > **Açıklama:** Sanal gerçeklik (SG), kullanıcıları fiziksel dünyadan soyutlayarak bilgisayar tarafından oluşturulmuş,
...
1. Hangisi tasarım alanında insan-merkezci olmayan yaklaşımların ortak özelliklerinden değildir?
    ...
    > **Açıklama:** Tasarım alanında posthümanistik yaklaşımlar
    > yeni sorular sormakta ve tasarımcılardan bu sorulara insanı merkeze yerleştirmeyen cevaplar vermelerini beklemektedir. Böylece insan-merkezci
    > olmayan pek çok olanak tasarımcıların karşısında
    > belirmektedir. Tasarım alanında insan-merkezci
    > olmayan yaklaşımların ortak özellikleri şu şekilde
    > sıralanabilir:
    > • Kullanıcıyı ya da insanı merkeze almayan
    > ve insan olmayan varlıkları da tasarım sürecinin bir parçası olarak kabul eden tasarım
    > anlayışları/fikirleri,
    > • İnsan ve insan olmayan varlıklar arasındaki
    > ilişki/etkileşim ağlarının incelenmesi,
    > • Yeni anlamların icat edilmesi,
    > • İyi tanımlanmamış problemlerden karmaşık problemlere geçiş (Payne, 2016),
    > • Tüketim amaçlı tasarım ve üretimden sürdürülebilir, etik ve eşitlikçi tasarım ve üretime yönelim
...
1. Aşağıdakilerden hangisi moda sistemini oluşturan faktörlerden değildir?
    ...
    > **Açıklama:** Moda sistemini oluşturan faktörler şunlardır:
    > Üreticiler: Elyaf üretiminden kumaş üretimine
    > ve giysi üretimine üretim zincirinde yer alan tüm
    > küçük ya da büyük ölçekli üreticileri, markaları,
    > tasarımcıları kapsamaktadır.
    > Mesleki Örgütler: Moda sektöründe faaliyet
    > gösteren aktörlerin sektöre giriş şartlarını belirleyen, düzenleyen ve destekleyen yapılardır.
    > Tüketiciler: Kendi tercihleri doğrultusunda
    > istedikleri ve satın alma güçlerinin yettiği moda
    > ürünlerini özgürce satın alabilen bireylerdir.
    > Moda medyası: Moda dergilerinden bloglara,
    > moda haftasından defilelere ve fuarlara modanın
    > yayılmasında faaliyet gösteren tüm bireyleri ve organizasyonları kapsamaktadır.
...
1. Bedende yerleştirildikleri yere göre giyilebilir teknolojiler kaç kategoriye ayrılmaktadır?
    ...
    > **Açıklama:** Bedende Yerleştirildikleri Yere Göre Giyilebilir Teknolojilerin Sınıflandırılması
    > Bedende yerleştirildikleri yere göre giyilebilir teknolojiler dört kategoriye ayrılmaktadır. Bunlar
    > bedene takılabilir araçlar, tene yerleştirilen araçlar, kumaşa entegre edilen araçlar ve aksesuar şeklindeki araçlardır.
...
1. Biyo-deriler için verilen aşağıdaki eşleşmelerden hangisi doğrudur?
    ...
    > olarak çeşitli yollarla üretilen deri benzeri ve deri
    > özellikleri gösteren tekstil yüzeyleridir. Biyo-derilerin kullanılan materyale göre birkaç türü vardır.
    > Hayvan bazlı biyo-deriler: Kolajen hayvanların derisinde bulunan, esneklik sağlayan bir proteindir.
    > Mantar bazlı biyo-deriler: Hif, “mantar türlerinin çoğunda bulunan, ince, saç benzeri doku
    > liflerinden oluşan kök sistemlerine” verilen isimdir
    > Bakteri bazlı biyo-deriler: Bazı bakterilerde,
    > bitkilerde olduğu gibi selüloz bulunmakta, bu selüloz biyo-teknoloji yardımıyla çoğaltılabilmekte
    > ve gözenekli, su itici deri benzeri yüzeylere dönüştürülebilmektedir.
    > Bitki bazlı biyo-deriler: Bitki bazlı biyo-deriler de bakteri bazlı biyo-deriler gibi selüloz tabanlı
    > uygulamalardır
...
1. I - Hayvan bazlı biyo-deriler<br />II - Mantar bazlı biyo-deriler<br />III - Bakteri bazlı biyo-deriler<br />IV - Bitki bazlı biyo-deriler<br />Yukarıdakilerden hangisi ya da hangileri biyo-derilerde kullanılan materyal türlerindendir?
    ...
    > olarak çeşitli yollarla üretilen deri benzeri ve deri
    > özellikleri gösteren tekstil yüzeyleridir. Biyo-derilerin kullanılan materyale göre birkaç türü vardır.
    > Hayvan bazlı biyo-deriler
    > Mantar bazlı biyo-deriler
    > Bakteri bazlı biyo-deriler
    > Bitki bazlı biyo-deriler
...
1. Sesin karakteristik tonu veya rengine ne ad verilmektedir?
    ...
    > **Açıklama:** "Timbre: Sesin karakteristik tonu veya rengi timbre olarak adlandırılır. Timbre, sesin
...
1. I- Dijital ses, analog sesin aksine, kalite kaybı olmadan kopyalanabilir ve aktarılabilir.<br />II- Dijital ses, bilgisayarlar ve dijital aygıtlar ile daha kolay entegre edilebilir.<br />III- Dijital ses, genellikle daha geniş bir dinamik aralığa sahip olabilir.<br />IV- Dijital ses sistemleri, analog sistemlere kıyasla daha basit ve ucuzdur.<br />Yukarıdaki ifadelerden hangileri dijital ses tasarımının avantajlarından biridir?
    ...
    > **Açıklama:** "Dijital ses tasarımının avantajları:
    > • Dijital ses, analog sesin aksine, kalite kaybı olmadan kopyalanabilir ve aktarılabilir.
    > • Dijital ses, bilgisayarlar ve dijital aygıtlar ile daha kolay entegre edilebilir.
    > • Dijital ses, genellikle daha geniş bir dinamik aralığa sahip olabilir.
    > Dezavantajları:
    > • Dijital ses; analog sesin doğal, sürekli sinyalini yakalamak için bir örnekleme işlemine tabi tutulur.
    > Bu bazen ses kalitesinde düşüşlere yol açabilir.
    > • Dijital ses sistemleri, genellikle analog sistemlere kıyasla **daha karmaşık ve pahalıdır.**" (s.261).
    > Bu nedenle I, II, III. maddeler avantajlar olup cevap c seçeneğidir.
...
1. Yapay ses efektleri oluşturma tekniğine ne ad verilmektedir?
    ...
    > **Açıklama:** "Ses Efektleri Sentezi: Yapay ses efektleri oluşturma tekniği. Bu yöntem, bilgisayar
    > tabanlı sentezleyiciler veya ses işleme yazılımları kullanılarak gerçek dışı seslerin yaratılmasını sağlar" (s.262). Buna göre cevap a seçeneğidir.
...
1. Aşağıdakilerden hangisi bilgisayar tabanlı ses düzenleme yazılımlarından biri **değildir**?
    ...
    > **Açıklama:** "Ses tasarımı genellikle bilgisayar tabanlı ses düzenleme yazılımları kullanılarak yapılır.
    > Bu yazılımlar ses kayıtlarını düzenlemenize, efektler eklemenize, sesleri karıştırmanıza
    > ve diğer ses işleme işlemlerini gerçekleştirmenize olanak tanır. Örneğin **Pro Tools,**
...
1. Aşağıdakilerden hangisi ses analizinde kullanılan yazılımlardan biridir?
    ...
    > **Açıklama:** "SpectraLayers Pro: Adobe tarafından geliştirilen ve ses spektrum analizi için kullanılan bir yazılımdır. Seslerin ayrı katmanlarda incelenmesine ve düzenlenmesine olanak sağlar" (s.264).
...
1. Önceden kaydedilmiş seslerin oynatılmasını ve manipülasyonunu içeriren ses sentezi tekniğine ne ad verilmektedir?
    ...
    > **Açıklama:** "Sample-Based Synthesis (Örnek Tabanlı Sentez): Bu teknik, önceden kaydedilmiş
    > seslerin (örneklerin) oynatılmasını ve manipülasyonunu içerir" (s.265). Buna göre cevap d seçeneğidir.
...
1. Posthümanist Tasarım Yaklaşımları filmsel ses tasarımında bilinen üç ana kategorisini ötesine geçip neyi dahil eder?
    ...
    > **Açıklama:** Filmsel ses tasarımında genellikle üç ana kategoriye odaklanılır: insan sesleri (diyaloglar, seslendirmeler vb.), müzik ve ses efektleri. Ancak, posthümanist bir yaklaşım, bu kategorilerin ötesine geçer ve insan olmayan varlıkların seslerini de dahil
    > eder.
...
1. I-Analog ses, doğal ve sürekli bir ses dalgası oluşturur bu da genellikle daha ‘sıcak’ ve ‘doğal’ bir ses kalitesi sağlar.<br />II-Analog ses sistemleri genellikle daha basit ve daha ucuzdur.<br />III-Analog ses kopyalandığında veya aktarıldığında kalite kaybına uğrayabilir.<br />IV-Analog ses, dijital sesin aksine genellikle daha dar bir dinamik aralığa sahiptir.<br />Yukarıdakilerden hangisi ya da hangileri analog ses tasarımının avantajlarındandır?
    ...
    > Avantajları:
    > • Analog ses, doğal ve sürekli bir ses dalgası
    > oluşturur bu da genellikle daha ‘sıcak’ ve
    > ‘doğal’ bir ses kalitesi sağlar.
    > • Analog ses sistemleri genellikle daha basit
    > ve daha ucuzdur.
    > Dezavantajları:
    > • Analog ses kopyalandığında veya aktarıldığında kalite kaybına uğrayabilir.
    > • Analog ses, dijital sesin aksine genellikle
    > daha dar bir dinamik aralığa sahiptir.
...
1. Muhsin Ertuğrul’un yönetmenliğini yaptığı hangi filmi ilk sesli Türk filmi olarak tarihe geçmiştir?
    ...
    > **Açıklama:** Gelişmelere Türk sinema sektörü de kayıtsız kalmamıştır. Muhsin Ertuğrul’un yönetmenliğini yaptığı İstanbul Sokaklarında (1931) filmi ilk sesli Türk filmi olarak tarihe geçmiştir. Filmin seslendirmesi
    > Paris’te yapıldı. (Sözen, 2003)
...
1. Bu teknik, karmaşık bir ses dalgası oluşturur ve ardından belirli frekansları çıkarır.<br />Ses sentezi, ses dalgalarını yapay olarak üretme sürecidir. Bu süreçte çeşitli teknikler kullanılır. Yukarıda açıklaması yapılan teknik hangisidir?
    ...
    > böylece karmaşık bir sesin karakterini değiştirebilir
...
1. Zira \_\_\_\_\_\_\_\_\_\_\_ ifade, insan deneyiminin, duygularının ve düşüncesinin karmaşıklıklarını sıradan günlük dili aşan bir biçimde keşfetme ve aktarma yönündeki köklü insan arzusunu ifade eder.<br />Aşağıdakilerden hangisi yukarıdaki tanımda verilen boşluğu **en doğru şekilde** tamamlar?
    ...
    > **Açıklama:** Zira **sanatsal** ifade, insan deneyiminin, duygularının ve düşüncesinin karmaşıklıklarını sıradan günlük dili aşan bir biçimde keşfetme ve aktarma yönündeki köklü insan arzusunu ifade eder.
...
1. Dijital medya ile blok zinciri teknolojisinin yakınsaması, dijital sanatın ve diğer dijital varlıkların satın alınması, satılması ve bu varlıklara sahip olunması için ortaya çıkan araç, aşağıdakilerden hangisidir?
    ...
    > **Açıklama:** **Dijital Sanat ve NFT’ler**
