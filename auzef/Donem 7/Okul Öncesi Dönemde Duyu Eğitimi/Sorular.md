...
1. Reseptörlerin bulundukları yerlere göre işlevleri ile ilgili aşağıdakilerden hangisi <u>doğrudur</u>?
...
1. Yenidoğan bir bebeğin çevreyi tanıması için kullandığı en <u>temel araç</u> hangisidir?
    - **Cevap A-) Duyular**
    - B-) Oyunlar
    - C-) Duygular
    - D-) Aileler
...
1. Eğitim alanındaki önemli düşünürlerle ilgili aşağıdakilerden hangisi <u>yanlıştır</u>?
...
1. İki yaşındaki bir çocuk eline aldığı bir nesnenin en ilgi çekici özelliğine dikkatini yoğunlaştırmaktadır. Yukarıda verilen durumda bu çocuk algısal olarak aşağıdakilerden hangisini gerçekleştiriyordur?
    - A-) Ayırt etme
    - B-) Tanıma
    - **Cevap C-) Seçicilik**
    - D-) Tanımlama
...
1. Duyuların aktif biçimde kullanılmaya başladığı en <u>erken dönem</u> aşağıdakilerden hangisidir?
...
1. Aşağıdakilerden hangisi duyusal sıkıntılar yaşayan çocuklar için yapılacak uygulamalardan biri <u>değildir</u>?
...
1. Doğumdan sonra beyin gelişiminin en hızlı olduğu dönem hangi ay aralığıdır?
    - **Cevap A-) 0-36 ay**
    - B-) 0-72 ay
    - C-) 0-120 ay
    - D-) 36-72 ay
...
1. Duyulardan elde edilen bilgiler beynin hangi kısmında birleşmektedir?
    - A-) Frontal lob
    - B-) Serebellum
    - C-) Oksipital lob
...
1. Duyu eğitiminde aşağıdaki öğrenme süreçlerinden hangisinin ele alınması <u>gerekmez</u>?
    - **Cevap A-) Refleks**
    - B-) Bellek
    - C-) Ayırt etme
    - D-) Eşleştirme
...
1. Erhan, sınıf içindeki etkinliklerde renkli boya kalemleri ile şekiller ve grafikler çizerek edindiği bilgileri pekiştirmektedir. Erhan ile ilgili aşağıdakilerden hangisi düşünülebilir?
...
1. Dış dünyadaki renk, parlaklık, şekil, yön, derinlik gibi özellikler hangi duyu ile algılanır?
    - A-) İşitme
    - **Cevap B-) Görme**
    - C-) Denge
    - D-) Koku alma
...
1. Aşağıdakilerden hangisi duyu eğitiminin önemleri arasında <u>yer almamaktadır</u>?
...
1. Aşağıdaki ifadelerden hangisi <u>yanlıştır</u>?
...
1. Özgül öğrenme bozukluğu ile ilgili aşağıdakilerden hangisi <u>söylenemez</u>?
...
1. Otistik olup duyusal sıkıntılar yaşayan çocukların desteklenmesi için hangisi önerilebilir?
...
1. Gözde Öğretmen sınıfındaki görme bozukluğu olan öğrencisi için duyusal bütünleştirmeyi sağlamak amacıyla duyu eğitimi için etkinlik planlarken aşağıdakilerden hangisini öncelikli olarak yapmalıdır?
...
1. Cansu, sulandırılmış parmak boyaları ve nişasta karışımına parmaklarını daldırdıktan sonra büyük boy bir muşamba üzerinde çeşitli desenler oluşturmaktadır. Bu deneyim sırasında Cansu’da aşağıdaki becerilerden hangisi gelişmiştir?
