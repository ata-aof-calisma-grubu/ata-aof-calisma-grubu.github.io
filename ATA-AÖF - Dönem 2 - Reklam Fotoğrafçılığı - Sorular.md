# Reklam Fotoğrafçılığı (Dönem 2) - Tüm Sorular

## Unite 1
1. Fotoğraf, Yunanca Photos ve Graphes sözcüklerinin bileşiminden oluşan yeni bir kelimedir.<br />**Photos ve Graphes sözcüklerinin Türkçe karşılığı aşağıdakilerden hangisidir?**
    - A-) Ses - Yazı
    - **Cevap B-) Işık - Yazı**
    - C-) Uzak - Görme
    - D-) Söz - Duyma
    - E-) Uzak - Işık
    ***
1. **Aşağıdakilerden hangisi fotoğrafın içeriksel özelliklerinden biri değildir?**
    - A-) Fotoğrafın sanatsal yönünün olması
    - B-) Fotoğrafın haber özelliği taşıması
    - C-) Fotoğrafın belge niteliği taşıması
    - **Cevap D-) Fotoğrafın görmeyle ilişkili olması**
    - E-) Fotoğrafın propaganda aracı olması
    ***
1. **Fotoğrafın kitlesel boyutta tüketilmesine zemin hazırlayan olay aşağıdakilerden hangisidir?**
    - A-) Nicephore Niepce'in maddi destek alması
    - B-) Daguerretype'ın icat edilmesi
    - C-) Fotoğrafların kopya edilmeye başlanması
    - D-) Pozlama süresinin uzaması
    - **Cevap E-) Kameraların stüdyo dışına yani sokağa çıkması**
    ***
1. **Fotoğrafın çekim konularının sadece sabit nesnelerden sıyrılıp sokağı ve yaşamı görselleştirmeye başlamasında aşağıdakilerden hangisinin etkisi olmamıştır?**
    - A-) Mercek sayısının ve kalitesinin artması
    - B-) Islak ve kuru levha yöntemlerinin bulunması
    - **Cevap C-) İnsanlığın yerleşik yaşama geçmesi**
    - D-) Teknolojik gelişmelerin hızlanması
    - E-) Fotoğraf ham maddesinin ucuzlaması
    ***
1. **“Heliografi” yani “Güneş Yazısı” şeklinde adlandırılan ilk fotoğrafımsı görüntü kim tarafından elde edilmiştir?**
    ...
    ***
1. **Aşağıdakilerden hangisi fotoğrafçılığın öncüleri arasında yer almaz?**
    - A-) Niepce
    - B-) Daguerre
    - C-) Talbot
    - **Cevap D-) Avedon**
    ...
    ***
1. **Niepce ilk fotoğrafı oluştururken kaç dakikalık bir pozlama yapmak durumunda kalmıştır?**
    - A-) 3
    - B-) 20
    - **Cevap C-) 480**
    - D-) 180
    - E-) 60
    ***
1. **Aşağıdakilerden hangisi Daguerretype’ın özelliklerinden biri değildir?**
    - A-) Ekonomik olarak pahalı olması
    - **Cevap B-) Herkes tarafından satın alınabilir olması**
    - C-) Kırılgan olması
    - D-) Tek kopya olması
    - E-) Mücevher gibi kutularda saklanması
    ***
1. **Aşağıdakilerden hangisi Talbot’un buluşunun adlandırılışını tanımlamaktadır?**
    - A-) Güneş yazısı - Heliography
    - B-) Cyonatype
    - C-) Pinhole
    - D-) Daguerretype
    - **Cevap E-) Calotype - Güzel yazı**
    ***
1. **Aşağıdakilerden hangisi Talbot’un buluşunun en önemli özelliğidir?**
    - A-) Ucuz olması
    - **Cevap B-) Çoğaltılabilir bir yapıya sahip olması**
    - C-) Çok keskin hatlara sahip olmaması
    - D-) Buluşun İngiltere’de gerçekleşmiş olması
    - E-) Talbot ve Daguerre ile aynı dönemde olması
    ***
1. **Aşağıdakilerden hangisi fotoğraf sözcüğünü ilk kez kullanan kişidir?**
    - A-) Talbot
    - B-) Daguere
    - **Cevap C-) Herschel**
    - D-) Niepce
    - E-) Nadar
    ***
1. **Fotoğraf tarihinin en çok bilinen, reklam/tanıtım – satış stratejisi olan “Siz deklanşöre basın gerisini biz halledelim” sloganını hangi fotoğraf firması geliştirmiştir?**
    - **Cevap A-) Kodak**
    - B-) Fuji
    - C-) Nikon
    - D-) Canon
    - E-) Sony
    ***
1. **Fotoğrafın en yoğun bir biçimde kitlelerce kullanımına yönelik olarak geliştirilip 1 dolar karşılığında piyasaya sürülen model aşağıdakilerden hangisidir?**
    - A-) No:1
    - B-) No:2
    - C-) No:3
    - D-) No:4
    - **Cevap E-) Brownie**
    ***
1. **Günümüzde 35 mm fotoğraf makinesi olarak adlandırılan kamera tipinin mucidi kimdir?**
    ...
    - E-) Nippon Kogaku
    ***
1. **Aşağıdakilerden hangisi biçimsel olarak fotoğraf göstergelerinden biri değildir?**
    - A-) Görmek
    - B-) Hissetmek
    - C-) Karar vermek
    - D-) Kaydetmek
    ...
    ***
1. **Aşağıdakilerden hangisi çekim esnasında çektiği fotoğraf ile fotoğrafçıyı farklılaştırır?**
    - A-) Kullandığı kameranın markası
    - **Cevap B-) Kullandığı bakış açısı**
    - C-) Kameranın rengi
    - D-) Fotoğrafçı yeleği
    - E-) Fotoğrafçı kaskı
    ***
1. **Fotoğrafın çağdaş bir tarih anlatıcısı olmasını sağlayan özellik aşağıdakilerden hangisidir?**
    - A-) Resim sanatının alçak gönüllü bir hizmetkârı olması
    - B-) Yazı ile birlikte kullanılabilir olması
    - **Cevap C-) Güncel hayatın kameraların tanıklığında yaşanması**
    - D-) Kameraların hafiflemesi
    - E-) Cep telefonlarında kamera kullanımı
    ***
1. **Aşağıdaki fotoğrafçılardan hangisi Art et Decoration dergisi için çektiği moda ve tanıtım fotoğraflarıyla bilinen bir fotoğrafçıdır?**
    - A-) Richard Avedon
    - B-) Man Ray
    - C-) Alfred Stiglitz
    ...
    - E-) Edward Weston
    ***
1. **Fotoğraf tarihinde seçim stratejisi amaçlı lider tanıtım fotoğrafını ilk olarak aşağıdakilerden hangisi çekmiştir?**
    - A-) Robert Capa – General Eisenhower
    - B-) Alberto Korda - Che
    - C-) Richard Avedon – Bill Clinton
    - **Cevap D-) Matthew Brady – Abraham Lincoln**
    - E-) Ara Güler – Recep Tayyip Erdoğan
    ***
1. **Aşağıdakilerden hangisi biçimsel olarak fotoğrafın tanımlarından biri değildir?**
    - A-) Fotoğraf ışığı görmek, yorumlamak ve kullanmaktır.
...
1. **1838'de Boulevard de Temple’de çekilen ilk canlı insan fotoğrafı hangi teknik aracılığıyla elde edilmiştir?**
    ...
    ***
## Unite 2
1. **Aşağıdakilerden hangisi enstantane hızını etkileyen değişkenlerden biri değildir?**
    - A-) Diyafram açıklığı ya da kısıklığı
    - B-) Işık şartları
    - **Cevap C-) Objenin büyüklüğü**
    - D-) Fotoğraf makinesinin hareketi
    - E-) Objektif boyutu
    ***
1. **Güçlü, kuvvetli ve heybetli bir izlenim oluşturması için fotoğrafın hangi açıdan çekilmesi gerekmektedir?**
    - A-) Göz seviyesi
    - B-) Yüksek açı
    - **Cevap C-) Düşük açı**
    - D-) Kuş bakışı
    - E-) Geniş açı
    ***
1. **Bir olay, nesne ya da mekânın kendisini çevreleyen her şeyle-tüm alanla birlikte görüntülenmesinin yapıldığı çekim ölçeğine ne ad verilir?**
    - **Cevap A-) Çok uzak çekim**
    - B-) Göğüs çekim
    - C-) Boy çekim
    - D-) Diz çekim
    - E-) Bel çekim
    ***
1. **Karşı karşıya konuşan iki kişiyi sırayla göstermede kullanılan ve birbirinin karşıtı iki açıdan çevrilen iki ayrı çekimin ortaya çıktığı çekim türü aşağıdakilerden hangisidir?**
    - A-) Ayrıntı-detay çekimi
    - **Cevap B-) Amors çekim**
    - C-) Yüz-yakın çekim
    - D-) Baş çekim
    - E-) Göğüs çekim
    ***
1. **Odak uzaklığı 6 - 16 mm arası olan, en geniş görüş açısına ve en fazla alan derinliğine sahip objektif türü aşağıdakilerden hangisidir?**
    - A-) Makro objektif
    - **Cevap B-) Balık gözü objektif**
    - C-) Zoom objektif
    - D-) Dar açılı objektif
    - E-) Geniş açılı objektif
    ***
1. **Aşağıdaki fotoğraf makinası türlerinden hangisinde obtüratör olarak ayna kullanılmaz?**
    ...
    ***
1. **Fotoğraflanması istenen bir kişiyi ezik ve komik göstermek için aşağıdaki objektiflerden hangisi kullanılmalıdır?**
    - A-) Normal 50 mm objektif
    - B-) Dar açılı 200 mm tele objektif
    - C-) 80-210 mm zoom objektif
    - D-) 90 mm objektif
    - **Cevap E-) 10 mm balık gözü objektif**
    ***
1. **Fotoğraflanması istenen bir kişiyi güçlü, heybetli ve büyük göstermek için ne tür bir objektif kullanılması gerekir?**
    - A-) 20 mm balık gözü objektif
    - B-) Normal 50 mm objektif
    - C-) Dar açılı 90 mm tele objektif
    - **Cevap D-) Geniş açılı bir objektif**
    - E-) 10 mm balık gözü objektif
    ***
1. **Aşağıdakilerden hangisi “İyi fotoğraf çekmek için çok pahalı ekipmana ihtiyaç vardır.” yanılsamasına gönderme yapmaktadır?**
    - A-) Öğrenmek
    - B-) Ertelemek
    - C-) Geliştirmek
    - **Cevap D-) Sahip olmak**
    - E-) Paylaşmak
    ***
1. **Aşağıdakilerden hangi enstantane/örtücü değeri deklanşöre basıldığı sürece perdenin açık kalıp pozlamanın devam ettiğinin göstergesidir?**
    - A-) 1/1000
    - B-) 1/200
    - **Cevap C-) B**
    - D-) T
    - E-) Z
    ***
1. **Objektif ile duyarlı yüzey/sensör arasında bulunan ve f ile simgelenen değere ne ad verilir?**
    - A-) Diyafram
    - B-) Enstantane
    - C-) Alan derinliği
    - D-) Netleme halkası
    ...
    ***
1. **Aşağıdakilerden hangisi dar açılı objektiflere ait değildir?**
    - A-) Büyüklük
    - B-) Yığılma etkisi
    ...
    ***
1. **Balık gözü gibi çok geniş açılı objektifler fotoğraf çekmek için ne tür mekânlarda fotoğrafçının işini kolaylaştırırlar?**
    - **Cevap A-) Çok dar mesafeli mekânlarda**
    - B-) Eski evlerde
    - C-) Antik kentlerde
    - D-) Portre çekimlerinde
    - E-) Yağmurlu havalarda
    ***
1. **Diyafram kısıldıkça (rakamsal olarak büyüdükçe) alan derinliği ne olur?**
    - A-) Azalır.
    - **Cevap B-) Artar.**
    - C-) Sabit kalır.
    - D-) Enstantane yükselir.
    - E-) İso değişir.
    ***
1. “Yüksek enstantane çekimleri ile ..................; düşük enstantene ile yapılan çekimler ise ......................... görülür.”<br />**Cümlede boş bırakılan yerlere aşağıdakilerden hangisi getirilmelidir?**
    - A-) portre - makro
    - B-) harekette netsizlik - hareketin yakalanması
    - **Cevap C-) hareketin yakalanması - harekette netsizlik**
    - D-) su damlacıklarının yakalanması - süt damlacıklarının havada yakalanması
    - E-) manzara - portre
    ***
1. **Diyafram açıldıkça (rakamsal olarak küçüldükçe) alan derinliği ne olur?**
    - **Cevap A-) Azalır.**
    - B-) Artar.
    - C-) Sabit kalır.
    - D-) Enstantane yükselir.
    - E-) İso değişir.
    ***
1. **ISO (International Standarts of Organization) değeri unutularak tüm fotoğraflar çekildiğinde ışık şartları arasındaki farklılıklar aşağıdaki olumsuzluklardan hangisi şeklinde fotoğraflarda karşımıza çıkar?**
    - A-) Işık patlaması
    - **Cevap B-) Noise (gürültü)**
    - C-) Netsizlik
    - D-) Blurluk
    - E-) Kararma
    ***
1. **Aşağıdakilerden hangisi fotoğrafçılığın temel ilkelerinden biri değildir?**
    - A-) Öğrenmek
    - B-) Sahip olmak
    - C-) Geliştirmek
    - **Cevap D-) Hissetmek**
    - E-) Paylaşmak
    ***
1. **Aşağıdakilerden hangisi diyafram açıklığı faktörlerinden biri değildir?**
    - A-) Enstantane hızı
    - B-) Alan derinliği uygulaması
    - **Cevap C-) Objektif türü**
...
1. I. Perde<br />II. Enstantene<br />III. Shutter<br />IV. Odak uzaklığı<br />**Yukarıdakilerden hangileri ışığın film ya da sensör üzerine düştüğü süreyi belirtmek için kullanılabilecek ifadelerdendir?**
    ...
    - E-) I, II, III ve IV
    ***
1. **Hızlı devinimi olan bir konunun hareket anını yakalamak için öncelikli olarak aşağıdaki yollardan hangisi denenir?**
    - A-) ISO’yu düşürmek
    - B-) Kısık diyafram değeri kullanmak
    - **Cevap C-) Yüksek enstantane değeri kullanmak**
    - D-) Düşük enstantane değeri kullanmak
    - E-) Parasoley kullanmak
    ***
## Unite 3
1. **Aşağıdakilerden hangisi diyafram açıklığını belirleyen faktörlerden biri değildir?**
    - A-) Enstantane hızı
    - B-) Alan derinliği uygulaması
    - C-) Efekt ya da filtre kullanımı
    - D-) ISO
    - **Cevap E-) Görsel kayıt türü**
    ***
1. **Genel olarak bir yüzey sanatının, özel olarak fotoğrafın dilini oluşturan tüm anlatım ögelerinin, belli bir çerçeve içerisinde, anlatımı etkili kılacak, izleyicinin duygu ve düşünceleriyle anlatılanı paylaşmasını sağlayacak doğrultuda düzenlenmesine ne ad verilir?**
    - A-) Fotografik görme
    - B-) Alan derinliği
    - C-) Altın oran
    - D-) Estetik
    - **Cevap E-) Kompozisyon**
    ***
1. ........................, en basit şekilde ifade edilecek olursa “aynanın/perdenin” açılıp kapanma hızıdır. Bir başka deyişle duyarlı yüzeye girecek olan ışığın süresini belirler.<br />**Cümlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?**
    - **Cevap A-) Enstantane**
    - B-) Kompozisyon
    - C-) Filtre
    - D-) Netleme
    - E-) Diyafram
    ***
1. Konudan yansıyarak gelen ışınları toplayarak duyarlı yüzey (emülsiyon taban-sensör) üzerinde net bir görüntü oluşturmaya yarayan, iç bükey-dış bükey mercekler topluluğuna ................... denir.<br />**Cümlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?**
    - **Cevap A-) objektif**
    - B-) metraj
    - C-) flaş
    - D-) örtücü
    - E-) denklanşör
    ***
1. **Aşağıdakilerden hangisi kompozisyon düzenlemelerinde etkili değildir?**
    - A-) Kullanılacak objektifin odak uzaklığı
    - B-) Konuyla aradaki mesafe
    - C-) Bakış açısı ve bakış yüksekliği
    - D-) Görsel kayıt türü
    - **Cevap E-) Objektifin optik kalitesi**
    ***
1. **Aşağıdakilerden hangisi kompozisyon kurallarını uygulama amaçları arasında yer almaz?**
    - **Cevap A-) Kurallara uymuş olmak**
    - B-) Hoşa gidecek bir biçim oluşturmak
    - C-) Anlam oluşturmak
    - D-) Doğru bir teknik uygulamak
    - E-) İzleyiciye konu hakkında açık bir iletide bulunmak
    ***
1. **Aşağıdakilerden hangisi izleyicilerin anlam oluşturmasında etkili değildir?**
    - A-) Algı düzeyi
    - B-) Kültürel altyapısı
    - C-) İnançları
    - D-) Yorum yeteneği
...
1. **Aşağıdakilerden hangisi hız ve hareket izlenimi yaratmada etki etmemektedir?**
    ...
    ***
1. **Fotoğrafta sade bir anlatım yapabilmek için aşağıdakilerden hangisi etkili olmaz?**
    - **Cevap A-) Geniş açı objektif kullanmak**
    - B-) Hareketli konularda doğru zamanlama
    - C-) Bakış yüksekliğini değiştirmek
...
1. **Fotoğrafçının hangi özellikleri çekim esnasında yapacağı tercihlerde anlam oluşumuna doğrudan etki etmemektedir?**
    ...
    - D-) Fotoğrafçının konuyla ilgili bilgi ve ilgisi
    - E-) Fotoğrafçının kültürel altyapısı
    ***
1. **İzleyiciye zaman ile ilgili bilgi aşağıdakilerden hangisiyle verilebilir?**
    - A-) Konunun hareketi
    - B-) Konu ile kamera arasındaki mesafe
    - C-) Kullanılan çekim ölçeği
    - **Cevap D-) Konunun üzerine düşen ışık**
    - E-) Konunun çerçeve içinde kapladığı alan
    ***
1. **Aşağıdaki kompozisyon ögelerinden hangisi çokluk etkisi yaratmada kullanılmaktadır?**
    - A-) Derinlik
    - B-) Uyum
    - **Cevap C-) Ritm**
    - D-) Zıtlık
    - E-) Simetri
    ***
1. **Aşağıdakilerden hangisi iki ya da daha fazla figürün birbirini tamamlayarak anlam oluşumuna katkı sağlayarak uyum ya da armoni olarak ifade edilmesini sağlayabilir?**
    - A-) Renk
    - B-) Ton
    - C-) Yön
    - D-) Biçim
    - **Cevap E-) Zıtlık**
    ***
1. **Görsel sanat disiplinleri içerisinde nesnelerin anlamlı ve estetik bir bütün oluşturacak şekilde yerleştirilmeleri için kabul edilmiş oranın adı aşağıdakilerden hangisidir?**
    - A-) Pozlama
    - B-) Kadraj
    - **Cevap C-) 1/3 kuralı**
    - D-) Yakın plan
...
1. I. Dosya boyutu<br />II. Hareketin hızı<br />III. Hareketin yönü<br />**Hareketli nesnelerin hız ve hareketinin ifadesi, teknik bilgi ve deneyimin yanı sıra yukarıdaki değişkenlerden hangisi ya da hangilerine bağlıdır?**
    ...
    ***
## Unite 4
1. **Dijital fotoğraf makinelerinde dâhilî ya da haricî kayıt edicilere ne ad verilmektedir?**
    - A-) İşletim sistemi
    ...
    - E-) Format
    ***
1. **Dijital fotoğraf makinelerinde, analog fotoğraf makinelerindeki filmin görevini aşağıdakilerden hangisi görmektedir?**
    - **Cevap A-) Sensör**
    - B-) Piksel
    - C-) Objektif
    - D-) Bellek kartı
    - E-) Filtre
    ***
1. ................ fotoğraf, elektronik ve bilgisayar teknolojisi kullanılarak fotoğraf çekme ve elde edilen görseli sayısal olarak saklama sistemi olarak tanımlanır.<br />**Cümlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?**
    - A-) Analog
    - **Cevap B-) Dijital**
    - C-) Portre
    - D-) Siyah-beyaz
...
1. Analog yöntem ile çekilen fotoğrafı görebilmek için filmin yıkanması gerekirken, dijital görüntüye hemen ulaşılır. Elde edilen fotoğrafın bir yere transferinde de analog verilerin dijitale oranla çok daha yavaş kaldığı aşikârdır.<br />**Paragrafta ifade edilen** **dijital fotoğrafçılık ve analog fotoğrafçılık karşılaştırmasıyla ilgili etken aşağıdakilerden hangisidir?**
    ...
    - E-) Taşıma kolaylığı
    ***
1. **ISO değeri arttıkça aşağıdakilerin hangisi ile karşılaşılmaz?**
    - A-) ISO değeri yükseldikçe enstantane değeri de yükselir.
    - **Cevap B-) ISO değeri yükseldikçe az ışıklı ortamda fotoğraf çekmek zorlaşır.**
    - C-) ISO değeri arttıkça grenlilik artar.
    - D-) ISO değeri arttıkça elde yapılan çekimlerde net fotoğrafa ulaşma olasılığı artar.
    - E-) ISO değerinin artması diyaframın kısılmasına yardımcı olur.
    ***
1. **İlk üretilen dijital fotoğraf makineleri ile ilgili olarak aşağıdakilerden hangisi yanlıştır?**
    - A-) Ağırlıkları fazlaydı.
    - B-) Çözünürlükleri düşüktü.
    - **Cevap C-) Ergonomik bir yapıya sahiplerdi.**
    - D-) Gövdeleri büyüktü.
    - E-) Hantallardı.
    ***
1. **Dijital makineleri birbiri ile kıyaslarken aşağıdakilerden hangisine bakılmaz?**
    - A-) Azami enstantane hızına
    - B-) Saniyede çekilebilen fotoğraf sayısına
    - C-) Netleme nokta sayısına
    - D-) Çekim hızına
    - **Cevap E-) Taksitle satılıp satılamayacağına**
    ***
1. **Dijital ve analog sistemi karşılaştırdığımızda aşağıdakilerden hangisi yanlıştır?**
    - A-) Dijital görüntülerin paylaşımı analog sisteme kıyasla daha kolaydır.
    - B-) Dijital makineler ile farklı ışık kaynaklarında çekim yapmak, analog kameralara göre çok daha kolaydır.
    - C-) Dijital fotoğraflara çekim sonrası müdahale, analog fotoğraflara oranla daha kolaydır.
    ...
    - E-) Dijital fotoğrafları bir kaynaktan başka bir kaynağa kaydetmek esnasında hiçbir kayıp söz konusu değildir. Oysa film karelerinde yapılacak çoğaltım için yapılan kopyalarda minimum % 15 oranında bir değer kaybı söz konusudur.
    ***
1. **Dijital görüntü kaydetme formatlarının en yüksek kaliteden en düşük kaliteye göre sıralaması aşağıdakilerden hangisidir?**
    ...
    - E-) RAW, JPEG, TIFF
    ***
1. **Yatay piksel adedi 5616 ve dikey piksel adedi 3744 çözünürlüğündeki görüntü kapasitesine sahip dijital bir makine ile çekilen fotoğrafın çözünürlüğü aşağıdakilerden hangisidir?**
    - A-) 12 Mega piksel
    - B-) 15 Mega piksel
    - C-) 18 Mega piksel
    ...
    - E-) 24 Mega piksel
    ***
1. **Fotoğraftaki gelişmeler incelendiğinde temelde aşağıdakilerden hangisi köklü bir değişime uğramamıştır?**
    - **Cevap A-) Karanlık kutu yapısı ve objektifler**
    - B-) Makine ebatları
    - C-) Kaydedici sistem ve film ebatları
    - D-) Işık ölçme yöntemleri
    - E-) Film sarma sistemi
    ***
1. **Aşağıdakilerden hangisi dijital fotoğrafçılıkla ortaya çıkan kavramlardan biri değildir?**
    - A-) Piksel sayısı
    - B-) Çarpan faktörü
    - C-) Sensör boyutu
    ...
    - E-) Bellek kartları
    ***
1. **Dijital fotoğrafçılıkta görüntü algılayıcı tiplerine bir örnek olarak aşağıdakilerden hangisi verilebilir?**
    ...
    ***
1. **Dijital fotoğraf sistemi düşünüldüğünde aşağıdakilerden hangisi yanlıştır?**
    ...
    - C-) Film yıkama aşamalarına ihtiyaç duyulmadığından fotoğrafa daha hızlı ulaşılır.
    - D-) Çekim sonrasında fotoğrafa müdahale etmek çok daha kolay ve esnek bir özellik gösterir.
    - E-) Dijital makineler ile farklı ışık kaynaklarında çekim yapmak çok daha kolaydır.
    ***
1. **Dijital fotoğraf makinesinin temelleri aşağıdaki hangi olayla atılmıştır?**
    - A-) Gizli görüntünün film üzerine yakalanması
    - **Cevap B-) Görsellerin tarayıcı yardımı ile bilgisayar ortamına transferi için ilk kez bir tarayıcı tasarlanması**
    - C-) Karanlık kutunun icat edilerek görüntünün ters bir şekilde kutu içinde elde edilmesi
    - D-) İnternetin bulunması ve yaygın kullanıma girmesi
    - E-) Daha önce yapılmış baskıların yeniden fotoğraflanması
    ***
1. **Dijital fotoğrafçılık aşağıdaki işlemlerden hangisini kapsamaz?**
    - A-) Görüntünün dijital fotoğraf makinesi yardımı ile kaydedilmesi
    - B-) Negatif-pozitif film baskıların taranarak dijital hâle getirilmesi
    - **Cevap C-) Daha önce çekilmiş fotoğrafların filme kaydedilip gösteri yapılması**
    - D-) Bilgisayar üzerinde bu görüntülerde istenilen değişikliğin yapılması
    - E-) Baskıların taranarak dijital hâle getirilmesi
    ***
1. **Analog fotoğraf makinelerindeki filmin işlevini dijital fotoğraf makinelerinde aşağıdakilerden hangisi görür?**
    - **Cevap A-) Sensörler**
    - B-) Tarayıcı bellek
    - C-) Batarya
    - D-) Netleme butonu
...
1. I. Yüksek kalitede görüntü barındırması ve birçok program tarafından okunabilmektedir.<br />II. Hem fotoğraflar üzerinde yapılacak müdahalelere hem de açılıp yeniden kaydetmeye imkan vermektedir.<br />III. Boyutlarının büyük olması sebebiyle kartlarda, taşıyıcı belleklerde ya da bilgisayarlarda daha büyük yer kaplar.<br />**Özellikleri verilen görüntü kaydetme formatı aşağıdakilerden hangisidir?**
    ...
    - E-) CMOS Formatı
    ***
1. SLR analog fotoğraf makinelerinde kullanılan filmin yerine, DSLR dijital fotoğraf makinelerinde ..................... kullanılmaktadır.<br />**Cümlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?**
    - **Cevap A-) sensörler**
    - B-) filtreler
    - C-) bayonetler
    - D-) parasoleyler
    - E-) körükler
    ***
1. **1963 yılında Frank Wanlass tarafından keşfedilen dijital görüntü algılayıcının adı aşağıdakilerden hangisidir?**
    - A-) PSD X
    - **Cevap B-) CMOS**
    - C-) PNG
    - D-) CCD
    ...
    ***
## Unite 5
1. **Aşağıdakilerden hangisi reklamlarda kullanılan kırmızı rengin anlamlarından biri değildir?**
    - A-) Sıcak
    - **Cevap B-) Doğal**
    - C-) Radikal
    - D-) Güçlü-kuvvetli
    - E-) Tutku
    ***
1. **Tüketicileri bir mal veya markanın varlığı hakkında bilgilendirmek ve tüketicilerin ilgili malı, markayı, hizmeti veya kurumu tercih etmesini sağlamak amacıyla göze ve/veya kulağa hitap eden mesajların hazırlanmasına ve bu mesajların kitle iletişim araçlarında ücretli olarak iletilmesine ne ad verilmektedir?**
    - **Cevap A-) Reklam**
    - B-) Pazarlama
    - C-) Tanıtım
    - D-) Halkla ilişkiler
    - E-) Sponsorluk
    ***
1. Tipografi, Eski Yunancada “typo” ve “graphie” kelime köklerinden gelir.<br />**"Typo" ve "graphie" kelimelerinin Türkçe karşılığı aşağıdakilerden hangisidir?**
    - **Cevap A-) Şekil - Yazı**
    - B-) Görsel - İçerik
    - C-) Şekil - Zemin
    - D-) Söz - Yazı
    - E-) Biçim - Denge
    ***
1. **Kelimeler, imgeler ve seslerin televizyon ve radyo reklamlarında, televizyon dizilerinde, sinema filmlerinde, kamu spotlarında, basılı materyallerde ve müzik kayıtlarında gizlenerek toplumsal hafızaya ekilmesine ne ad verilir?**
    - A-) Gizli reklam
    - **Cevap B-) Bilinçaltı mesaj**
    - C-) Propaganda
    - D-) Ürün yerleştirme
    - E-) İmaj
    ***
1. **Reklam denildiğinde aşağıdakilerden hangisi akla gelmez?**
    - A-) Reklam=tanıtım
    ...
    - **Cevap E-) Reklam=din**
    ***
1. **Reklamın temel bileşenleri arasında aşağıdakilerden hangisi yer almaz?**
    - A-) Görüntü - İmaj
    - B-) Yazı - Tipografi
    - C-) Ses - Müzik
    - D-) Slogan
    - **Cevap E-) Piktogram**
    ***
1. **Reklam fotoğrafçılığında maliyetin ucuzlamasıyla tematik portre stüdyolarının açılmasına olanak sağlayan mucit fotoğrafçı aşağıdakilerden hangisidir?**
    - A-) Daguerre
    - B-) Muybridge
    - **Cevap C-) Disdéri**
    - D-) Nadar
    - E-) Edward Curtis
    ***
1. **Abraham Lincoln başkanlık seçim kampanyası için aşağıdaki fotoğrafçılardan hangisine poz vermiştir?**
    ...
    - E-) Robert Frank
    ***
1. **Fotoğraf tarihinin en başarılı kampanya satış sloganı aşağıdakilerden hangisidir?**
    - A-) Kodak ile güvenle
    - **Cevap B-) Siz deklanşöre basın gerisini biz hâlledelim.**
    - C-) Siz çekin biz basalım.
    - D-) Fotoğraf Kodaktır.
    - E-) 150 yıl önce tüm insanlığın anlaşabileceği bir dil icat edildi.
    ***
1. **Günümüz modern reklam fotoğrafçılığının temellerini atan fotoğrafçı kimdir ve hangi firma için fotoğraflar çekmiştir?**
...
1. **Reklam fotoğraflarının aldatıcılığı hangi filmde hangi aktörün performansı ile eleştirilmiştir?**
    ...
    - B-) Godfather – Al Pacino
    - C-) Kill Bill – Uma Truman
    - D-) Truman Show – Jim Carry
    - E-) Beverly Hills Ninja – Chris Farley
    ***
1. **Reklamların en basit amacı aşağıdakilerden hangisidir?**
    - A-) Tanıtmak
    - **Cevap B-) Satış**
    - C-) Ürün çeşitliliği
    - D-) Yerel tanınırlık
    ...
    ***
1. **Günümüz reklam fotoğrafları en çok hangi medya sektöründe yayımlanmaktadır?**
    - A-) Televizyon
    - B-) Radyo
    - C-) Gazete – Dergi - Internet
    - D-) Tiyatro
    - **Cevap E-) Sinema**
    ***
1. **Aşağıdakilerden hangisi reklamın yazılı ve görsel ögelerinden biri değildir?**
    - A-) Görmek ve algılamak
    - B-) Görseller
    - C-) Tipografi
    - **Cevap D-) Teknoloji**
    - E-) Renk
    ***
1. **Bir mal veya hizmeti kamuya duyurmak, tanıtmak, ürüne ilişkin bilgi vermek, övmek veya ürünün satışını artırmak için kullanılacak olan görsel materyallerin, profesyonel ve/veya profesyonel olmayan kişiler tarafından üretilmesini ifade etmek için kullanılan kavram aşağıdakilerden hangisidir?**
    - A-) Tipografi
    - B-) Tanıtım
    - C-) Reklam
...
1. **Aşağıdakilerden hangisi başarılı bir reklamın amaçları arasında yer almaz?**
    ...
    - D-) Dikkat çekici olması
    - E-) Akılda kalıcı olması
    ***
## Unite 6
1. **Bir reklam fotoğrafının çekiminde modellerin giyeceği kostümlerden üzerinde taşıyacakları aksesuarlara, çekimin yapılacağı mekânın seçiminden, dekorun tasarlanmasına ve yerleştirilmesine değin pek çok şeyi denetlemek aşağıdakilerden hangisinin görevidir?**
    - A-) Sekreter
    - B-) Prodüksiyon yardımcısı
    - C-) Kreatif direktör
    - **Cevap D-) Sanat yönetmeni**
    - E-) Yapımcı
    ***
1. **Bir reklam fotoğrafının çekimi sırasında modelin üzerine düşen ışıkları ve pozlama değerlerini kontrol eden, çekimi koordine eden ve yeri geldiğinde çekim yapan kişi aşağıdakilerden hangisidir?**
    - **Cevap A-) Çekim asistanı**
    - B-) Reklam fotoğrafçısı
    - C-) Işıkçı
    - D-) Sanat yönetmeni
    - E-) Yapımcı
    ***
1. **Aşağıdakilerden hangisi reklam fotoğrafının çekimi öncesinde yapılması gerekenlerden biri değildir?**
    - A-) Mekân, kostüm ve dekorun belirlenmesi
    - B-) Çekimin gerçekleşeceği yere nasıl gidileceğinin planlanması
    - C-) Hangi saatlerde çekim yapılacağının tespit edilmesi
    - D-) Işık ölçümlerinin yapılması
    - **Cevap E-) Görüntülerin senaryoya uygun biçimde işlenmesi**
    ***
1. **Reklam fotoğrafçılığında mali konuları kontrol etmek, bütçeyi belirlemek ve çekim maliyetini hesaplamak aşağıdakilerden hangisinin görevidir?**
    - A-) Makyöz
    - **Cevap B-) Yapımcı**
    - C-) Prodüksiyon yardımcısı
    - D-) Sekreter
    - E-) Yaratıcı yönetmen
    ***
1. **Aşağıdakilerden hangisi modern reklam fotoğrafçısında olması gereken özelliklerden biri değildir?**
    - A-) İyi bir tasarım bilgisine sahip olmak
    - B-) Fotoğrafçılık alanındaki yeniliklere hakim olmak
    - C-) Müşteri beklentilerine tam anlamıyla karşılık vermek
    - D-) Evrensel anlamda düşünmek ve iletişim kurmak
    - **Cevap E-) İşini sadece yerel ölçekte sürdürmek**
    ***
1. **Reklam fotoğrafçılığının yapım sürecinde müşteri ile ilk diyalog sağlayan kişi aşağıdakilerden hangisidir?**
    - A-) Yapımcı
    - **Cevap B-) Sekreter**
    - C-) Kreatif direktör
    - D-) Sanat yönetmeni
    - E-) Işıkçı
    ***
1. **Tanıtımı istenen bir ürünle ilgili olarak anlaşma yapım sürecinde ilk iş nedir?**
    - A-) Çekim yeri aramak
    - B-) Model aramak
    - C-) Ekipman aramak
    - **Cevap D-) Zaman çizelgesi hazırlamak**
    - E-) Dekor yapmak
    ***
1. **Aşağıdakilerden hangisi tasarım ekibinde yer almaz?**
    - A-) Creatif direktör
    - B-) Sanat yönetmeni
    - C-) Metin yazarı
    - **Cevap D-) Makyöz**
...
1. “Görüntü işleme ekibinin görevlerinden biri .................... ve fotoğrafı ................hâle getirmektir.”<br />**Cümlede boş bırakılan yerlere sırasıyla aşağıdakilerden hangisi getirilmelidir?**
    ...
    - D-) photoshop kullanmak – siyah beyaz
    - E-) genel çekim – pazarlama
    ***
1. **Aşağıdakilerden hangisi çekim ekibinde yer almaz?**
    - A-) Reklam Fotoğrafçısı
    - **Cevap B-) Müşteri ilişkileri temsilcisi**
    - C-) Işıkçı
    - D-) Makyöz
    - E-) Çekim asistanı
    ***
1. Grafik tasarımcı ............. ile .......... başarılı bir biçimde kompoze eden kişidir.<br />**Cümlede boş bırakılan yerlere sırasıyla aşağıdakilerden hangisi getirilmelidir?**
    ...
    - E-) yazı- sloganı
    ***
1. **Benjamin Franklin kışın evde oturmaktan hastalanan kadınlar için hangi ürünün tanıtımını yapmıştır?**
    - A-) Opon
    - B-) Taylol Hot
    - C-) Ayakkabı keçesi
    - **Cevap D-) Pennsylvania Şömineleri**
    - E-) UFO elektrikli ısıtıcı
    ***
1. **Creative Director, tasarım grubunda aşağıdaki vasıflardan hangisi ile anılır?**
    - A-) Organizatör
    - B-) Tek sorumlu
    - **Cevap C-) Amiral**
    - D-) Prodüktör
    - E-) Müşteri ilişkileri temsilcisi
    ***
1. **Aşağıdakilerden hangisi görüntü işleme ekibinin fotoğrafın görselliğine kalite katmak ve onu olduğundan daha ilgi çekici göstermek için kullandığı filtrelerden biridir?**
    - A-) Blur
    - B-) Gussian Blur
    - **Cevap C-) High Pass**
    - D-) Sharpen
    - E-) High Volume
    ***
1. “Işıkçının görevleri arasında yeri geldiğinde atmosfer yaratacak ..............yeri geldiğinde Hollywood yıldızları için kullanılan .............. tipi ışıklandırmayı ayarlayabilmek yer alır.”<br />**Cümlede boş bırakılan yerlere sırasıyla aşağıdakilerden hangisi getirilmelidir?**
    - A-) dramatik Işık – duman
    - B-) duman – röprüdüksüyon
    - C-) üç ışık – hotlight
    - D-) soft Light – hotlight
    - **Cevap E-) dramatik ışık – glamour lighting**
    ***
1. **Reklam fotoğçılığında gelişen teknoloji sonucunda dia/slayt filmlerin kullanımdan kalkması hangi sektörü doğrudan etkilemiştir?**
    - A-) Gazetecilik sektörünü
    - B-) Fotoğraf malzemeleri satan toptancıları
    - **Cevap C-) Matbaada çalışan renk ayrımcılarını**
    - D-) Fotoşopçuları
    - E-) Reklam fotoğrafçılarını
    ***
1. **Reklam fotoğrafhaneleri gelişen ve değişen şartlar sonucunda ne tür bir yapıya dönüşmüşlerdir?**
    - A-) Aliminütçü dükkanına
...
1. **Fotoğrafta konu üzerinde oluşan en aydınlık bölge ile en karanlık bölge arasındaki farka ne ad verilir?**
    ...
    - E-) Cephe ışığı
    ***
1. **Fotoğraf çekiminde kullanılan güneş ışığı aydınlatmalarının diğer adı aşağıdakilerden hangisidir?**
    - A-) Yapay ışık
    - **Cevap B-) Doğal ışık**
    - C-) Cephe ışığı
    - D-) Tepe ışığı
    - E-) Ters ışık
    ***
1. **Yüksek kontrast ve az ışıklı alanları barındırarak korku ve dramatik bir yapıyı yakalamaya imkân veren aydınlatma türü aşağıdakilerden hangisidir?**
    - **Cevap A-) Low Key aydınlatma**
    - B-) High Key aydınlatma
    - C-) Dört ışıklı aydınlatma
    - D-) Üç ışıklı aydınlatma
    - E-) İki ışıklı aydınlatma
    ***
1. Işık, ister doğal ister yapay olsun konuyu üç hâlde aydınlatır.<br />**Işığın üç aydınlatma hâli aşağıdakilerden hangisinde doğru olarak verilmiştir?**
    - A-) Doğal aydınlatma, yapay aydınlatma, tersten aydınlatma
    - B-) Tek ışık aydınlatması, iki ışık aydınlatması, üç ışık aydınlatması
    - C-) Süzülmüş aydınlatma, kontrast aydınlatma, doğal aydınlatma
    - **Cevap D-) Doğrudan aydınlatma, yansımış aydınlatma, süzülmüş aydınlatma**
    - E-) Süzülmüş aydınlatma, difüz aydınlatma, yapay aydınlatma
    ***
1. **Bir fotoğraf çekerken ya da çekilmiş bir fotoğrafa bakarken, ışığın konuyu hangi yönden aydınlattığı nasıl anlaşılır?**
    - A-) Şiddeti ölçülerek
    - B-) Rengi ölçülerek
    - C-) Konuya olan mesafesine bakılarak
    - **Cevap D-) Objenin gölgesine bakılarak**
    - E-) Yansıtıcı kullanılarak
    ***
1. **Gün ışığı aşağıdaki hangi yönde konuyu aydınlatmaz?**
    - A-) Cephe
    - B-) Tepe
    - **Cevap C-) Alttan**
    - D-) Ters
...
1. I. Fotoğrafçılıkta en çok kullanılan ışık türüdür.<br />II. Cisimlerin üç boyut yapısını vurgulayan en ideal ışıktır.<br />III. Doğru renklerin en kolay yakalandığı aydınlatma yönüdür.<br />IV. Gölge ve aydınlık bölgeyi aynı anda barındırır.<br />**Yukarıdaki özellikler konuyu hangi yönden aydınlatan ışık için geçerlidir?**
    ...
    - **Cevap E-) Yanal**
    ***
1. **Aşağıdakilerden hangisi Rembrandt aydınlatması için söylenemez?**
    - A-) Dar açılı ışık veren aydınlatma kaynağı kullanılarak konu aydınlatılır.
    - **Cevap B-) Birden fazla aydınlatma kullanıldığından konu üzerinde yeterince gölgeli alan yoktur.**
    - C-) Işık yüzün bir bölümüne 45 derecelik açı ile verilir.
    - D-) Az ışık alan yüzün diğer bölümünde gözün altında ve elmacık kemiğinde ters üçgen şeklinde bir aydınlatma olur.
    - E-) Kadraj alanı içinde konunun belli bölgeleri aydınlatılırken diğer bölgeleri tamamen ya da azaltılmış oranda karartılır.
    ***
1. **Stüdyo ortamında fotoğrafı çekilecek bir konunun dört ışık ile aydınlatılmasında aşağıdaki ışıklardan hangisi kullanılmaz?**
    - A-) Ana (anahtar) ışık
    - B-) Yardımcı ışık
    - **Cevap C-) Ortam ışığı**
    - D-) Fon ışığı
...
1. **High Key aydınlatma için** **aşağıdakilerden hangisi** **söylenemez?**
    ...
    - E-) Işığın şiddetinin yüksek oluşu, gölgeleri ve görüntüde doku zenginliğini yok eder.
    ***
1. **Low Key Aydınlatma ile ilgili olarak aşağıdakilerden hangisi yanlıştır?**
    - A-) Fotoğraf karesi içinde objenin yalnız bir bölümü aydınlatılır.
    - B-) Dramatik bir atmosfer elde edilerek gerilimli bir ifadeye ulaşmaya çalışılır.
    - C-) Çekilen fotoğraflarda tonlar daha koyu ve hâkim renk genellikle siyahtır.
    - D-) Çoğu zaman tek ışık kullanılır.
    - **Cevap E-) Reflektör yardımı ile fotoğraf tamamen karartılır.**
    ***
1. **Reklam fotoğrafında ışıktan söz edildiğinde aşağıdakilerden hangisi yanlıştır?**
    - A-) Işığın konu üzerinde en aydınlık bölgeden en karanlık bölgeye göre “ton farkı” oluştururken kontrastı da belirlenmiş olur.
    - B-) Gün ışığında yapılan bir reklam çekimi düşünüldüğünde; sabahın erken ve akşamın geç saatlerinde, güneşin rengi daha sarı olduğu için çekilen fotoğrafta da hakim renk sarı olacaktır.
    - C-) Işık, konudan uzaklaştıkça şiddeti, aldığı mesafenin karesi oranında azalır.
    - **Cevap D-) Işık, saydam ya da yarı saydam bir objeden süzülerek konuyu aydınlatıyorsa, süzüldüğü objenin rengini almaz, kaynağındaki rengi konu üzerine taşır.**
    - E-) Işık, yansıyarak geldiğinde, yansıdığı yüzeyin rengini alarak konuyu aydınlatır.
    ***
1. **Rembrandt’ın asıl mesleği aşağıdakilerden hangisidir?**
    - A-) Heykeltıraş
    - B-) Şair
    - **Cevap C-) Ressam**
    - D-) Fotoğrafçı
    - E-) Sanat Tarihçi
    ***
1. **Özel ışık aydınlatma başlığı altında verilen aydınlatma çeşitleri aşağıdakilerin hangisinde doğru verilmiştir?**
    - **Cevap A-) Rembrandt aydınlatma, High Key, Low Key**
    - B-) Tek ışıklı aydınlatma, iki ışıklı aydınlatma
    - C-) High Key, Low Key, çoklu aydınlatma
    - D-) Rembrandt aydınlatması, çoklu aydınlatma, üçlü aydınlatma
    - E-) İkili aydınlatma, üçlü aydınlatma, çoklu aydınlatma
    ***
1. **Fotoğrafçılıkta anahtar ışığın diğer adı aşağıdakilerin hangisidir?**
    - **Cevap A-) Ana ışık**
    - B-) Tepe ışığı
    - C-) Dolgu ışığı
    - D-) Kelebek ışık
    - E-) Süzülmüş ışık
    ***
1. **İki ışık aydınlatmasında kullanılan ışıklar aşağıdaki hangi şıkta doğru olarak verilmiştir?**
    - A-) Anahtar Işık, Ana Işık
    - B-) Ana Işık, Yansımış Işık
    - C-) Süzülmüş Işık, Dolgu Işığı
    - **Cevap D-) Anahtar Işık, Dolgu Işığı**
    - E-) Anahtar Işık, Tepe Işığı
    ***
1. **Işık, konuyu aydınlatırken şiddetli aydınlattığı bölgeden daha az şiddetli aydınlattığı bölgeye doğru ilerlerken güç kaybederek yoluna devam eder. Işığın konu üzerinde oluşturduğu bu değişim fotoğrafçılıkta aşağıdaki hangi kavram ile ifade edilmektedir?**
    - **Cevap A-) Ton Farkı**
    - B-) Kontrast
    - C-) Fon Işığı
    - D-) Ortam Işığı
    - E-) Tepe Işığı
    ***
1. **İster doğal ister yapay olsun ışığın konuyu aydınlatma hâlleri aşağıdakilerden hangisinde doğru verilmiştir?**
    - **Cevap A-) Doğrudan aydınlatma, yansıyarak aydınlatma ve süzülerek aydınlatma**
    ...
    - E-) Cephe aydınlatma, tepe aydınlatma, süzülerek aydınlatma
    ***
1. **Aşağıdakilerden hangisi reklam fotoğrafçılığında aydınlatma çeşitlerinden biri değildir?**
    - A-) Özel Işık
    - B-) Üç Işıklı
    - C-) İki Işıklı
    - D-) Çoklu Işıklı
    - **Cevap E-) Dört Işıklı**
    ***
1. **Bir fotoğrafta ana ışıkla konunun bir bölümü aydınlanırken diğer bölümünde kullanılan ve ana ışığa oranla daha düşük şiddette olan ışık türüne verilen ad aşağıdakilerden hangisidir?**
    - A-) Ters ışık
    - B-) Tepe ışığı
    - C-) Ana ışık
    - D-) Cephe ışığı
