...
1. Aşağıdakilerden hangisi sözlü kültüre özgü kültür aktarım mecralarından biri değildir?
    ...
    <hr />
1. Sözlü kültür aktarılan kültür ögelerinin tamamına ne ad verilir?
    - A-) Kültürel miras
    - B-) Bellek
    - C-) Ses
...
1. Bir şeyin yerini tutan, o şeyi üreten ya da niteleyen düşünceye ne ad verilir? *(2 kez soruldu)*
    ...
    <hr />
1. Bir şeye fiziksel varlığının dışında anlam veren; bir şeyi işaret eden söze, tasarıma, görüntüye ya da biçime ne ad verilir? *(2 kez soruldu)*
    - A-) Simge
    - B-) Gösterilen
    - C-) Algı
    - **Cevap D-) Gösteren**
...
1. Aşağıdakilerden hangileri Althusser'in ideolojik aygıtlarındandır?
    ...
    <hr />
1. I. Okul<br />II. Medya<br />III.Polis<br />IV.Kolluk güçleri<br />Yukarıdakilerden hangisi/hangileri devletin ideolojik aygıtlarındandır?
    - A-) Yalnız I
    - B-) Yalnız II
    - **Cevap C-) I ve II**
    - D-) II, III ve IV
...
1. I. Medya modern toplumlarda adeta bir simülasyon makinesi olarak işlev görmektedir.<br />II. Modern toplumlarda kitle iletişim araçları toplumsalı desteklemektedir.<br />III. Postmodern toplumlarda medyanın egemenliğinde hipergerçek bir ortam yaratılmakta ve bu ortam olayların gerçeklerle ve tarihle olan ilişkisini kopararak âdeta tarihin sonunu getirmektedir.
    - A-) Yalnız I
    - B-) Yalnız II
    - **Cevap C-) I ve III**
    - D-) II ve III
