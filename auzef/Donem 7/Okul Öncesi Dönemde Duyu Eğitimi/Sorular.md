...
### 1.1. Duyularla Dolu Bir Yaşam - Temel Kavramlar

1. Duyularla ilgili aşağıdaki tanımlardan hangisi <u>yanlıştır</u>?
    - A-) Uyaran, organizmada duyusal veya davranışsal bir tepki ortaya çıkaran herhangi bir güç, nesne veya olaydır.
    - B-) Reseptörler duyu organlarının yapısında bulunan uyaranları alıp beyne ileten özelleşmiş hücre, hücre grubu ve sinir yapılarıdır.
    - C-) Serebral korteks, duyuların beyinde işlemlendiği ve anlamlandırıldığı bölümdür.
    - **Cevap D-) Merkezi sinir sistemi, sinir sisteminin beyin ve omurilik <u>haricindeki</u> kısmına verilen addır.**
    - E-) Çevresel sinir sistemi, merkezi sinir sistemi ile organlar arasındaki iletişimi sağlayan sinir sistemine verilen addır.
...
2. Duyuların algılanması süreciyle ilgili hangisi <u>doğrudur</u>?
    ...
    - D-) Duyu reseptörleri, merkezi sinir sistemine vücudun içinden ve dışından bilgi veren özelleşmiş yapılardır.
    - **Cevap E-) Hepsi**
...
4. Yenidoğan bir bebeğin çevreyi tanıması için kullandığı en <u>temel araç</u> hangisidir?
    - **Cevap A-) Duyular**
    - B-) Oyunlar
    - C-) Duygular
    - D-) Aileler
...
### 1.2. Duyuların Önemi / Duyu Gelişimi

5. Duyuların aktif biçimde kullanılmaya başladığı en <u>erken dönem</u> aşağıdakilerden hangisidir?
    - A-) Yetişkinlik yılları
    - B-) Doğumla beraber
    - **Cevap C-) Doğum öncesi dönem**
    - D-) Bir yaş civarı
    - E-) Üç yaş civarı
...
6. Aşağıdaki durumlardan hangisi duyuların kişinin <u>güvenliğini sağlayıcı</u> işlevini ortaya koymaktadır?
...
7. Bebekle geçirdiği zaman göz önünde bulundurulduğunda; bebeğin gelişiminin desteklenmesi açısından hangi birey daha büyük sorumluluğa sahiptir?
    - A-) Kardeş
    - B-) Akran
    - **Cevap C-) Ebeveyn**
    - D-) Kreş öğretmeni
...
8. Aşağıdakilerden hangisi çocukların potansiyel gelişim düzeylerine ulaşabilmesi için gerekli olan etmenlerden biri <u>değildir</u>?
    - A-) Ebeveynler ile yakın ilişki
    - B-) Kaliteli ev ortamı
    - C-) Gelişime uygun çeşitli materyallerin sağlanması
    - D-) Oyun oynama, şarkı söyleme gibi etkinliklerin yapılması
    - **Cevap E-) Çocuğun kendiliğinden büyüyebilmesi için özgürlük tanınması**
...
9. Aşağıdakilerden hangisi duyulara yönelik imgelerden biri <u>değildir</u>?
    - A-) Ses
    - B-) Koku
    - C-) Titreşim
    - **Cevap D-) Hüzün**
...
10. Aşağıdaki kavramlardan hangisi duyu çalışmaları ile etkin bir şekilde <u>öğrenilemez</u>?
    - A-) Pürüzlü-pürüzsüz
    - **Cevap B-) Sağ-sol**
    - C-) Açık-koyu
    - D-) Sıcak-soğuk
...
11. Kişiler arası iletişimde belirli bir duruma yönelik tanımlamalar yaparken karşı tarafın anlatılan durumu duyusal olarak algılamasına yardımcı olmak amacıyla duyulara yönelik nasıl bir ifade biçimi kullanılabilir?
    ...
    - D-) Durumu üstü kapalı cümlelerle açıklama
    - **Cevap E-) Duyulara yönelik <u>sıfatların</u> kullanılması**
...
12. Aşağıdakilerden hangisi duyusal sıkıntılar yaşayan çocuklar için yapılacak uygulamalardan biri <u>değildir</u>?
    - A-) İşitsel entegrasyon eğitimi
    - **Cevap B-) Duyusal kaçınma desteği**
    - C-) Duyu uyarım yöntemleri
    - D-) Duyusal entegrasyon terapisi
    - E-) Duyu-motor müdahale

    > **Açıklama:** Duyusal entegrasyon terapisi, duyu uyarım yöntemleri ve duyu-motor müdahale birer destek uygulamasıdır. <b>Duyusal kaçınma desteği</b> ise bir müdahale değil, çocuğun gösterdiği bir tepki biçimidir.

    <hr />

### 1.2. Duyuların Önemi

13. Aşağıdakilerden hangisi duyuların önemi kapsamına <u>girmez</u>?
...
14. 6 aylık bir bebek, eline aldığı bir çıngırağı tekrar tekrar sallayarak çıkardığı sesi dinlemekten keyif aldığını göstermektedir. Bu bebekle ilgili aşağıdakilerden hangisi <u>söylenemez</u>?
...
15. Okul bahçesinde oyun saati sürecince Furkan büyük oranda kum alanında oynamaktadır. Ellerini toprağın içerisinde gezdirir, bulduğu farklı dokudaki taşları incelemektedir. Taşları pürüzlü ve pürüzsüz olarak ayırmaktadır. Yukarıdaki duruma bakıldığında Furkan’ın hangi duyu özelliğinin baskın olduğu söylenebilir?
    ...
    > **Açıklama:** Furkan’ın kum, toprak ve farklı dokudaki taşlarla ilgilenmesi, pürüzlü/pürüzsüz ayrımı yapması <b>Dokunma</b> (Taktil) duyusunun baskın olduğunu gösterir.

    <hr />

### 1.1. Duyularla Dolu Bir Yaşam - Temel Kavramlar

16. Nesnelerle el ile dokunmadan hissetmek ve hareket ettirmek hangi tür dokunma olarak adlandırılır?
    - A-) Doğrudan dokunma
    - B-) Etkin dokunma
    - C-) Dolaylı dokunma
    - D-) Aktif dokunma
...
### 1.2. Duyuların Önemi / Algısal Gelişim

17. İki yaşındaki bir çocuk eline aldığı bir nesnenin en ilgi çekici özelliğine dikkatini yoğunlaştırmaktadır. Yukarıda verilen durumda bu çocuk algısal olarak aşağıdakilerden hangisini gerçekleştiriyordur?
    - A-) Ayırt etme
    - B-) Tanıma
    - **Cevap C-) Seçicilik**
    - D-) Tanımlama
    ...
    > **Açıklama:** Çocuğun nesnenin sadece <b>en ilgi çekici</b> özelliğine dikkatini odaklaması, algısal süreçte <b>Seçicilik</b> yaptığını gösterir.

    <hr />

### 1.2. Duyuların Önemi / Duyu Gelişimi

18. Aşağıdaki duyu çeşitleri arasından hangisi diğerlerine göre daha önce gelişmektedir?
    - **Cevap A-) Dokunma**
    - B-) Koklama
    - C-) Görme
    - D-) Tat alma
...
19. Hangi yaşlar anne, baba ya da bakıcının çocukla olumlu iletişim ve etkileşim içine girmesi ile hem zihinsel hem de kişilik yapısı olarak sağlıklı ve yaşamda başarılı bireyler yetişmesinde etkili yaş dönemidir?
    - A-) Beş-altı yaşlar
    - B-) Ergenlik çağları
    - C-) İlkokul dönemi
    - **Cevap D-) İlk üç yıl**
...
### 1.2. Duyuların Önemi - Tarihsel Temeller

20. Eğitim alanındaki önemli düşünürlerle ilgili aşağıdakilerden hangisi <u>yanlıştır</u>?
    - A-) Comenius, erken çocuklukta en iyi öğrenmenin duyular yoluyla olduğunu savunmakadır.
    - B-) Duyu temelli eğitime yönelik ünlü Resimli Dünya (Orbis Pictus) isimli ilk çalışma Comenius’a aittir.
    - **Cevap C-) Boş levha (tabula rasa) kavramı Comenius tarafından ortaya atılmıştır.**
    - D-) J.J. Rousseau, çocuğun her şeyi öğrenebilecek nitelikte doğduğunu savunmaktadır.
    - E-) J.J. Rousseau, çocuğun keşfetme arzusunun duyuları yoluyla karşılandığını belirtmiştir.

    > **Açıklama:** Boş levha (tabula rasa) kavramı Comenius tarafından değil, <b>John Locke</b> tarafından ortaya atılmıştır.

    <hr />

### 1.2. Duyuların Önemi

21. Aşağıdakilerden hangisi duyu eğitiminde dikkate alınabilecek göstergelerden biri <u>değildir</u>?
    - **Cevap A-) Sohbeti sürdürme**
    - B-) Ağzıyla ses çıkarma
    - C-) Farklı tatları ayırt etme
    - D-) Göz kontağı kurma
    - E-) Isı değişimini algılama
...
22. Aşağıdakilerden hangisi duyuların önemi kapsamına girmez?
    - A-) Nesneleri tanıma, algıyı geliştirme becerilerini geliştirir.
    - B-) Zararlı olabilecek durumları fark etmeye olanak sağlar.
    - C-) Gelişimin temelini oluşturur.
    - **Cevap D-) Fiziksel kondisyonu geliştirir.**
...
23. Bebeklik ve ilk çocukluk dönemindeki duyu gelişimiyle ilgili hangisi <u>yanlıştır</u>?
    ...
    - D-) Her bebek yaşama aynı duyu hassasiyeti ile gelemeyebilmektedir.
    - E-) Tüm duyular doğumdan itibaren aktif biçimde kullanılmaya başlanmaktadır.

    > **Açıklama:** Yeni doğan bebeklerde tat duyusunun kısmen gelişmiş olmasına rağmen, kaynaklar koku duyusunun <b>fazla gelişmemiş olduğunu</b> belirtmektedir.

    <hr />

### 1.2. Duyuların Önemi

24. Aşağıdakilerden hangisini söyleyen bir birey diğerlerine göre duyulardan daha çok etkileniyor olabilir?
...
25. Çevreden gelen görme, işitme, dokunma, koklama ve tatma duyularına yönelik duyusal mesajları alan duyu sistemi hangisidir?
    - **Cevap A-) Dışsal**
    - B-) Dokunsal
    - C-) Erişimsel
    - D-) İçsel
    ...
    > **Açıklama:** Görme, işitme, dokunma, koklama ve tatma duyularına yönelik mesajları alan sistem <b>Dışsal</b> duyu sistemidir.

    <hr />

### 1.1. Duyularla Dolu Bir Yaşam - Reseptörler

26. Reseptörlerin bulundukları yerlere göre işlevleri ile ilgili aşağıdakilerden hangisi <u>doğrudur</u>?
    - A-) Ekteroseptörler, vücudun dışında deride bulunur ve derinin maruz kaldığı çevresel etkiyi yansıtır.
    - B-) İnteroseptörler, vücudun iç kısmında bulunan tansiyon ve pH değişimi gibi çeşitli uyaranları alır.
    - C-) Teleseptörler, koku, ses, görüntü gibi uzaktan gelen uyaranları alır.
    - D-) Proprioseptörler, kas, tendon, eklemler ve iç kulağın denge ile ilgili kısmında yer alırlar.
    - **Cevap E-) Hepsi**

    > **Açıklama:** Listelenen tüm reseptör tipleri (Ekteroseptörler, İnteroseptörler, Teleseptörler ve Proprioseptörler) bulundukları yerlere göre doğru işlevlere sahiptir.

    <hr />

### 1.2. Duyuların Önemi

27. Yediği mamayı tadından dolayı yemeyi reddeden bir bebek hangi duyusunu kullanıyordur?
    - A-) Denge
    - B-) Görme
    - **Cevap C-) Tat**
    - D-) İşitme
...
28. Bir okul öncesi çocuğu karşılaştığı kişilerden birinin cinsiyetini anlamasında duyusal olarak önce hangi duyusunu kullanır?
    - A-) Tatma
    - **Cevap B-) Görme**
    - C-) Denge
    - D-) Koklama
...
29. Bir okul öncesi çocuğu parkta arkadaşlarıyla oyun oynarken arkasından hızla yaklaşan salıncağın kendisi için tehlikeli bir durum oluşturacağını duyusal olarak önce hangi duyusu ile anlayabilir?
    - **Cevap A-) İşitme**
    - B-) Tatma
    - C-) Görme
    - D-) Koklama
    ...
    > **Açıklama:** Hızla yaklaşan salıncağın oluşturduğu tehlike, çıkan ses (rüzgar, salıncağın sesi) yoluyla <b>İşitme</b> duyusuyla önce algılanabilir.
...
### 2.1. Beyindeki Duyusal Alanlar

2. Duyulardan elde edilen bilgiler beynin hangi kısmında birleşmektedir?
    - A-) Frontal lob
    - B-) Serebellum
    - C-) Oksipital lob
...
### 2.1. Beyin ve Duyu İlişkisi

3. Doğumdan sonra beyin gelişiminin en hızlı olduğu dönem hangi ay aralığıdır?
    - **Cevap A-) 0-36 ay**
    - B-) 0-72 ay
    - C-) 0-120 ay
    - D-) 36-72 ay
...
4. Doğum sonrasından kaç yaş civarına kadar sinaps oluşumu oldukça hızlıdır?
    - A-) 16 yaş
    - B-) 14 yaş
    - C-) 10 yaş
    - **Cevap D-) 6 yaş**
...
5. Kaç yaş civarında beyinde nöral budama başlar?
    - A-) 3 yaş
    - **Cevap B-) 9 yaş**
    - C-) 8 yaş
    - D-) 6 yaş
...
7. Vestibüler duyusunun işlevi aşağıdakilerden hangisidir?
...
9. Çocuğun vücudunu, boynunu ve başını yer çekimine karşı dik tutabilmesi hangi duyu ile ilişkilidir?
    - A-) Görme
    - B-) İşitme
    - C-) Dokunma
    - **Cevap D-) Denge**
...
10. Beş yaşındaki Aycan anasınıfındaki etkinliklere katılmakta zorluk çekmektedir. Özellikle sınıf içi ve dışındaki her hareket dikkatinin dağılmasına neden olmaktadır. Bu bilgiler ışığında, Aycan için aşağıdakilerden hangisini söylemek mümkündür?
...
### 2.2. Günlük Yaşamın Parçası Olarak Duyu İşlemleme

11. Duyu eğitiminde aşağıdaki öğrenme süreçlerinden hangisinin ele alınması <u>gerekmez</u>?
    - **Cevap A-) Refleks**
    - B-) Bellek
    - C-) Ayırt etme
    - D-) Eşleştirme
...
12. Zeynep oyun oynadığı sırada dışarıdan gelen bir kokuyu fark edip oyununu yarım bırakmıştır. Kokunun kaynağını bulmak için çaba göstermektedir. Buna göre Zeynep’in davranışı Dunn’ın hangi duyusal örüntü türü ile açıklanabilir?
    - A-) Düşük algılama
    - B-) Duyusal kaçınma
...
13. Altı yaşındaki Ahmet uygun destek alamadığında başkalarının fark ettiklerini fark etmekte başarısızlık göstermektedir. Bu durumda Ahmet’in duyusal özelliği aşağıdakilerden hangisidir?
    - A-) Duyusal duyarlık
...
14. Aşağıdakilerden hangisi düşük algılama modeline sahip çocukları desteklemek için yapılabilecek bir uygulamadır?
...
15. Bir bebeğin doğduktan sonraki süreçte duyularını çok daha aktif ve etkin biçimde kullanımında aşağıdakilerden hangisi ön plana çıkmaktadır?
    ...
    - D-) Duyusal sistemlerin oluşmaya başlaması
    - E-) Sinir sisteminin duyuların tamamını işlemesi
...
### 2.4. Duyuların Gelişimini Destekleyici Etkinlikler
...
16. Erhan, sınıf içindeki etkinliklerde renkli boya kalemleri ile şekiller ve grafikler çizerek edindiği bilgileri pekiştirmektedir. Erhan ile ilgili aşağıdakilerden hangisi düşünülebilir?
    - **Cevap A-) Görsel olarak öğrenen bir çocuktur.**
    - B-) Dokunarak rahat öğrenebilir.
    - C-) Dinleyerek kolay öğrenebilir.
    - D-) Seslere odaklanması kolaydır.
    - E-) Duyusal olarak kaçınması vardır.
...
17. Bireylerde görme ve konuşma yeteneğini oluşturan beyin sistemleri ne kadar süre içerisinde yapılandırılmaktadır?
    - A-) İlk 4 ay
    - B-) 3 yaş sonrası
    - **Cevap C-) İlk 8 ay**
    - D-) İlk 1 ay
...
18. Nörolojik olarak bedenin koordineli olarak kullanılması sürecinde, beynin bir tarafının vücudun diğer tarafı ile ilgili yapacağı hareketi üstlenmesi durumuna verilen ad aşağıdakilerden hangisidir?
    - A-) Nöronlaşma
    - B-) Sinyalizasyon
    - C-) Miyelinizasyon
    - D-) Koordinasyon
    ...
    > **Açıklama:** Beynin sağ ve sol yarıkürelerinin farklı işlevleri üstlenmesi ve bedenin bir yarısının diğer yarıküre tarafından kontrol edilmesi durumuna <b>Lateralizasyon</b> denir.

    <hr />

### 2.1. Beyin ve Duyu İlişkisi

19. Duyusal işlemlemede sorunlar yaşayan çocuklarla ilgili aşağıdakilerden hangisi <u>doğrudur</u>?
...
20. Duyusal olarak yetersiz ortamların çocukların gelişiminde nasıl bir etkisi bulunmaktadır?
...
21. Tende sıcak-soğuk ve basıncı algılayan duyu aşağıdakilerden hangisidir?
    - A-) İşitme Duyusu
    - **Cevap B-) Dokunma Duyusu**
    - C-) Koku Duyusu
    - D-) Hareket Duyusu (Proprioseptif Duyu)
    - E-) Denge duyusu (Vestibüler Duyu)
...
22. Berna sınıf içindeki etkinliklerde müzikal ve ritmik etkinliklere katılmaktan keyif almakta, sınıftaki nesnelerin sesleriyle ilgilenerek ses taklitleri yapmaktan hoşlanmaktadır. Berna’nın eğitiminde hangisine odaklanmak gerekir?
    - A-) Doku eşleşmesi yaptırmak
    - B-) Elle tutulur materyaller sunmak
    - C-) Tat ve koku çalışmaları yapmak
    - **Cevap D-) İşitsel ve sözel uyaranlar vermek**
    - E-) Görsel algılamasına odaklanmak
...
23. Zihinsel gelişimin en önemli süreci aşağıdakilerden hangisidir?
...
25. Aşağıdakilerden hangisi dokunma alanına yönelik bir gösterge <u>değildir</u>?
    - A-) Isı değişimini algılama (sıcak-soğuk ortama tepki verme)
    - **Cevap B-) Ağzıyla ses çıkarma**
    - C-) Altı kirlendiğinde rahatsız olma
    - D-) Su ve/veya kum vb. materyallere ilgi gösterme
    - E-) Diş fırçalamaya ilgi gösterme
...
26. Ses çıkaran nesnelere ilgi gösterebilme hangi duyu alanının göstergesidir?
    - **Cevap A-) İşitme**
    - B-) Görme
    - C-) Koklama
    - D-) Dokunma
...
27. Bebekler hangi ay civarında sesin kaynağını bulabilmekte ve ses tonlarını ayırt edebilmektedir?
    - A-) 10 ay
    - B-) 18 ay
    - C-) 3 ay
    - D-) 1 ay
...
28. Çocuklarda hoşlandıklarını, kaçındıklarını ve ne şekilde daha kolay öğrenebileceklerini belirleyebilmek amacıyla ön plana çıkan duyusal özelliklerinin belirlenmesinde bir çocuk gelişimcinin aşağıdakilerden hangisini yapması önemlidir?
    - A-) Resim çizdirmesi
    - B-) Konuşma yapması
    - C-) Ölçek uygulaması
    - **Cevap D-) Gözlem yapması**
    - E-) Form doldurtması
...
29. Ayşe Öğretmen kitap okuma etkinliğinde çocuklara bir tavşanla sırtlan arasında geçen can yakma tartışmasıyla ilgili bir kitap okur. Kitap sonunda çocuklara kitabın içinde geçen “çörek” terimiyle ilgili de etkinlik yaptırarak bütünleştirilmiş bir program uygular. Bu çalışma sonunda çocukların hangi duyuları uyarılır?
    - A-) Tatma ve koklama
    - B-) Görme ve tatma
    - C-) İşitme ve tatma
...
30. Duyusal olarak yetersiz ortamların çocukların gelişiminde nasıl bir etkisi bulunmaktadır?
    - **Cevap A-) Çocukları ulaşabilecekleri düzeyin gerisinde bırakır.**
    - B-) Çocukları duyularını kullanamaya teşvik eder.
    - C-) Çocukların bulundukları çevreye ilgi duymasını sağlar.
    - D-) Çocukları işbirliğine ve koordinasyona yönlendirir.
...
31. Ali sınıfındaki sanat merkezinde parmak boyasıyla hem dokunma hem de görme duyularını kullanarak çalışmalar yapmaktadır. Bu çalışması gelişimsel olarak Ali’nin beyninde somut ve anlamlı hale gelmektedir. Bu sürece verilen ad aşağıdakilerden hangisidir?
    - A-) Görsel algılama
    ...
    > **Açıklama:** Duyusal bilgilerin (dokunma ve görme) beyinde organize edilerek somut ve anlamlı hale gelmesi sürecine <b>Duyu işlemleme</b> adı verilir.
...
1. Vücuttan ve çevreden alınan duygusal uyaranların bütüncül olarak daha etkin şekilde kullanılabilmesi için organize eden nörolojik sürece ne ad verilir?
    - A-) Duyu deneyimleme
    - **Cevap B-) Duyu bütünleme**
    - C-) Algı bütünleme
    - D-) Duyu sentezleme
    - E-) Algı sentezleme
...
2. Beynimizin, çevremizde olan bitenleri fark etme, değerlendirme, yaşanılan karmaşık durumları çözme yetkinliğine ne ad verilir?
    ...
    - D-) Duygusal yetkinlik
    - E-) Duygusal entegrasyon
...
6. Nazan Öğretmen sınıfında planladığı duyu eğitimi çalışmalarında Ali’nin belirli nesnelere dokunmada ve elinde tutmada sıkıntısı olduğunu fark etmiştir. Bu durumda Ali ile ilgili aşağıdakilerden hangisi düşünülmelidir?
    - A-) Düşük algılama
    - B-) Duyusal uyarım
    - C-) Duyusal duyarlık
...
7. Dunn’un duyu modeline göre kolayca ağlayan çocuk hangi maddede yer alır?
    - A-) Duyusal arama
...
8. Banyo oyuncağının bulundurulmaması, tabakta tek besinin bulundurulması gibi görsel algıya yönelik çalışmalar hangi tür modelde uygulanması önerilir?
    - A-) Duyu farkındalığı
    - B-) Duyusal arayış
...
9. Ayşe gündelik yaşantısında duyusal olarak izlediği ve edindiği bilgileri uygulamaya geçirmek istediğinde, uygun zaman ve ortamda kendinden beklenen uygun hareketleri yapmada sorun yaşamaktadır. Ayşe’nin bu durumu aşağıdakilerden hangisidir?
...
10. Normal gelişim gösteren bir bireyde entegre çalışan ve işlemleme yapan duyular….. sağlar. Yukarıdaki boşluğa getirilebilecek en uygun ifade aşağıdakilerden hangisidir?
...
11. Bedensel, işitsel ve/veya görsel yetersizlikler yaşayan özel gereksinimli çocukların duyularını kullanmalarında aşağıdaki yetersizlik türlerinden hangisi görülebilmektedir?
...
12. Eda, yumuşak tüylü oyuncaklara ilgi duymakta ve sürekli elinde tutma ve taşıma, eliyle tüylerini okşama ve sarılma eğilimi göstermektedir. Aşağıdakilerden hangisi duyusal bütünlemeye göre Eda’nın sergilediği duyusal örüntüdür?
    - A-) Düşük algılama
    - B-) Duyusal kaçınma
    - C-) Duyusal arayış
...
13. Ali gündelik yaşantısında çevredeki hareketlerden fazlasıyla rahatsız olmaktadır. Bilmediği ortamlardaki ani hareketlere ağlayarak tepki vermektedir. Buna göre Ali’nin dahil olduğu modele göre çocuğun desteklenmesi için aşağıdakilerden hangisi yapılabileceklerden biri <u>değildir</u>?
    ...
    - D-) Giysileri çocuğun görüş hizasındaki çekmecelere yerleştirmek
    - **Cevap E-) Halka açık alanda özgürlük tanımak**

    > **Açıklama:** Ani hareketlere ağlayarak tepki veren bir çocuk (Duyusal Kaçınma/Duyarlılık), uyaranı azaltma ihtiyacı duyar. <b>Halka açık alanda özgürlük tanımak</b>, kontrol edilemeyen aşırı uyaranlara maruz kalmasına neden olur ve destekleyici değildir.

    <hr />

### 3.1. Duyu Bütünleme Modeli

14. Aşağıdakilerden hangisi duyu bütünleme basamaklarından biri <u>değildir</u>?
...
15. I. Duyusal arayış II. Duyusal kaçınma III. Duyusal hassasiyet IV. Düşük kayıt Yukarıdakilerden hangileri Dunn modeline göre duyusal süreçte kullanılan stratejilerdendir?
    - A-) I, II
    - B-) I, II, III
    - C-) II, III, IV
    - D-) II, III
...
17. Duyusal işlemlemede sorunlar yaşayan çocuklarla ilgili aşağıdakilerden hangisi <u>doğrudur</u>?
    - A-) Görsel algılarında sorun yoktur.
    - B-) Gelişimsel bir sorun değildir.
    - C-) Tatma ya da koklama sorununda görülüç
    - **Cevap D-) Motor ya da nöral yetersizlikte görülebilir.**
...
18. Bedensel, işitsel ve/veya görsel yetersizlikler yaşayan özel gereksinimli çocukların duyularını kullanmalarında aşağıdaki yetersizlik türlerinden hangisi görülebilmektedir?
    - **Cevap A-) Duyusal işlemleme**
    - B-) Duyusal ayrım
    - C-) Duyusal tepkisellik
    - D-) Duyusal tutarsızlık
...
19. Ayşe gündelik yaşantısında duyusal olarak izlediği ve edindiği bilgileri uygulamaya geçirmek istediğinde, uygun zaman ve ortamda kendinden beklenen uygun hareketleri yapmada sorun yaşamaktadır. Ayşe’nin bu durumu aşağıdakilerden hangisidir?
    - **Cevap A-) Duyusal işlememe sorunu**
    - B-) Genel denge bozukluğu
    - C-) Duyusal eğilim sapması
    - D-) Duygu durum bozukluğu
...
20. Normal gelişim gösteren bir bireyde entegre çalışan ve işlemleme yapan duyular….. sağlar. Yukarıdaki boşluğa getirilebilecek en uygun ifade aşağıdakilerden hangisidir?
    - A-) dikkat ve odaklanmanın normalleşmesini
    - B-) normal gelişimin üst düzeyde olmasını
    - C-) bireyin dengeli yaşam sürmesini
    - D-) görsel algının daha ileride olmasını
...
21. Duyularla algılananların beyinde somut ve anlamlı hale gelme süreci ne olarak adlandırılmaktadır?
    - A-) Motivasyon
    - B-) Duyarlılık
    - C-) Hassasiyet
    - **Cevap D-) Duyu işlemleme**
...
22. Aşağıdakilerden hangisi duyusal bütünlemede yaşanılan sorunların yol açtığı etkilerden biri <u>değildir</u>?
    - A-) Akademik yetenekte sorunlar
    - B-) Yemek yeme sorunu
    - C-) Öğrenmede güçlük
    - **Cevap D-) Sinir sistemi bozuklukları**
...
23. Altı yaşındaki Ahmet uygun destek alamadığında başkalarının fark ettiklerini fark etmekte başarısızlık göstermektedir. Bu durumda Ahmet’in duyusal özelliği aşağıdakilerden hangisidir?
    - A-) Duyusal duyarlık
    - **Cevap B-) Düşük algılama**
    - C-) Duyusal kaçınma
    - D-) Duyusal rahatlama
...
24. Aşağıdakilerden hangisi düşük algılama modeline sahip çocukları desteklemek için yapılabilecek bir uygulamadır?
    - **Cevap A-) Yemekte farklı tatlar sunmak**
    - B-) Tek başına yemesine olanak sağlamak
    - C-) Yemeklerle ilgili sohbet etmek
    - D-) Sofra kurulumu için yardım istemek
...
25. Dunn’un duyu modeline göre kolayca ağlayan çocuk hangi maddede yer alır?
    - A-) Duyusal arama
    - B-) Duyusal duyarlılık
    - **Cevap C-) Duyusal uyarım**
    - D-) Düşük tahammül
...
26. Nazan Öğretmen sınıfında planladığı duyu eğitimi çalışmalarında Ali’nin belirli nesnelere dokunmada ve elinde tutmada sıkıntısı olduğunu fark etmiştir. Bu durumda Ali ile ilgili aşağıdakilerden hangisi düşünülmelidir?
    - A-) Düşük algılama
    - B-) Duyusal uyarım
    - C-) Duyusal duyarlık
    - **Cevap D-) Duyusal kaçınma**
...
27. Duyu işlemleme sorunu yaşayan çocuklarda duyu bütünlüğünü sağlamak için aşağıdakilerden hangisinin yapılması <u>önceliklidir</u>?
    - A-) Çocuğa uygun program belirlenmesi
    - B-) Destekleyici çalışmalar gerçekleştirilmesi
    - C-) Çocuğun grup çalışmalarına katılması
    - **Cevap D-) Çocuğun değerlendirilmesinin yapılması**
...
28. Eda, yumuşak tüylü oyuncaklara ilgi duymakta ve sürekli elinde tutma ve taşıma, eliyle tüylerini okşama ve sarılma eğilimi göstermektedir. Aşağıdakilerden hangisi duyusal bütünlemeye göre Eda’nın sergilediği duyusal örüntüdür?
    - A-) Düşük algılama
    - B-) Duyusal kaçınma
    - C-) Duyusal arayış
    - **Cevap D-) Duyusal duyarlılık**
...
29. Zeynep oyun oynadığı sırada dışarıdan gelen bir kokuyu fark edip oyununu yarım bırakmıştır. Kokunun kaynağını bulmak için çaba göstermektedir. Buna göre Zeynep’in davranışı Dunn’ın hangi duyusal örüntü türü ile açıklanabilir?
    - A-) Düşük algılama
    - B-) Duyusal kaçınma
    - **Cevap C-) Duyusal arayış**
    - D-) Yüksek hassasiyet
...
30. Aşağıdakilerden hangisi duyusal bütünlemede yaşanılan sorunların yol açtığı etkilerden biri <u>değildir</u>?
    - A-) Akademik yetenekte sorunlar
    - B-) Yemek yeme sorunu
    - C-) Öğrenmede güçlük
    - **Cevap D-) Sinir sistemi bozuklukları**
...
31. Duyularla algılananların beyinde somut ve anlamlı hale gelme süreci ne olarak adlandırılmaktadır?
    - A-) Motivasyon
    - B-) Duyarlılık
    - C-) Hassasiyet
    - **Cevap D-) Duyu işlemleme**
...
32. Aşağıdakilerden hangisi duyu bütünleme basamaklarından biri <u>değildir</u>?
    - A-) Duyusal işlemleme becerilerinin gelişimi
    - B-) Duyusal işlemleme becerilerinin tanımı
    - C-) Duyusal işlemleme bozukluklarının tanımlanması
    - **Cevap D-) Duyuların kategorizasyonun yapılması**
...
33. I. Duyusal arayış II. Duyusal kaçınma III. Duyusal hassasiyet IV. Düşük kayıt Yukarıdakilerden hangileri Dunn modeline göre duyusal süreçte kullanılan stratejilerdendir?
    - A-) I, II
    - B-) I, II, III
    - C-) II, III, IV
    - D-) II, III
...
### 4.8. Denge duyusu (Vestibüler Duyu)

1. İç kulakta işitme duyusu dışında gerçekleşen duyu aşağıdakilerden hangisidir?
    - A-) İşitme
    - B-) Proprioseptif
    - C-) Dokunma
    - D-) Görme
...
2. Aşağıdakilerden hangisi duyularımızdan biri <u>değildir</u>?
    - A-) Denge
    - B-) Hareket
    - **Cevap C-) Sezgi**
    - D-) İşitme
...
3. Dış dünyadaki renk, parlaklık, şekil, yön, derinlik gibi özellikler hangi duyu ile algılanır?
    - A-) İşitme
    - **Cevap B-) Görme**
    - C-) Denge
    - D-) Koku alma
...
4. Bebekler yaklaşık olarak hangi ayda renkleri ayırt edebilirler?
    - A-) 1 ay
    - B-) 2 ay
    - **Cevap C-) 4 ay**
    - D-) 6 ay
...
6. Duyu gelişimi sistemlerinden hangi duyu sistemi gelişimini anne karnında tamamlamaz?
    - A-) Vestibüler duyu sistemi
    - B-) Taktil duyu sistemi
    - C-) Proprioseptif duyu sistemi
    - **Cevap D-) Görsel duyu sistemi**
    - E-) Hepsi
...
7. Aşağıdakilerden hangisi duyularımızdan biri <u>değildir</u>?
    - A-) Denge
    - B-) Hareket
    - **Cevap C-) Sezgi**
    - D-) İşitme
...
8. Aşağıdaki duyu çeşitleri arasından hangisi diğerlerine göre daha önce gelişmektedir?
    - **Cevap A-) Dokunma**
    - B-) Koklama
    - C-) Görme
    - D-) Tat alma
...
9. Duyu sistemi gelişiminde gerilik olan çocuklarda aşağıdaki alanlardan hangisi ile ilgili sorun görülür?
    - A-) İşitsel algılama
    - B-) Bilişsel, sosyal, duygusal, özbakım alanları
    - C-) Dikkat alanı
    - D-) Görsel algılama
...
10. Vestibüler duyusunun işlevi aşağıdakilerden hangisidir?
    - A-) Sıcak-soğuk basıncı algılama
    - B-) Sesleri duyup anlama
    - **Cevap C-) Dengenin sağlanması**
    - D-) Bedenin poziyonunu algılama
...
11. Beş duyu dışında uzuvlar hareket ettirilmeden bedenin pozisyonunun algılandığı duyu olarak da bilinen duyu aşağıdakilerden hangisidir?
    - **Cevap A-) Proprioseptif**
    - B-) Wernikülasyon
    - C-) Retrosentif
    - D-) Vestibüler
...
### 5.3. Duyu Eğitimi ve Öğrenme Stilleri Arasındaki İlişki

3. Aşağıdaki ifadelerden hangisi <u>yanlıştır</u>?
    - A-) Öğrenme sürecinde farklı duygular farklı zamanlarda etkin olabilirler.
    - B-) Öğrenme, duyu organları yoluyla gerçekleşmektedir.
    - C-) Çocuklar duyusal deneyimler aracılığıyla farklı biçimlerde öğrenebilirler.
    - D-) Bilginin işlemlenmesinde farklı duyusal deneyimlerin bir arada olması öğrenmeyi kolaylaştırır.
    - **Cevap E-) Öğrenme süreci sadece görsel ve işitsel uyaranlarla olur.**
...
4. Ahmet çevresinde olan biten tüm olayları öğrenmek için öncelikli olarak olayları yaşayarak hissetmeye odaklanmaktadır. Bu durumda Ahmet duyusal olarak hangi öğrenme tarzına sahiptir?
    - A-) Görsel
    - B-) Estetik
    - **Cevap C-) Kinestetik**
    - D-) İşitsel
    ...
    > **Açıklama:** Olayları <b>yaşayarak hissetmeye</b> odaklanma, hareket ve dokunma yoluyla öğrenmeyi tercih eden <b>Kinestetik</b> öğrenme tarzına işaret eder.

    <hr />

### 5.1. Duyu Eğitimi ve Çoklu Duyu Yaklaşımı

5. Aşağıdakilerden hangisi duyu eğitiminin önemleri arasında <u>yer almamaktadır</u>?
    - A-) Çocuğun varolan enerjisini ortaya çıkarmasına yardımcı olur.
    - B-) Çocuğun öğrenme isteğini artırır.
    - C-) Çocuğun özgüvenini geliştirir.
    - D-) Çocuğun çok yönlü düşünme becerisini geliştirir.
    - **Cevap E-) Çocuğun potansiyel zeka kapasitesini artırır.**
...
6. Aşağıdakilerden hangisi duyusal çalışmaların ana hedeflerinden birisidir?
...
9. Montessori yaklaşımına göre hangisi <u>söylenemez</u>?
    - A-) Montessori her çocuğun doğumla birlikte çevresini keşfetme eğiliminde olduğundan bahsetmektedir.
    - **Cevap B-) Duyular, küçük çocukların öğrenmelerini gerçekleştirmelerinde diğer eğitim programlarına göre <u>ikinci plandadır</u>.**
    - C-) Bebekler, doğdukları andan itibaren her yeni objeyi tanımak için ağzına doğru götürmekte ya da etraflarındaki yüzeyi tanımaya çalışmaktadır.
    - D-) Doğumdan üç yaşına kadar çocuk farkında olmaksızın çevresi tarafından etkilenmekte ve çevresinde etkileştiği her şeyi zihinsel olarak emmektedir.
...
10. Bu eğitim yaklaşımında duyusal etkinlikler; basitten zora doğru ilerleyerek belirli bir düzen içinde gerçekleştirilirken uygulamalarda tek bir duyuya yönelerek, sadece belirli özelliklere odaklanarak hassaslaştırma ön plandadır. Yukarıda verilen eğitim modeli aşağıdakilerden hangisidir?
    - **Cevap A-) Montessori**
    - B-) Reggio Emilia
    - C-) Waldorf
    - D-) High/Scop
...
11. Nilay Öğretmen duyu eğitiminde özellikle doğa ile ruhun uyumunu güçlendirici bir felsefeye odaklanan bir okul öncesi kurumunda görev yapmaktadır. Bu kurumda çocukların karşılıklı etkileşimle duyusal, bilişsel, sosyal, duygusal ve motor gelişimlerinin desteklenmesi amaçlanmaktadır. Nilay Öğretmen’in çalıştığı kurum aşağıdakilerden hangisidir?
    - A-) Bank Street
    - **Cevap B-) Waldorf**
    - C-) Reggio Emilia
    - D-) High/Scope
...
12. Aşağıdakilerden hangisi duyusal çalışmaların ana hedeflerinden birisidir?
    - A-) Duygularını çeşitli yollardan ifade etme
    - B-) Öz bakım becerilerini geliştirme
    - **Cevap C-) Çevredeki benzerlik, farklılıkları algılama, çevresel değişiklikleri fark etme**
    - D-) Parça-bütün ilişkisini kavrayabilme
...
5. Aşağıdaki adları verilen etkinliklerden hangisi 0-1 yaş aralığında <u>uygulanmaz</u>?
    - A-) Cee oyunu
    - B-) Sesi duydum
    - C-) Görüyorum
    - D-) Ben dönmeye başladım
    - **Cevap E-) Aynısını buluyorum**
...
7. Aşağıdaki adları verilen etkinliklerden hangisi 1-2 yaş aralığında <u>uygulanmaz</u>?
...
8. I. Adım Soyadım II. Duyu Torbası III. Tekse Tek, Çiftse Çift Zıplarım IV. Prenses takıları Yukarıdaki adı geçen etkinliklerden hangileri 2-3 yaş aralığında uygulanır?
    - **Cevap A-) Hepsi**
    - B-) I, II, IV
    - C-) I, III, IV
    - D-) II, III, IV
...
9. Etkinlik adı: Dans dans dans. 25-30 ay aralığında oynanan bu etkinlik sırasında özellikle hangi duyu alanları ile ilgili uyaran <u>verilmez</u>?
    - A-) Görme
    - B-) İşitme
    - C-) Vestibüler
    - D-) Proprioseptif
...
11. Çocukların duyularını kullanmaya yönelik oyun etkinliklerini ve oyundaki davranışlarını zenginleştirmede …………… önemli görülmektedir. Yukarıdaki cümlede noktalı kısma aşağıdakilerden hangisi gelmesi en uygundur?
...
12. Aşağıdakilerden hangisi duyulara yönelik çalışmalarda kullanılabilecek materyallerden biri <u>değildir</u>?
    - A-) Kum
    - B-) Sabun köpüğü
    - C-) Poşet
    - D-) Keçe
...
13. Aşağıdaki materyallerden hangisini incelerken 5 ana duyu türlerinin tamamı kullanılabilir?
    - A-) Boyama sayfası
    - B-) Bilgisayar destekli eşleştirme çalışması
    - C-) Deney tüpündeki karışım
    - D-) Gazete
...
14. Aşağıdaki adı geçen etkinliklerden hangisi tat alma duyusunun gelişimine katkıda bulunur?
    - A-) Bu dolapta neler oluyor
    - B-) Yaşadığım yeri düzenliyoruz
    - C-) Kim ne yapar
    - D-) Adım soyadım
...
15. Begüm Öğretmen çocuklara sıcak-ılık-soğuk, ıslak-kuru, pütürlü-kaygan, sert-yumuşak gibi kavramları öğretme ve pekiştirme amacıyla çeşitli materyallerle sınıfını düzenlemek istemektedir. Bu durumda Begüm Öğretmen için sınıfında kullanmak üzere aşağıdakilerden hangisini önermek amacını gerçekleştirmeye yönelik olacaktır?
    - **Cevap A-) Su ve kum havuzları**
    - B-) Bilgi işlem materyalleri
    - C-) Müzik ve ritm aletleri
    - D-) Ahşap ve plastik bloklar
...
16. Aşağıdakilerden hangisi dokunma duyusunu geliştirmek için kullanılabilecek materyallerin birisi <u>değildir</u>?
    - **Cevap A-) CD’ler**
    - B-) Taşlar
    - C-) Kum
    - D-) Su
...
17. Çocukların duyularını kullanmaya yönelik oyun etkinliklerini ve oyundaki davranışlarını zenginleştirmede …………… önemli görülmektedir. Yukarıdaki cümlede noktalı kısma aşağıdakilerden hangisi gelmesi en uygundur?
    - A-) görsel materyaller
    - **Cevap B-) aile katılımı**
    - C-) açık hava
    - D-) işitsel materyaller
...
18. 25-30 ay aralığında oynanan 'Dans dans dans' etkinliği sırasında özellikle hangi duyu alanları ile ilgili uyaran <u>verilmez</u>?
    - A-) Görme
    - B-) İşitme
    - C-) Vestibüler
    - D-) Proprioseptif
...
19. Aşağıdakilerden hangisi duyulara yönelik imgelerden biri <u>değildir</u>?
    - A-) Titreşim
    - B-) Koku
    - C-) Sembol
    - D-) Ses
...
### 7.1. Özel Gereksinimi Olan Çocuklar ve Duyu Eğitimi

1. Serebral palsy ile ilgili aşağıdakilerden hangisi <u>söylenemez</u>?
    - **Cevap A-) Semptomlar ilerleyen dönemlerde kötüleşme gösterir.**
    - B-) Bulaşıcı olmayan bir beyin hastalığıdır.
    - C-) Kronik bir hastalıktır.
    - D-) Fiziksel ve motor yetersizlikleri içermektedir.
    - E-) Duygusal ve davranışsal bozukluklar eşlik edebilir.

    > **Açıklama:** Serebral palsy'nin semptomları ilerleyen dönemlerde <b>kötüleşme göstermez</b>.

    <hr />

### 7.3. Otizm Spektrum Bozukluğunda Duyusal Eğitim

2. Otistik olup duyusal sıkıntılar yaşayan çocukların desteklenmesi için hangisi önerilebilir?
    - **Cevap A-) Duyu-motor müdahaleler**
    - B-) Sanat terapi
    - C-) Sarılma desteği
    - D-) Dans eğitimi
    - E-) Beslenme programı
...
3. Aşağıdaki hastalık ya da bozukluklardan hangisi için duyu temelli eğitim desteği önemlidir?
...
4. Aşağıdaki gelişimsel bozuklardan hangisinin prematüre bebekler görülme sıklığı normal doğan bebeklere göre daha fazladır?
...
5. Düşük doğum ağırılığı ile doğan bir bebek için aşağıdaki ifadelerden hangisi <u>yanlıştır</u>?
    ...
    - D-) Düşük doğum ağırlıklı çocuklarda duyusal gelişim geriden gelebilir.
    - **Cevap E-) Düşük doğum ağırlıklı çocuklara yönelik herhangi bir tarama, erken müdahale programına gerek duyulmamaktadır.**
...
6. Prematüre bebekler için aşağıdaki ifadelerden hangisi <u>yanlıştır</u>?
...
7. Anıl otistik özellikler gösteren altı yaşında bir çocuktur. Kendisiyle konuşulduğunda duymuyormuş gibi davranmakta ve belirli materyallere dokunmakta sorunlar yaşamaktadır. Anıl ile ilgili aşağıdakilerden hangisi kesin olarak söylenebilir?
...
### 7.4. Duyusal Yetersizlik Yaşayan Çocuklarda Duyusal Eğitim

8. Gözde Öğretmen sınıfındaki görme bozukluğu olan öğrencisi için duyusal bütünleştirmeyi sağlamak amacıyla duyu eğitimi için etkinlik planlarken aşağıdakilerden hangisini öncelikli olarak yapmalıdır?
    - A-) Hareket ve denge yeteneğini geliştirmek için sportif etkinlikler planlamalıdır.
    - B-) İş birliği, paylaşma ve yardımlaşmayı içeren etkinliklere odaklanmalıdır.
    - C-) Çocuğun kendini ifade etmesini destekleyici çalışmalar yapmalıdır.
    - **Cevap D-) Görme duyusunun yanında dokunma, işitme gibi duyularını da desteklemelidir.**
    - E-) Sosyal ve duygusal olarak çocuğu destekleyici oyunlar oynatmalıdır.

    > **Açıklama:** Görme yetersizliği olan çocuklarda, eksik kalan duyuyu telafi etmek ve bütünleştirmeyi sağlamak amacıyla <b>Görme duyusunun yanında dokunma, işitme gibi duyularını da desteklemelidir</b>.

    <hr />

### 7.1. Özel Gereksinimi Olan Çocuklar ve Duyu Eğitimi

9. Begüm Öğretmen duyusal yetersizliği olan çocuklarla çalışan bir eğitimcidir. Çalıştığı çocuklarla bireysel etkinliklerinde uygun etkinlikler seçerek onları duyusal olarak yönlendirmesinde hangisine dikkat etmesi <u>önceliklidir</u>?
    ...
    - D-) Çocukların görsel duyarlılıklarını belirlemek
...
### 7.2. Öğrenme Güçlüğünde Duyusal Eğitim

10. Özgül öğrenme bozukluğu ile ilgili aşağıdakilerden hangisi <u>söylenemez</u>?
    - A-) Özel öğrenme bozukluğu olan çocukların dili kullanma ya da anlama ile ilgili zorlukları olabilmektedir.
    - B-) Özel öğrenme bozukluğu olan çocuklar nesneleri dokunarak tanımlamada güçlük çekerler.
    - C-) Özel öğrenme bozukluğu olan çocukların işitsel bellekleri yaşıtlarına kıyasla zayıftır.
    - D-) Birbirlerine benzeyen sesleri ayırmada zorluklar yaşayabilmektedirler.
    - **Cevap E-) Temelinde görsel algılama sorunlarının olduğu öne sürülmüştür, ancak görsel takipte sorun yaşamazlar.**

    > **Açıklama:** Özel öğrenme bozukluğunun temelinde görsel algılama sorunları olduğu öne sürülmüştür ve bu çocukların görsel takipte de sorun yaşamaları olasıdır. Bu nedenle <b>görsel takipte sorun yaşamazlar</b> ifadesi söylenemez.

    <hr />

### 7.3. Otizm Spektrum Bozukluğunda Duyusal Eğitim

11. Otizm spektrum bozukluğu olan çocuklardaki motor ve duyusal gelişimi desteklemek amacıyla aşağıdaki oyun/aktivitelerden hangisi önerilmektedir?
    - A-) İp atlama
...
12. Aşağıdaki gelişimsel bozuklardan hangisinin prematüre bebekler görülme sıklığı normal doğan bebeklere göre daha fazladır?
    - A-) Zihinsel yetersizlik
    - B-) Otizm spektrum bozukluğu
    - C-) Özel öğrenme bozukluğu
    - D-) Dikkat eksikliği hiperaktivite bozukluğu
...
13. Prematüre bebekler için aşağıdaki ifadelerden hangisi <u>yanlıştır</u>?
    - A-) Toplumda sıklığı giderek artmaktadır.
    - B-) Erken gelişim dönemlerinden itibaren izleme alınmalıdır.
    - **Cevap C-) Gelişimi geriden gelen çocuklar sadece izlenmeli erken müdahaleye gerek yoktur.**
    - D-) Prematür bebeklerde işitme ve görme ile ilgili problemler de sıklıkla görülmektedir.
...
14. Anıl otistik özellikler gösteren altı yaşında bir çocuktur. Kendisiyle konuşulduğunda duymuyormuş gibi davranmakta ve belirli materyallere dokunmakta sorunlar yaşamaktadır. Anıl ile ilgili aşağıdakilerden hangisi kesin olarak söylenebilir?
    - **Cevap A-) Duyusal entegrasyon desteği almalıdır.**
    - B-) İşitsel ya da dokunsal sorunu yoktur.
    - C-) Duyusal odaklanma becerisi yüksektir.
    - D-) Duyularını aktif biçimde kullanabilir.
...
15. Duyu bütünlüğü eğitimini, özel gereksinimli öğrencilerinin desteklenmesinde kullanmayı amaçlayan bir eğitimci aşağıdakilerden hangi beceriyi arttırmaya odaklanmaktadır?
    ...
    - D-) Çocuğun kaba motor becerilerini geliştirme
    - E-) Çocuğun bilişsel becerilerini geliştirme

    > **Açıklama:** Duyu bütünleme eğitiminin temel amacı, çocuğun <b>duyu uyaranlarını organize edebilmesini sağlayarak onlara uygun cevap oluşturabilmesini</b> sağlamaktır.
...
3. Çocuğa; “Görmüyorsan, karanlıkta yolunu bulmak için neler yapabilirsin?” sorusu sorulduğunda hangisini desteklemek amaçlanıyordur?
...
4. Ayşe Öğretmen bireysel destek vereceği bir öğrencisini değerlendirirken ilgi duyduğu ve başarılı olduğu alanları merak etmiş ve çocuğun annesine sormuştur. Bu durumun nedeni aşağıdakilerden hangisi olabilir?
    ...
    - D-) Ailenin yeteneklerini daha da geliştirmek
    - E-) Çocuğun yetersizliğini sınamak
...
6. Emine Öğretmen sınıfındaki çocuklardan birinin görmesinde bazı sorunlar olabileceğini düşünmektedir. Bu durumda öncelikli olarak hangisini yapması önerilir?
    ...
    - D-) Çocuğu tek başına destekleyici uygulamalar yapmak için bireyselleştirilmiş program hazırlamak
    - E-) Çocuğun sınıfta başarısız olacağını düşünerek başka bir sınıf ya da okula yönlendirmek
...
8. Çocuk günlük yaşantısı sırasında nesnelerin birbirlerine göre farklı özelliklerini uygulamalı biçimde …………………… yöntemiyle öğrenebilir. Yukardaki noktalı boşluk için en uygun olan yöntem hangisidir?
    - A-) anlatım
...
### 8.5. 3 Yaş ve Üzeri Çocuklar İçin Örnek Duyu Etkinlikleri

9. Cansu, sulandırılmış parmak boyaları ve nişasta karışımına parmaklarını daldırdıktan sonra büyük boy bir muşamba üzerinde çeşitli desenler oluşturmaktadır. Bu deneyim sırasında Cansu’da aşağıdaki becerilerden hangisi gelişmiştir?
    - A-) İşitsel algısı ve dinlenme becerisi
    - B-) Temizlik ve sağlık bilgisi
    - **Cevap C-) Dikkatini belirli bir işe yoğunlaştırması**
    - D-) Büyük kas motor becerileri
    - E-) Bilgiyi akılda tutma ve hatırlaması

    > **Açıklama:** El-göz koordinasyonu ile büyük yüzeyde çalışma ve desen oluşturma, çocuğun <b>Dikkatini belirli bir işe yoğunlaştırması</b> becerisini geliştirir.

    <hr />

### 8.2. Duyu Eğitiminde Belirlenecek Hedefler

10. Bahadır sınıf içi ve dışında gerçekleştirilen eğitimsel etkinliklerde kendisine sunulan bilgileri öğrenirken aşağıdaki duyulardan hangisini diğerlerine oranla <u>daha az kullanmaktadır</u>?
    - A-) Dokunma
    - **Cevap B-) Tatma**
    - C-) Hareket
    - D-) Görme
...
11. Aşağıdakilerden hangisi duyu eğitiminde belirlenecek hedeflerden biridir?
    - **Cevap A-) Dikkatini çevreye yoğunlaştırmak**
    - B-) Kaba motor becerilerini geliştirmek
    - C-) Kelime dağarcığını geliştirmek
    - D-) Duygu düzenlemesini geliştirmek
...
12. Aşağıdakilerden hangisi duyu eğitiminde hedeflere ulaşırken dikkat edilecek noktalardan birisi <u>değildir</u>?
    - A-) Çocuğun fizyolojik olarak sağlıklı olup olmadığının kontrol edilmesi
    - B-) Çocuğun ilgi alanlarının fark edilmesi
    - C-) Çocuğun gelişimsel düzeyi ve güçlü yanlarının saptanması
    - D-) Çocuğun yaşantı sırasında öğrenim için denemeler yapmasına fırsat verilmesi
...
13. Çocuğa; “Görmüyorsan, karanlıkta yolunu bulmak için neler yapabilirsin?” sorusu sorulduğunda hangisini desteklemek amaçlanıyordur?
    - A-) Mekânda konum algısını ölçmek
    - B-) Dokunsal ve görsel algısını sınamak
    - **Cevap C-) Duyu organlarını amaca ulaşmak için kullanmayı desteklemek**
    - D-) Sözcük dağarcığını arttırmak
...
14. Yasemin Öğretmen dört yaş grubunda özel gereksinimli çocuklara yönelik duyu etkinlikleri hazırlarken, bu sürece başlarken öncelikli olarak aşağıdakilerden hangisini yapması gerekmektedir?
    - A-) Eğitim programını tasarlamalıdır.
    - B-) Bol ve yeterli materyal almalıdır.
    - C-) Çocukların başarılarını övmelidir.
    - **Cevap D-) Çocukların ön değerlendirmesini yapmalıdır.**
...
15. I. Ön değerlendirme yaparak çocuğun gelişim özelliğini belirlemek II. Çocuğun sevdiği işleri sıralamak III. Çocuğun fizyolojik olarak sağlığını kontrol etmek IV. Desteğe gereksinim duyulan duyusal alanı saptamak Duyu eğitim programı planlanırken yukarıdakilerden hangilerinin <u>öncelikli</u> olarak dikkate alınması gerekmektedir?
    - A-) I, II ve III
    - B-) I ve III
    - **Cevap C-) I, III ve IV**
    - D-) I ve IV
...
16. Alihan Öğretmen çocuklar için ahşap, metal ve plastik materyallerin kullanımlarını ön plana alarak görme, işitme ve dokunmaya yönelik olarak planladığı duyu eğitimi uygulamalarında en uygun hedefleri belirlemek için dikkate alması gereken noktaları yeniden gözden geçirmiştir. Alihan Öğretmen’in bu süreçte aşağıdakilerden hangisini dikkate almasına gerek <u>yoktur</u>?
    - A-) Çocuğun gelişimsel düzeyinin saptanması
    - B-) Çocuğun ilgi alanlarının fark edilmesi
    - C-) Çocuğun fizyolojik sağlığının kontrol edilmesi
    - **Cevap D-) Planlı ve sınırlı müfredat oluşturulması**
    - E-) Çocuğun denemeler yapmasına fırsat verilmesi

    > **Açıklama:** Duyu eğitimi esnek olmalıdır. '<b>Planlı ve sınırlı müfredat oluşturulması'</b> gibi katı bir yapıyı dikkate almasına gerek yoktur.

    <hr />

### 8.2. Duyu Eğitiminde Belirlenecek Hedefler

17. Çocuk günlük yaşantısı sırasında nesnelerin birbirlerine göre farklı özelliklerini uygulamalı biçimde …………………… yöntemiyle öğrenebilir. Yukardaki noktalı boşluk için en uygun olan yöntem hangisidir?
    - A-) anlatım
    - **Cevap B-) deneme yanılma**
    - C-) gözlem
    - D-) ezber
