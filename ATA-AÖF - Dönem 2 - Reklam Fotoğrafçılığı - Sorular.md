...
1. <strong>Fotoğraf tarihinin en &ccedil;ok bilinen, reklam/tanıtım &ndash; satış stratejisi olan &ldquo;Siz deklanş&ouml;re basın gerisini biz halledelim&rdquo; sloganını hangi fotoğraf firması geliştirmiştir?</strong>
    ...
    - E-) Sony
    <hr />
1. <strong>Fotoğrafın en yoğun bir bi&ccedil;imde kitlelerce kullanımına y&ouml;nelik olarak geliştirilip 1 dolar karşılığında piyasaya s&uuml;r&uuml;len model aşağıdakilerden hangisidir?</strong>
    - A-) No:1
    - B-) No:2
    - C-) No:3
    - D-) No:4
...
1. <strong>Aşağıdakilerden hangisi bi&ccedil;imsel olarak fotoğraf g&ouml;stergelerinden biri <u>değildir</u>?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi &ccedil;ekim esnasında &ccedil;ektiği fotoğraf ile fotoğraf&ccedil;ıyı farklılaştırır?</strong>
...
1. <strong>Fotoğrafın &ccedil;ağdaş bir tarih anlatıcısı olmasını sağlayan &ouml;zellik aşağıdakilerden hangisidir?</strong>
    ...
    <hr />
1. <strong>Aşağıdaki fotoğraf&ccedil;ılardan hangisi Art et Decoration dergisi i&ccedil;in &ccedil;ektiği moda ve tanıtım fotoğraflarıyla bilinen bir fotoğraf&ccedil;ıdır?</strong>
    - A-) Richard Avedon
    - B-) Man Ray
    - C-) Alfred Stiglitz
...
1. <strong>Aşağıdaki kompozisyon &ouml;gelerinden hangisi &ccedil;okluk etkisi yaratmada kullanılmaktadır?</strong>
    ...
    - E-) Simetri
    <hr />
1. <strong>Aşağıdakilerden hangisi iki ya da daha fazla fig&uuml;r&uuml;n birbirini tamamlayarak anlam oluşumuna katkı sağlayarak uyum ya da armoni olarak ifade edilmesini sağlayabilir?</strong>
    - A-) Renk
    - B-) Ton
    - C-) Y&ouml;n
    - D-) Bi&ccedil;im
...
1. <strong>Dijital fotoğraf makinesinin temelleri aşağıdaki hangi olayla atılmıştır?</strong>
    ...
    <hr />
1. <strong>Dijital fotoğraf&ccedil;ılık aşağıdaki işlemlerden hangisini <u>kapsamaz</u>?</strong>
...
<strong>&quot;Typo&quot; ve &quot;graphie&quot; kelimelerinin T&uuml;rk&ccedil;e karşılığı aşağıdakilerden hangisidir?</strong>
    - **Cevap A-) Şekil - Yazı**
...
1. <strong>High Key aydınlatma i&ccedil;in </strong><strong>aşağıdakilerden hangisi&nbsp;</strong><strong><u>s&ouml;ylenemez</u>?</strong>
    ...
    <hr />
1. <strong>Low Key Aydınlatma ile ilgili olarak aşağıdakilerden hangisi <u>yanlıştır</u>?</strong>
...
1. <strong>Rembrandt&rsquo;ın asıl mesleği aşağıdakilerden hangisidir?</strong>
    ...
    <hr />
1. <strong>&Ouml;zel ışık aydınlatma başlığı altında verilen aydınlatma &ccedil;eşitleri aşağıdakilerin hangisinde doğru verilmiştir?</strong>
    ...
    <hr />
1. <strong>Fotoğraf&ccedil;ılıkta anahtar ışığın diğer adı aşağıdakilerin hangisidir?</strong>
    - **Cevap A-) Ana ışık**
    - B-) Tepe ışığı
    - C-) Dolgu ışığı
    - D-) Kelebek ışık
...
<strong>Yukarıda &ouml;zellikleri sıralanan fotoğraf&ccedil;ılık tekniği aşağıdakilerden hangisidir?</strong>
    ...
    - E-) Lomografi
    <hr />
1. <strong>T&uuml;rkiye&rsquo;de ilk lomografi mağazası ne zaman a&ccedil;ılmıştır?</strong>
    - A-) 2001
    - B-) 2003
    - C-) 2005
    - D-) 2009
...
1. <strong>Polaroid firması 2009 yılında girmiş olduğu ekonomik krizden &ccedil;ıkmak i&ccedil;in aşağıdaki hangi &uuml;nl&uuml; sanat&ccedil;ıyı creative director olarak ortaklığına almıştır ?</strong>
    ...
    - E-) Taylor Swift
    <hr />
1. <strong>Aşağıdakilerden hangisi&nbsp;</strong><strong>2000&rsquo;li yıllardan sonra ortaya &ccedil;ıkan sosyal medya platformları arasında&nbsp;<u>yer almaz</u>?</strong>
    - A-) Youtube
    - B-) Facebook
    - C-) Twitter
    - D-) MySpace
...
1. <strong>Aşağıdakilerden hangisi panaromik fotoğraf elde etmek i&ccedil;in birleştirme yapılan yazılımlardan biri <u>değildir</u>?</strong>
    ...
    - E-) Photoshop
    <hr />
1. <strong>Dijital fotoğraf teknolojisinde &ccedil;ekilen fotoğrafların kameraya takılarak kaydedilmesini sağlayan donanım aşağıdakilerden hangisidir?</strong>
    - A-) Ram
    - B-) DVD
...
1. <strong>&Ccedil;ekim sonrası&nbsp;(Post-Prod&uuml;ksiyon) aşamasından baskı aşamasına kadarki s&uuml;re&ccedil;te kullanılan monit&ouml;rlerin renk kalibrasyonunun doğruluğunun &ouml;nemi aşağıdakilerin hangisinde a&ccedil;ık&ccedil;a belirtilmiştir?</strong>
    ...
    - E-) Kalibrasyonu doğru olmayan monit&ouml;rler perspektif bozulmalara sebep olacaktır.
    <hr />
## Unite 10
...
1. <strong>Portre fotoğrafı kullanılan reklam fotoğraflarında aşağıdakilerden hangisine dikkat <u>edilmez</u>?</strong>
    ...
    <hr />
1. <strong>Moda fotoğraflarının işlevsel olarak başarılı kabul edilebilmesi i&ccedil;in aşağıdakilerden hangisi &ouml;nemli <u>değildir</u>?</strong>
...
1. <strong>Reklamlarda kullanılan portre fotoğraflarında t&uuml;keticinin yaşam tarzına ilişkin verilen mesajlarda aşağıdakilerden hangisi etkili <u>değildir</u>?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi &uuml;lkemizde reklam fotoğraf&ccedil;ılarının tek bir alanda uzmanlaşarak iş yapmalarının &ouml;n&uuml;ndeki engeller arasında <u>yer almaz</u>?</strong>
...
1. <strong>Aşağıdakilerden hangisi bina, otel, alışveriş merkezi, k&ouml;pr&uuml;, fabrika, okul vb. yapıların i&ccedil; ve dış g&ouml;r&uuml;n&uuml;mlerini, detaylarını, işlevsel ve bi&ccedil;imsel &ouml;zelliklerini konu edinen reklam fotoğraf&ccedil;ılığı uzmanlık alanlarından biridir?</strong>
    ...
    <hr />
## Unite 11
1. <strong>Cam &uuml;r&uuml;nlerin fotoğrafı &ccedil;ekilirken &uuml;r&uuml;n&uuml;n y&uuml;zeyinde oluşabilecek yansımaları &ouml;nlemek i&ccedil;in hangi y&ouml;ntem kullanılır?</strong>
    - A-) Sert Işık Y&ouml;ntemi
    - B-) Yumuşak Işık Y&ouml;ntemi
    - C-) Sektirmeli Aydınlatma Y&ouml;ntemi
    - D-) Noktasal Aydınlatma Y&ouml;ntemi
    - **Cevap E-) Dif&uuml;z Aydınlatma Y&ouml;ntemi**
    <hr />
1. <strong>Still life fotoğraf&ccedil;ılığı ile ilgili olarak aşağıdakilerden hangisi <u>yanlıştır</u>?</strong>
    - A-) Genelde fotoğraf st&uuml;dyolarında ya da st&uuml;dyoya d&ouml;n&uuml;şt&uuml;r&uuml;lm&uuml;ş mek&acirc;nlarda &ccedil;ekilmektedir.
    - B-) K&uuml;&ccedil;&uuml;k boyutlu &uuml;r&uuml;nlerin &ccedil;ekiminde genelikle sonsuz fon oluşturan&nbsp;still life masaları kullanılmaktadır.
    - C-) &Uuml;r&uuml;nlerin g&ouml;rsel potansiyelinin artırılmasında ve algının y&ouml;nlendirilmesinde arka plan &ouml;nem kazanmaktadır.
...
1. <strong>Aşağıdakilerden hangisi aydınlatmanın ama&ccedil;ları arasında <u>yer almaz</u>?</strong>
    ...
    - D-) &Uuml;r&uuml;n&uuml;n estetik g&ouml;r&uuml;n&uuml;m&uuml;n&uuml; ortaya &ccedil;ıkarmak.
    - E-) T&uuml;keticileri psikolojik olarak etkilemek.
    <hr />
1. I. Metal y&uuml;zeyli &uuml;r&uuml;nler<br />
II.&nbsp;Ahşap y&uuml;zeyli &uuml;r&uuml;nler<br />
III. Kumaş y&uuml;zeyli &uuml;r&uuml;nler<br />
<strong>Yukarıdakilerden hangisi ya da hangileri &ccedil;ekimi yapılacak &uuml;r&uuml;nlerin sahip oldukları y&uuml;zeylere g&ouml;re sınıflandırmaları arasında yer alır?</strong>
    - A-) Yalnız I
    - B-) Yalnız II
    - C-) I ve III
    - D-) II ve III
    - **Cevap E-) I, II ve III**
    <hr />
1. <strong>Aşağıdakilerden hangisi still life fotoğraflarında fon kullanımının ama&ccedil;ları arasında <u>yer almaz</u>?</strong>
    - A-) İlginin &uuml;r&uuml;ne toplanmasını sağlar.
    ...
    <hr />
1. <strong>Still life fotoğraf &ccedil;ekimlerde &uuml;r&uuml;nlerin aşağıdaki &ouml;zelliklerden hangisi <u>vurgulanmaz</u>?</strong>
    - A-) Bi&ccedil;im
    - B-) Formu
    - C-) Rengi
    - D-) Dokusu
    - **Cevap E-) &Uuml;retim yılı**
    <hr />
1. <strong>&Uuml;r&uuml;nlerin y&uuml;zeylerindeki maddeye g&ouml;re aşağıdakilerden hangisi ışığı yansıtma &ouml;zelliğine sahiptir?</strong>
    - A-) Ahşap
    - B-) Plastik
    - **Cevap C-) Metal**
    - D-) Kau&ccedil;uk
    - E-) K&acirc;ğıt
    <hr />
1. <strong>Aşağıdaki maddelerden hangisi ışık ge&ccedil;irme &ouml;zelliğine g&ouml;re yarı ge&ccedil;irgendir?</strong>
    - A-) Ahşap
    - **Cevap B-) Buz**
    - C-) Metal
    - D-) Cam
    - E-) K&acirc;ğıt
    <hr />
1. <strong>Cam y&uuml;zeye sahip olan bir &uuml;r&uuml;n&uuml;n formunun ortaya &ccedil;ıkarılması i&ccedil;in hangi a&ccedil;ıdan aydınlatılmış olması gerekir?</strong>
    - A-) Cephe ışık
    - B-) Yanal ışık
    - **Cevap C-) Ters ışık**
    - D-) &Ouml;n yanal ışık
    - E-) Tepe ışığı
    <hr />
1. <strong>Metal y&uuml;zeyli bir &uuml;r&uuml;n&uuml;n aydınlatılmasında aşağıdaki aydınlatma y&ouml;ntemlerinden hangisi kullanılır?</strong>
    - **Cevap A-) Dif&uuml;z ışık**
    - B-) Sert ışık
    - C-) Doğrudan ışık
    - D-) Ters ışık
    - E-) Yanal ışık
    <hr />
1. <strong>Işık ge&ccedil;irmeyen (opak) bir &uuml;r&uuml;ne hacim etkisinin kazandırılması i&ccedil;in aydınlatmanın hangi y&ouml;nden yapılması gerekir?</strong>
    - A-) Cephe ışık
    - **Cevap B-) Yanal ışık**
    - C-) Ters ışık
    - D-) Alt ışık
...
1. <strong>Stil life olarak adlandırılan &ccedil;ekim tekniği aşağıdaki alanlardan hangisinde <u>uygulanmaz</u>? </strong>
    ...
    - **Cevap D-) Mimari &uuml;r&uuml;nler**
    - E-) Kozmetik &uuml;r&uuml;nler
    <hr />
1. <strong>St&uuml;dyo fotoğraflarında aydınlatma i&ccedil;in aşağıdaki fiziki &ouml;zelliklerden hangisi &ouml;nemlidir ?</strong>
    - A-) Tavan Y&uuml;ksekliği
    - B-) Genişliği
...
<strong>C&uuml;mlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?</strong>
    - A-) barndoor
    - B-) r&ouml;prod&uuml;ksiyon
    - C-) panel reflekt&ouml;r
    - **Cevap D-) still life**
    - E-) ışık şekillendirici
    <hr />
## Unite 12
1. <strong>Aşağıdakilerden hangisi reklam metinlerinin i&ccedil;ermesi gereken işlevlerden biri <u>değildir</u>?</strong>
    - A-) İlgi &ccedil;ekme
    - B-) Bilgi verme
...
<strong>Paragrafta boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?</strong> 
    ...
    - E-) Başlık
    <hr />
1. <strong>Bir kurumu, mal ya da hizmeti simgelemesi amacıyla somut ve soyut simgelerden yararlanılarak &ouml;zel olarak tasarlanan, marka işareti olarak da adlandırılan unsura ne ad verilir?</strong>
    - **Cevap A-) Amblem**
    - B-) Logo
    - C-) Piktogram
    - D-) Grafik
    - E-) Sembol
    <hr />
1. <strong>Reklamlarda yer alan metinlerin bi&ccedil;imsel &ouml;zelliklerinin belirlenmesiyle ilgili olarak aşağıdakilerden hangisi <u>yanlıştır</u>?</strong>
    - A-) El yazısı ve s&uuml;sl&uuml; karakterler&nbsp;okunurluğu zorlaştırır.
    - **Cevap B-) Yazı karakteri ile zemin renginin aynı olması gerekir.**
    - C-) Başlık ve sloganlarda d&uuml;z karakterler kullanılmalıdır.
    - D-) C&uuml;mlelerin ve &ouml;zel&nbsp;isimlerin baş harfleri b&uuml;y&uuml;k olmalıdır.
...
<strong>C&uuml;mlede boş bırakılan yerlere sırasıyla aşağıdakilerden hangisi getirilmelidir?</strong>
    ...
    - **Cevap D-) &ccedil;ağrışım &ndash; g&ouml;sterge &ndash; ikonografik d&uuml;ş&uuml;nce**
    - E-) &ccedil;ekicilik &ndash; mizah &ndash; korku
    <hr />
...
1. <strong>Aşağıdakilerden hangisi fotoğrafın &ouml;zelliklerinden biri <u>değildir</u>?</strong>
    ...
    - **Cevap B-) İzleyeni kararsızlığa s&uuml;r&uuml;klemesi**
    - C-) G&ouml;r&uuml;nt&uuml;lerin &ouml;ğretici nitelik taşıması
    - D-) G&ouml;r&uuml;nt&uuml;lerin kanıt olarak kullanımı
    - E-) Bilgi taşıyıcı nitelikte olması
    <hr />
1. <strong>Markanın, t&uuml;keticinin zihninde belirli bir &ouml;zelliğiyle ya da istenilen bi&ccedil;imde yerleşmesini ve anımsanmasını sağlamak amacıyla kullanılan ve tekrarlanan &ccedil;arpıcı s&ouml;z aşağıdakilerden hangisidir?</strong>
    - **Cevap A-) Slogan**
    - B-) Metin
    - C-) Marka
    - D-) Reklam
...
1. <strong>Aşağıdakilerden hangisi reklam mesajını iletmede başvurulan ve anlam oluşumunu sağlayan unsurlardan biri <u>değildir</u>?</strong> 
    ...
    - **Cevap E-) Monografi**
    <hr />
1. <strong>Aşağıdakilerden hangisi reklam metninin ama&ccedil;lanan işlevlerindendir?</strong>
    - A-) Benzerlikleri ortaya koyma
    - **Cevap B-) Bilgi verme**
    - C-) Uzlaşı sağlama
    - D-) D&uuml;ş&uuml;nd&uuml;rme
    - E-) Taktik geliştirme
    <hr />
1. I. Hedef kitleyle temas kurulmasını sağlar.<br />
II. Tonlama, ritm ve &ccedil;ağrışımlara başvurulur.<br />
III. &Ccedil;ok sayıda anahtar s&ouml;zc&uuml;k yoluyla geliştirilir.<br />
<strong>&Ouml;zellikleri sıralanan kavram aşağıdakilerden hangisidir?</strong>
    - A-) Reklam
    - B-) Spot
    - C-) Logo
    - D-) Reklamveren
    - **Cevap E-) Slogan**
    <hr />
1. <strong>Aşağıdakilerden hangisi reklam fotoğrafının &ouml;zelliklerinden biri <u>değildir</u>?</strong>
    - A-) Fotoğraf bir anlatım dilidir.
    - B-) Fotoğraf uygun bir tasarımla sunulmalıdır.
    - **Cevap C-) Fotoğrafın &ccedil;oklu amacı olmalıdır.**
...
<strong>C&uuml;mlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?</strong>
    ...
    - E-) Simge
    <hr />
1. <strong>Aşağıdakilerden hangisi reklamda duyguları harekete ge&ccedil;irmek amacıyla başvurulan stratejilerden biri <u>değildir</u>?</strong>
    - A-) Duygusallık
    - B-) Zaman
    - C-) &Ouml;d&uuml;llendirme
    - **Cevap D-) Tanık kullanımı**
    - E-) Mizah
    <hr />
1. Fotoğraf, reklamcılıkta ................... stratejinin &ouml;nemli bir unsurudur.<br />
<strong>C&uuml;mlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?</strong>
    - A-) uydurma
    - B-) aldatma
    - **Cevap C-) yaratıcı**
...
1. <strong>Aşağıdakilerden hangisi reklam metni yazımı sırasında g&ouml;z &ouml;n&uuml;nde bulundurulan unsurlardan&nbsp;biri&nbsp;<u>değildir</u>?</strong>
    ...
    - B-) Firmanın pazar i&ccedil;erisindeki konumu
    - C-) Hedef kitlenin cinsiyeti, yaşı ve eğitim durumu
    - **Cevap D-) Reklamı yapan firmanın uyguladığı reklam stratejisi**
    - E-) Hedef kitlenin yaşam bi&ccedil;imi ve eğilimleri
    <hr />
1. I. Estetik bir g&ouml;r&uuml;n&uuml;m a&ccedil;ığa &ccedil;ıkarmak<br />
II. Nesnelerin var olan &ouml;zelliklerinin etkisini artırmak<br />
III. Nesnelerin istenmeyen y&ouml;nlerini karartarak belirsizleştirmek<br />
<strong>Reklam fotoğrafında aydınlatma tasarımı yapılırken yukarıda verilen ama&ccedil;lardan hangisi ya da hangileri&nbsp;&ouml;n plana &ccedil;ıkarılmalıdır?</strong>
    - A-) Yalnız I
    - B-) Yalnız II
    - C-) I ve II
    - D-) II ve III
    ...
    <hr />
## Unite 13
1. <strong>G&ouml;steren ile g&ouml;sterilen arasında imgesel (g&ouml;r&uuml;nt&uuml;sel) benzerlik taşıyan g&ouml;stergelere ne ad verilir?</strong>
    - A-) Kod
    - B-) Metonim
    - C-) Simge
    - **Cevap D-) İkon**
    - E-) Paradigma
    <hr />
1. <strong>Fotoğrafta bi&ccedil;imsel unsurların kullanılma yollarına ne ad verilir?</strong>
    - A-) Betimleme
    - B-) Tarz
    - C-) Eksilti
...
II. Yabancılaşma<br />
III. T&uuml;ketim toplumu<br />
<strong>Yukarıdaki temel kavramlar reklam analiz y&ouml;ntemlerinden hangisine aittir?</strong>
    - A-) G&ouml;stergebilimsel &ccedil;&ouml;z&uuml;mleme
    - B-) Psikanalitik &ccedil;&ouml;z&uuml;mleme
    - **Cevap C-) İdeolojik &ccedil;&ouml;z&uuml;mleme**
...
<strong>C&uuml;mlede boş bırakılan yerlere sırasıyla aşağıdakilerden hangisi getirilmelidir?</strong>
    ...
    - C-) ne - neden
    - **Cevap D-) ne - nasıl**
    - E-) neden &ndash; ne i&ccedil;in
    <hr />
1. G&ouml;stergebilim reklamlarda kullanılan fotoğraflara g&ouml;r&uuml;nen g&ouml;r&uuml;nt&uuml;n&uuml;narkasında yatan ...............&nbsp;ortaya &ccedil;ıkarmaya yol g&ouml;steren disiplinlerden biridir.<br />
<strong>C&uuml;mlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?</strong>
    - A-) yapıyı
    - B-) farkları
    - **Cevap C-) anlamı**
    ...
    - E-) sebepleri
    <hr />
1. <strong>Psikanalatik &ccedil;&ouml;z&uuml;mleme 19. y&uuml;zyılın sonlarında aşağıdakilerden hangisi tarafından ortaya koyulmuştur?</strong>
    - A-) Eric From
    - B-) Julia Kristeva
    - C-) Roland Barthes
    - D-) Peirce
    ...
    <hr />
1. <strong>Sınıf farklılığının vurgulandığı reklamlarda &ldquo;farklılığın&rdquo; ifadesi aşağıdakilerden hangisiyle <u>vurgulanamaz</u>?</strong>
    - A-) Giyim tarzı
    - B-) Kullanılan &uuml;r&uuml;nler
    - C-) Stat&uuml; farklılıklar
    - D-) Kullanılan karakterler
    - **Cevap E-) Standartlıklar**
    <hr />
1. <strong>Aşağıdakilerden hangisi g&ouml;stergelerarasılık kavramına ilişkin y&ouml;ntemler arasında <u>yer almaz</u>?</strong>
    - A-) Sinema - Edebiyat
    - **Cevap B-) Şiir - Roman**
    - C-) Resim - Fotoğraf
    - D-) Fotoğraf - Metin
...
1. <strong>Aşağıdakilerden hangisi g&ouml;stergelerarası y&ouml;ntemlerden biri <u>değildir</u>?</strong>
    ...
    - E-) Taklit
    <hr />
1. <strong>Tarihteki bir sanat eserini referans alarak onu andıran benzerini farklı bir sanat dalında &ldquo;yeniden &uuml;retmek&rdquo; g&ouml;stergelerarası y&ouml;ntemlerden hangisiyle ifade edilir?</strong>
    - A-) Gizli alıntı
    - **Cevap B-) Alıntı**
    - C-) Taklit
    - D-) &Ouml;yk&uuml;nme
    - E-) Yansılama
    <hr />
1. <strong>Genel anlamıyla alayı ve taklidi i&ccedil;eren yeniden &uuml;retimlere g&ouml;stergelerarası kavramlardan ne ad verilir?</strong>
    - A-) Alıntı
    - B-) Taklit
    - **Cevap C-) Yansılama**
    - D-) &Ouml;yk&uuml;nme
    - E-) Gizli alıntı
    <hr />
1. G&ouml;stergelerarası bir alıntılama y&ouml;ntemi olarak &ldquo;gizli alıntıda&rdquo; eserin ger&ccedil;ek sahibinin kim olduğunun belirtilmemesi, o eserden esinlenme olarak tanımlanabildiği gibi kimi kuramcılar tarafından da .............. şeklinde adlandırılır.<br />
...
<strong>C&uuml;mlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?</strong>
    ...
    - E-) metafizik
    <hr />
1. <strong>Reklamlarda&nbsp;yazıyı belirlenen ama&ccedil; doğrultusunda istenilen yere yerleştirmeyi hedefleyen,&nbsp;okunabilirlik ya da se&ccedil;ilebilirlik kavramını &ouml;n plana &ccedil;ıkaran&nbsp;&ouml;zellik aşağıdakilerden hangisidir?</strong>
    - A-) Fotografi
    - B-) Fonografi
    - C-) Grafik
    - **Cevap D-) Tipografi**
...
1. <strong>Bir eşyayı, objeyi, yeri, işleyişi ya da kavramı resmetme yoluyla temsil eden sembole ne ad verilir?</strong>
    ...
    - E-) İl&uuml;strasyon
    <hr />
1. <strong>Reklam fotoğrafı ve g&ouml;rsel unsur kullanımında başvurulan tekniklerden biri olan odak ve g&ouml;r&uuml;ş derinliğinin kullanım amacı aşağıdakilerden hangisidir?</strong>
    - **Cevap A-) Nesneleri net, donuk, kırışık, bulanık veya sisli olarak bir fotoğrafın belli b&ouml;lgelerini vurgulayıp diğerlerini soluk&nbsp;g&ouml;stermek i&ccedil;in kullanılır.**
    - B-) Nesnelerin t&uuml;m albenili detaylarını g&ouml;stermek ya da normal&nbsp;g&ouml;r&uuml;n&uuml;m&uuml;nden daha b&uuml;y&uuml;k g&ouml;stermek i&ccedil;in kullanılır.
    - C-) Doğal olmayan g&ouml;r&uuml;n&uuml;mler, hareketlilik ve heyecan&nbsp;izlenimi vermek i&ccedil;in kullanılır.
    - D-) Dramatik ya da olağan&uuml;st&uuml; etki yaratılmak istenildiğinde veya yan anlam denetimi i&ccedil;in a&ccedil;ı değişikliklerine başvurulur.
    - E-) Daha &ccedil;ok insan v&uuml;cudunun belli bir kısmına dikkati &ccedil;ekmek i&ccedil;in fotoğrafın kesilmesi y&ouml;ntemidir.
    <hr />
1. <strong>Alıntı yapılan eserin ger&ccedil;ek&nbsp;sahibinin adının belirtilmediği alıntılama&nbsp;&ccedil;eşidine ne ad verilir?</strong>
    - A-) Metonim (D&uuml;zdeğişmece)
    - B-) &Ouml;yk&uuml;nme (Pastiche)
...
1. <strong>Bir fotoğraf portfolyosu aşağıdakilerden hangisi i&ccedil;in <u>hazırlanmaz</u>?</strong>
    ...
    - E-) Bir fotoğraf projesine kaynak bulmak i&ccedil;in
    <hr />
1. <strong>Bir fotoğraf portfolyosu hazırlamanın ilk adımı aşağıdakilerden hangisidir?</strong>
    - A-) Hangi fotoğrafların kullanacağına karar vermek.
    - B-) En etkili fotoğrafları se&ccedil;mek.
    ...
    <hr />
1. <strong>Fotoğraf se&ccedil;menin fotoğraf &ccedil;ekmekten daha zor olmasının nedeni aşağıdakilerden hangisidir?</strong>
    - A-) Fotoğraf &ccedil;ekmek daha &ccedil;ok dış ortamda olduğu i&ccedil;in
    - **Cevap B-) Fotoğraf se&ccedil;erken &ccedil;ekim anındaki yaşananların etkisinde kalındığı i&ccedil;in**
    - C-) İnsan yapısı gereği &uuml;&ccedil; boyutlu d&uuml;nyayı g&ouml;rmeye alışkın olduğu i&ccedil;in
    - D-) Fotoğraf anı dondurduğu ve i&ccedil;inde hareket barındırmadığı i&ccedil;in
    - E-) Fotoğraf &ccedil;ekmekten daha &ccedil;ok zevk alındığı i&ccedil;in
    <hr />
1. <strong>Fotoğraf portfolyosunda kullanılacak giriş yazısı i&ccedil;in verilen aşağıdaki &ouml;zelliklerden hangisi <u>yanlıştır</u>?</strong>
    - **Cevap A-) Uzun ve ayrıntılı olması**
    - B-) Yeterince a&ccedil;ık olması
    - C-) Etkileyici olması
    - D-) &Ouml;zet niteliğinde olması
    - E-) Talebin ne olduğunu belirtiyor olması
    <hr />
1. <strong>Bir fotoğraf portfolyosu hazırlarken fotoğraf dizgisi aşağıda verilen hangi &ouml;zelliğe g&ouml;re <u>yapılmaz</u>?</strong>
    - A-) Genelden detaya doğru
    - B-) Detaydan genele doğru
    - **Cevap C-) B&uuml;y&uuml;kten k&uuml;&ccedil;&uuml;ğe doğru**
    - D-) Ton değeri birbirine yakın olanların ardada gelişine g&ouml;re
    - E-) Fotoğrafların kontrastlıklarına g&ouml;re
    <hr />
1. <strong>Bir fotoğraf&ccedil;ı hazırladığı portfolyo ile aşağıdakilerden hangisini <u>s&ouml;ylemez</u>?</strong>
    - A-) Fotoğrafta konu b&uuml;t&uuml;nl&uuml;ğ&uuml;n&uuml; etkili bir şekilde kullanabildiğini
    ...
    <hr />
1. <strong>Fotoğraf portfolyosunun kapağında aşağıdakilerden hangisi mutlaka olmak zorundadır?</strong>
    - A-) S&uuml;sl&uuml; bir k&acirc;ğıt
    - B-) Konuyu anlatan resim
    - C-) Konuyu anlatan fotoğraf
    - D-) İ&ccedil;indekiler
    - **Cevap E-) Fotoğraf&ccedil;ının isimi**
    <hr />
1. <strong>Bir fotoğraf değerlendiricisi aşağıda g&ouml;sterilen aşamalardan hangisini her zaman <u>yapmayabilir</u>?</strong>
    - **Cevap A-) Fotoğraf&ccedil;ıyı &ccedil;ağırıp y&uuml;z y&uuml;ze konuşmak.**
    - B-) Portfolyoyu inceleyip konunun kendisini ilgilendirip ilgilendirmediğine karar vermek.
    - C-) Fotoğraf&ccedil;ının sunduğu portfolyo ile işinde başarılı olup olmadığını incelemek.
    - D-) Portfolyo i&ccedil;eriği ile talep edilenlerin &ouml;rt&uuml;ş&uuml;p &ouml;rt&uuml;şmediğini sorgulamak.
    - E-) Fotoğraf&ccedil;ının kendine has bir &uuml;slubunun olup olmadığına bakmak.
    <hr />
1. <strong>Bir fotoğraf portfolyosunda hazırlanış nedenine bağlı olarak değişiklik g&ouml;sterse de genelde hangi sayılar aralığında fotoğraf adeti kullanılır?</strong>
    - A-) 5&nbsp;- 10
    - B-) 10 - 20
    - **Cevap C-) 10 - 30**
    - D-) 20 - 50
    - E-) 30 &ndash; 60
    <hr />
1. <strong>Bir fotoğraf portfolyosu hazırlanırken aşağıdakilerden hangisinden ka&ccedil;ınmak gerekir?</strong>
    - A-) Belirlenen ama&ccedil; doğrultusunda en etkili fotoğrafları &ouml;zenle se&ccedil;mekten
    - **Cevap B-) Fotoğrafları se&ccedil;erken duygusal bir tavırla se&ccedil;ki yapmaktan**
    - C-) Kendimizi portfolyoyu değerIendirecek kişinin yerine koyarak empati kurmaktan
    - D-) Se&ccedil;ilen fotoğrafları anlam b&uuml;t&uuml;nl&uuml;ğ&uuml;nde sıralamaktan
    - E-) Se&ccedil;ilen fotoğrafları en iyi şekilde yansıtacak baskı tekniğini se&ccedil;mekten
    <hr />
1. Fotoğraf se&ccedil;menin, fotoğraf &ccedil;ekmekten daha zor olduğu dile getirilirken, &ccedil;ekim esnasında yaşananların etkisi fotoğraflara yansımasa da fotoğraf&ccedil;ının belleğinde varlıklarını devam ettirirler. Bu y&uuml;zden &ccedil;ekimlerin &uuml;zerinden bir s&uuml;renin ge&ccedil;mesinin doğru olduğu dile getirilir.<br />
<strong>Ortalama bir fotoğraf&ccedil;ının duygusal davranıştan kurtulması i&ccedil;in ne kadar s&uuml;re ge&ccedil;irdikten sonra fotoğraf se&ccedil;imini yapması &ouml;nerilir?</strong>
    - A-) Bir hafta
    - B-) İki hafta
    - C-) Bir ay
    - **Cevap D-) Altı ay**
    - E-) Bir yıl
    <hr />
1. Portfolyo i&ccedil;in se&ccedil;ilen fotoğrafların baskı aşamasına gelindiğinde k&acirc;ğıt &ccedil;eşitliliği ile karşılaşılır. Bu noktada fotoğraflar i&ccedil;in en doğru k&acirc;ğıdı se&ccedil;mek gerekir.<br />
<strong>Aşağıdaki &ouml;zelliklerden hangisi k&acirc;ğıt se&ccedil;iminde karşımıza <u>&ccedil;ıkmaz</u>?</strong>
    - A-) K&acirc;ğıt tabanlı k&acirc;ğıt
    - B-) Metalik k&acirc;ğıt
...
1. <strong>Usta fotoğraf&ccedil;ıların, fotoğraf se&ccedil;mek i&ccedil;in &ccedil;ekimden sonra altı ay&nbsp;gibi bir s&uuml;renin ge&ccedil;mesini &ouml;nermesinin nedeni aşağıdakilerden hangisidir?</strong>
    ...
    - C-) Hızlı yapılan se&ccedil;imlerde hata yapma olasılığının fazla olacağı d&uuml;ş&uuml;n&uuml;lmektedir.
    - D-) &Ccedil;ekilen projeye devam edilmesinin daha doğru olacağı d&uuml;ş&uuml;n&uuml;lmektedir.
    - **Cevap E-) Duygusallıktan uzaklaşılarak daha objektif davranılmasına imk&acirc;n vermiştir.**
    <hr />
