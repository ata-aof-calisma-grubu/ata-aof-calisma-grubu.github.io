...
## Unite 1
1. **Görsel iletişim örneği olan mağara resimlerinin bulunduğu bilinen en eski mağara aşağıdakilerden hangisidir?**
    - A-) Altamira Mağarası
...
1. **Reklam sektörünün gelişmesiyle birlikte endüstriyel bir boyut kazanan fotoğrafın önemli uygulama alanlarından biri hâline gelmesine ne ad verilir?**
    ...
    - B-) Sanat fotoğrafçılığı
    - C-) Belgesel fotoğrafçılığı
...
1. I. Fotoğrafın endüstriyel bir boyut kazanması<br />II. Fotoğrafın ilk yıllarında kendini gösteren resimsel fotoğraf eğilimi<br />III. Bir statü aracı olarak kullanılması<br />IV. Birinci Dünya Savaşı sonrası yaşanan sorunlarda insanların hayatın acımasız yönünü gündeme getirme çabaları<br />**Yukarıdakilerden hangileri b****elgesel fotoğrafın ortaya çıkmasında** **etkili olmuştur?**
    ...
    - E-) I, II, III ve IV
    <hr/>
1. **İşaretler, semboller, resimler gibi görüntü merkezli bir dil kullanan ve evrensel bir ifade biçimi olarak tanımlanan iletişim türü aşağıdakilerden hangisidir?**
    - A-) Sözel iletişim
    - B-) İşitsel iletişim
    - C-) Yazılı iletişim
    - D-) Duyusal iletişim
    - **Cevap E-) Görsel iletişim**
    <hr/>
1. **MÖ 8. yüzyıl sonlarında, özellikle denize kıyısı olan ülkelerdeki tüccarların kendi aralarında tanıtıcı işaretler olarak kullandıkları sembollere verilen isim aşağıdakilerden hangisidir?**
    - **Cevap A-) Amblem**
    - B-) Flama
    - C-) Bayrak
    - D-) Afiş
    - E-) Resimli bez
    <hr/>
1. Fotoğraf, özgürlüklerin kazanılması mücadelesinde ön ayak olmuş, modern çağı sembolize eden tipik bir iletişim aracı hâline gelmiştir.<br />**Yukarıdaki cümlede fotoğrafın hangi işlevi vurgulanmaktadır?**
    ...
    - E-) Sanatsal işlevi
    <hr/>
1. **Kültür, tarih, doğa, yaşam biçimleri, sanat gibi insanı ilgilendiren birçok konu hakkında bilgi aktarmayı ve ele alınan konuyu belgeleriyle ortaya koymayı hedefleyen fotoğraf türü aşağıdakilerden hangisidir?**
    - A-) Sanat fotoğrafı
    ...
    - E-) Reklam fotoğrafı
    <hr/>
1. **Fotoğrafın hedef kitleye en fazla sayıda erişimini sağlamak ve görsel etkiyi arttırıp zihinde bir görüntü oluşturmak amacıyla kullanılan fo****toğraf türü aşağıdakilerden hangisidir?**
    - A-) Haber fotoğrafı
    - B-) Sanat fotoğrafı
    ...
    - E-) Soyut fotoğraf
    <hr/>
1. **Fotoğrafçılıkta belirlenmiş veya kendi belirlediği ölçülere göre neyi, ne zaman, nasıl, ne kadar çekeceğine karar vererek fotoğrafı duygu, düşünce veya fikirlerini insanlara aktarmada bir iletişim yöntemi olarak kullanılan fotoğraf türü aşağıdakilerden hangisidir?**
    - A-) Spor fotoğrafı
    - B-) Haber fotoğrafı
    - C-) Reklam fotoğrafı
    - D-) Tanıtım fotoğrafı
    ...
    <hr/>
1. **İletişim biçimi olarak kullanılan türler arasında aşağıdakilerden hangisi bulunmaz?**
    - A-) Sözlü İletişim
    - B-) Yazılı İletişim
    - C-) Görsel İletişim
    - D-) Kitle İletişimi
    - **Cevap E-) Küresel İletişim**
    <hr/>
1. **Herhangi bir nesneyi, mekânı, kavramı vb. şeyleri görsellerle sembolik olarak aktaran dil aşağıdakilerden hangisidir?**
    - A-) Fotoğraf
    - **Cevap B-) Piktogram**
    - C-) Fonogram
    - D-) Kaligrafi
    - E-) Epigrafi
    <hr/>
1. **Aşağıdakilerden hangisi fotoğrafın özellikleri arasında yer almaz?**
    - A-) Görsel dili kullanan bir iletişim biçimidir.
    - B-) Belleğimizin saklayamadığı anı yakalar.
    - **Cevap C-) Çağa tanıklık etmeyen bir belge niteliği taşır.**
    - D-) Bilim, sanat, eğitim gibi alanlarda kullanılır.
    - E-) Duyguları harekete geçirir.
    <hr/>
1. **Aşağıdakilerden hangisi fotoğraf türlerinden biri değildir?**
    - A-) Portre fotoğrafı
    ...
    - E-) Haber fotoğrafı
    <hr/>
1. Görsel iletişim, …………. resimleriyle başlayan, sembolik ifade araçları veya işaretleriyle gelişen ve ……………..; etkisiyle ilerleyen bir süreçte gelişme göstermiştir.<br />**Cümlede boş bırakılan yerlere sırasıyla aşağıdakilerden hangisi getirilmelidir?**
    ...
    <hr/>
1. Fotoğrafın yoğun şekilde kullanıldığı yerdir. Günümüzde ticari amaçlı olarak kullanılır ve tüketicilere yönelik yapılır. Fazla sayıda hedef kitleye ulaşmayı sağlar. Hem görsel etkiyi artırmak hem de zihinde bir görüntü oluşturmak için etkili bir yöntem olmayı hedefler.<br />**Paragrafta bazı özellikleri verilen fotoğraf türü aşağıdakilerden hangisidir?**
    - A-) Figür fotoğrafı
    ...
    - E-) Sanat fotoğrafı
    <hr/>
1. Fotoğraf, özgürlüklerin kazanılması mücadelesinde ön ayak olmuş, modern çağı sembolize eden tipik bir iletişim aracı hâline gelmiştir.<br />**Cümledeki ifade fotoğrafın hangi işlevini vurgulamaktadır?**
    - A-) Eğitici işlevi
    - B-) Duygusal işlevi
    ...
    <hr/>
1. **Aşağıdakilerden hangisi ışıkla yazı yazmak anlamına gelmektedir?**
    - A-) Reklam
    - B-) Teknoloji
    - **Cevap C-) Fotoğraf**
    - D-) İletişim
    - E-) Resim
    <hr/>
1. **Aşağıdakilerden hangisi kültürün oluşmasına önemli katkı sunan görsel bir iletişim aracı olarak ortaya çıkmıştır?**
    - **Cevap A-) Fotoğraf**
    - B-) Yazı
    - C-) Din
    - D-) Tarih
    - E-) Edebiyat
    <hr/>
1. **Aşağıdakilerden hangisi fotoğrafın, ortaya çıktığı çağda sosyal statünün bir göstergesi olarak kullanılmıştır?**
...
1. Papirüs ve duvar üzerine yapılan ilk çizimler hikâyeleri iletme amacı taşırken; Mısır’da kaçan esirleri bulup getirene ödül verileceğini duyuran papirüsler, esirlerin fiyat ve özelliklerinin kazındığı duvarlar .................. olarak kabul edilirler.<br />**Cümlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?**
    ...
    - **Cevap D-) ilk reklam örnekleri**
    - E-) ilk mesaj örnekleri
    <hr/>
## Unite 2
1. **1856 yılında Kırım Savaşı'nda ilk haber fotoğraflarını çeken İngiliz fotoğrafçı aşağıdakilerden hangisidir?**
    - A-) Mathew Brady
    - B-) William Henry
    - C-) Robert Adamson
    - D-) Sir John Herschel
    ...
    <hr/>
1. **İngiliz astronom John Herschel’in, fotoğrafçı Fox Talbot’a yazdığı mektupta fotoğraf sözcüğünü ilk kez kullandığı yıl aşağıdakilerden hangisidir?**
    - **Cevap A-) 1839**
    - B-) 1850
    - C-) 1890
    - D-) 1903
...
1. **Fotoğrafın gelişimine önemli katkıları olan isimlerden 13. yüzyılda yaşamış İngiliz Profesör Roger Bacon ile ilgili aşağıdakilerden hangisi yanlıştır?**
    ...
    - D-) Mercek ve aynalarla yaptığı çeşitli çalışmalarla sihirbaz olarak da tanınmıştır.
    - E-) Güneş tutulmasını karanlık kutu sayesinde izleyerek optik alanda verimli çalışmalara imza atmıştır.
    <hr/>
1. **Aşağıdakilerden hangisi 1850- 1860 yılları arasındaki ünlü fotoğraf atölyeleri arasında yer almaz?**
    - A-) Matthew Brady
    - B-) Meade kardeşler
...
1. **Tarihte ilk fotoğraf olarak kabul edilen ve Niepce'nin evinin penceresinden aldığı ilk görüntüleri maden ve taş üzerine kaydettiği yönteme ne ad verilir?**
    ...
    - E-) Fotografi
    <hr/>
1. **Sanayi Devrimi ile ilgili aşağıdaki buluşlardan hangisi gerçekleşmiştir?**
    - A-) Yazının icadı
    - B-) Matbaanın icadı
    ...
    <hr/>
1. **Işıkla resim çizmek anlamına gelen fotoğraf (photograph) kelimesini ilk kez kullanan bilim insanı aşağıdakilerden hangisidir?**
    ...
    - E-) İbn-i Heysem
    <hr/>
1. **Fotoğrafçılık çalışmalarıyla ilgili olarak aşağıdakilerden hangisi yanlıştır?**
    - A-) Fotoğraf fikrini ortaya atan ve geliştiren Aristo’dur.
    - **Cevap B-) Fotoğraf çalışmaları milattan sonraki dönemde ortaya çıkmıştır.**
    - C-) Işıkla görüntü oluşturmanın ilk aracı Camera Obscura’dır.
    - D-) Camera Obscura karanlık kutu anlamına gelmektedir.
    - E-) Frisius, karanlık kutunun ilk çizimini yapmış kişidir.
    <hr/>
1. Matematik, astronomi, fizikle ilgilenmiş bilim insandır. Karanlık oda ile ilgili ilk uygulamayı gerçekleştirmiştir. “Üç Mum Deneyi” önemli optik çalışmalarından biridir.<br />**Hakkında bilgi verilen bilim insanı aşağıdakilerden hangisidir?**
    - A-) İbni Sina
    - B-) El Biruni
    - **Cevap C-) İbni Heysem**
    - D-) Farabi
...
1. I. Yeni bir görme biçimi ve görme kültürü gelişmesine yardımcı olmuştur.<br />II. Eğlence, harita çizimleri ve resim yapmada yardımcı araç olarak kullanılmıştır.<br />III. Adını koyan bilim adamı Johannes Kepler olmuştur.<br />**Yukarıdakilerden hangisi ya da hangileri Camera Obscura (Karanlık Kutu)'nın özellikleri arasında yer alır?**
    ...
    - **Cevap E-) I, II ve III**
    <hr/>
1. Niepce, tarihte ilk fotoğraf olarak kabul edilen ve evinin penceresinden aldığı ilk görüntüleri maden ve taş üzerine kaydettiği yönteme …………….. adını vermiştir.<br />**Cümlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?**
    - A-) Daguerrotype
    - B-) Calotype
    - C-) Graphi
    - **Cevap D-) Helyografi**
    - E-) Photos
    <hr/>
1. **Aşağıdakilerden hangisi ilk haber fotoğrafçılığına örnektir?**
    ...
    - E-) Matbaanın İcadı
    <hr/>
1. **Fotoğraf, negatif, pozitif gibi sözcükleri ilk kullanan isim aşağıdakilerden hangisidir?**
...
1. **Aşağıdakilerden hangisi 19. yüzyılda fotoğraf alanındaki gelişmelerden biri değildir?**
    ...
    - D-) Fotoğraf atölyeleri
    - **Cevap E-) Polaroid fotoğraf**
    <hr/>
1. Camera Obscura adı Latincede “............” anlamına gelen camera ve “............” anlamına gelen obscura kelimelerinin birleşmesinden oluşur.<br />**Cümlede boş bırakılan yerlere sırasıyla aşağıdakilerden hangisi getirilmelidir?**
    - A-) ışık-oda
    - B-) ışık-kamera
    - C-) oda-kamera
...
1. **Camera obscura’nın çalışma prensibini Rönesans Dönemi’nde ilk kez tanımlayan isim aşağıdakilerden hangisidir?**
    ...
    - E-) Michalengelo
    <hr/>
1. **Aynadaki yansıma kuralını bularak görüntünün baş aşağı görülme eksikliğini gideren isim aşağıdakilerden hangisidir?**
    ...
    - E-) Daguerre
    <hr/>
1. **1826 yılında kalıcı görüntüyü sağlayarak ilk fotoğraf görüntüsünü elde eden isim aşağıdakilerden hangisidir?**
    - A-) François Arago
    - **Cevap B-) Niepce**
    ...
    - E-) Joseph Bancroft
    <hr/>
1. **Fotoğrafın resmen bir buluş olarak kabul edilmesinin resmî belgesi niteliğindeki buluş aşağıdakilerden hangisidir?**
    - A-) Banyolama
    - B-) Calotype
    - C-) Fotogram
    ...
    - E-) Pozlama
    <hr/>
1. **İlk kez negatif ve pozitif tekniğini bularak tek bir negatifi çoğaltıp pozitif görüntüler elde etmenin mümkün olduğunu gösteren isim aşağıdakilerden hangisidir?**
    - A-) Niepce
    - B-) George Eastman
    - C-) François Arago
    - D-) Giovanni Battista Della
    ...
    <hr/>
1. **Yüzey üzerinde görüntü oluşmasına yardımcı olan ve ışıkla etkileşimi sonucu kararma-ağarma özelliklerine sahip kimyasal madde aşağıdakilerden hangisidir?**
    - **Cevap A-) Gümüş**
    - B-) Bakır
    - C-) Altın
    - D-) Krom
    - E-) Civa
    <hr/>
1. **“Universal tip” olarak bilinen hem gün ışığında hem de yapay ışıkta elde edilen renkli negatifler hangi yöntemle fotoğraf kartlarına tab edilerek birer pozitif görüntüye dönüştürülürler?**
    - A-) Banyolama
    - B-) Küçültme
    - **Cevap C-) Büyütme**
    - D-) Fotogram
    - E-) Calotype
    <hr/>
1. **İki boyutlu fotoğraflar yerine üç boyutlu fotoğraflar elde ederek fotoğraflara derinlik hissi veren fotoğraf makinesi türü aşağıdakilerden hangisidir?**
    ...
    <hr/>
1. **Niepce’nin metal levha üzerinde ilk mimari fotoğrafı elde ederken kullanmış olduğu yöntem aşağıdakilerden hangisidir?**
    - A-) Fotografi
    - B-) Gölgeleme
    - **Cevap C-) Heliografi**
    - D-) Calotyp
    - E-) Daguerreotype
    <hr/>
1. **Kutu fotoğraf makinesinin özellikleri arasında aşağıdakilerden hangisi yoktur?**
    ...
    <hr/>
## Unite 4
1. **Atatürk’ün albüm niteliğindeki portrelerini çeken, Türkiye Cumhuriyeti’nin ilk foto muhabiri olarak bilinen kişi aşağıdakilerden hangisidir?**
    ...
    - E-) Şinasi Barutçu
    <hr/>
1. **Fotoğrafın Türkiye'de gelişim süreci değerlendirildiğinde Cumhuriyet'in ilanından 1950'ye kadar olan döneme ne ad verilir?**
    - **Cevap A-) Romantik Dönem**
    - B-) Realist Dönem
    - C-) Geçiş Dönemi
    - D-) Deneysel Dönem
    - E-) Dijital Dönem
    <hr/>
1. **Türk Hanımlar Fotoğrafhanesi adıyla evinde kurduğu stüdyoda fotoğrafçılık yapmaya başlayan ilk Müslüman kadın fotoğrafçı aşağıdakilerden hangisidir?**
    - A-) Nedret Ekşigil
    - B-) Muzaffer Hanım
    - C-) Yıldız Moran
...
1. I. Bir imgeye bakışta farklı yollar ileri sürmektedir.<br />II. Fotoğrafa bakan kişiye farklı bakış açısı kazandırarak keşfetmeye yöneltir.<br />III. Anlamın sınırsız okunmasına imkân sağlamaktadır.<br />**Yukarıda özellikleri verilen fotoğraf türü hangisidir?**
    ...
    - E-) Modern fotoğraf
    <hr/>
1. **Türkiye Fotoğraf Sanatı Dernekleri Birliğinin kurulduğu yıl aşağıdakilerden hangisidir?**
    - A-) 1930
    - B-) 1950
    - C-) 1985
    - **Cevap D-) 1998**
    - E-) 2003
    <hr/>
1. **Aşağıdakilerden hangisi Osmanlı’da 1850 yılında ilk yerli stüdyoyu açan fotoğrafçıdır?**
    ...
    - E-) Şinasi Barutçu
    <hr/>
1. **Osmanlı’da kaliteli fotoğraf-kâğıt-baskı anlamında fotoğrafçılığı profesyonel anlamda uygulayan ve gelişimine katkı sağlayan dergi aşağıdakilerden hangisidir?**
    - A-) Takvim-i Vakayi
    - B-) Tercüman-ı Ahvâl
    - **Cevap C-) Servet-i Fünun**
    - D-) Tasvir-i Efkâr
    - E-) Akbaba
    <hr/>
1. **Osmanlı dönemi fotoğrafçıları arasında aşağıdakilerden hangisi yoktur?**
    - A-) Ferit İbrahim
    - B-) Ebuzziye Tevfik
    - C-) Velid Ebuzziya
    - **Cevap D-) Ara Güler**
    ...
    <hr/>
1. **Osmanlı’nın son dönemlerinde Türk Hanımlar Fotoğrafhanesini kurarak portre fotoğrafları çeken ilk profesyonel kadın fotoğrafçımız aşağıdakilerden hangisidir?**
...
1. **Aşağıdakilerden hangisi** **1980 Sonrası Fotoğrafçılık Akımı'nın özellikleri arasında yer almaz?**
    ...
    - E-) Deneyseldir.
    <hr/>
1. **Tanıtım ve reklam fotoğrafçılığının siyasal iletişimden, pazarlamaya hemen her mecrada (billboard, gazete, dergi ve internet) küresel dünyada genişleyen bir alana dönüştüğü dönem aşağıdakilerden hangisidir?**
    - A-) Osmanlı Dönemi
    - B-) Romantik Dönem
    - C-) Geçiş Dönemi
    - D-) 1950-1970 Dönemi
    - **Cevap E-) 1980 Sonrası Dönem**
    <hr/>
1. **Fotoğrafçılık alanında dernekleşme faaliyetlerinin başladığı dönem aşağıdakilerden hangisidir?**
    - A-) Osmanlı Dönemi
    - B-) Romantik Dönem
    - C-) Geçiş Dönemi
    - **Cevap D-) 1950-1970 Arası Dönem**
    - E-) 1980 Sonrası Dönem
    <hr/>
1. **Türkiye’de fotoğrafçıların köyden kente göç, şehirleşme, yoksulluk gibi sosyal sorunlara odaklanmaya başladıkları dönem aşağıdakilerden hangisidir?**
    - A-) Osmanlı Dönemi
    - B-) Romantik Dönem
    - C-) Dijital Dönem
...
1. I. Görüntünün önceden izlenebilmesi<br />II. Fotoğraf filminin ortadan kalkması<br />III. Görüntünün anında elde edilebilmesi<br />**Yukarıdakilerden hangisi ya da hangileri dijital fotoğrafçılığın özellikleri arasında yer alır?**
    ...
    - **Cevap E-) I, II ve III**
    <hr/>
1. **Osmanlı Devleti'ni fotoğraflarla tanıtan Yıldız Albümleri’ni yaptıran ve fotoğrafa ilgisiyle bilinen Osmanlı padişahı aşağıdakilerden hangisidir?**
    - A-) Abdülaziz
    ...
    - E-) Vahdettin
    <hr/>
1. **Türkiye Cumhuriyeti’nin tanıtılması amacıyla Mustafa Kemal Atatürk tarafından fotoğraf çekmekle görevlendirilen Avusturyalı fotoğrafçı aşağıdakilerden hangisidir?**
    - A-) Basile Kargopoulo
    - B-) Paskal Sebah
    ...
    - E-) Compa
    <hr/>
1. **Türkiye Cumhuriyeti’nin ilk yıllarında fotoğrafçılıkta, ülkenin tanıtılmasının ve inkılapların yerleşmesinin amaçlandığı dönem aşağıdakilerden hangisidir?**
    - A-) Geçiş Dönemi
    - B-) Deneysel Dönem
    - C-) Soyut Dönem
    - D-) Sosyal Gerçekçi Dönem
    - **Cevap E-) Romantik Dönem**
    <hr/>
1. **Atatürk Dönemi'nin portre geleneğini başlatan ve Türkiye Cumhuriyeti’nin ilk foto muhabiri olan fotoğrafçı aşağıdakilerden hangisidir?**
    - **Cevap A-) Cemal Işıksel**
    - B-) Etem Tem
    ...
    - E-) Semiha Es
    <hr/>
1. **1950’de Ankara’da Türkiye’nin ilk fotoğraf derneği olan TAFK’ı (Türkiye Amatör Fotoğraf Kulübü) kuran fotoğraf sanatçısı aşağıdakilerden hangisidir?**
    - A-) Nurettin Erkılıç
    - B-) Ara Güler
    - C-) Yıldız Moran
    - D-) Ozan Sağdıç
    - **Cevap E-) Şinasi Barutçu**
    <hr/>
1. **Türkiye’nin ilk kadın savaş foto muhabiri aşağıdakilerden hangisidir?**
    - A-) Yıldız Moran
    - **Cevap B-) Semiha Es**
    - C-) Sevil Sert
    - D-) Naciye Suman
...
1. I. Burhan Felek<br />II. Ara Güler<br />III. Ferit İbrahim<br />**Yukarıdakilerden hangisi ya da hangileri Osmanlı Dönemi fotoğrafçıları arasında yer alır?**
    ...
    - E-) I, II ve III
    <hr/>
1. ……………………fotoğrafın kitaplaşma çalışmalarına ev sahipliği yapmıştır. Bu dönemde fotoğrafla ilgili iki kitap olan Risale-i Fotografya yayınlanmıştır.<br />**Cümlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?**
    - **Cevap A-) Osmanlı Dönemi**
    - B-) Romantik Dönem
    - C-) Cumhuriyet Dönemi
    - D-) Deneysel Dönem
    - E-) Dijital Dönem
    <hr/>
1. **Aşağıdakilerden hangisi 1980 ve sonrası deneysel - dijital fotoğraf döneminin özellikleri arasında yer almaz?**
    - A-) Sosyal gerçekçi anlayış yerini deneysel fotoğrafa bırakmıştır.
    - B-) Belirli kalıplar dışına çıkarak sınırsız özgürlüğe izin verilmiştir.
    - **Cevap C-) Romantik Dönem olarak adlandırılmıştır.**
    - D-) Yaratıcılık ve bireysellik ön plana çıkmıştır.
    - E-) Farklı bakış açısı kazandırarak fotoğrafı keşfetmeye yöneltmiştir.
    <hr/>
1. **1891’de yayın hayatına başlayan ve basın fotoğrafçılığının öncüsü olarak kabul edilen dergi aşağıdakilerden hangisidir?**
    - A-) Vakayı Tıbbiye Dergisi
    - B-) Hayat Dergisi
    - **Cevap C-) Servet-i Fünun Dergisi**
    - D-) Haftanın Sesi Dergisi
    - E-) Musavver Malûmat Dergisi
    <hr/>
1. **Aşağıdakilerden hangisi dijital fotoğrafın avantajlarından biri değildir?**
    - A-) Görüntünün önceden izlenebilmesi
    - B-) İstenilen fotoğrafın silinebilmesi
    - C-) Çekim esnasında hafıza kartlarına kaydedilmesi
    - **Cevap D-) Karanlık odada dijital pozlama yapılması**
    - E-) Cep telefonu ya da bilgisayar aracılığıyla görüntülerin başka yerlere gönderilmesi
    <hr/>
1. **Kurgusallık, soyut yaklaşımlar ve dijital teknolojinin getirdiği popüler uygulamalar, aşağıdakilerden hangisinin gelişimine yol açmıştır?**
    - A-) Flaşlar
    ...
    <hr/>
## Unite 5
1. **Bir mercek sistemine giren ışığın denetimini sağlamak için üst üste binerek apertürün çapını değiştirebilen metal yaprakçıklar düzenine ne ad verilir?**
    - A-) Mod kadranı
    - **Cevap B-) Diyafram**
    - C-) Diyoptri düğmesi
    - D-) Zoom halkası
    - E-) Vizör
    <hr/>
1. **Netliği daha iyi yapabilmek için lens üzerinde bulunan ve makinede olabilecek küçük titreşimleri engelleyen düğme aşağıdakilerden hangisidir?**
    - A-) SF
    - B-) AV
    - C-) MF
    - D-) AF
    - **Cevap E-) VR**
    <hr/>
1. **Diyoptri kadranının tanımı aşağıdakilerden hangisidir?**
    - A-) Yapılan çekimin izlenmesi için basılan düğmedir.
    - **Cevap B-) Göz ile vizörü buluşturan yani vizörün görme netliğini göze göre ayarlamaya yarayan düğmedir.**
    - C-) Objektifin yakın kısmında bulunan, objektifin takılıp çıkarılmasında kolaylık sağlayan düğmedir.
...
1. **Aşağıdakilerden hangisi bataryayı daha verimli kullanmak için alınması gereken önlemlerden biri değildir?**
    ...
    - E-) Ekran koruma modunu aktif hâle getirmek
    <hr/>
1. **Fotoğraf makinesinin ana yapısını oluşturan iki mekanizma aşağıdakilerden hangisinde doğru verilmiştir?**
    - A-) Vizör-LCD ekran
    - **Cevap B-) Objektif-gövde**
    - C-) Batarya-Flaş
    - D-) Hafıza kartı-flaş
    - E-) Diyafram-zoom halkası
    <hr/>
1. **Aşağıdakilerden hangisi objektif üzerinde bulunan mekanizmalar arasında yer almaz?**
    - A-) Netleme halkası
    - B-) Vibrasyon değeri
    ...
    - E-) Zoom halkası
    <hr/>
1. **Fotoğraf makinesinde diyafram değerini gösteren ifade aşağıdakilerden hangisidir?**
    - **Cevap A-) f numarası**
    - B-) z numarası
    - C-) m numarası
    - D-) d numarası
    - E-) k numarası
    <hr/>
1. **Fotoğrafta konuların ayrıntılarının miktarını belirleyen netlik, fotoğraf makinesinde aşağıdaki hangi halka üzerinden yapılır?**
    - A-) Zoom halkası
    ...
    - E-) Mod halkası
    <hr/>
1. **Fotoğraf makinesinin tüm sistem ve işlevlerini gösteren ekran olan ve aynı zamanda vizör yerine kullanılabilen parçası aşağıdakilerden hangisidir?**
    - A-) Flaş
    - B-) Info
    - **Cevap C-) LCD ekran**
    - D-) Ön izleme düğmesi
    - E-) Diyoptri düğmesi
    <hr/>
1. **Aşağıdakilerden hangisi fotoğraf makinesinin gövde bölümünde yer almaz?**
    - A-) Lens çıkarma düğmesi
    - B-) İnfo düğmesi
    - **Cevap C-) Vibrasyon düğmesi**
    - D-) Diyoptri tuşu
    - E-) Kulaklık çıkışı
    <hr/>
1. **Aşağıdakilerden hangisi f****otoğraf makinesinin temel mekanizmalarından biri olan deklanşörün tanımıdır?**
    - A-) Netlik sağlayan düğmedir.
    - B-) Diyafram ayarlarını yapan düğmedir.
    - **Cevap C-) Fotoğraf çekilirken basılan düğmedir.**
    - D-) Işığın yetersiz olduğu durumlarda kullanılan düğmedir.
    - E-) Ön izleme yapabilmek için basılan düğmedir.
    <hr/>
1. **Fotoğraf makinelerine takılan hafıza kartı çeşitleri arasında aşağıdakilerden hangisi bulunmaz?**
    ...
    <hr/>
1. **Fotoğraf makinesinden depolama alanına veri aktarımı yapan çıkışlardan biri aşağıdakilerden hangisidir?**
    - **Cevap A-) USB çıkışı**
    - B-) Aux çıkışı
    - C-) VGA çıkışı
    - D-) Kompozit çıkışı
    - E-) A/V çıkışı
    <hr/>
1. **Göz ile vizörün buluştuğu noktada netliğin ayarlanmasını sağlayan, fotoğrafın net olması için kullanılan düğme aşağıdakilerden hangisidir?**
    - A-) Info
    - **Cevap B-) Diyoptri**
    - C-) Vibrasyon
    - D-) Menü
    - E-) Lens çıkarma
    <hr/>
1. **Zoom halkası ile ilgili olarak aşağıdaki ifadelerden hangisi yanlıştır?**
    - A-) Lenste odak mesafesinin değiştirilmesini sağlar.
    - B-) Makinenin konumunu değiştirmeden çekilmek istenen nesnenin özel detaylarını yakınlaştırmada kullanılır.
    - C-) Makinenin konumunu değiştirmeden çekilmek istenen nesnenin özel detaylarını uzaklaştırmada kullanılır.
    - D-) Makinenin konumunu değiştirmeden çekilmek istenen kişinin genel ya da özel detaylarını yakınlaştırıp uzaklaştırmada kullanılır.
    - **Cevap E-) Makineye giren ışığın dengesini sağlar.**
    <hr/>
1. **Fotoğraf çekerken ışık seviyesinin az olduğu durumlarda kullanılan yapay ışık kaynağı aşağıdakilerden hangisidir?**
    - **Cevap A-) Flaş**
    - B-) Batarya
    - C-) Vibrasyon
    - D-) Diyafram
    - E-) Zoom halkası
    <hr/>
1. **Mod kadranında bütün ayarların fotoğrafçı tarafından yapıldığı çekim modu aşağıdakilerden hangisidir?**
    - A-) AUTO modu
    - B-) P modu
    - C-) A/AV modu
    - **Cevap D-) M modu**
    - E-) S/TV modu
    <hr/>
1. **Aşağıdakilerden hangisi fotoğraf makinesi bataryasını daha verimli kullanmak için alınması gereken önlemlerden biri değildir?**
    - **Cevap A-) Çekilen fotoğraflar ve videolar tekrar tekrar izlenebilir.**
    - B-) Yedek pil ya da batarya taşımak önemlidir.
    - C-) LCD ekran parlaklığını kısmak, gücü arttıracaktır.
    - D-) Makineyi gereğinden fazla şarj etmekten kaçınmak gerekir.
    - E-) Gereksiz yere flaş kullanmaktan sakınmak gerekir.
    <hr/>
1. **Çekim esnasında ekranda histogram, çekim ızgarası gibi bilgileri görüntülemek için kullanılan düğme aşağıdakilerden hangisidir?**
    - A-) Silme tuşu
    - **Cevap B-) Info düğmesi**
    - C-) Diyoptri tuşu
    - D-) Ön izleme düğmesi
    - E-) Lens çıkarma düğmesi
    <hr/>
1. **Yeni nesil fotoğraf makinelerinde video çekerken daha kaliteli ses almak için kullanılan giriş aşağıdakilerden hangisidir?**
    - A-) HDMI
    - B-) USB
    - **Cevap C-) Haricî mikrofon**
    - D-) Haricî flaş yuvası
    - E-) Hafıza kartı
    <hr/>
1. **Çekim esnasında oluşabilecek küçük titreşimleri engellemek için aşağıdakilerden hangisi kullanılır?**
    - A-) Netlik kilitleme düğmesi
    - **Cevap B-) Vibrasyon düğmesi**
    - C-) Moda kadranı
    - D-) Info düğmesi
    - E-) Diyoptri düğmesi
    <hr/>
1. **Fotoğraf makinesinin gövdesinde bulunan ve makineyi kullanan kişinin objektifin kapsadığı alanı görmesini sağlayan optik görme aracı aşağıdakilerden hangisidir?**
    - A-) Bilgisayar ekranı
    - **Cevap B-) Vizör**
    - C-) Diyafram
    - D-) Lens
    - E-) Netleme halkası
    <hr/>
1. **Aşağıdakilerden hangisi gövdede bulunan ana mekanizmalardan biri değildir?**
    - A-) Deklanşör
    - B-) Mod katranı
    - C-) Batarya
    - D-) Flaş
    ...
    <hr/>
1. **Makinenin konumunu değiştirmeden çekimi yapılan konuya yakınlaşıp uzaklaşmamıza imkân veren ve lenste bulanan halka aşağıdakilerden hangisidir?**
    - A-) Focus halkası
    ...
    - E-) Vibrasyon halkası
    <hr/>
1. **Aşağıdakilerden hangisi fotoğraf makinelerindeki bataryayı verimli kullanmak için alınması gereken önlemlerden biri değildir?**
    - A-) Ekran koruma modu aktif hâle getirilmelidir.
    - B-) Gereksiz yere flaş kullanmaktan kaçınılmalıdır.
    - **Cevap C-) Çekilen videolar tekrar tekrar izlenmelidir.**
...
1. I. Netlik kilitleme düğmesi<br />II. Hafıza kartı<br />III. Objektif (lens) değerleri<br />IV. Vibrasyon düğmesi<br />**Yukarıdakilerden hangileri objektif üzerinde bulunan mekanizmalar arasında yer alır?**
    ...
    - E-) I, II, III ve IV
    <hr/>
1. **Makinede başlangıç ekranının görüntülenmesini sağlayan güç tuşu aşağıdakilerden hangisidir?**
    - **Cevap A-) Açma-kapama düğmesi**
    - B-) Lens çıkarma düğmesi
    - C-) Menü tuşu
    - D-) Ön izleme düğmesi
    - E-) Batarya
    <hr/>
1. **50 mm’lik objektifler normal bu değerinin altı ve üstünün ifade şekli aşağıdakilerden hangisidir?**
    - **Cevap A-) Altı geniş, üstü dar açı olarak ifade edilir.**
    - B-) Altı dar, üstü geniş açı olarak ifade edilir.
    - C-) Altı kısa, üstü uzun açı olarak ifade edilir.
    - D-) Altı uzun, üstü kısa açı olarak ifade edilir.
    - E-) Altı geniş, üstü dik açı olarak ifade edilir.
    <hr/>
## Unite 6
1. **Diyafram enstantane eşdeğerlik çizelgesinde f 2.8'in karşılığı olan enstantane değeri aşağıdakilerden hangisidir?**
    - A-) 1/1000
    - **Cevap B-) 1/500**
    - C-) 1/250
    - D-) 1/125
...
1. I. Fotoğraf makinelerinin bütününde kullanılan diyafram tipidir.<br />II. Metal levhalar objektif etrafında yer alan bir levhaya yerleştirilmiştir.<br />III. Objektif dışındaki kontrol halkasının hareket ettirilmesiyle, ince metal plakaların açılıp kapanmasıyla istenilen diyafram açıklığı elde edilir.<br />**Belirtilen özelliklerin ait olduğu diyafram türü aşağıdakilerden hangisidir?**
    ...
    - E-) Manuel diyafram
    <hr/>
1. **Fotoğraf makinesinde diyaframın yeri ile ilgili olarak aşağıdakilerden hangisi yanlıştır?**
    - A-) Tek objektifli (SLR) olan fotoğraf makinelerinde, diyafram için uygun olan yer merceğin önüdür.
    - B-) Objektiflerde, mercekler birçok elemana sahip ise diyafram kesinlikle mercek elemanları arasında bulunur.
    - C-) Objektif simetrik bir yapıda ise diyafram simetrik mercek gruplarının ortasında, tam arasındadır.
    - D-) Eğer objektifin yapısı simetrik değil de bir mercek düzeni şeklinde ise diyafram iki mercek arasına konur.
    - **Cevap E-) Diyaframın yeri sabittir, değiştirilemez.**
    <hr/>
1. Fotoğraf makinesinden giren ışık miktarını bir diyafram aracılığı ile kontrol etmek beraberinde ......................... de/da etkilemektedir.<br />**Cümlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?**
    ...
    - E-) netlik açısını
    <hr/>
1. **Fotoğrafta iyi ya da doğru pozlamanın doğrudan ilişkili olduğu öge aşağıdakilerden hangisidir?**
    - A-) Fotoğrafın çekim kalitesi
    - B-) Işığın geliş yönü
    - C-) Fotoğrafın kalitesi
    - **Cevap D-) Fotoğrafın aydınlık düzeyi**
    - E-) Fotoğrafın uygun şartlarda depolanabilmesi
    <hr/>
1. **Aşağıdakilerden hangisi bir fotoğrafın aydınlık ve karanlık oluşu anlamına gelmektedir?**
    - A-) Diyafram
    - B-) Odak uzaklığı
    - C-) Enstantane
    - **Cevap D-) Pozlama**
    - E-) ISO
    <hr/>
1. **Diyafram tarafından ışığın objektiften geçmesine izin veren delik ya da açıklığa ne ad verilmektedir?**
    - A-) ISO
    - B-) Diyafram boyutu
    - C-) Enstantane
    - D-) İris diyafram
    - **Cevap E-) Diyafram açıklığı**
    <hr/>
1. **Filmin ışığa duyarlılık hassasiyetini belirleyen unsur aşağıdakilerden hangisidir?**
    - A-) F/stop
    - B-) Alan derinliği
    - C-) Basit diyafram
    - **Cevap D-) ISO**
    - E-) Enstantane
    <hr/>
1. **Görüntüsü alınan objeden yansıyan ışınların aynanın üzerine düşeceği yoğunluğu belirleyen sisteme ne ad verilmektedir?**
    - A-) ISO
    - B-) F/durak
    - **Cevap C-) Diyafram**
    - D-) Enstantane
    - E-) Işık yoğunluğu
    <hr/>
1. **Aşağıdakilerden hangisi diyafram, deklanşör hızı ve ISO arasındaki dengeleme eylemi olarak adlandırılır?**
    - A-) Enstantane
    - **Cevap B-) Demir üçgen**
    - C-) F/durak
    - D-) Basit diyafram
    - E-) Açık diyafram
    <hr/>
1. **Bir fotoğrafta net odakta görünen en yakın ve en uzak nesneler arasındaki mesafe miktarı aşağıdakilerden hangisidir?**
    - A-) Diyafram boyutu
    - B-) Diyafram açıklığı
    ...
    - E-) Pozlama
    <hr/>
1. **Diyafram açıklıklarının aydınlanma koşullarına göre otomatik olarak sağlanması için yapılmış diyafram sistemi aşağıdakilerden hangisidir?**
    - A-) Basit diyafram
    - B-) İris diyafram
    - C-) Odak diyafram
    ...
    - E-) Diyafram açıklığı
    <hr/>
1. **Bir merceğin bir görüntüyü veya sahneyi ne kadar büyüttüğünü tanımlayan kavram aşağıdakilerden hangisidir?**
...
1. **Bir fotoğrafta net olarak görülen alanı ifade eden kavram aşağıdakilerden hangisidir?**
    ...
    - E-) Diyafram açıklığı
    <hr/>
1. **Fotoğraf çekerken görüntünün ne kadarına odaklanıldığını ve odaklanıp odaklanılmadığını kontrol eden unsur aşağıdakilerden hangisidir?**
    - A-) Diyafram açıklığı
    - B-) Diyafram değeri
    ...
    - E-) Diyafram türleri
    <hr/>
1. **Aşağıdakilerden hangisi alan derinliğinin özellikleri arasında yer almaz?**
    - A-) Derinlik arttıkça öndeki ve arkadaki obje arasında netlik farkı oluşur.
    - **Cevap B-) Netlik azaldıkça keskin bir görüntü elde edilmektedir.**
    - C-) Netlik azaldıkça flu bir görüntü elde edilmektedir.
    - D-) Diyafram ayarı kısıldıkça alan derinliği artmaktadır.
    - E-) F-stop numarası ne kadar küçük olursa, alan derinliği de o kadar sığ olur.
    <hr/>
1. **Sensör üzerine düşen ışık miktarının az olmasından dolayı fotoğrafta karanlık bölgelerin oluşacağını ifade eden terim aşağıdakilerden hangisidir?**
    - A-) Pozlama
    - B-) Diyafram
    ...
    - E-) ISO
    <hr/>
1. **Aşağıdakilerden hangisi diyaframın özellikleri arasında yer almaz?**
    - A-) Görüntüdeki ışık farklılığını eşitler.
    - **Cevap B-) Örtücünün açılıp kapanma hızını belirler.**
    - C-) Işığın yoğunluğunu kontrol eder.
    - D-) Diyaframdaki değişiklikler, fotoğraflarınızın nasıl göründüğünü de değiştirir.
    - E-) Alan derinliğini ayarlamak için kullanılır.
    <hr/>
1. **Diyafram ve enstantanenin yetersiz kaldığı durumlarda ışığın şiddetini arttırmak ya da azaltmak için kullanılan ayar aşağıdakilerden hangisidir?**
    - A-) Enstantane
    - B-) Alan derinliği
    - **Cevap C-) ISO**
    - D-) Odak noktası
    - E-) Diyafram boyutu
    <hr/>
1. **ISO’nun özellikleri arasında aşağıdakilerden hangisi yer almaz?**
    - A-) ISO, filmin ışığa duyarlılık hassasiyetini belirleyen unsurdur.
    - B-) ISO’nun fotoğraf üzerindeki etkisi doğrudan görüntü kalitesi üzerinedir.
    - C-) Yüksek ISO değerlerini kullandıkça genel görüntü kalitesi düşer.
    - **Cevap D-) Yüksek ISO değerlerini kullandıkça genel görüntü kalitesi artar.**
    - E-) ISO değeri yükseldikçe enstantane değeri artar.
    <hr/>
1. **Diyafram açıklarının aydınlanma koşullarına göre otomatik olarak sağlanması için yapılmış diyafram sistemi aşağıdakilerden hangisidir?**
    - A-) Basit diyafram
    ...
    - E-) İris diyafram
    <hr/>
1. **Aşağıdakilerden hangisi diyafram kullanımının temel amaçları arasında yer alır?**
    - **Cevap A-) Işığın yoğunluğu ve net alan derinliğini belirler.**
    - B-) Pozlama süresini belirler.
    - C-) Filmin ışık hassasiyetini belirler.
    - D-) Bir merceğin görüntüsünün küçüklüğünü ayarlar.
    - E-) Fotoğraftaki renk doygunluğunu belirler.
    <hr/>
1. **Günümüzdeki fotoğraf makinelerinde kullanılan ve çalışma prensibi olarak metal levhaların objektif etrafında yer alan levhaya konumlandırıldığı diyafram sistemi aşağıdakilerden hangisidir?**
    - A-) Basit diyafram
    - B-) Otomatik diyafram
    - C-) Açık diyafram
    - **Cevap D-) İris diyafram**
    - E-) Kısık diyafram
    <hr/>
1. **Sensörün algılayacağı ışığı belirlemeye yarayan ve bir fotoğrafın aydınlık ve karanlık oluşu anlamına gelen kavram aşağıdakilerden hangisidir?**
    - A-) ISO
    - B-) Diyafram
    - **Cevap C-) Pozlama**
    - D-) Işık yoğunluğu
...
1. I. Diyafram değeri (ışığın giriş aralığının genişliği)<br />II. ISO değeri (sensörün ışığa duyarlılık düzeyi)<br />III. Enstantane değeri (ışığın giriş süresi)<br />**Yukarıdakilerden hangisi ya da hangileri fotoğraf makinelerinde temel pozlama ayarları arasında yer alır?**
    ...
    - **Cevap E-) I, II ve III**
    <hr/>
1. Diyafram açıldığında yani rakamsal olarak küçüldüğünde ........... azalır. Sadece netlenen obje görünür.<br />**Cümlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?**
    - A-) alan ışığı
    - B-) alan karanlığı
    - C-) alan beyazlığı
    - **Cevap D-) alan derinliği**
    - E-) alan rengi
    <hr/>
1. Diyafram iki temel amaçla kullanılır.<br />**Aşağıdakilerden hangisinde bu iki temel amaç doğru şekilde verilmiştir?**
    - **Cevap A-) Işığın yoğunluğu/Net alan derinliği**
    - B-) Işığın zayıflığı/Net alan derinliği
    - C-) Işığın yansıması/Silüet alan derinliği
    - D-) Işığın kararması/Yarı alan derinliği
    - E-) Işığın kontrolü/Yarı alan derinliği
    <hr/>
1. Bir nesnenin görüntüsünün istenilen biçimde çekilmesi için cisimlerin üzerine düşen ya da etrafındaki ışık miktarını ayarlamak için enstantane ayarına uygun bir ............ ayarı yapılmalıdır.<br />**Cümlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?**
    - A-) flaş
    - B-) vibrasyon düğmesi
    - **Cevap C-) diyafram**
    - D-) mod kadranı
    - E-) USB girişi
    <hr/>
1. **Aşağıdakilerden hangisi bütün dijital fotoğraf makinelerinde kullanılan bir özelliğe sahiptir?**
    - A-) Gelişmiş diyafram
    - B-) Otomatik kontrollü diyafram
    - C-) Uzun diyafram
    - **Cevap D-) İris diyafram**
    - E-) Kısa diyafram
    <hr/>
## Unite 7
1. **Fotoğraf makinesinin içerisinde, objektifin arkasında, ışığa duyarlı yüzeyin önünde yer alan yatay hareketli bez ya da dikey hareketli çelik perdelerden oluşan mekanizma aşağıdakilerden hangisidir?**
    - A-) Mercek
    - **Cevap B-) Perde obtüratör**
    - C-) Yaprak obtüratör
    - D-) Sensör
    - E-) Diyoptri kadranı
    <hr/>
1. **Enstantane hızının 1/60’tan daha düşük olması hâlinde aşağıdakilerden hangisi gerçekleşmez?**
    - **Cevap A-) Örtücü perdenin açık kalma süresi kısalır.**
    - B-) Olası el titremelerinden kaynaklı hareketler fotoğrafa yansır.
    - C-) Böylesi bir fotoğrafta herhangi bir net bölge olmayacaktır.
    - D-) Fotoğraf tamamen flu olacaktır.
    - E-) Böyle durumlarda özellikle elde düşük enstantane değerlerinde fotoğraf çekerken tripot (üç ayak) kullanmak gerekir.
    <hr/>
1. **Fotoğraf makinelerinde 30 saniyelik pozlama süresinden daha uzun bir pozlamaya ihtiyaç duyulan durumlarda yapılması gereken ayar aşağıdakilerden hangisidir?**
    - **Cevap A-) BULB modu (B)**
    - B-) Manuel mod (M)
    - C-) Otomatik pozlama modu (A/AV)
    - D-) Enstantane öncelikli mod (S)
    - E-) Diyafram öncelikli mod (A)
    <hr/>
1. **Filmlerde olduğu gibi, “Noise” olarak adlandırılan parazit etkisinin fotoğrafta belirmesine neden olan şey aşağıdakilerden hangisidir?**
    - A-) Hafıza kartının yetersizliği
    - B-) Şarjın ortamdaki ışık yoğunluğunu algılayacak dereceden düşük olması
    - C-) Diyafram değerinin gereken miktardan yüksek ayarlanması
    - **Cevap D-) ISO değeri artırılması ile sensörlerin az miktardaki ışığa daha fazla hassas hâle gelebilmek için fotoğraf makinesinin pilinden daha fazla elektrik enerjisi alması**
    - E-) 15'' enstantane değerinde obtüratörün 15 saniye boyunca açık kalması sonucunda 1/ ifadesiyle belirtilen rakamlar büyüdükçe enstantane değerlerinin giderek hızlanması
    <hr/>
1. .........., filme veya sensöre düşecek ışık miktarını; ................, belirlenen aralıktan giren ışığın ne kadar süre ile film ya da sensör üzerinde kalacağını; ............... ise filmin veya sensörün bu gelen ışığa karşı ne kadar hassasiyet göstereceğini belirler.<br />**Cümlede boş bırakılan yerlere sırasıyla aşağıdakilerden hangisi getirilmelidir?**
    ...
    <hr/>
1. **Dijital fotoğraf makinelerinde yüksek ISO’dan kaynaklanan görüntü bozulmasına ne ad verilir?**
    - A-) Piksel
    - B-) Ayna
    - **Cevap C-) Noise**
    - D-) Obtüratör
    - E-) Perde
    <hr/>
1. **Aşağıdakilerden hangisi eski doğu bloğu ülkelerinde ASA yerine kullanılan kavramdır?**
    - A-) ISO
    - B-) Grain
    - C-) Stop
    - **Cevap D-) DIN**
    - E-) Gümüş nitrat
    <hr/>
1. **En fazla pozlama aşağıdakilerden hangisinde gerçekleşir?**
    - A-) 1/8
    - B-) 1/15
    - C-) 1/60
    - **Cevap D-) 1/500**
    - E-) 1/250
    <hr/>
1. **Yüksek ISO’dan kaynaklanan görüntü hatasını ifade eden kavram aşağıdakilerden hangisidir?**
    - A-) Af
    - B-) Asa
    - **Cevap C-) Noıse**
    - D-) Shutter
    - E-) Graın
    <hr/>
1. **Işığın, ışığa duyarlı yüzey üzerinde bıraktığı etkiyi ifade eden kavram aşağıdakilerden hangisidir?**
    - A-) Film
    - **Cevap B-) Fotoğraf**
    - C-) Noise
    - D-) Odak
    - E-) SLR
    <hr/>
1. **Konudan yansıyan ışığın, ışığa duyarlı yüzeye düşüş süresini ayarlayan mekanizmaya ne ad verilir?**
    - A-) Pozlama
    - B-) Netleme
    - **Cevap C-) Enstantane**
    - D-) Diyafram
    - E-) ISO
    <hr/>
1. **Yaprak obtüratörlerin hız aralığını belirten değerler aşağıdakilerden hangisidir?**
    - **Cevap A-) 1/1 – 1/500**
    - B-) 1/250 – 1/4000
    - C-) 1/30 – 1/60
    - D-) 1/125 – 1/8000
    - E-) 1/15 – 1/2000
    <hr/>
1. **Obtüratör hızının fotoğrafı çekilecek nesnenin hızından yavaş olduğu durumlarda fotoğrafta ortaya çıkan etki aşağıdakilerden hangisidir?**
    - A-) Nesnenin hareketi sabit hâlde fotoğraflanır.
    - B-) Noise etkisi oluşur.
    - C-) Grain etkisi oluşur.
    - D-) Netlik problemi oluşur.
    - **Cevap E-) Hareket flu olarak fotoğraflanır.**
    <hr/>
1. **Aşağıdaki enstantane değerlerinden hangisi tam stop değeri olarak da ifade edilen ana stop değeridir?**
    - A-) 1/100
    - B-) 1/160
    - C-) 1/13
    - **Cevap D-) 1/125**
    - E-) 1/80
    <hr/>
1. **ISO değeri aşağıdakilerden hangisine doğrudan etki eder?**
    - **Cevap A-) Enstantane**
    - B-) Diyafram
    - C-) Sensör
    - D-) Film
    - E-) Body
    <hr/>
1. **Aşağıdakilerden hangisi çalışma prensipleri olarak kullanılan obtüratör çeşitleri arasında yer alır?**
    - A-) Üçgen
    - B-) Kare
    - C-) Daire
    - D-) Desen
    - **Cevap E-) Yaprak**
    <hr/>
1. **Fotoğrafın doğru pozlanabilmesi için objektiften geçen ışığın makinenin içine düşme süresini kontrol etmeye yarayan mekanizma aşağıdakilerden hangisidir?**
    - A-) Sensör
    - **Cevap B-) Obtüratör**
    - C-) Hafıza kartı
    - D-) Diyafram
    - E-) Vizör
    <hr/>
1. ISO değeri kaç stop ....................., enstantane süresi de o kadar stop değerinde ..................<br />**Cümlede boş bırakılan yerlere sırasıyla aşağıdakilerden hangisi getirilmelidir?**
    - A-) azalır - yükselir.
    - B-) yükselir - aynı kalır.
    - **Cevap C-) yükselir - yükselir.**
    - D-) yükselir - azalır.
...
1. I. İleri düzey profesyonel analog veya dijital fotoğraf makinelerinde kullanılır.<br />II. Objektifler değiştirilemediğinden objektif, makine gövdesine sabit hâldedir.<br />III. Daha çok compact olarak adlandırılır.<br />**Yukarıdakilerden hangisi ya da hangileri perde obtüratörlerin özellikleri arasında yer alır?**
    ...
    - E-) I, II ve III
    <hr/>
1. **Obtüratörün açılıp kapanma hızına ne ad verilir?**
    - A-) Odak uzaklığı
    - **Cevap B-) Enstantane**
    - C-) Alan derinliği
    - D-) Odak noktası
    - E-) Pozlama
    <hr/>
1. ........ değeri ne kadar azsa, çekilen fotoğraflar da o kadar keskin ve detaylı olur. Başka bir ifadeyle mecbur kalmadıkça fotoğraf çekimlerinde ............. kullanımından kaçınılmalıdır.<br />**Cümlede boş bırakılan yerlere sırasıyla aşağıdakilerden hangisi getirilmelidir?**
    - A-) ISO-Diyafram
    - B-) İris-Bulp
    - C-) Enstantane-ISO
    - D-) Obtüratör-Perde
    - **Cevap E-) ISO -Yüksek ISO**
    <hr/>
1. ISO konusunu anlayabilmek için filmin yapısını ve fotoğrafın oluşumuna neden olan ................................. bilmek gerekir.<br />**Cümlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?**
