# Türk Dili I (Dönem 3) - Tüm Sorular

## Unite 1
1. **Aşağıdaki tanımlardan hangisi dilin doğuşu ile ilgilidir?**
    - A-) Dil, sıkı sıkıya millî varlığa ve topluma bağlıdır.
...
1. **Aşağıdakilerden hangisi konuşma dilinin özelliklerinden biri değildir?**
    ...
    - **Cevap B-) Konuşma dili, lehçelerden veya ağızlardan birine göre şekillenir.**
    ...
    ***
1. **Dillerin doğuşu aşağıdaki bilim dallarından hangisinin merak konusu olamaz?**
    - A-) Dilbilim
    - B-) Genetik bilim
    - C-) Ruh bilim
    - D-) İnsan bilim
    - **Cevap E-) Tıp bilim**
    ***
1. **"İlk insanlar, çevrelerindeki sesleri taklit etme yoluyla ilk ve ilkel dilleri ortaya çıkarmışlardır." düşüncesini destekleyen dil görüşü aşağıdakilerden hangisidir?**
...
1. **Aşağıdakilerden hangisi konuşma dilinin özelliklerinden biri değildir?**
    ...
    ***
1. **Deneyimci Görüş Teorisi aşağıdakilerden hangisini savunmaktadır?**
...
1. **Aşağıdakilerden hangisi dilin özelliklerinden biri değildir?**
    ...
    ***
1. **Babil Kulesi Efsanesi aşağıdakilerden hangisinde doğru ifade edilmiştir?**
...
1. **Dilin doğuşu teorilerinin amacı aşağıdakilerden hangisinde doğru verilmiştir?**
    ...
    ***
1. **Aşağıdakilerden hangisi konuşma ve yazı dili arasındaki farklardan biri değildir?**
    ...
    ***
1. **Aşağıdakilerden hangisi ses dilinin çeşitli anlamlarından biri değildir?**
    - A-) Eski bir tarihi ve geçmişi olan insan topluluğunun anlaşma vasıtası
    - B-) Belli bir çağın kelime dağarcığı ve söz dizimi
    ...
    ***
1. **Aşağıdakilerden hangisi dilin türeyişi ile ilgili olarak ortaya atılan görüşlerden biri değildir?**
    ...
    ***
1. **İlahiyatçı Dil Türeyiş Teorisi hakkında aşağıda verilenlerden hangisi doğrudur?**
    ...
    ***
1. **Kültür dili aşağıdakilerden hangisinde doğru tanımlanmıştır?**
    - A-) Bir toplumun yerel olarak kullandığı dildir.
    - B-) Toplumun sanat anlayışının jargon dilidir.
    ...
    ***
1. **Türkiye Türklerinin yazı dili aşağıdakilerden hangisidir?**
    - A-) Erzurum ağzı
    - B-) Rize ağzı
    - C-) Kütahya ağzı
    - D-) Manisa ağzı
    ...
    ***
1. **Aşağıdakilerden hangisinde “dil” kavramı diğerlerinden farklı anlamda kullanılmıştır?**
    ...
    ***
1. **Dil ile ilgili ilk sistematik düşüncelere aşağıdakilerden hangisinde rastlanır?**
    - **Cevap A-) Herakletios**
    - B-) Hintli Yaska
    - C-) Demokritos
    - D-) Sokrat
    - E-) Aristo
    ***
1. **Aşağıdakilerin hangisinde dilin temel işlevlerinden biri belirtilmemiştir?**
    ...
    ***
1. Yeryüzündeki bütün diller doğadaki seslerin taklit edilmesiyle ortaya çıkmıştır.<br />**Görüşünü savunan dil doğuş teorisi aşağıdakilerden hangisidir?**
    - A-) Ünlem Teorisi
    - B-) İş Teorisi
    ...
    - E-) Psikolojik Teori
    ***
1. Yunan filozof Herakleitos'a (M.Ö. V. yy.) göre dili anlamak evreni anlamak demektir.<br />**Cümlede altı çizili sözle anlatılmak istenen aşağıdakilerden hangisinde doğru olarak verilmiştir?**
    ...
    ***
1. **Aşağıdakilerden hangisi dilin nasıl türediğine yönelik ortaya atılan görüşlerden biri değildir?**
    ...
    - E-) Antropolojik görüş
    ***
1. **Teolojik Görüş aşağıdakilerden hangisini savunmaktadır?**
...
1. **Aşağıdakilerden hangisi yazı dilinin özelliklerinden biri değildir?**
    - A-) Yapma bir dildir.
    - B-) Kullanım alanı ve etkisi konuşma diline göre daha geniştir.
    ...
    ***
1. **Aşağıdakilerden hangisi konuşma dili ile yazı dili arasındaki farklardan biri değildir?**
    ...
    ***
1. I. Deneyimci<br />II. Doğuştancı<br />III. İlahiyatçı<br />IV. Antropolojik<br />**Yukarıdakilerden hangileri dillerin doğuşu ile ilgili teorilerdendir?**
    - A-) I ve II
    - B-) I ve III
    - C-) II ve III
    - D-) I,II ve III
    ...
    ***
## Unite 2
1. I. Toplumların tarihsel belleğidir.<br />II. Sosyal ve kültürel değerlerin taşıyıcısıdır.<br />III. Birlik ve beraberliğin en temel simgesidir.<br />**Dil ile ilgili olarak yukarıdakilerden hangisi ya da hangileri doğrudur?**
    - A-) Yalnız III
    - B-) I ve II
    - C-) I ve III
    - D-) II ve III
    - **Cevap E-) I, II ve III**
    ***
1. ………………. daha çok dilin işitsel ve biçimsel boyutunu ifade ederken ………………. dilin zihinsel boyutundaki soyut kavram olarak ifade edilebilir.<br />**Cümlede boş bırakılan yerlere sırasıyla aşağıdakilerden hangisi getirilmelidir?**
    - A-) Yazı-konuşma
    - B-) Biçim-anlam
    - C-) Anlatım-anlam
    ...
    - E-) Şekil-düşünce
    ***
1. I.Betimleyici işlev<br />II.Toplumsal işlev<br />III. Çağrı işlevi<br />**Yukarıdakilerden hangisi ya da hangileri Lyons’a göre dilin işlevlerindendir?**
    - A-) Yalnız II
    - **Cevap B-) I ve II**
    - C-) I ve III
    - D-) II ve III
    - E-) I, II ve III
    ***
1. I. Bu yılki tohum ekiminde özellikle domatese ağırlık vereceğim.<br />II. İnşaat böyle yavaş ilerlerse kooperatife biz daha çok para öderiz.<br />III. Arkadaşlarının arkasından konuşan insanlardan hiç hoşlanmam.<br />**Yukarıdakilerden hangisi ya da hangileri dilin anlatım işlevine örnek olabilir?**
    - A-) Yalnız II
    - B-) Yalnız III
    - C-) I ve II
    - D-) II ve III
    - **Cevap E-) I, II ve III**
    ***
1. Dilin sadece sözcüklerden ve dil bilgisi yapılarından ibaret olarak görülmesi yanlıştır. Dil, toplumsal ve kültürel birikimin aklın ve mantığın temelinde estetik bir duyuşla işlendiği muazzam bir varlıktır.<br />**Paragrafta dilin hangi işlevinden bahsedilmektedir?**
    - A-) Anlatım
    - B-) Betimleme
    - **Cevap C-) Edebî**
    - D-) Toplumsal
    - E-) Çağrı
    ***
1. **Kültür ile ilgili olarak aşağıdakilerden hangisi yanlıştır?**
    ...
    ***
1. I. Mimari<br />II. Dünya görüşü<br />III. Gelenek<br />**Yukarıdakilerden hangisi ya da hangileri maddi kültüre örnektir?**
    - A-) I ve III
    - **Cevap B-) Yalnız I**
    - C-) II ve III
    - D-) I, II ve III
    - E-) Yalnız III
    ***
1. Edebiyatın ana malzemesi ……………. ; dolayısıyla dil gibi edebiyat da …………. hem unsuru hem de taşıyıcısıdır.<br />**Cümlede boş bırakılan yerlere sırasıyla aşağıdakilerden hangisi getirilmelidir?**
    ...
    ***
1. **Dil ile ilgili olarak aşağıdakilerden hangisi yanlıştır?**
    - **Cevap A-) Teknolojik gelişmelerle birlikte dilin sınırlandırıcı etkisi giderek azalmaktadır.**
    - B-) Çağımızda yaşanan önemli değişimler dilin önemini daha da artırmıştır.
...
1. Bazı araştırmacılar insanı diğer varlıklardan ayıran en önemli özelliğin zekâ ve düşünme yeteneği olduğunu, zekâ ve düşünme yeteneğinin insanın benliğinin oluşmasını sağlayan ögeler ve bu ögelerin oluşturduğu duygu ve düşüncelerin dışarı aktarımında en büyük yardımcının …………………….. olduğunu belirtmektedirler.<br />**Cümlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?**
    ...
    - E-) din
    ***
1. …………………..göre dil bir göstergeler dizgesidir ve belirli kuralları olan bir sistemdir.<br />**Cümlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?**
    - A-) Wittgenstein’a
    - B-) Chomsky’ye
    - **Cevap C-) Saussure’e**
    - D-) Bach’a
    - E-) Austin’e
    ***
1. **Aşağıdakilerden hangisi ses organlarından biri değildir?**
    - A-) Ağız
    - **Cevap B-) Göz**
    - C-) Diş
    - D-) Damak
    - E-) Gırtlak
    ***
1. **Aşağıdakilerden hangisi Jakobson’a göre dilin işlevlerinden biri değildir?**
    - A-) Anlatım
    - B-) Çağrı
    - C-) İlişki
    - D-) Betimleme
    - **Cevap E-) Belgesel**
    ***
1. I. Dil, toplumun kültürel anlayışını yansıtan en önemli araçtır.<br />II. Kültürel derinlik ancak dilin zenginliğiyle ölçülebilir.<br />III. Kültürel değerlerin izlerini dil üzerinde sürmek mümkündür.<br />**Dil ve kültür ile ilgili olarak yukarıdakilerden hangisi ya da hangileri doğrudur?**
    - **Cevap A-) I ve III**
    - B-) Yalnız III
    - C-) I ve II
    - D-) II ve III
    - E-) I, II ve III
    ***
1. Mevlana, "Sen ne söylersen söyle, söylediğin karşındakinin anladığı kadardır." der. Bu veciz söz, dilin ............ işleviyle ilgilidir.<br />**Cümlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?**
    - A-) tarihsel
    - **Cevap B-) çağrı**
    - C-) toplumsal
    - D-) anlatım
    - E-) edebî
    ***
1. Scollon'a (1995) göre ortak bir kültürü paylaşan insanlar, ...........................................................<br />**Cümlede boş bırakılan yere aşağıdakilerden hangisi getirilemez?**
    - A-) birbirlerini daha kolay anlarlar.
    - B-) kendi aralarında üretken ilişkiler kurarlar.
    ...
    ***
1. .............................. göndericinin düşünceleri, hisleri, ilkeleri, öncelikleri, ön yargıları hakkında anlatıcıya bilgi verir.<br />**Cümlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?**
    - A-) Betimleme işlevi
    - B-) Çağrı işlevi
    - C-) Toplumsal işlev
    - D-) Edebî işlev
    ...
    ***
1. Kılıç-kalkan sesinden, nal şıkırtısından / Dilimde ince kalın "k" sesinin bolluğu / Bellidir ecdadımın at üstünde yaşayıp/ Yeri göğü kılıçla imzaladığı (Arif Nihat Asya)<br />**Bu dörtlükte Türkçenin hangi özelliği vurgulanmaktadır?**
    - **Cevap A-) Türk yaşam biçiminin Türkçeye etkisi**
    - B-) Türkçenin Türk yaşama biçimine etkisi
    - C-) Türkçede ''k'' sesinin çok kullanılması
    - D-) Kılıç ve kalkanın Türkçe olması
    - E-) Türklerin ata mesleğinin demircilik olması
    ***
1. **Aşağıdakilerden hangisi dilin işlevlerinden biri değildir?**
    - A-) Çağrı işlevi
    - B-) Toplumsal işlev
    - C-) Edebî işlev
    - D-) Betimleme işlevi
    ...
    ***
1. Bireyler arasında anlaşamayı sağlayan, kültür ve medeniyetin yapıcısı ve bu unsurları geçmişten günümüze ve günümüzden de geleceğe aktaran, temeli bilinmeyen zamanlarda atılan ve seslerden örülmüş doğal bir vasıtadır.<br />**Tanımı verilen kavram aşağıdakilerden hangisidir?**
    - A-) Din
    - B-) Kültür
    - C-) Törel değerler
    - **Cevap D-) Dil**
    - E-) Tarihsel miras
    ***
1. **Aşağıdakilerden hangisi kültürün özgün bir grup yaratma işlevine uygun olamaz?**
    - A-) İnsanların birbirlerini kolay anlamaları
    - B-) İnsanların birbirleriyle üretken ilişkiler kurmalarını
    ...
    ***
1. **"Dil, bir göstergeler dizgesi ve belirli kuralları olan bir sistemdir." ifadesi aşağıdakilerden hangisine aittir?**
    - **Cevap A-) Saussure**
    - B-) Wittgenstein
    - C-) Martinet
    - D-) Bloomfield
    ...
    ***
## Unite 3
1. **Aşağıdaki dil ailelerinden hangisi yapı bakımından eklemeli dilleri içine alır?**
    - A-) Çin-Tibet Dilleri
    ...
    ***
1. **Türk dili tarihinde en erken dönem, aşağıdaki adlandırmalardan hangisiyle yapılır?**
    - A-) İlk Türkçe Dönemi
    - B-) Ana Türkçe Dönemi (Proto-Türkçe)
    - **Cevap C-) Altay Dil Birliği Dönemi**
    - D-) Eski Türkçe Dönemi
    - E-) Orta Türkçe Dönemi
    ***
1. **Eski Türkçe Dönemi’nin dil, kültür ve edebiyat özelliklerini başarılı bir şekilde yansıtan ve Türk yazı dilinin başlangıcı olarak kabul edilen eser aşağıdakilerden hangisidir?**
    - A-) Şaman Yazıtları
    - B-) Budizm Yazıtları
    - C-) Türkmen Yazıtları
    - D-) Uygur Yazıtları
    ...
    ***
1. **Aşağıdakilerin hangisinde Türkçenin dünya dilleri arasındaki yeri doğru olarak verilmiştir?**
    ...
    ***
1. **Aşağıdakilerden hangisi Türkçenin genel özellikleri arasında yer a****lma****z?**
    - **Cevap A-) Türkçe sözcüklerde erillik, dişillik (yani cinsiyet ayrımı) özelliği vardır.**
    - B-) Türkçede sayı sıfatlarından sonra istisnalar hariç gelen adlar çoğul eki almaz.
...
1. **Türkçe aşağıdaki dil gruplarından hangisine dâhil edilmektedir?**
    ...
    ***
1. **Aşağıdaki dillerden hangisi Ural-Altay dillerinden biri değildir?**
    - A-) Fince
    - B-) Moğolca
    - C-) Mançuca
    - **Cevap D-) Arapça**
...
1. **Aşağıdakilerden hangisi Altay dilleri ile Türkiye Türkçesinin ortak özelliklerinden biri değildir?**
    ...
    ***
1. **Aşağıdakilerden hangisi Türkçenin tarihsel gelişim dönemlerinden biri değildir?**
    ...
    ***
1. **Aşağıdakilerden hangisi Orta Türkçe Dönemi’nde oluşan yazı dillerinden biri değildir?**
...
1. **Eski Türkçe Dönemi ile ilgili aşağıdakilerden hangisi yanlıştır?**
    ...
    ***
1. **Aşağıdakilerden hangisi Gagauz Türkçesinin konuşulduğu yerlerden biri değildir?**
    - A-) Moldova
    - B-) Bulgaristan
    - C-) Romanya
    - **Cevap D-) Afganistan**
    - E-) Kazakistan
    ***
1. **Türkçe aşağıdaki dillerden hangisiyle en çok benzerlik gösteren dildir?**
    - **Cevap A-) Moğolca**
    - B-) Habeşçe
    - C-) Arapça
    - D-) Farsça
    - E-) Hintçe
    ***
1. **Aşağıdakilerden hangisi Altay dillerinin ortak özelliklerinden biri değildir?**
    - **Cevap A-) Ünlü uyumu yoktur.**
    - B-) Ünsüzlere göre ünlüler bakımından zengindir.
    - C-) Kelimeler çift ünsüzle başlamaz.
    - D-) Cinsiyet ayrımı gösteren ek bulunmaz.
    - E-) Anlatım dolayısıyla çekim, son eklerle sağlanır.
    ***
1. **Aşağıdakilerden hangisinde Türkiye’de Altayistik bilim kolunda çalışma yapan bilim adamlarından üçü birlikte verilmiştir?**
...
1. I. Türkçe sözcüklerde söz başında bulunabilen ünsüz sayısı sınırlıdır. B, ç, d, g, k, s, t, v, y, c ünsüzü, söz başında başka ünsüzlerden değişmiş olarak birkaç sözcükte bulunur: cibinlik &lt;çıpın vb.<br />II. n ünsüzü Türkçe kökenli sözcükler içinde yalnız ne ve türevlerinde bulunur: ne, neden, niçin, nasıl vb.<br />III. p ünsüzü de söz başında, birkaç Türkçe sözcükte b'den değişmiş olarak bulunur: piş-<br />**Türkçe ile ilgili olarak yukarıdakilerden hangisi ya da hangileri doğrudur?**
    ...
    - E-) I ve III
    ***
1. **Türk dilinin tarihsel dönemlerinden Orta Türkçe Dönemi hangi yüzyılları kapsar?**
    - A-) VI.-X. yüzyıllar
    - B-) XVII.-XVIII. yüzyıllar
    - C-) XIV.-XIX. yüzyıllar
    - D-) IX.-XI. yüzyıllar
    - **Cevap E-) XI.-XVI. yüzyıllar**
    ***
1. **Suci, Şine-Usu, Karabalgasun Yazıtları Türkçenin hangi dönemine aittir?**
    - A-) Altay Dil Birliği Dönemi
    ...
    ***
1. **Aşağıdaki dillerden hangisi çekimli dillerden biri değildir?**
    - A-) Rusça
    - B-) Latince
    - C-) İngilizce
    - D-) Arapça
    - **Cevap E-) Çince**
    ***
1. **Türkiye Türkçesi hangi lehçenin devamı niteliğindedir?**
    - A-) Kuzeybatı Türk lehçesi
    - **Cevap B-) Güneybatı Türk lehçesi**
    - C-) Güneydoğu Türk lehçesi
    - D-) Kuzeydoğu Türk lehçesi
    - E-) Azerbaycan Türk lehçesi
    ***
1. **Aşağıdaki dillerden hangisi Ural-Altay Dil Ailesi'nin Altay kolundadır?**
    - A-) Çince
    - B-) Fince
    - C-) Estonca
    - **Cevap D-) Türkçe**
    - E-) İngilizce
    ***
1. **Aşağıdaki eserlerden hangisi Karahanlı Türkçesi ile yazılmamıştır?**
    - A-) Kutadgu Bilig
    - B-) Divân-ı Hikmet
    - C-) Atabetü'l-Hakayık
    ...
    ***
1. Dünyanın en büyük dil ailesidir. Yüzlerce dil ve lehçe içerir. Dünyada 2,5 milyardan fazla insanın ana dilidir.<br />**Özellikleri verilen dil ailesi aşağıdakilerden hangisidir?**
    ...
    ***
1. Kitap her iki dünyada da mutluluğa kavuşmak için gidilmesi gereken yolu göstermek amacıyla kaleme alınmıştır. Yazara göre bir insanın erdemi ancak başka insanlar arasındayken belli olur. Çünkü sadece kendisine fayda düşünen biri ölülere benzer.<br />**İçeriği hakkında bilgi verilen kitap aşağıdakilerden hangisidir?**
    ...
    - E-) Çarhnâme
    ***
1. **Aşağıdakilerden hangisi eklemeli dillerden biri değildir?**
    - A-) Türkçe
    - **Cevap B-) Çince**
    - C-) Moğolca
    - D-) Mançuca
    - E-) Macarca
    ***
1. **Aşağıdakilerden hangisi modern Türkçe dönemlerinden biridir?**
    - **Cevap A-) Çuvaşça**
    - B-) Yakutça
    - C-) Selçuklu Dönemi
    - D-) Osmanlı Dönemi
    ...
    ***
## Unite 4
1. **Türkiye, Azerbaycan, Kırgız, Kazak ve Türkmen Türkçelerinin arasındaki fark aşağıdaki kavramlardan hangisiyle ifade edilir?**
    - A-) Ağız
    - B-) Lehçe
    - **Cevap C-) Şive**
    - D-) Diksiyon
    - E-) Dil ailesi
    ***
1. **Aşağıdakilerden hangisi Türklerin tarih boyunca kullandığı alfabelerden biri değildir?**
    - A-) Göktürk Alfabesi
    - **Cevap B-) Gürcü Alfabesi**
    - C-) Soğd Alfabesi
    - D-) Kiril Alfabesi
    - E-) Arap Alfabesi
    ***
1. Türklerin kullandığı bu alfabe 4’ü sesli, 26’sı sessiz, 8’i bitişken olmak üzere 38 harften oluşur. Sağdan sola ve yukarıdan aşağıya doğru yazılır. Harfler birbiriyle bitişmez, çivi yazısına benzerliğinden dolayı taş ve eşya üzerine kazınmaya elverişlidir.<br />**Paragrafta bazı özellikleri verilen alfabe aşağıdakilerden hangisidir?**
    - A-) Uygur Alfabesi
    - **Cevap B-) Göktürk Alfabesi**
    - C-) Latin Alfabesi
    - D-) Kiril Alfabesi
    - E-) Brahmi Alfabesi
    ***
1. **Aşağıdaki Türk Dillerinden hangisi "Batı Grubu / Oğuz Grubu" kolunda yer almaz?**
    ...
    - E-) Türkmen Türkçesi
    ***
1. **Türkiye Türkçesinde kullanılan Latin alfabesinin kabul ediliş tarihi aşağıdakilerden hangisinde doğru verilmiştir?**
    ...
    - E-) 16 Kasım 1928
    ***
1. **Türklerin İslam'a girmeye başladıkları IX. yüzyıldan itibaren kullandıkları alfabe aşağıdakilerden hangisidir?**
    - A-) Kiril Alfabesi
    ...
    - E-) Göktürk Alfabesi
    ***
1. **Aşağıdakilerden hangisi Türkçenin bilinmeyen bir zamanda ayrılan ve yeni bir dil olma yolu tutan lehçelerinden biridir?**
    ...
    ***
1. . ……………… bir dilin en yeni zamanda ayrılmış ve farklılıkların sadece seste görüldüğü koludur.<br />**Cümlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?**
    - **Cevap A-) Ağız**
    - B-) Argo
    - C-) Terim
    - D-) Lehçe
    - E-) Şive
    ***
1. I. Farklı coğrafyalarda yaşamış olmaları<br />II. Savaşlar<br />III. Göçler<br />**Yukarıdakilerden hangisi ya da hangileri Türklerin tarih boyunca birçok alfabe kullanmalarının temel nedenleri arasında yer alır?**
    - A-) Yalnız I
    - B-) Yalnız II
    - C-) I ve II
    - D-) I ve III
...
1. **Aşağıdakilerden hangisi Türklerin tarih boyunca kullandığı alfabelerden biri değildir?**
    ...
    - E-) Uygur Alfabesi
    ***
1. Dil bilimcilere göre dünya üzerinde günümüzde yaklaşık olarak …………’den fazla dil konuşulmaktadır.<br />**Cümlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?**
    - A-) 2000
    - **Cevap B-) 3000**
    - C-) 4000
    - D-) 5000
    - E-) 7000
    ***
1. **Türkiye Türkçesi ve Azerbaycan Türkçesi aşağıdakilerden hangisine dâhildir?**
    ...
    - E-) Uygur Türkçesine
    ***
1. **Türkiye Türkçesinin yazı dili aşağıdakilerden hangisidir?**
    - A-) Ankara ağzı
    - B-) Konya ağzı
    ...
    - E-) Gaziantep ağzı
    ***
1. **Aşağıdakilerden hangisi Göktürk alfabesinin özelliklerinden biri değildir?**
    ...
    ***
1. **Göktürk alfabesini ilk olarak çözen bilim insanı aşağıdakilerden hangisidir?**
    - A-) Kâzım Mirşan
    - B-) Jean Paul Roux
    - C-) Josef von Hammer
    ...
    - E-) Andreas Tietze
    ***
1. **Türkçeyi Arap harfleriyle ilk defa yazanlar aşağıdakilerden hangisidir?**
    - A-) Türkiye Türkleri
    - B-) Memluk Türkleri
    - C-) Safeviler
    ...
    - E-) Göktürkler
    ***
1. **Türklerin Arap Alfabesi ile yazdıkları ilk metnin konusu nedir?**
    ...
    ***
1. I. Farklı coğrafyalarda yaşamış olmaları<br />II. Savaşlar<br />III. Göçler<br />**Yukarıdakilerden hangisi ya da hangileri Türklerin tarih boyunca farklı alfabe kullanmalarının nedenleri arasında yer alır?**
    - A-) Yalnız I
    - B-) Yalnız II
    - C-) I ve II
    - D-) I ve III
...
1. Türkçeyi doğduğu yörenin ağzı ile edinen bir bireyin eğitim sürecinde ölçünlü (standart) Türkiye Türkçesini öğrendikten sonra kendi yöresine döndüğünde yöresel dil kullanması o yörede yaşayan insanlara dayanışma duygusu verebilir. Ölçünlü dil kullanması ise toplumsal mesafenin açılmış olduğu düşüncesini yansıtabilir.**Bu durumda eğitimli birey için doğru davranış aşağıdakilerin hangisinde belirtilmiştir?**
    ...
    ***
1. **Bir dilin bilinmeyen bir zamanda kendisinden ayrılan ve yeni bir dil olma yolu tutan koluna ne ad verilir?**
    - A-) Ağız
    - B-) Şive
    - **Cevap C-) Lehçe**
    - D-) Benzeşme
    - E-) Genişleme
    ***
1. **Türkler ilk olarak hangi alfabeyi kullanmıştır?**
    - **Cevap A-) Göktürk**
    - B-) Uygur
    - C-) Soğd
    - D-) Arap
    ...
    ***
## Unite 5
1. **Aşağıdaki atasözlerinden hangisi gerçek anlamıyla kullanılmıştır?**
    - **Cevap A-) Sebepsiz ölüm olmaz.**
    - B-) Çivi çiviyi söker.
    - C-) Minareyi çalan kılıfını hazırlar.
    - D-) Mum dibine ışık vermez.
    - E-) Ayağını yorganına göre uzat.
    ***
1. **Türklerin çok geniş bir coğrafyada, birçok milletle etkileşim hâlinde olması Türkçenin söz varlığıyla ilgili hangi sonucu ortaya çıkarmıştır?**
    - A-) Kendi dilini güçlendirmesi
    - B-) Başka dilleri küçümsemesi
    ...
    ***
1. **Türkçede ikilemelerin kullanılması Türkçenin hangi özelliği ile ilgilidir?**
    - A-) Dilin kelime sayısındaki azlığı
    - B-) Dilin kelime sayısındaki çokluğu
    - **Cevap C-) Anlatımın güçlü ve canlı olması**
    - D-) Anlatımın yetersizliği
    - E-) Diğer dillerin etkisinde olması
    ***
1. En temel ihtiyaçları karşılayan kelimeler, başta organ isimleri olmak üzere yemek, içmek, uyumak, gitmek, gelmek, almak, vermek gibi kavramlar; akrabalık adları, sayılar ve maddi ve manevi kültür içine giren çeşitli kavramlar bu başlık altında incelenir.<br />**Sözü edilen başlık aşağıdakilerden hangisidir?**
    - A-) Alt Söz Varlığı
    ...
    - E-) Argo Söz Varlığı
    ***
1. **Aşağıdakilerden hangisi Türkçenin ses kurallarına göre şekillenmeyen yabancı kelimeler arasında yer alır?**
    - A-) Mandıra
    - B-) Kilise
    - C-) Panayır
    - **Cevap D-) Enflasyon**
...
1. **Türkçenin köklü bir dil olmasındaki temel etken aşağıdakilerden hangisidir?**
    ...
    ***
1. **Bir dilde yabancı kelimelerin bulunması aşağıdakilerden hangisinin göstergesidir?**
    ...
    ***
1. **Türkçenin sondan eklemeli bir dil olması ona aşağıdakilerden hangisini kazandırmıştır?**
    ...
    ***
1. **“Saz” kelimesinin hem “çalgı aleti” hem de “sulak alan” anlamında kullanılması aşağıdakilerden hangisini ifade eder?**
    ...
    ***
1. **Türklerin birden çok lehçeye sahip olması aşağıdakilerden hangisinin sonucudur?**
    ...
    ***
1. **Aşağıdakilerden hangisi gerçek anlamlı atasözüne bir örnektir?**
...
1. **Aşağıdaki atasözlerinin hangisinde mecazlı bir söyleyiş yoktur?**
    ...
    ***
1. **Türkçede renk ve akrabalık kavramlarının geniş bir yelpazede olması aşağıdakilerden hangisini ifade eder?**
    ...
    ***
1. Şimdi bir rüzgâr geçti buradan.<br />Koştum ama yetişemedim.<br />Sorsaydım söylerdi herhâlde.<br />Soramadım.<br />**“Yetişmek” kelimesi aşağıdakilerin hangisinde bu dizelerdeki anlamıyla kullanılmıştır?**
    - A-) Arkadan bize laf yetiştiriyordu.
    - **Cevap B-) Otobüse son dakikada yetişebildim.**
    - C-) Bu proje yarına yetişmeli.
    - D-) Tam bir asker olarak yetiştirildi.
    - E-) Çocuğun boyu bana yetişti.
    ***
1. **Aşağıdakilerin hangisinde, “yan” sözcüğü deyim içerisinde kullanılmamıştır?**
    - A-) Babasını da yanına alınca istediği her şeyi yaptırdı.
    - B-) Okula devam edeceğini söylemesine rağmen sürekli yan çiziyor.
    ...
    ***
1. **Aşağıdakilerin hangisinde “zor durumda kalmak” anlamında bir deyim kullanılmıştır?**
    ...
    ***
1. Son gül dağıldı, son kuş uçup gitti<br />Şimdi yaz, yaprakların tabiatı örten pasındadır<br />**“Son” sözcüğü aşağıdakilerin hangisinde bu dizelerdeki anlamıyla kullanılmamıştır?**
    ...
    ***
1. **“Derin” sözcüğü aşağıdaki cümlelerin hangisinde “İçinde ona karşı derin bir sevgi besliyordu.” cümlesindeki anlamıyla kullanılmıştır?**
    ...
    ***
1. **Türkçenin sondan eklemeli bir dil olması ona hangi özelliği kazandırmıştır?**
    - **Cevap A-) Kolay kelime ve kavram üretimi**
    - B-) Fiillerin cümlenin sonunda olması
...
1. Sözünü sakınarak, tartarak kullanmak güzel söz söyleme hastalığından daha değerli bir şeydir. Karşımızdaki kişiyi düşünerek konuşmak ise yerli yerinde söylenmiş derli toplu sözlerden yeğdir. Konuya girmeden önce sözü uzun uzun ağızda gevelemek can sıkar, bir şeyi damdan düşer gibi söylemek ise etkiyi azaltır.<br />**Bu parçada savunulan düşünce ile doğrudan ilgi kurulabilecek atasözü aşağıdakilerden hangisidir?**
    ...
    ***
1. I. Gözden geçirmek<br />II. Gözleri dolmak<br />III. Gözleri yaşarmak<br />IV. Gözleri süzülmek<br />**Yukarıdaki deyimlerden hangileri duygulanma sonucu ortaya çıkan bir durumu ifade eder?**
    - A-) I ve III
    - B-) I ve IV
    - **Cevap C-) II ve III**
    - D-) II ve IV
    - E-) III ve IV
    ***
1. **Aşağıdaki atasözlerinin hangisinde mecazlı bir söyleyiş vardır?**
    - A-) Dost ile ye iç alışveriş etme.
    - B-) Sebepsiz ölüm olmaz.
    - C-) Aklı başa yaş getirir.
    - D-) Akıl için yol birdir.
    - **Cevap E-) Minareyi çalan kılıfını hazırlar.**
    ***
1. **Aşağıdaki cümlelerin hangisinde hem atasözü hem de deyim anlamlı kelime kullanılmıştır?**
    - A-) Kafana takma iş işten geçti. Olamayız artık eskisi gibi
    - B-) Sen seni bil sen seni. Sen sıkı tut çeneni.
    ...
    ***
1. Yarı mecaz anlamlı atasözlerine aynı zamanda .................. söyleyiş denir.<br />**Cümlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?**
    - **Cevap A-) kinayeli**
    - B-) tarizli
    - C-) istişareli
    - D-) iştikaklı
    - E-) teşhisli
    ***
1. **Aşağıdaki kelimelerden hangisi köken bakımından Türkçeye aittir?**
    - A-) Oksijen
    - **Cevap B-) Dağ**
    - C-) Lokomotif
    - D-) Enflasyon
    ...
    ***
## Unite 6
1. **Aşağıdaki kelimelerden hangisi aldığı ekten dolayı "Büyük Ünlü Uyumuna (Kalınlık-İncelik Uyumu)" uymaz?**
    - A-) Okuyorum
    - B-) Gezerken
    - **Cevap C-) Sabahleyin**
    - D-) Yoldaş
    - E-) Sesteş
    ***
1. Türkçe bir kelimede yuvarlak ünlülerden (o, ö, u, ü) sonra ya dar yuvarlak ünlüler (u, ü) ya da düz geniş ünlüler (a, e) gelir.<br />**Aşağıdakilerden hangisi bu kurala uymaz?**
    - A-) Uzak
    - B-) Okul
    - C-) Ordular
    - D-) Ürkek
    - **Cevap E-) Otomobil**
    ***
1. **Aşağıdakilerin hangisinde "Türkçedeki ünsüzlerin sınıflandırılması" yanlıştır?**
    - A-) Dudak ünsüzleri: b, p, m
    - **Cevap B-) Diş-dudak ünsüzleri: f, v, c**
    - C-) Ön damak ünsüzleri: g, k, l, r, y
    - D-) Arka damak ünsüzleri: ğ
    - E-) Gırtlak ünsüzü: h
    ***
1. Türkçede p, ç, t, k ünsüzleri ünlü ile başlayan bir ek aldıklarında b, c, d, ğ ünsüzlerine dönüşür.<br />**Aşağıdakilerden hangisi bu kurala uymaz?**
    - A-) Dip
    - B-) Ağaç
    - C-) Yurt
    - **Cevap D-) Türk**
    - E-) Sokak
    ***
1. **Aşağıdaki kelimelerin hangisinde iç seste ünsüz türemesi olmuştur?**
    - **Cevap A-) Fiyat**
    - B-) Akıl
    - C-) İstop
    - D-) Devir
...
1. **Aşağıdaki cümlelerin hangisinde ünlü düşmesiyle ilgili bir yazım yanlışı yapılmıştır?**
    ...
    ***
1. **Aşağıdaki sözcüklerin hangisine ünlü ile başlayan bir ek getirildiğinde “ünsüz değişmesi” olmaz?**
    - A-) Uçak
    - B-) Ağaç
    - C-) Renk
    - **Cevap D-) Tut**
    - E-) Bıçak
    ***
1. Sonu sert ünsüzle biten tek heceli sözcüklerde genellikle ünsüz değişimi olmaz.<br />**Aşağıdaki sözcüklerin hangisi bu kurala aykırı bir örnektir?**
    - A-) Kat
    - B-) Çat
    - **Cevap C-) Yurt**
    - D-) Top
...
1. **Aşağıdaki cümlelerin hangisinde sert ünsüz yumuşamasına uğrayan bir kelime yoktur?**
    ...
    ***
1. Ela gözlerine kurban olduğum<br />Yüzüne bakmaya doyamadım ben<br />İbret için gelmiş cihana<br />Noktadır benlerin sayamadım ben<br />**Bu dizelerde aşağıdaki ses olaylarından hangisi yoktur?**
    - A-) Ulama
    - **Cevap B-) Ünsüz sertleşmesi**
    - C-) Kaynaştırma
    - D-) Büyük ünlü uyumuna aykırı sözcük
    - E-) Ünsüz türemesi
    ***
1. Topraktandır cümle beden,<br />Nefsini öldür ölmeden,<br />Böyle emretmiş yaradan,<br />Sen kalemsin ben uç muyum?<br />**Bu dizelerde aşağıdaki ses olaylarından hangisi yoktur?**
    - A-) Ünsüz benzeşmesi
    - B-) Ulama
    ...
    - E-) Ünsüz yumuşaması
    ***
1. “Etmek, olmak” gibi yardımcı fiillerle birleşen sözcüklerde herhangi bir ses olayı meydana gelirse bu sözcükler birleşik yazılır.<br />**Aşağıdakilerden hangisinde bu kurala uymayan bir sözcük vardır?**
    - A-) hissetmek
    - B-) kaybolmak
    - C-) fark etmek
    - D-) razı etmek
    - **Cevap E-) keşf etmek**
    ***
1. **Türkçenin genel özellikleriyle ilgili olarak aşağıdakilerden hangisi yanlıştır?**
    - A-) Ünlü uyumu vardır.
    - **Cevap B-) Sözcük başında birden çok ünlü bulunur.**
    - C-) Çekim, eklerle yapılır.
    - D-) Ön ek değil, son ek kullanılır.
    - E-) Soru ekle yapılır.
    ***
1. O gönlü yüce biridir.<br />**Altı çizili sözcükte görülen ses olayının benzeri aşağıdaki cümlelerin hangisinde yapılmıştır?**
    ...
    ***
1. **Aşağıdakilerin hangisinde birleşik fiilin yazımı yanlıştır?**
    - A-) Her şeyi kendine dert etme.
    - B-) Bu maçta da iki gol yedi.
    - **Cevap C-) Hastayı başka yere nakil ettiler.**
    - D-) Bunu yapamayacağını zannediyordum.
    - E-) Bizi umutsuz günlere sevk etti.
    ***
1. **Aşağıdakilerden hangisi ses organlardan biri değildir?**
    - A-) Akciğer
    - **Cevap B-) Karaciğer**
    - C-) Küçük dil
    - D-) Burun
    - E-) Dudaklar
    ***
1. **Aşağıdakilerden hangisi Türkiye Türkçesinin ses özelliklerinden biri değildir?**
    - A-) Türkiye Türkçesinde içinde "j" bulunan sözcükler Türkçe değildir.
    - B-) Türkiye Türkçesinde "c, ğ, l, m, n, r, z" sesleriyle sözcük başlamaz.
    ...
    ***
1. I. Nerde kaldı mahyalar<br />II. Haniymiş minareler<br />III. Nedenler, niçinler hep bir adım önümde<br />IV. Ayağımla konuşup, ağzımla dönünce<br />**Yukarıda verilen dizelerin hangisi ya da hangilerinde birden fazla ses olayı vardır?**
    - A-) Yalnız I
    - B-) I ve III
    - C-) II ve III
    - **Cevap D-) III ve IV**
    - E-) I, II ve III
    ***
1. **Aşağıdaki cümlelerin hangisinde ünlü düşmesiyle ilgili bir yazım yanlışı yapılmamıştır?**
    - A-) İnsan dünyayı zapt eder ama ağızını zapt edemez.
    - **Cevap B-) İnsanların karşısına ak bir alınla çıkmak gerek.**
    ...
    ***
1. **Aşağıdaki cümlelerin hangisinde ünsüz benzeşmesinin örneği yoktur?**
    ...
    - B-) Abdullah Harmancı'ya (2022) göre öykü yazmak iddiası; öykü yazarlarının metinlerini bilmeyi, tanımayı, okumayı, onların metinleriyle hesaplaşmayı gerektirir.
    ...
    ***
1. **Aşağıdakilerden hangisinde damak-diş ünsüzleri bir arada verilmiştir?**
    - **Cevap A-) c, ç, j, ş**
    - B-) f, v
    - C-) b, p, m
    - D-) g, k, l, r, y
    ...
    ***
## Unite 7
1. **Aşağıdakilerin hangisinde ek fiilin kullanımı diğerlerinden farklıdır?**
    - A-) O kadar süre sonunda makale dergi tarafından raporlanmıştı.
    - B-) Bazen çok kızdığında kendi kendine söylenirdi.
    ...
    ***
1. **Aşağıdakilerin hangisinde yapım ekinin kullanımı kural dışı bir uygulamaya örnektir?**
    - A-) Akıllı düşman, akılsız dosttan iyidir.
    - **Cevap B-) Yüzdelik dilime giremeyince atanamadı.**
    - C-) Gönüllüler sayesinde ağaç yoldan kaldırıldı.
    - D-) Bildiğim kadarıyla hiç evlenmemişti.
    - E-) Bu konularda oldukça tecrübelidir.
    ***
1. **Aşağıdakilerden hangisinde soru eki cümleye zaman anlamı katmaktadır?**
    - A-) Birden bire bana soru sormasın mı!
    - B-) Canımı sıktın mı o zaman görürsün.
    - C-) Güzel mi güzel bir kızları vardı.
    - D-) Sınavlarını verdin mi tatili hak edersin.
    - **Cevap E-) Erzurum’a indin mi beni ara.**
    ***
1. **Aşağıdakilerin hangisinde yalın hâlde bulunan bir sözcük cümlenin belirtisiz nesnesidir?**
    - A-) Dün uçakla Adana’ya gitti.
    - B-) Aslında tüm kızgınlığım sana.
...
1. **“-den” eki aşağıdaki cümlelerin hangisinde karşılaştırma görevinde kullanılmıştır?**
    ...
    ***
1. **Aşağıdakilerin hangisinde “-ler / -lar” eki eklendiği sözcüğü çoğul anlamlı yapmamıştır?**
    ...
    ***
1. **Aşağıda altı çizili olarak verilen sözcüklerden hangisi diğerlerinden farklı bir ek almıştır?**
    ...
    ***
1. **Aşağıdaki cümlelerden hangisinde “–den” eki diğerlerinden farklı bir görevde kullanılmıştır?**
    ...
    ***
1. **Aşağıdaki altı çizili kelimelerden hangisi hâl eki almamıştır?**
...
1. **Aşağıdakilerin hangisinde “-ce / -ca” eki “Çocuksu davranışların artık bizi bunalttı.” cümlesindeki “-su” ekiyle aynı görevde kullanılmıştır?**
    ...
    ***
1. **Aşağıdakilerin hangisinde tamlayan eki diğerlerinden farklı bir görevde kullanılmıştır?**
...
1. **Aşağıdakilerin hangisinde soru eki “-mı / -mi” “Sana söylediklerimi yaptın mı sınavı geçersin.” cümlesindekiyle aynı görevde kullanılmıştır?**
    ...
    ***
1. **“-le / -la” eki aşağıdakilerin hangisinde “Havaların ısınmasıyla sobalar kaldırıldı.” cümlesindekiyle aynı anlamda kullanılmıştır?**
    ...
    ***
1. **Aşağıdaki cümlelerin hangisinde "-den" eki diğerlerinden farklı bir görevde kullanılmıştır?**
    ...
    ***
1. **Aşağıdaki dizelerin hangisinde hem yapım hem de çekim eki almış bir sözcük vardır?**
    ...
    ***
1. "Kardeşimin yüzünde ben çıkmış."<br />**Aşağıdaki cümlelerin hangisinde altı çizili sözcüğün sesteşi bulunmaktadır?**
    - A-) Çarşafların yüzü eskimiş değişmeliyiz.
    - **Cevap B-) Bugün deniz dalgalı, yüzmeye gitme!**
    - C-) Onda yüz yok ki astarı olsun.
    - D-) Sikkelerin bir yüzünde aslan şekli var.
    - E-) Ey güzel! Yüzün sanki amber çiçeği
    ***
1. Ete kemiğe büründüm, Yunus diye göründüm.<br />**Yukarıdaki mısrada kök durumunda kaç sözcük vardır?**
    - A-) 1
    - B-) 2
    - C-) 3
    - **Cevap D-) 4**
    - E-) 5
    ***
1. **Aşağıdaki cümlelerin hangisinde birden fazla birleşik sözcüğe yer verilmiştir?**
    - A-) Duyan duysun bilen bilsin böyledir bizim sevdamız.
    - B-) Ağlasam bugün toprak çatlar utancından
    ...
    ***
1. **Aşağıdakilerden hangisi Türkçede ortak köke örnek değildir?**
    - A-) Yarış
    - B-) Dik
    - C-) Şiş
    - **Cevap D-) Laf**
    - E-) Tat
    ***
1. I.Kan<br />II.Göz<br />III.Pek<br />IV.Tepe<br />**Yukarıda verilen kelimelerden hangisi ya da hangileri isim köklüdür?**
    - A-) Yalnız I
    - B-) Yalnız II
    - C-) Yalnız III
    - D-) I,II ve III
...
1. **Aşağıdaki cümlelerin hangisinde altı çizili sözcük mecaz anlamıyla kullanılmıştır?**
    ...
    ***
1. **Aşağıdaki cümlelerde altı çizili sözcüklerden hangisi gerçek anlamda kullanılmıştır?**
    ...
    ***
1. **Aşağıdakilerin hangisinde bir terim kullanılmıştır?**
    ...
    ***
1. **Aşağıdaki cümlelerin hangisinde somut anlamlı bir sözcük soyut anlam ifade etmektedir?**
    ...
    ***
1. Ne olursa olsun bu işi bitireceğim.<br />**Bu cümleye altı çizili sözün kattığı anlam aşağıdakilerin hangisinde vardır?**
    ...
    ***
1. Gelir gelmez odasına geçti.<br />**Bu cümlede altı çizili sözün kattığı anlam aşağıdakilerin hangisinde vardır?**
    ...
    ***
1. I. Hafif hafif bir rüzgâr esiyordu.<br />II. Hemen hemen işi bitirdik.<br />III. Zaman zaman yağmur yağıyordu.<br />IV. Aşağı yukarı sekiz ayı kaldı.<br />V. Ara sıra iş yerine uğrardı.<br />**Bu cümlelerde altı çizili sözcükler birbirine yakın olma durumuna göre gruplandırıldığında hangisi dışarıda kalır?**
    - **Cevap A-) I**
    - B-) II
    - C-) III
    - D-) IV
    - E-) V
    ***
1. Bu ağrıyı çok çok on gün daha çekersin.<br />**Altı çizili kelime grubunun cümleye kattığı anlam aşağıdakilerden hangisidir?**
    ...
    ***
1. **Çekmek kelimesi aşağıdakilerden hangisinde gerçek anlamda kullanılmamıştır?**
    ...
    ***
1. Bir tatil dönüşü evinin kapısını açmak için elini cebine attığı anda, herkesi bir gün kavrayacak olan karanlık onu da kavradı.<br />**Bu cümle ve onu oluşturan sözcükler için aşağıdakilerden hangisi yanlıştır?**
    - A-) “attığı” sözcüğü, başka bir sözcüğün anlamca yerini tutmuştur.
    - B-) “kavradı” sözcüğü gerçek anlamı dışında kullanılmıştır.
    ...
    ***
1. I. Çocukluğumun en güzel anıları birden aklıma geldi.<br />II. Çocuklarının bir yetişkin gibi davranmasına öylesine şaşırıyordu ki…<br />III. İçimden bir an çocukluğumun geçtiği sokaklarda yürümek geldi.<br />IV. Giderken ansızın dönüp yaşlı gözleriyle bize baktı.<br />**Yukarıda numaralanmış cümlelerin hangi ikisinde altı çizili sözcükler anlamca en yakındır?**
    - A-) I ve II
    - **Cevap B-) I ve IV**
    - C-) II ve III
    - D-) II ve IV
    - E-) III ve IV
    ***
1. **Aşağıdaki cümlelerin hangisinde mecaz anlamlı sözcük kullanılmamıştır?**
    - A-) Soğuk memleketin sıcak türküleriyle büyüdüm ben.
    - B-) Benden bilgi sızdırmak için benimle samimi olmaya çalıştığını çok geç fark ettim.
    ...
    ***
1. **Aşağıdakilerden hangisi yakın anlamlı kelimelerin tekrarıyla oluşan bir ikileme değildir?**
    - A-) Doğru dürüst
    - B-) Ağrı sızı
    ...
    - E-) Yer yurt
    ***
1. **Anlatıma akıcılık ve zenginlik kazandırmak için birden fazla sözcükten en az birinin gerçek anlamından uzaklaştırılmasıyla oluşturulmuş söz gruplarına ne ad verilir?**
    - **Cevap A-) Deyim**
    - B-) Atasözü
    - C-) Kalıp söz
    - D-) İkileme
    - E-) Argo
    ***
1. **Aşağıdakilerden hangisinde zıt anlamlı kelimeler bir arada verilmemiştir?**
    - A-) Yakın-Uzak
    - **Cevap B-) İleri-Yukarı**
    - C-) İleri-Geri
    - D-) Kolay-Zor
    - E-) Az-Çok
    ***
## Unite 9
1. **Aşağıdaki cümlelerde veya dizelerde kullanılan ikilemelerden hangisi cümleye abartma anlamı katmıştır?**
    - A-) Ağır ağır çıkacaksın bu merdivenlerden
    - B-) Türkülerde tüter dağ dağ, yayla yayla / Köyümüz köylümüz türkülerimiz
    ...
    ***
1. **Ağşağıdakilerden hangisi "kalıp / ilişki sözlerin" özelliklerinden biri değildir?**
    - A-) Bu sözler ekleme ve çıkarma yapılamayan, değiştirilemeyen türden dil birimleridir.
    - B-) Genellikle cümle veya kelime öbeği dizilişiyle var olurlar.
    ...
    ***
1. **Aşağıdaki atasözlerinden hangisinde "bir başkasının hakkında hüküm verme" gerekçesi vurgulanmıştır?**
    ...
    ***
1. **Aşağıdaki atasözlerinden hangisi ölçülü ve kafiyeli olarak söylenmiştir?**
    ...
    ***
1. **Aşağıdaki cümlelerin hangisinde bir deyim değiştirilerek söylenmiş ve anlam kaybına uğramıştır?**
    - **Cevap A-) Bu adamı aklım tutmadı.**
    - B-) Kara gün dostu olarak tanınmıştı.
    - C-) Aklım dün akşamki olaya takıldı.
    - D-) Bugünkü olaydan sonra ağzına lokma koymadı.
    - E-) Şu yaramazın pabuç kadar dili var.
    ***
1. **Aşağıda deyimlerle ilgili verilen bilgilerden hangisi yanlıştır?**
    ...
    ***
1. **“**Dolu küpün sesi çıkmaz.**” atasözünde anlatılmak istenen aşağıdakilerden hangisidir?**
...
1. **Aşağıdaki cümlelerin hangisinde ikileme cümleye "zorlukla" anlamı katmıştır?**
    ...
    ***
1. **Aşağıdaki ikilemelerden hangisi diğerlerinden farklıdır?**
    ...
    ***
1. I. Düşünmeden, tutarsız söz söylemek<br />II. Öç almak<br />III. Bir işi yapmakta acele etmemek<br />IV. Ağzında bakla ıslanmamak<br />**Aşağıdakilerden hangisi, yukarıda açıklaması verilen deyimlerden biri değildir?**
    ...
    ***
1. **Aşağıdakilerden hangisi “bir istek bildiren” ilişki söz/kalıp sözdür?**
    ...
    ***
1. **Aşağıdakilerden hangisi “konuşanı ve dinleyeni yüceltme" bildiren bir kalıp sözdür?**
    - A-) Hoşça kal.
    - B-) Alacağın olsun.
    ...
    ***
1. **“Akıl kârı olmamak” deyiminin doğru karşılığı aşağıdakilerden hangisidir?**
    - A-) Çok cahil olmak
    - B-) Kötülük yapmak
    - C-) Beğenmemek
    ...
    ***
1. **Aşağıdaki atasözlerinden hangisinde deyim kullanılmamıştır?**
    ...
    ***
1. **Aşağıdaki atasözlerinden hangisi aynı veya yakın anlamlıdır?**
    - A-) Dost ile ye iç; alışveriş yapma/Bugünün işini yarına bırakma.
    - B-) Fazla mal göz çıkarmaz./Azıcık aşım, kaygısız başım.
    ...
    ***
1. **Aşağıdaki ikilemelerden hangisi kuruluşu yönüyle diğerlerinden farklıdır?**
    - A-) Yamru yumru
    - B-) Eğri büğrü
    - C-) Eski püskü
    - D-) Yırtık pırtık
    - **Cevap E-) Ev bark**
    ***
1. **Aşağıdaki ilişki sözlerin hangisi diğerlerinden farklıdır?**
    - A-) İyi saatte olsunlar.
    - B-) Yediğin içtiğin senin olsun gezdiğin gördüğün yerleri anlat.
    - **Cevap C-) Ölülerin ardından kötü söz söylenmez.**
    - D-) Küçüklerin gözlerinden büyüklerin ellerinden öperim.
    - E-) Ayıptır söylemesi.
    ***
1. **Aşağıdaki ilişki sözlerden hangisi diğerlerinden farklıdır?**
    - A-) Sadede gelelim.
    - **Cevap B-) Baş üstüne**
    - C-) Bize de buyurun.
    ...
    - E-) Bana müsaade
    ***
1. **Aşağıdakilerden hangisi zıt anlamlı kelimelerden oluşan bir ikileme değildir?**
    - A-) İleri geri
    - B-) Az çok
    - **Cevap C-) Çer çöp**
    - D-) Bata çıka
...
1. **“Dolu küpün sesi çıkmaz” atasözünde anlatılmak istenen aşağıdakilerden hangisidir?**
    ...
    - E-) Sıkıntılı insanlar her zaman sessizdir.
    ***
1. **Aşağıdaki cümlelerin hangisinde deyim, açıklamasıyla birlikte verilmemiştir?**
    - **Cevap A-) Bu da benim kulağıma küpe olsun, seninle tüm bağlarımı koparıyorum.**
    - B-) Kuzenim aile şirketlerinin yönetimini üstlendi, dizginleri ele aldı artık.
    ...
    ***
1. **Aşağıdaki ikilemelerden hangisi oluşum yönüyle diğerlerinden farklıdır?**
    - A-) İşlerini yarım yamalak yaptığı için, patronu onu herkesin içinde azarladı.
    - B-) Akrabalar bayramda cümbür cemaat bize gelince bu bayram evde oturmak zorunda kaldık.
    ...
    ***
1. **Aşağıdakilerden hangisi deyime örnek değildir?**
    - A-) Kara gün dostu
    ...
    - E-) Biçilmiş kaftan
    ***
1. **Aşağıdakilerden hangisi eksiz ikilemeye örnek değildir?**
    - A-) Ses seda
    - B-) Estek köstek
    - C-) Gele gide
    - D-) Fıldır fıldır
    ...
    ***
## Unite 10
1. **Aşağıdakilerden hangisi "vurgu" kavramı ile ilgili özelliklerden biri değildir?**
    - A-) Vurgu, konuşurken bir hece üzerine düşen hava şiddeti veya soluk baskısıdır.
    - **Cevap B-) Vurgu, söz içinde bir heceyi, bir kelimeyi diğerlerine göre daha alçak ses tonuyla, söyleyiş süresini uzatarak öteki hece ya da kelimelerden daha az belirgin bir biçimde söyleme işlemidir.**
    ...
    ***
1. **Aşağıdaki cümlelerin hangisinde yer bildiren kelime vurgulu söylenmiştir?**
    - **Cevap A-) Bugün arkadaşımla kütüphanede çalıştım.**
    - B-) Bugün okula Ahmet gelmedi.
    - C-) Nehir kenarında büyük bir ağaç vardı.
    - D-) Yarın Ankara'ya uçakla gideceğiz.
    - E-) Erzurum Türkiye'nin en soğuk ilidir.
    ***
1. **"Dün akşam evin bahçesinde kimi gördün?" cümlesinde vurgu hangi kelime üzerindedir?**
    - A-) Dün
    - B-) Akşam
    - C-) Bahçesinde
    - **Cevap D-) Kimi**
    - E-) Evin
    ***
1. Dilimizde bulunan Arapça- Farsça kökenli bazı kelimelerde uzun heceler vardır. Uzun seslerde istisnai bir durum olarak vurgu, uzatılan hece üzerinde görünür.<br />**Aşağıdaki kelimelerden hangisi buna bir örnek olamaz?**
    - A-) Mücadele
    - B-) Kâtip
    - C-) Şair
    - D-) Zeki
    - **Cevap E-) Kaya**
    ***
1. **Aşağıdaki dizelerin hangisinde şiddet vurgusu vardır?**
    - A-) Fersiz gözlerimi dağlama gurbet
    - B-) Sessizlik içinde çağlama gurbet
    - C-) Ne söylemez akan suların dili
    - D-) Bir öğretmen gördüm çocukların başında
    - **Cevap E-) Zafer ırak mı? dedim; Aha diyordu**
    ***
1. **Aşağıdaki cümlelerin hangisinde ”yer” kavramı daha çok vurgulanmıştır?**
    ...
    ***
1. Konuşma esnasında sözcükler ve sözcükleri oluşturan seslerin ifadesi hep aynı düzeyde olmaktan ziyade duruma, ifadeye duyguya göre alçalıp yükselir. Buna ………... denir.<br />**Bu parçada boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?**
    - A-) vurgu
    - B-) ünsüz benzeşmesi
    - C-) ulama
    - D-) ünlü daralması
    - **Cevap E-) tonlama**
    ***
1. **Aşağıdaki cümlelerin hangisinde altı çizili sözcük vurguludur?**
    ...
    ***
1. **Aşağıdaki cümlelerin hangisinde vurgu yüklem üzerindedir?**
    ...
    ***
1. **Aşağıdaki cümlelerin hangisinde vurgu altı çizili sözcüğün üzerindedir?**
    ...
    ***
1. **Aşağıdaki cümlelerin hangisinde vurgu, zaman kavramı üzerindedir?**
    ...
    ***
1. **Aşağıdaki cümlelerin hangisinde bir eylemin nasıl yapıldığı vurgulanmıştır?**
    ...
    ***
1. Türkçe kelimelerde vurgu genellikle son hecede bulunur.<br />**Aşağıdakilerin hangisinde buna aykırı bir durum vardır?**
    - A-) Getirdim
    - **Cevap B-) Benimle**
    - C-) Sizlerden
    - D-) Kurtuluş
    - E-) Heyecanlı
    ***
1. **Aşağıdaki kelimelerden hangisi vurgu yönünden diğerlerinden farklıdır?**
    - **Cevap A-) Fransızca**
    - B-) Teyze
    - C-) Erzurum
    - D-) Hâriç
...
1. **Aşağıdaki cümlelerin hangisinde vurgu, zaman kavramı üzerindedir?**
    ...
    - B-) Ahmet okula dün otobüsle gitmiş.
    - C-) Otobüsle okula dün Ahmet gitmiş.
    - D-) Ahmet dün otobüsle okula gitmiş.
    - E-) Dün Ahmet okula otobüsle gitmiş
    ***
1. **Aşağıdaki cümlelerin hangisinde öznenin yaptığı işten etkilenen bir öge vurgulanmıştır?**
    - A-) Annemin hastalığında kardeşimi okula babam götürdü.
    - **Cevap B-) Pervasız hareketleri ve tavırları hepimizi üzüyordu.**
...
1. **Aşağıdaki cümlelerin hangisinde vurgu, zaman üzerindedir?**
    ...
    ***
1. **"Ovada sıralanan arsaların içinde koca koca binalar hızla yükseliyordu." cümlesinde hangi sözcükte cümle vurgusu vardır?**
    - **Cevap A-) Hızla**
    - B-) Koca koca
    - C-) Binalar
    - D-) Arsaların içinde
    - E-) Arsaların
    ***
1. **Aşağıdaki cümlelerin hangisinde “zaman” vurgulanmaktadır?**
    - **Cevap A-) İki aydır beklediğim diplomam yarın gelecek.**
    - B-) Tatilde teyzemler bize geleceği için hazırlık yapıyoruz.
    ...
    ***
1. **Söz içinde bir heceyi, bir kelimeyi diğerlerine göre daha yüksek ses tonuyla, söyleyiş süresini uzatarak öteki hece ya da kelimelerden daha baskılı ve belirgin bir biçimde söylemeye ne ad verilir?**
    - A-) Tonlama
    - B-) Boğumlama
    - C-) Sesletim
    - **Cevap D-) Vurgu**
    - E-) Heceleme
    ***
1. **Aşağıdakilerden hangisi vurgu türlerinden biri değildir?**
    - A-) Cümle vurgusu
    - B-) Mısra vurgusu
    - C-) Şiddet vurgusu
    - D-) Kelime vurgusu
    ...
    ***
## Unite 11
1. **Aşağıdakilerden hangisinde "Türkçede cümle içerisinde anlam yükünü temel olarak taşıyan ögeler" bir arada verilmiştir?**
    - **Cevap A-) Yüklem ve özne**
    - B-) Yüklem ve nesne
    - C-) Yüklem ve dolaylı tümleç
    - D-) Özne ve nesne
    - E-) Özne ve zarf tümleci
    ***
1. **Aşağıdaki cümlelerin hangisinde dolaylı tümleç yoktur?**
    - A-) Tolga sinemaya gidiyordu.
    - **Cevap B-) Ali evi çok dağıtmıştı.**
...
1. **Aşağıdakilerden hangisi cümle değildir?**
    ...
    ***
1. **Aşağıdaki cümlelerin hangisinde belirtisiz nesne vardır?**
    - A-) Babam balıkları akvaryumdan çıkardı.
    - **Cevap B-) Ayşe ekmek almıştı.**
    - C-) Bana dargın gibi bakıyor.
    - D-) Okulun bahçesini ağaçlandırdık.
    - E-) Dünyanın nasıl döndüğünü kavrayamamıştı.
    ***
1. **"Nasıl, ne zaman, ne kadar?” soruları yükleme yöneltildiğinde alınan cevap cümlenin hangi ögesini karşılar?**
    ...
    - E-) Özne
    ***
1. Yakıcı güneşin altında tarlada çalışan işçilerin umutları da onlar gibi yanıyordu.<br />**Yukarıdaki cümlenin ögelerinin sıralanışı hangisinde doğru verilmiştir?**
    ...
    - E-) Nesne – Yüklem – Özne
    ***
1. Ufak bir tepeyi aşan izciler ağaçlıklar arasından geçerek kamp yerine ulaştılar.<br />**Cümlenin ögelerinin sıralanışı aşağıdakilerden hangisinde doğru verilmiştir?**
    ...
    ***
1. Dostları onu kötü gününde yalnız bırakmadılar.<br />**Yukarıdaki cümlenin ögelerinin sıralanışı hangisinde doğru verilmiştir?**
    ...
    ***
1. En zor anlarımda bile yanımda olan dostlarımın beni bugünümde yalnız bırakmayacaklarını sanmıştım.<br />**Yukarıdaki cümlenin ögelerinin sıralanışı hangisinde doğru verilmiştir?**
    ...
    ***
1. **Aşağıdaki cümlelerde kullanılan ara sözlerden hangisi farklı bir ögenin açıklayıcısıdır?**
    ...
    ***
1. Sınıftaki sessizliğin devamı dün akşam evde de devam etti.<br />**Bu cümlede aşağıdaki ögelerden hangisi kullanılmamıştır?**
    - A-) Özne
    - B-) Yüklem
    - C-) Yer tamlayıcısı
    - D-) Zarf tümleci
    - **Cevap E-) Nesne**
    ***
1. Karışıklığa karşı mücadele vermek yabani otlara karşı mücadele vermeye benzer.<br />**Yukarıdaki cümlenin ögelerinin sıralanışı hangisinde doğru verilmiştir?**
    ...
    ***
1. Korkma, sönmez bu şafaklarda yüzen al sancak;<br />Sönmeden yurdumun üstünde tüten, en son ocak.<br />**Altı çizili öge aşağıdakilerden hangisidir?**
    - A-) Yüklem
    - **Cevap B-) Özne**
    - C-) Nesne
    - D-) Yer tamlayıcısı
    - E-) Zarf tümleci
    ***
1. **“Türkü söyleyen kimdi?” sorusunun cevabı hangi ögeyi bulmaya yöneliktir?**
    - A-) Yüklem
    - B-) Nesne
    - **Cevap C-) Özne**
    - D-) Yer tamlayıcısı
    - E-) Zarf tümleci
    ***
1. **Aşağıdaki cümlelerin hangisinde ögeleri ayırmada yanlışlık yapılmıştır?**
    - A-) Buraya kadar geldiğiniz için / teşekkür ederim.
    - B-) Sorulara şöyle bir göz atıp / kitabı / kapattı.
    ...
    ***
1. **Aşağıdakilerden hangisinde sözde özne vardır?**
    - **Cevap A-) Konular bugün özetlendi.**
    - B-) Soruyu doğru cevapladı.
    - C-) Konuyu yavaşça bize anlattı.
    - D-) Kardeşini bizimle tanıştırdı.
    - E-) Okula yeni başlayan öğrenciler andımızı ezberledi.
    ***
1. **Aşağıdaki cümlelerin hangisinde yüklem isim tamlamasından oluşmuştur?**
    - A-) Çocuklarla iletişim kurmak zor bir iştir.
    - **Cevap B-) Günümüzde teknoloji ve bilim, uygarlığın göstergesidir.**
    - C-) Matematik öğretmenimiz sinirli bir adamdı.
    - D-) Hülya’nın uğurlu günü salıymış.
    - E-) Gömleğinin rengi ceketine hiç uymamış.
    ***
1. Savuruyordu dört yana umutlarımızı bir ömürden arta kalmanın hüznü.<br />**Yukarıdaki cümlenin ögelerinin sıralanışı hangisinde doğru sırayla verilmiştir?**
    ...
    ***
1. **Aşağıdaki cümlelerin hangisinde zarf tümleci vurgulanmıştır?**
...
1. **Aşağıdakilerden hangisi iki ögeli bir cümledir?**
    ...
    - B-) Onun aniden gidişi bu saf, temiz ailede büyük bir etki bıraktı.
    ...
    ***
1. Dünyada yer alan olaylar ve olgular üzerine derinlikli düşünceler, varoluşun felaketimsi çekilmezliğini ve dayanılmazlığını ifşa eder.<br />**Cümlenin ögelerinin doğru sıralanışı aşağıdakilerden hangisidir?**
    - A-) Nesne / Özne / Zarf Tümleci / Yüklem
    ...
    ***
## Unite 12
1. **Aşağıdakilerden hangisi kurallı bir isim cümlesidir?**
    - **Cevap A-) Okulumuz, eve birkaç yüz metre uzaklıktaydı.**
    - B-) Oyundan, sahneye aktarılamayacak bölümleri çıkardık.
    - C-) Sanma gidersen gelirim arkandan.
    - D-) İncecikten bir yağmur yağıyordu yollara.
    - E-) Kitaplarımı güzelce ciltledim.
    ***
1. **Aşağıdakilerden hangisi bir isim cümlesidir?**
    - A-) Bütün gece yağmurda dolaştım.
    - B-) Seni gördüm sokakta koşarken.
    - C-) Okuyordu güzel sesiyle şiiri.
    - **Cevap D-) Seninle geçirdiğimiz günler ne kadar güzeldi.**
    - E-) Her gün yeni bir işe koyulurdu.
    ***
1. **Aşağıdakilerden hangisi kurallı bir cümledir?**
    - A-) Bütün gün düşündüm yalnızlığımı ve çaresizliğimi.
    - **Cevap B-) Komiser, elli yaşlarında, babacan, güler yüzlü bir adamdı.**
    - C-) Karda gezip izini belli etmeyen bir tilkidir o.
    - D-) Muhabbet bir Köroğlu’dur artık.
    - E-) Boş değil ettiğin niyaz.
    ***
1. **Aşağıdakilerden hangisi eksiltili bir cümledir?**
    - **Cevap A-) Dar günümde el uzattığınız için teşekkürler.**
    - B-) İlacını geciktirirsek babaannem keser iflahımızı.
    - C-) Kim bu cennet vatanın uğruna olmaz ki feda!
    - D-) Kuş kanadıyla selam gönderilir.
    - E-) Hâlden bilmiyor kimseler.
    ***
1. **"Arkadaşımın evinde gördüğüm tablolar bana çocukluğumda yaşadığım yerleri bütün ayrıntılarıyla anımsattı." ifadesi yüklemin cümledeki yerine göre nasıl bir cümledir?**
    - A-) Devrik cümle
    - B-) Eksiltili cümle
    ...
    - E-) İsim cümlesi
    ***
1. **Aşağıdaki cümlelerden hangisi yükleminin yerine göre diğerlerinden farklıdır?**
    ...
    ***
1. I. Eylem<br />II. İsim<br />III. Zarf<br />IV. Zamir<br />**“Kalpler kırılınca eller bir mana ifade etmez.” cümlesi yukarıdaki cümle çeşitlerinden hangisi ya da hangilerinin kapsamına girer?**
    - A-) Yalnız I
    - B-) Yalnız II
    - C-) I ve II
    - **Cevap D-) I ve IV**
    - E-) I, II ve III
    ***
1. **“Uzanıp sıcacık kuma saatlerce hayal kurmak isterdi” cümlesi yükleminin yerine göre nasıl bir cümledir?**
    - A-) Devrik
    - B-) Birleşik
    - C-) Basit
    - **Cevap D-) Kurallı**
...
1. **Eksiltili (Kesik) cümle ile ilgili aşağıdakilerden hangisi yanlıştır?**
    ...
    ***
1. Türkçede cümleler yüklemin türüne göre isim ve fiil cümlesi olarak iki gruba ayrılmaktadır. Fiil cümleleri olumsuzluk ekleri (-ma, -me) ile olumsuz şekle dönüştürülürken; isim cümleleri “değil” kelimesi ile olumsuz hâle getirilmektedir.<br />**Aşağıdaki cümlelerden hangisi bu kurala örnek teşkil etmez?**
    ...
    ***
1. **Aşağıdakilerden hangisi yüklemine göre cümle çeşitlerinden biri değildir?**
    - **Cevap A-) Zarf**
    - B-) Kurallı
    - C-) Devrik
    - D-) Kesik
...
1. **“Gözleri aşka gülen taze söğüt dalısın.” cümlesinin yüklemi, çeşidine göre aşağıdakilerden hangisidir?**
    ...
    - E-) Sıfat
    ***
1. **Aşağıdaki cümlelerin hangisi devrik isim cümlesidir?**
    ...
    ***
1. **Aşağıdakilerden hangisi bir isim cümlesi değildir?**
...
1. **Aşağıdaki cümlelerin hangisinde yüklem, ek eylem almamıştır?**
    ...
    ***
1. **‘’Su öylesine neşeli akıyordu ki insanın ruhu âdeta su yüzeyindeki köpükle dans ediyordu.’’ cümlesi yükleminin yerine göre nasıl bir cümledir?**
    - A-) Birleşik
    - B-) Basit
    - **Cevap C-) Kurallı**
    - D-) İsim
    - E-) Devrik
    ***
1. I. Kurallı<br />II. Birleşik<br />III. Basit<br />IV. Devrik<br />**Türk Dili dersinde cümle çeşitleri ünitesine çalışan Nazlı, yüklemi yerine göre incelemek istemektedir. Nazlı yukarıdakilerden hangisini ya da hangilerini kullanırsa yüklemi yerine göre doğru incelemiş olur?**
    - A-) Yalnız I
    - B-) I ve II
    - C-) I, III ve IV
    - **Cevap D-) I ve IV**
    - E-) I, II, III ve IV
    ***
1. ………… cümle, yüklemi kullanılmadığı hâlde yargı bildiren cümlelerdir.<br />**Cümlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?**
    - A-) Devrik
    - **Cevap B-) Eksiltili**
    - C-) Kurallı
    - D-) Basit
    - E-) Sıralı
    ***
1. Kurallı cümle …………………. cümle olarak da adlandırılmaktadır.<br />**Cümlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?**
    - A-) Sıradan
    - B-) Uygun
    - **Cevap C-) Düz**
    - D-) Alışkın
...
1. **“Sudan sebeplerle beni terk edemezsin.” cümlesi yüklemin türüne göre aşağıdakilerden hangisidir?**
    ...
    - E-) Zamir
    ***
1. **Aşağıdakilerden hangisi “eylem (fiil) cümlesi” değildir?**
    - A-) Şampiyon sporcu, bayrağımızı farklı ülkelerde dalgalandırmayı başardı.
    - **Cevap B-) O gece kâbustan uyandığından beri benzi soluktu.**
    ...
    ***
1. **Türkçenin Grameri isimli eser aşağıdakilerden hangisine aittir?**
    - A-) Zeynep Korkmaz
    - B-) Günay Karaağaç
...
1. **Aşağıdakilerden hangisi kurallı bir cümledir?**
    - A-) Bütün gün düşündüm yalnızlığımı ve çaresizliğimi.
    - B-) Karda gezip izini belli etmeyen bir tilkidir o.
    - C-) Boş değil ettiğin niyaz.
    - **Cevap D-) Sabahları burası sessiz olur.**
    - E-) Hâlden bilmiyor kimseler.
    ***
## Unite 13
1. **Aşağıdaki cümlelerden** **hangisi** **yapı bakımından olumsuz olduğu hâlde soru yolu ile olumlu anlam kazanmıştır?**
    - A-) Bugün derse neden gelmedin?
    - B-) Kapıyı çalanı niçin bana söylemedin?
    - C-) Doktor içeride mi?
    - **Cevap D-) Bana yalvaran sen değil miydin?**
    - E-) Niçin bu kadar geç kaldınız?
    ***
1. **Aşağıdakilerden hangisi biçimce olumsuz anlamca olumlu bir cümledir?**
    - A-) Gerçek belirince yalan ortadan kalkar.
    - B-) Dedesi iyi bir insan değildi.
...
1. **Aşağıdakilerden hangisi sıralı birleşik cümledir?**
    ...
    ***
1. **Aşağıdakilerden hangisi birleşik cümle çeşitlerinden biri değildir?**
    ...
    ***
1. **Aşağıdakilerden hangisi şartlı birleşik cümledir?**
    ...
    ***
1. **Aşağıdaki cümlelerin hangisinde “bağımlı sıralı” bir yapı söz konusudur?**
...
1. **Aşağıdaki cümlelerin hangisinde soru sormak değil, bilinen bir şeyi vurgulamak söz konusudur?**
    ...
    ***
1. **Aşağıdaki cümlelerin hangisinde yan cümlecik temel cümlenin nesnesidir?**
    ...
    ***
1. **Aşağıdakilerden hangisi, öznesi ortak bir sıralı cümledir?**
    ...
    ***
1. **Aşağıdakilerden hangisi bağlı cümleye örnek oluşturmaz?**
    ...
    ***
1. **Aşağıdaki cümlelerden hangisi "mi"li soru cümlesine örnektir?**
    ...
    ***
1. **‘’Ellerini arkadan bağlamıştı ve beylik tabancası belindeydi.’’ cümlesinin özellikleri aşağıdaki seçeneklerden hangisinde doğru olarak verilmiştir?**
    ...
    ***
1. **‘’Doğmazsa güneş yeryüzüne aydınlıklar karanlıkta kalır, dedi.’’ cümlesi yapısına göre aşağıdaki cümle çeşitlerinden hangisine örnektir?**
    - A-) Bağlı
    - B-) Sıralı
    - C-) Eylem
    - D-) Basit
    - **Cevap E-) Birleşik**
    ***
1. **Girişik birleşik cümleye aşağıdaki cümlelerden hangisi örnek teşkil eder?**
    - A-) Su, dere yatağında öylece akıp gidiyordu.
    - B-) Kuşlar gibi özgürüm artık.
    - **Cevap C-) Elini bana uzatarak kuyudan çıktı.**
    - D-) Sönük bir lamba alevi bu aşk.
    - E-) Kitabın başında uyuya kalmış.
    ***
1. **Aşağıdakilerden hangisi olumsuz cümleye örnek değildir?**
    - **Cevap A-) Elleri göğsünde bağlı uyuyordu.**
    - B-) Hiç kimse susturamazdı onu.
    - C-) Duramazdı, devam etmek zorundaydı.
    - D-) Gözleri görmezdi hiçbir güzelliği.
    - E-) Gece boyu uyanık kalır hiç uyumazdı.
    ***
1. ‘’Şart cümlesi temel cümleyi genellikle şart, zaman, sebep, benzetme gibi anlamlarla tamamlar ve temel cümlenin zarfı olur.’’<br />**Aşağıdaki cümlelerden hangisi verilen bilgiye uygun bir örnek değildir?**
    - A-) Mutluluk dünyaya yayılırsa sorunlar çözülür.
    - B-) Atlar eğerlenirse geziye çıkarız.
    - C-) Sular durulursa enkazın boyutunu görürler.
    - D-) Bana karşı kin kusmaya devam ederse ölür.
    - **Cevap E-) Dün neden derse geç kaldın?**
    ***
1. **‘’Gözleri maviydi, elleri bembeyaz ve saçları alabildiğine kumral’’ cümlesinin özellikleri aşağıdakilerden hangisinde doğru olarak verilmiştir?**
    ...
    ***
1. **Aşağıdakilerden hangisi anlamına göre cümle çeşitlerinden biridir?**
    - A-) Bağlı
    - B-) Sıralı
    - C-) Basit
    - D-) Birleşik
    - **Cevap E-) Soru**
    ***
1. **“O zaman vecd ile bin secde eder varsa taşım.” cümlesinin özellikleri aşağıdakilerin hangisinde doğru olarak verilmiştir?**
    ...
    ***
1. **Sıralı cümle için aşağıdakilerden hangisi söylenebilir?**
    ...
    ***
1. **Aşağıdaki cümlelerden hangisi yapısı yönüyle diğerlerinden farklıdır?**
    - A-) Yazılarımı genellikle geceleri kaleme alırım.
    - B-) Gerçek bir sanatçı için yaşam koşullarının bir önemi yoktur.
...
1. **Aşağıdakilerden hangisi yapısı yönüyle basit bir cümledir?**
    ...
    - B-) Memlekete giderken yolda öğrencilerimle karşılaştım.
    ...
    ***
1. **Aşağıdaki cümlelerden hangisi nesnesi ortak bağımlı sıralı bir cümledir?**
    - A-) Bana söylediklerine inanamıyor, neden böyle davrandığını anlamıyordum.
    - B-) Sonunda güneş doğdu, muhabbetle bizi selamladı.
    ...
    ***
1. Türkçede anlamına göre cümlede yüklem ...........-..................-................ şeklinde olabilir.<br />**Cümlesinde boş bırakılan yerlere aşağıdakilerden hangisi getirilmelidir?**
    - A-) Olumlu-Olumsuz-Devrik
    - B-) Olumsuz-Olumlu-Bileşik
    - **Cevap C-) Olumlu-Olumsuz-Soru**
    - D-) Olumlu-Olumsuz-Sıralı
    - E-) Olumlu-Olumsuz-Kurallı
    ***
1. **"Girişik, iç içe, şartlı" gibi ifadeler aşağıdakilerden hangisiyle birlikte kullanılır?**
    - **Cevap A-) Birleşik**
    - B-) Bağlı
    - C-) Basit
    - D-) Sıralı
    - E-) Devrik
    ***
1. Dün gece çok ağladım ama sesimi duyan olmadı.<br />**Verilen cümle aşağıdaki cümle çeşitlerinden hangisine örnektir?**
    - A-) Birleşik
    - B-) Sıralı
    - C-) Kurallı
    - **Cevap D-) Bağlı**
...
1. **‘’Çocuklar inanın, İnanın çocuklar.’’ cümlesinin özellikleri aşağıdaki seçeneklerden hangisinde doğru olarak verilmiştir?**
    ...
    ***
1. Türkçe, dünya dilleri arasında en sağlam matematiksel yapıya sahip dillerden biridir. Cümlede önce özne sonra nesne en son yüklem gelir.<br />**Paragrafta verilen bilgilerden hareketle aşağıdaki cümlelerden hangisi özne-nesne-yüklem şeklinde sıralanmamıştır?**
    - A-) Zayıflıklar insanı sıradanlaştırır.
    - **Cevap B-) Vedalaştık bir ikindi öncesi.**
    - C-) Sen de onu getir.
...
1. **Aşağıdaki cümlelerden hangisi yükleminin yerine göre diğerlerinden farklıdır?**
    ...
    - B-) Soğuk gelir pencereyi kapatmazsan.
    - C-) Kin güderler bize karşı.
    - D-) Nefret söylemi var dillerinde.
    - **Cevap E-) Yavaş adımlarla eve doğru yürüdüler.**
    ***
1. **Birbiriyle anlam bağlantısı olan en az iki yüklem ve bağlaçlarla kurulan cümle yapısına ne denir?**
    - A-) Sıralı
    - B-) Basit
    - **Cevap C-) Bağlı**
    - D-) Birleşik
    - E-) Girişik birleşik
    ***
1. **“Sora sora Bağdat bulunur.” cümlesinin özellikleri aşağıdakilerin hangisinde belirtilmiştir?**
    ...
    ***
1. **Aşağıdakilerden hangisi "olumlu, isim, kurallı, basit" cümle şeklindedir?**
...
1. **Aşağıdaki cümlelerden hangisi biçimce olumlu, anlamca olumsuz bir cümledir?**
    ...
    - B-) Fransız İhtilâli'nin çok uluslu devletler üzerinde olumsuz etkileri olmuştur.
    ...
    ***
1. Türk halk zekâsının ve halkın, olayları karikatürize etme gücünün büyük sanatlarından biri olan meddahlık, yüzyıllar boyu yaşamış, Türk halkı arasında çok ilgi görmüştür.<br />**Bu cümlenin özellikleri aşağıdakilerin hangisinde doğru sıralanmıştır?**
    ...
    ***
1. **Aşağıdakilerden hangisi cümleyi yapısına göre incelerken aranmaz?**
    - A-) Basit
    - **Cevap B-) Devrik**
    - C-) Birleşik
    - D-) Bağlı
