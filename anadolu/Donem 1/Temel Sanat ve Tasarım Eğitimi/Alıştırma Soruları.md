...
1. Aşağıdakilerden hangisi Arts and Crafts hareketi için söylenebilir?
    - A-) Elit sınıflar hitap eden yüksek estetik değerli işlevsel nesnelerin yapımı amaçlanmıştır.
    - **Cevap B-) Eleştirmen John Ruskin ve sanatçı William Morris’in üzerinde şekillenmiştir.**
    - C-) Art Nouveau hareketinden etkilenmiştir.
    - D-) Desen tekrarlı tasarım temel alınmıştır.
    - E-) XVIII. yüzyıl İngiltere’sinde ortaya çıkmıştır.

    > **Açıklama:** Yeni sanat biçimlerini doğuran sosyal, ekonomik ve teknolojik değişimlerin tarihindeki en açık örneklerden biri, 19. yüzyıl İngiltere’sindeki ‘Sanat ve zanaat’ orijinal ismi ile ‘Arts and Crafts’ hareketidir. Bu hareket eleştirmen John Ruskin ve sanatçı William Morris’in fikirleriyle şekillenmiştir. Arts and Crafts hareketinin üyeleri, kendilerini geniş halk kitleleri için yüksek estetik değeri olan işlevsel nesneler yapmaya adadılar. Genellikle çiçek veya geometrik desenlerin tekrarlanan tasarımlarından oluşan yapay formlardan ziyade doğal formlara dayalı bir stili savundular. Bu hareket zanaat için biçimsel güzelliği temel almakta ve zanaat ile sanatı bir arada icra etme girişi- mini gerçekleştirmektedir. Hareket kendinden sonra Art Nouveau gibi başka hareketleri de etkilemiş ve sanatın zanaatla iç içe geçişini fikirsel olarak desteklemiştir. Fakat sonraki başka akım ve hareketlerde sanat ve zanaat arasındaki ayrımın daha net yapıldığı ve el becerisi veya zanaat olmaksızın da sanat üretilebileceği fikri sanatçılar tarafından kabul görmeye başlamıştır.
...
1. Bir dönem içinde kalıplaşmış sanatsal kuralları ve anlayışları aşarak onları değiştirme amaçlı üretilen ve çoğu zaman kendi dönemlerinde ağır eleştirilere maruz kaldıktan sonra tarihsel süreçte kabul gören sanatsal hareketlere verilen genel isim aşağıdakilerden hangisidir?
    - **Cevap A-) Avangard Sanat**
    - B-) Sürrealist Sanat
    - C-) Yeni Sanat
    - D-) Fütürist Sanat
    - E-) Dadaist Sanat

    > **Açıklama:** SANAT TEORİLERİ VE TARTIŞMALAR<br />Avangart sanat tanımı bir dönem içinde kalıplaşmış sanatsal kuralları ve anlayışları aşarak onları değiştirme amaçlı üretilen ve çoğu zaman kendi dönemlerinde ağır eleştirilere maruz kaldıktan sonra tarihsel süreçte kabul gören sanatsal hareketlere verilen genel isimdir.

    <hr />
1. Bir nesnenin, kendine özgü niteliklerini tam ve açık bir biçimde söz, resim veya yazı ile anlatmaya ne denir?
    - **Cevap A-) Tasvir, betimlemek**
    - B-) Resmetmek
    - C-) Doğaçlamak
    - D-) Stilize etmek
    - E-) Deforme etmek

    > **Açıklama:** Tasvir, betimlemek<br />Tasvir kelimesi betimlemek kelimesiyle eş anlamlıdır. Her iki kelime de “Bir nesnenin, kendine özgü niteliklerini tam ve açık bir biçimde söz, resim veya yazı ile anlatmak” anlamını taşır.
...
1. Guernica adlı tablonun ressamı aşağıdakilerden hangisidir?
    ...
    > **Açıklama:** Guernica adlı tablonun ressamı Picasso'dur.

    <hr />
1. Güzel sanatları zanaat veya bilim gibi diğer insan faaliyetlerinden ve ürünlerinden ayıran, sanat yapıtlarının üretimini ve kullanımlarını modern anlamda betimleyecek, açıklayacak ve yorumlayacak sanatsal kavram ve diller ilk defa hangi yüzyılda ortaya çıkmıştır?
    - A-) XV. Yüzyıl
    - B-) XVI. Yüzyıl
    - C-) XVII. Yüzyıl
...
1. Sanat, bir insanın belirli dış işaretler aracılığıyla bilinçli olarak yaşadığı duyguları başkalarına aktarması ve başkalarına bulaşması ile oluşan bir insan etkinliğidir” tanımıyla sanat ve duygular ile onları deneyimlemek arasındaki ilişkiyi kuran sanatçı aşağıdakilerden hangisidir?
    ...
    > **Açıklama:** Dışavurum Olarak Sanat<br />Sanatın duyguların iletilmesi olduğunu öne süren Tolstoy, “Sanat, bir insanın belirli dış işaretler aracılığıyla bilinçli olarak yaşadığı duyguları başkalarına aktarması ve başkalarına bulaşması ile oluşan bir insan etkinliğidir” tanımıyla sanat ve duygular ile onları deneyimlemek arasındaki ilişkiyi kurmaktadır.
...
1. Sanatı, bir insanın belirli dış işaretler aracılığıyla bilinçli olarak yaşadığı duyguları başkalarına aktarması ve başkalarına bulaşması ile oluşan bir insan etkinliği olarak tanımlayan düşünür aşağıdakilerden hangisidir ?
    ...
    > **Açıklama:** Sanatı, bir insanın belirli dış işaretler aracılığıyla bilinçli olarak yaşadığı duyguları başkalarına aktarması ve başkalarına bulaşması ile oluşan bir insan etkinliği olarak tanımlayan düşünür Tolstoy'dur.
...
1. Temsil ve taklit yaklaşımında sanatın nesnelliği ile bilimin nesnelliği eş değer görülme eğilimindedir. Yirminci yüzyılın başlarında sanat felsefesi düşünsel olarak önemli bir devrime hazırlanmaktaydı. Bu süreçte temsil yaklaşımı yerini neye bırakmıştır?
    ...
    <hr />
1. Willem De Kooning’in temsil ettiği sanat akımı aşağıdakilerden hangisidir ?
    - A-) Kavramsalcılık
    - B-) Pop-art
    - C-) Dadaizm
...
1. Zanaatın ticari olduğu için alıcısına ve dolayısıyla pazara bağlılığından dolayı özgür olmadığı düşüncesi hangi filozofa aittir?
    ...
    > **Açıklama:** Sanat ve Zanaat Arasındaki Ayrım<br />Sanat Kant’a göre özgürdür fakat zanaat ise ticari olduğu için alıcısına ve dolayısıyla pazara bağlıdır ve özgür değildir.

    <hr />
1. Öz ve biçim hakkında, aşağıdaki tanımlamalardan hangisi yanlıştır?
    - A-) Öz ve biçim ilişkisi plastik sanatlarda bir sanatsal ürünün var olabilmesi adına ön koşuldur.
    - B-) Öz biçimden önce gelir ve biçim öze göre üretilir.
    - **Cevap C-) Öz kavramını içerik olarak tanımlamak mümkün değildir.**
...
1. "........................ , düşünceleri, kavramları temsil eden sembollerin belirli kural ve kodlara göre mesajlara dönüştürülmesi anlamına gelir" cümlesindeki boşluğa aşağıdakilerden hangisinin gelmesi doğru olur?
    ...
    > **Açıklama:** Sayfa 50'ye göre "İletişimde kodlama, düşünceleri, kavramları temsil eden sembollerin belirli kural ve kodlara göre mesajlara dönüştürülmesi anlamına gelir". Buna göre cevap b seçeneğidir.

    <hr />
1. "............................, yeni medya teknolojilerini kullanarak tasarımı birleştirerek kurgulayan iletişim ve etkileşimi sağlayan, kuran yaratıcı bir süreçtir" cümlesindeki boşluğa aşağıdakilerden hangisinin gelmesi doğru olur?
    - A-) İletişim Süreci
    - **Cevap B-) Görsel İletişim Tasarımı**
    - C-) İletişimde Kodlama
    - D-) Evrensel Tasarım
    - E-) Grafik Tasarımı
...
1. "...................................., tasarımınızdaki bir ögenin algılanan ağırlığıdır. Bir ögenin tasarımınızdaki diğer ögelerle karşılaştırıldığında ne kadar öne çıktığını ortaya koyan bir ölçüdür" cümlesindeki boşluğa aşağıdaki kavramlardan hangisi gelmelidir?
    - A-) Görsel hizalama
    - B-) Görsel denge
    - **Cevap C-) Görsel ağırlık**
    - D-) Görsel hiyerarşi
    - E-) Görsel hizalama

    > **Açıklama:** Sayfa 54'e göre "**Görsel ağırlık**, tasarımınızdaki bir ögenin algılanan ağırlığıdır. B**ir ögenin tasarımınızdaki diğer ögelerle karşılaştırıldığında ne kadar öne çıktığını ortaya koyan bir ölçüdür** ". Buna göre cevap c seçeneğidir.

    <hr />
1. Aşağıdakilerden hangisi grafik tasarımındaki kavramsal ögelerden biri **değildir?**
    - **Cevap A-) Yön**
    - B-) Hacim
    - C-) Düzlem
    - D-) Çizgi
    ...
    > **Açıklama:** * Kavramsal Ögeler: Nokta, Çizgi, Düzlem, Hacim<br />* Görsel Ögeler: Şekil, Boyut, Renk, Doku<br />* İlişkisel Ögeler: Yön, Konum, Boşluk, Ağırlık<br />* Uygulamalı Ögeler: Temsil, Anlam ve İşlev

    <hr />
1. Bireylerin bilişsel becerilerini sınıflandıran sisteme ne ad verilir?
    - **Cevap A-) Bloom Taksonomisi**
    - B-) Çoklu Zeka Kuramı
    - C-) Tam Öğrenme
    - D-) Yapılandırmacılık
    - E-) Küresel sistemin dijitalleştirilmesi

    > **Açıklama:** “Bloom Taksonomisi” bireylerin bilişsel becerilerini sınıflandıran bir sistemdir.

    <hr />
1. Aşağıdaki tanımlardan hangisi Temel tasarımı açıklar?
    - A-) Yeni medya teknolojilerini kullanarak tasarımı birleştirerek kurgulayan iletişim ve etkileşimi sağlayan, kuran yaratıcı bir süreçtir.
    - **Cevap B-) Araştırma, deneme, uygulama gibi süreçlerde mekanik olarak el ile yapılan somut tasarıma dayalı estetik amaçlı pratiklerdir.**
    - C-) Kullanıcıları anlamayı, varsayımlara meydan okumayı, sorunları yeniden tanımlamayı ve prototip ve test için yenilikçi çözümler yaratmayı amaçlayan doğrusal olmayan, yinelemeli bir süreçtir .
    - D-) İletişimci tarafından mesajın iletilmesi ile başlar ve alıcılar tarafından verilen geri bildirim ile sona eren bir süreçtir.
    - E-) Kullanıcı merkezli olan tasarım odaklı düşünme pratikleri aynı zamanda problem çözücü, yeniliği teşvik eden, öngörülü, ilerici bir bakış açısını gerektiren bir yaklaşım biçimidir.
    ...
    <hr />
1. Aşağıdakilerden hangisi Endüstriyel tasarımın tarihsel süreç içindeki gelişimlerinden biri olan De Stijl hareketini açıklar?
    - A-) Melez/Hybrit tasarımlar
    - B-) İçinde zanaat etkisini barındıran el becerisine dayalı üretim
    - C-) Açıklık ve şeffaflık, sanat, zanaat ve tasarım
    - D-) Yeni sanat anlayışı
    - **Cevap E-) Fonksiyonellik anlayışına dayalı fütürizmden etkilenen bir hareket**

    > **Açıklama:** De Stijl: Fonksiyonellik anlayışına dayalı fütürizmden etkilenen bir hareketdir.

    <hr />
1. Aşağıdakilerden hangisi grafik tasarımda görsel ögelerden biri **değildir**?
    - A-) Şekil
    - **Cevap B-) Çizgi**
    - C-) Renk
    - D-) Doku
...
1. Aşağıdakilerden hangisi moda tasarımını açıklar?
    ...
    - **Cevap E-) Sosyal, kültürel olgulardan etkilenerek zamana ve mekâna göre değişiklikler gösterir.**

    > **Açıklama:** Moda tasarımı, sosyal, kültürel olgulardan etkilenerek zamana ve mekâna göre değişiklikler gösterir.

    <hr />
1. Aşağıdakilerden hangisi tasarım kavramı için doğru bir ifade **değildir**?
    - A-) Tasarım, bir yapının fiziksel niteliklerini bütünleştiren yaratıcı, işlevsel bir süreçtir.
    - B-) Toplumun ihtiyaçlarına göre evrensel bir nitelik taşıma özelliğine sahiptir.
    - C-) Süreç olarak tasarım, teknoloji ve estetik arasındaki bilgi ve kaygılardan gerçekleştirilen özgün ve yaratıcı bir üründür.
    - **Cevap D-) Tasarım; bir model, kalıp ya da süsleme yapmaktır.**
    - E-) Tasarım süreci kullanıcıların ilgi, beğeni ve ihtiyaçları dikkate alınarak gerçekleştirilen inovatif bir pratiktir.

    > **Açıklama:** Tasarım; bir model, kalıp ya da süsleme yapmak değildir.
...
1. Aşağıdakilerden hangisi tasarım odaklı düşünme süreçlerinden biri **değildir**?
    ...
    > **Açıklama:** Sayfa 45'e göre "Tasarım düşüncesi doğrusal olmayan esnek ve akışkan bir sürecin karşılığıdır. Tasarım odaklı düşünme; “**Empati, Tanımlama, Fikir Edinme, Prototip Oluşturma ve Test Etme**” süreçlerinden oluşmaktadır". Buna göre cevap c seçeneğidir.

    <hr />
1. Aşağıdakilerden hangisi yeni medya teknolojilerinden biridir?
    - A-) Radyo
    - B-) Gazete
    - **Cevap C-) e-posta**
    - D-) Televizyon
    ...
    > **Açıklama:** Yeni medya teknolojilerinin, biçimlerinin sınır tanımadığı günümüzde iletişim araçlarıyla (e-posta, ins-tagram, whatsapp, facebook, vlog, blog, twitter ve skype, perculus, teams ve zoom gibi görüşme/top-lantı/paylaşım ve sunum programları) olağanüstü etkileyici bir süreç yaşanmaktadır.

    <hr />
1. Aşağıdakilerden hangisi yeni medyanın iletişim disiplinine **girmez?**
    - A-) Çoklu Medya
    - B-) Gazetecilik
    - **Cevap C-) Güzel Sanatlar**
    - D-) Ürün Modelleme
    - E-) Web Tasarımı Pazarlama

    > **Açıklama:** Güzel Sanatlar Sanat Alanları disiplinine aittir.

    <hr />
1. Bir duruma uyma konusunda organizmada bulunan ve doğuştan gelen güç, kapasite ile anlık gelişen doğal iş başarma yetkinliğine ne ad verilir?
    - A-) Deneyim
    - **Cevap B-) Yetenek**
    - C-) Alışkanlık
    - D-) Öğrenme
    ...
    <hr />
1. Bir nesnenin en, boy/yükseklik, derinlik ve hacminin algılanabilir olması aşağıdakilerden hangisi ile tanımlanır?
    - A-) Gölge
    - B-) 2 Boyut
    - C-) 4 Boyut
    - D-) Uzay
    ...
    > **Açıklama:** 3 Boyut: Bir nesnenin en, boy/yükseklik, derinlik ve hacminin algılanabilir olması durumudur.

    <hr />
1. Bireylerin bilişsel becerilerini sınıflandıran sistem aşağıdakilerden hangisiyle tanımlanmaktadır?
    - A-) İnovasyon
    - B-) Yetenek
    - **Cevap C-) Bloom Taksonomisi**
    - D-) Prototip
    - E-) Empati

    > **Açıklama:** Benjamin Bloom tarafından, kendi adıyla ifade edilen “Bloom Taksonomisi” bireylerin bilişsel becerilerini sınıflandıran bir sistemdir. Özellikle eleştirel ve yaratıcı düşünmeyi öncelemesi aşamalarının tasarım süreciyle ilişkili olabileceği düşüncesiyle konuya ilişkin kısa ön bilgilerin paylaşılmasının yararlı olduğu düşünülmektedir.

    <hr />
1. Endüstri sorunlarına çözüm arandığı bir dönemde, 1919’da, Alman mimar Walter Gropius tarafından kurulan sanat okulun adı aşağıdakilerden hangisidir?
    - A-) Art Nouveau
    - B-) De Stijl
    - **Cevap C-) Bauhaus**
    - D-) Art Deco
    ...
    > **Açıklama:** Sayfa 62'ye göre "Bauhaus, endüstri sorunlarına çözüm arandığı bir dönemde 1919’da Alman mimar Walter Gropius tarafından kurulmuştur." Buna göre cevap c seçeneğidir.

    <hr />
1. Fütürist mimariye ilişkin aşağıdaki ifadelerden hangisi **yanlıştır?**
    - A-) Doğa dostu bir anlayışa sahiptir.
    - B-) Dinamik, iddialı tasarımlardır.
    - C-) Hareket duygusu veren çizgileri vardır.
    - **Cevap D-) Geleneksellikten yanadır.**
    - E-) Yapısal özellikleri/formları doğaya uyumludur.

    > **Açıklama:** Sayfa 61'e göre "Fütürist mimaride “hareket” duygusu kazandıran, keskin kenarları olan girinti çıkıntılar, oval, geometrik hatlardan oluşan, **geleneksellik karşıtı** dinamik, iddialı tasarımlardır. Fütürist mimari, doğa dostu bir anlayışa sahiptir, yapısal özellikleri/formları doğaya uyumludur.". Buna göre d seçeneği yanlış olup, sorunun cevabıdır.

    <hr />
1. Grafik tasarım sürecinin aşamalarında aşağıdakilerden hangisi yer almamaktadır?
    - A-) Bilgi toplama
    - **Cevap B-) Lojistik**
    - C-) Yaratıcılık ve Buluş
    - D-) Problemin Tanımı
    - E-) Çözüm Bulma

    > **Açıklama:** Tasarım süreçleri: Farklı kaynaklarda birbirlerine çok benzemekle birlikte çeşitli aşamalardan oluştuğu sonucuna varabiliriz. Grafik tasarımının aşamalarına ilişkin, Problemin Tanımı • Bilgi toplama • Yaratıcılık ve Buluş Süreci • Çözüm Bulma • Uygulama dır.

    <hr />
1. I-Arka planda içeriğe uymayan müziği eklemekten kaçınılmalıdır.<br />II-Görseller ve anlatım kaynakları bir öğrenmeyi tanımlamalıdır<br />III-Dört kelimeden uzun ekran metni okunmamalıdır.<br />IV-Basit dekoratif ögelerden kaçınılmalıdır.<br />Etkili bir video tasarımına ilişkin yukarıdaki ifadelerden hangileri doğrudur?
    - A-) I, II
    - B-) I, III
    - C-) I, II, III
    - D-) I, II, IV
    ...
    > **Açıklama:** Sayfa 56'ya göre "Etkili bir video tasarımında gözetilecek noktalardan bazıları aşağıdaki şekliyle sadeleştirilerek özetlenmiştir (Fyfield., Henderson vd., 2019: 419):<br />• Ses net olmalı, rahatsız edici harici seslerden arındırılmalıdır.<br />• **Arka planda içeriğe uymayan müziği eklemekten kaçınılmalıdır.**<br />• İlginç olabilir ancak gereksiz görüntüleri dahil etmekten kaçınılmalıdır.<br />• **Dört kelimeden uzun ekran metni okunmamalıdır.** <br />• **Görseller ve anlatım kaynakları bir öğrenmeyi tanımlamalıdır**.<br />• Animasyon stili, içeriğe göre yönlendirilmelidir.<br />• **Basit dekoratif ögelerden kaçınılmalıdır. "**<br />Buna göre verilen öncüllerin hepsi doğrudur. Cevap E seçeneği.

    <hr />
1. I-Nokta<br />II-Çizgi<br />III-Doku<br />IV-Hacim<br />Yukarıdakilerden hangileri grafik tasarımında kavramsal ögelerden biridir?
    - A-) I ve II
    - B-) I ve III
    - C-) I, II, III
    - **Cevap D-) I, II, IV**
    ...
    > **Açıklama:** Sayfa 53'e "......Buna göre grafik tasarımında ögeler üç kısımda incelenir<br />• Kavramsal Ögeler: **Nokta, Çizgi,** Düzlem, **Hacim.**"<br />Bu nedenle cevap d seçeneğidir.

    <hr />
1. Kullanıcıları anlama, varsayımları sorgulama, sorunları yeniden tanımlama ve prototip geliştirme ile test etme aşamalarında yenilikçi çözümler üretmeyi hedefleyen doğrusal olmayan ve yinelemeli tasarım süreci aşağıdakilerden hangisiyle tanımlanmaktadır?
    - A-) Çerçeveli düşünme
    - **Cevap B-) Tasarım odaklı düşünme**
    - C-) Kararlı düşünme
    - D-) Zihinsel Düşünme
...
1. Mesajın alıcıya iletilmesi yöntemine ne ad verilir?
    ...
    > **Açıklama:** İletişim kanalı, mesajın alıcıya iletilmesi veya iletilmesi yöntemidir.

    <hr />
1. Sanat yapıtının yapısındaki yasallıkları, sanatçının düşünüş biçimi, anlayış, algı ve ifade tarzları anlamında kullanılan bir kavrama ne ad verilir?
    - A-) Kültür ve Entelektüel Kavramı
    - B-) Estetik deneyim
    - **Cevap C-) Sanatsal Üslup**
    - D-) Endüstriyel tasarım
    - E-) Mimari tasarım

    > **Açıklama:** Sanatsal üslup kavramı, sanat yapıtının yapısındaki yasallıkları, sanatçının düşünüş biçimi, anlayış, algı ve ifade tarzları anlamında kullanılan bir kavramdır.
...
1. Tasarım odaklı düşünme sürecinde aşağıdakilerden hangisi yer alması gerekmektedir?
    ...
    > **Açıklama:** Tasarım odaklı düşünme; “Empati, Tanımlama, Fikir Edinme, Prototip Oluşturma ve Test Etme” süreçlerinden oluşmaktadır. Tasarımda problem çözme süreci yaratıcı düşünmeyi içerir. Tasarımda merak ve empati duygusu müşterilerin ihtiyaçlarına odaklanmayı ifade eder. Bu yaklaşım soruna daha geniş bir perspektiften bakma açısından bütüncül bir yaklaşım olarak da düşünülebilir. Bu açıdan, kullanıcıların ve tasarımcıların ortak bir paydada buluşmasında “empati” kavramı hayati bir rol oynar.

    <hr />
1. Video tasarımı hangi tasarımlarda yaygın olarak kullanılır?
    - A-) Çevrenin/ekosistemin sürdürülebilir tasarımda
    - B-) Moda tasarımında
    - C-) Mimari tasarımda
    - **Cevap D-) Eğitim ve iletişim tasarımında**
    - E-) Görsel tasarımda

    > **Açıklama:** Video tasarımı; eğitim ve iletişim tasarımında yaygın olarak kullanılmaktadır.

    <hr />
1. Yeni bir ürün oluşturmak amacıyla zihinde canlandırılarak gerçekleştirilen, biçimsel estetik problemleri araştırma ve çözme eylemi aşağıdakilerden hangisi ile tanımlanır?
    - **Cevap A-) Tasarım**
    - B-) Buluş
    - C-) Yenilik
    - D-) Eskiz
...
1. Yeni medya teknolojilerini kullanarak, tasarımı birleştirerek kurgulayan iletişim ve etkileşimi sağlayan, kuran yaratıcı bir süreç aşağıdakilerden hangisi ile tanımlanır?
    - **Cevap A-) Görsel iletişim tasarımı**
    - B-) Sayısal dünya
    - C-) VR tasarımı
    - D-) 3D tasarım
    - E-) 2D tasarım
...
1. İletişim sürecinde mesajın alıcıya ulaşılmasından sonra kaynağa, yani göndericiye ulaşan tepkilere ne ad verilmektedir?
    ...
    > **Açıklama:** Sayfa 49'a göre "Geribildirim: Mesajın alıcıya ulaşılmasından sonra kaynağa, yani göndericiye ulaşan tepkilerdir". Buna göre cevap e seçeneğidir.

    <hr />
1. İnsanların karşılıklı olarak sözel veya görsel (sembolik) araçlar vasıtasıyla birbirlerini anlamalarını sağlayan süreç aşağıdakilerden hangisiyle tanımlanmaktadır?
    - **Cevap A-) İletişim**
    - B-) Medya
    - C-) Yeni medya
    - D-) Sosyalleşme
...
1. "Hançerlioğlu'na göre imgeler, duyusal imgeler ve ............ imgeler olmak üzere iki türlüdür. Duyusal imgeler duyumlar, algılar ve tasarımlardır; ............ imgeler ise kavramlar, önermeler, kuramlar ve varsayımlardır." cümlesinde boş bırakılan yerlere aşağıdakilerden hangisi gelmelidir?
    ...
    > **Açıklama:** Hançerlioğlu’na (1989) göre imgeler, duyusal imgeler ve ussal imgeler<br />olmak üzere iki türlüdür. Duyusal imgeler duyumlar,<br />algılar ve tasarımlardır; ussal imgelerse kavramlar,<br />önermeler, kuramlar ve varsayımlardır.
...
1. "Yunanca öyküleştirme anlamına gelen .............. İsa’dan bin yıl kadar önce Homeros (İlyada Destanı) ile başladığını söyleyebiliriz." Cümlesinde boşluğa aşağıdakilerden hangisi gelmelidir?
    ...
    > **Açıklama:** Mitoloji<br />Mitoloji, evrenin doğasını ve yaratılışını, inanç<br />ve kültürleri ve daha genel bir anlamda mitleri araştıran,<br />inceleyen söylencelerin tümünü kapsayan bir<br />alandır. Yunanca öyküleştirme anlamına gelen mitoloji<br />İsa’dan bin yıl kadar önce Homeros (İlyada<br />Destanı) ile başladığını söyleyebiliriz.
...
1. "Kamufle edildiğinde veya kısmen gizlendiğinde ayrı formları ayırt etme"<br />Yukarıdaki ifade aşağıdakilerden hangisi ile ifade edilmektedir?
    - **Cevap A-) Görsel Şekil/Zemin**
    - B-) Görsel Kapanma
    - C-) Görsel Ayrımcılık
    - D-) Görsel Algı
    - E-) Görsel Hafıza

    > **Açıklama:** Görsel şekil/zemin: Kamufle edildiğinde veya kısmen gizlendiğinde ayrı formları ayırt etme yeteneği. <br />Görsel Şekil/Zemin

    <hr />
1. Görme engellendiğinde iki ila yedi ögeyi sırayla hatırlama yeteneği aşağıdakilerden hangisi ile ifade edilmektedir?
    - **Cevap A-) Görsel Sıralı Bellek**
    - B-) Görsel Şekil
    - C-) Görsel Kapanma
    - D-) Görsel Algı
    - E-) Görsel Hafıza

    > **Açıklama:** * Görsel sıralı bellek: Görme engellendiğinde iki ila yedi ögeyi sırayla hatırlama yeteneği.<br />Görsel Sıralı Bellek
...
1. Gözümüze giren ışık yoluyla beynin görsel uyaranları alma, yorumlama ve bunlara göre hareket etme yeteneği aşağıdakilerden hangisini tanımlamaktadır?
    ...
    > **Açıklama:** Görsel algı, gözümüze giren ışık yoluyla beynin görsel uyaranları alma, yorumlama ve bunlara göre hareket etme yeteneğidir. Algı, aşağıdaki yedi unsura dayanmaktadır (Schriber, 2004). <br />Görsel Algı

    <hr />
1. Aşağıdakilerden hangisi *sezgisel tasarımın* özellikleri içinde yer almaz?
    - A-) Gereksiz tekrar veya etkileşim yoktur.
    - **Cevap B-) Zor keşfedilebilir ve kullanıcı katılımını teşvik etmez.**
    - C-) Sezgisel tasarım tahmin edilebilir.
    - D-) Geri bildirim anında ve nettir.
    - E-) Sezgisel tasarım fark edilemez.

    > **Açıklama:** * Sezgisel bir tasarım birçok özelliği kapsar, bunlar: • Gereksiz tekrar veya etkileşim yoktur. **• Kolayca keşfedilebilir ve kullanıcı katılımını teşvik eder.** • Sezgisel tasarım tahmin edilebilir - eylemler her zaman amaçlanan sonuçları veya sonuçları sağlar. • Geri bildirim anında ve nettir. • Sezgisel tasarım fark edilemez. • Sezgisel tasarım, kullanıcıları kazanmanıza ve elde tutmanıza yardımcı olabilir. Sezgisel bir tasarım, tüketici tercihi adına çok az çaba gerektirir. Keşfedilebilirlik, elde edilebilirlik, anlaşılabilirlik, duyarlı geri bildirim, öngörülebilirlik, verimlilik gibi kavramlar sezgisel tasarım sonuçlarının önemli göstergeleri arasında yer almaktadır. Dolayısıyla sezgisel tasarım, içgüdüler ve geçmiş bilgilerle oluşturulmuş bir tasarım olarak tanımlanabilir.

    <hr />
1. Aşağıdakilerden hangisi figür içermeyen resimlerin de birer sanat eseri olabileceğini kanıtlayan sanatçılardandır?
    ...
    > **Açıklama:** Günümüzde çağdaş sanat, teknik beceriye dayalı, temsili figüratif resme duyulan hayranlığın sonunu getirerek sanatın sınırları olmayan özgür, disiplinler arası soyut bir anlatım dilinin kapılarını açmıştır. Bu bağlamda Jackson Pollock, Pablo Picasso, Vassily Kandinsky ve **Piet Mondrian** figür içermeyen resimlerinde birer sanat eseri olabileceğini kanıtlayan sanatçılar olarak düşünülebilir.
...
1. Aşağıdakilerden hangisi görsel düşünmeyi kullanmanın yararları içinde yer almaz
    ...
    > **Açıklama:** Görsel düşünmeyi kullanmanın yararları aşağıda belirlenmiştir .<br />• Hafızayı, dikkati ve özellikle konsantrasyonu geliştirir. • Fikirleri mantıklı bir şekilde sıralamaya ve düzenlemeye yardımcı olur. • Bilgileri **küresel bir bakış açısıyla** görmemizi sağlar. • İletişimi ve katılımı artırır. • Yaratıcılığı, kıvılcımları, merakı ve yeniliği geliştirmeye yardımcı olur. • Düşünme becerilerini güçlendirir. • Karmaşık kavramları görsel olarak anlaşılır bir şekilde basitleştirerek öğrenmeyi kolaylaştırır.
...
1. Aşağıdakilerden hangisi mantıksal/muhakeme tabanlı bir düşünce biçimi olup, bir problemi veya sorunu küçük parçalara ayırarak alt başlıklar halinde karmaşık durumları değerlendirme ve çözüme ulaştırma yaklaşımıdır?
    - A-) Yanal düşünme
    - B-) Yaratıcı düşünme
    - **Cevap C-) Analitik düşünce**
    - D-) Dikey düşünme
    - E-) Yakınsak düşünme

    > **Açıklama:** Analitik düşünce mantıksal/muhakeme tabanlı<br />bir düşünce biçimidir. Bir problemi veya sorunu<br />küçük parçalara ayırıp, alt başlıklar hâlinde karmaşık<br />durumları değerlendirme ve çözüme ulaştırma<br />yaklaşımıdır. Sorunlar analiz edilir, sınıflandırılır,<br />sadeleştirilir, küçük parçalardan bütüne ulaşılır.
...
1. Aşağıdakilerden hangisi metafor ve metonim arasındaki farklılıklar açısından bakıldığında metafor kavramı ile ilişkilidir?
    - A-) Fikirleri birleştirerek hareket etmesidir.
    - B-) Olay ve olguların yerleri değişebilir.
    - C-) Fikirler yer değiştirilir.
    - D-) Karşılaştırma ilişkilendirmeye dayalıdır.
    - **Cevap E-) Bir olayın/olgunun ifade biçimidir.**

    > **Açıklama:** Tablo 3.2 Metafor ve metonim arasındaki farklılıklar<br />Bir olayın/olgunun ifade biçimidir.

    <hr />
1. Aşağıdakilerden hangisi metafora ait bir özelliktir?
    - **Cevap A-) Bir olayın/olgunun ifade biçimidir.**
    - B-) Bir konuşma şeklidir.
    - C-) Çağrışım odaklıdır.
    - D-) Olay ve olguların yerleri değişebilir.
    - E-) Karşılaştırma ilişkilendirmeye dayalıdır.

    > **Açıklama:** Tablo 3.2 Metafor ve metonim arasındaki farklılıklar <br />|  |<br />| --- |<br />| Metafor |&lt;td style="border-style: solid; background-color: rgb(63.140000%, 4.920000%, 21.320000%); border<br />Bir olayın/olgunun ifade biçimidir.
...
1. Aşağıdakilerden hangisi metonominin bir özelliğidir?
    ...
    > **Açıklama:** Tablo 3.2 Metafor ve metonim arasındaki farklılıklar <br />|  |<br />| --- |<br />| Metafor |&lt;td style="border-style: solid; background-color: rgb(63.140000%, 4.920000%, 21.320000%); border<br />Çağrışım odaklıdır.
...
1. Aşağıdakilerden hangisi semiyolojinin başka bir ifade edilişidir?
    ...
    > **Açıklama:** Gösterge, bireyin kendisinin dışındaki görün- gülerdir. Bunlar her türlü olguların, varlıkların ve kavramların ilişkisel bağlamdaki görüntüleri olabilir. Gösterge bilim (semiyoloji) ise göstergelerin üretilmesini, yorumlanmasını ya da imleri/işaretleri kavrama, anlama süreçlerini kapsayan ve buna benzer bütün faktörlerin organize bir biçimde ince- lenmesine dayalı bir alan olup dil biliminin önemli bir parçasıdır. <br />Göstergebilim

    <hr />
1. Aşağıdakilerden hangisi “bir şekli diğerinden ayırt etme yeteneği" olarak adlandırılır?
    - **Cevap A-) Görsel ayrımcılık**
    - B-) Görsel hafıza
    - C-) Görsel-mekânsal ilişkiler
    - D-) Görsel form sabitliği
    - E-) Görsel sıralı bellek

    > **Açıklama:** **Görsel ayrımcılık: Bir şekli diğerinden ayırt etme yeteneği.** Görsel hafıza: Görsel alanınızdan çıkarıldığında belirli bir formu hatırlama yeteneği. • Görsel-mekânsal ilişkiler: Aynı olan ancak farklı bir uzamsal yönlerde/alanlarda olabilen formları tanıma yeteneği. • Görsel form sabitliği: Boyut, renk veya uzamsal yönelim açısından farklı olabilecek benzer formları ayırt etme ve benzer formları tutarlı bir şekilde eşleştirme yeteneği. • Görsel sıralı bellek: Görme engellendiğinde iki ila yedi ögeyi sırayla hatırlama yeteneği. • Görsel şekil/zemin: Kamufle edildiğinde veya kısmen gizlendiğinde ayrı formları ayırt etme yeteneği. • Görsel kapatma: Kısmen tamamlanmış formları tanıma yeteneği.

    <hr />
1. Aşağıdakilerden hangisi “masallara" ilişkin karakteristik bir özelliktir?
    - A-) Belirli bir inanç sistemi içinde ritüeller barındırır.
    - B-) Kutsallık, erişilmezlik ve inanılırlık atfedilir.
    - C-) Ezici, doğaüstü bir güç kült/tapınma etkisi yaratır.
    - D-) Suretler tam olarak insan veya kozmik bir varlığa benzemez.
    - **Cevap E-) Neredeyse her zaman açık bir ahlaki mesajla biter.**

    > **Açıklama:** Mitler, kutsallık, olağandışılık üzerine bina edilen bir yaradılış öyküsüdür. Mit ancak gerçek[1]ten olup bitmiş, tam anlamıyla ortaya çıkmış olan şeyden söz eder. Mitlerdeki kişiler doğaüstü varlık[1]lardır. Sonuç olarak, mitler, kutsal(ya da doğaüstü) olan şeyin, dünyaya çeşitli, kimi zaman da heyecan verici akınlarını betimlerlerMitler dünyanın başlangıcı, dünyanın sonu ya da ölüm, cennet, cehennem gibi durumlarla ilgilendikleri için, insanların asla “kendileri için göremeyecekleri” şeyleri tanımlamaya muktedirdirler. Mitler gibi masallar da olağanüstü varlık ve olaylar sunar. **Mitlerin aksine, masallar neredeyse her zaman açık bir ahlaki mesajla biter ve bu, masalların karakteristik özelliğini vurgular.**

    <hr />
1. Bir konuşma şekli olan, fikirleri birleştiren ve yerlerini değiştiren, karşılaştırmada ilişkilendirmeye dayanan anlatım biçimi aşağıdakilerden hangisidir?
    - **Cevap A-) Metonomi**
    - B-) Metafor
    - C-) İşaret
    - D-) Masal
    ...
    > **Açıklama:** Bakınız, Tablo 3.2 Metafor ve metonim arasındaki farklılıklar <br />Metonomi
...
1. Bir toplumun duygu ve düşünce birliğini oluşturan, gelenek, örf/adet gibi olgu ve yaşanmışlıklara dayalı, ritüeller ve her türlü yaşayış, düşünce ve sanat varlıklarının tümüne ne ad verilir?
    ...
    > **Açıklama:** Kültür, bir toplumun duygu ve düşünce<br />birliğini oluşturan, gelenek, örf/adet gibi<br />olgu ve yaşanmışlıklara dayalı, ritüeller ve<br />her türlü yaşayış, düşünce ve sanat varlıklarının<br />tümü.

    <hr />
1. Edward De Bono tarafından geliştirilen, yaratıcı düşünme eylemiyle önemli paralellikler gösteren ve yeni fikirlerin üretilmesiyle ilgili düşünme türü aşağıdakilerden hangisidir?
    - A-) Analitik düşünce
    - **Cevap B-) Yanal düşünme**
    - C-) Yakınsak düşünme
    - D-) Iraksak düşünme
    - E-) Dikey düşünme

    > **Açıklama:** Yanal düşünme (lateral düşünme), Edward De Bono tarafından 1973 yılında geliştirilen bir kavramdır. Yanal düşünme, yaratıcı düşünme eylemiyle önemli paralellik gösterir Yanal düşünme, yeni fikirlerin üretilmesiyle ilgilidir. Eski fikirlerden kurtuluş ve yeni fikirlerin teşvik edilmesi, yanal düşünmenin ikiz yönleridir.

    <hr />
1. Edward De Bono'nun geliştirdiği Altı Şapkalı Düşünme Modelinde Yeşil Şapka neyi temsil etmektedir?
    - A-) Duyguların, sezgilerin, önsezilerin özgürce ifade edilmesini sağlar.
    - **Cevap B-) Yaratıcılığa odaklanır.**
    - C-) Kontrol/disiplin şapkasıdır ve düşünme sürecinin yönetimi ile ilgilidir.
    ...
    > **Açıklama:** Beyaz Şapka, bilgiye özel bir odaklanmayı<br />gerektirir, tarafsız ve objektif, gerçekçi bir bakış<br />açısını temsil eder. Kırmızı Şapka,duyguların,<br />sezgilerin, önsezilerin özgürce ifade edilmesini<br />sağlar. Yeşil Şapka, yaratıcılığa odaklanır. Olasılıkların,<br />kavramların, alternatiflerin ve yeni fikirlerin<br />üretildiği bir aksiyon şapkasıdır. Mavi<br />Şapka, kontrol/disiplin şapkasıdır ve düşünme<br />sürecinin yönetimi ile ilgilidir. Sarı Şapka, canlılığı,<br />parlaklığı ve iyimserliği simgelemektedir.<br />Bu şapkanın altında pozitifleri keşfediyor, değer<br />ve faydayı araştırıyorsunuz. Siyah Şapka, sorunlara<br />işaret eder. Dikkatli olmak içindir ve tehlikeli,<br />zarar verici veya işe yaramaz şeyler yapmanızı<br />engeller.
...
1. Genellikle kökeni bilinmeyen ve kısmen geleneksel olan, gerçek olaylarla ilişkilendirilen doğaüstü güçlerle ve özellikle dini inançlarla, insanların ve Dünya’nın yaratılışıyla bağlantılı olan sembolik anlatılara ne ad verilir.
    ...
    > **Açıklama:** Mit, genellikle kökeni bilinmeyen ve kısmen<br />geleneksel olan, gerçek olaylarla ilişkilendirilen<br />doğaüstü güçlerle ve özellikle dinî inançlarla, insanların<br />ve Dünya’nın yaratılışıyla bağlantılı olan<br />sembolik bir anlatı.

    <hr />
1. Görmek ile ilgili olarak aşağıdakilerden hangisi yanlıştır?
    - A-) Aynı zamanda bir olay veya olguya/nesneye odaklanmak, anlamak ve duyumsamaktır, sezmektir.
    - B-) Büyük ölçüde çaba gerektiren öğrenilebilir bir davranıştır.
    - C-) Her insanın görme biçimi farklıdır.
    - **Cevap D-) Görme eyleminde bir seçicilik yoktur.**
    - E-) Görmekte bilinç vardır.

    > **Açıklama:** Görmek, büyük ölçüde çaba gerektiren öğrenilebilir bir davranıştır. Görmek, aynı zamanda bir olay veya olguya/nesneye odaklanmak, anlamak ve duyumsamaktır, sezmektir. Görme eyleminde bir seçicilik vardır. <br />Görme eyleminde bir seçicilik olduğu için "Görme eyleminde bir seçicilik yoktur." ifadesi yanlıştır.
...
1. Gözümüze giren ışık yoluyla beynin görsel uyaranları alma, yorumlama ve bunlara göre hareket etme yeteneğine ne ad verilir?
    ...
    > **Açıklama:** Görsel algı, gözümüze giren ışık yoluyla<br />beynin görsel uyaranları alma, yorumlama<br />ve bunlara göre hareket etme yeteneğidir.<br />Algı, aşağıdaki yedi unsura dayanmaktadır<br />(Schriber, 2004).

    <hr />
1. I.Müşahhas<br />II.Varlığı duyularla algılanamayan<br />III.Mücerret<br />IV. Abstre<br />Yukarıdakilerden hangisi /hangileri soyut kavramını tanımlar?
    - A-) Yalnız I
    - B-) Yalnız II
    - C-) I,II
    - D-) I,II,III
    ...
    > **Açıklama:** Kavram: Türk Dil Kurumu Sözlüğü’ne göre kavram, bir düşüncenin, nesnenin, duygunun zihindeki soyut ve genel bir tasarımıdır. Somut kavramı, “Varlığı duyularla algılanabilen, müşahhas, soyut karşıtı” olarak, soyut kavramı ise “Varlığı duyularla algılanamayan, mücerret, somut karşıtı, abstre” şeklinde tanımlanmıştır.

    <hr />
1. Metoniminin özelliklerinden hangisi aşağıda doğru olarak verilmiştir?
    - A-) Bir olayın/olgunun ifade biçimidir.
    - B-) İkame (yerine geçme) ve bir ifade edilene odaklanır.
    - C-) Olgu ve olayların özüne yoğunlaşılır.
    - D-) Karşılaştırma benzerliklere dayalıdır.
    - **Cevap E-) Çağrışım odaklıdır.**

    > **Açıklama:** **Metafor ve metonim arasındaki farklılıklar**<br />**Metafor**  **Metonomi**<br />Bir olayın/olgunun ifade biçimidir. Metonomi bir konuşma şeklidir.<br />İkame (yerine geçme) ve bir ifade edilene odaklanır**. Çağrışım odaklıdır.**<br />Olgu ve olayların özüne yoğunlaşılır. Olay ve olguların yerleri değişebilir.<br />Fikirleri bastırarak hareket eder. Fikirler birleştirilir, yer değiştirilir.<br />Karşılaştırma benzerliklere dayalıdır. Karşılaştırma ilişkilendirmeye dayalıdır
...
1. “Bu bir pipo değildir" adlı çalışmasında dil ve imge arasındaki kanıksanmış, geleneksel ilişkiyi kırmayı hedeflemiş olan sanatçı aşağıdakilerden hangisidir?
    ...
    > **Açıklama:** Magritte, özellikle bu çalışmasıyla (Görsel 3.5)<br />“İmgelerin İhaneti” adlı çalışmasında dil ve imge<br />arasındaki kanıksanmış, geleneksel ilişkiyi kırmayı<br />hedeflemiştir. Bu resimde; gerçekçi bir şekilde ifade<br />edilen pipo, aslında pipo olmayıp pipo imgesini<br />yansıtmaktadır.<br />Rene Magritte

    <hr />
1. …………..………….. temsil niteliği tam olarak yorumlayanına bağlı olan göstergedir.<br />Yukarıdaki cümlede boş bırakılan yeri aşağıdakilerden hangisi doğru tamamlar?
    - A-) İkon:
    - B-) Belirti:
    - **Cevap C-) Sembol:**
    - D-) Semantik:
...
1. "Görsel düşünme" ve "görsel algı"nın aynı anlamda olduğunu savunan düşünür aşağıdakilerden hangisidir?
    ...
    > **Açıklama:** Arnheim terim olarak “bilişsel”in ve “bilme yetisi”nin anlamına algıyı dahil etmeyi önerir. Algısal süreçlerin yaşandığı anı “düşünme” olarak ifade eder ve “görsel algı” ile “görsel düşünme”nin aynı anlamda olduğunu belirtir.

    <hr />
1. **Aşağıdaki ifadelerden hangisi, bitmap grafiklerin özelliklerinden biri değildir?**
    - A-) Pixel yazılımlara sahiptirler.
    - **Cevap B-) Yeniden boyutlandırıldıklarında keskin kenar görüntülerini korurlar.**
    - C-) Fotoğraflar üzerinde çalışmaya uygun koşullar sağlarlar.
    - D-) Çoklu renk ve geçiş seçenekleri oluşturabilirler.
    - E-) Bitmap grafikleri noktalardan oluşur.

    > **Açıklama:** Bitmap grafikler büyütüldükçe bu noktalar görülmeye başladığı için netlik kaybo­lur. *Vektör* grafikler ise piksellerden oluşmadığı için herhangi bir büyütme işleminde bozulma yaşan­maz.
...
1. Aşağıdaki şıklardan hangisi Marker kalemin özelliklerinden birisidir?
    ...
    > **Açıklama:** Markerlar şeffaf bir boya olduğu için arka plandan ön plana doğru, açık renklerin üzerine koyu renklerin girilmesiyle sulu boya tekniğine benzer bir şekilde aşamalı olarak kullanılır (Parramón, 2012, s. 88).<br />Şeffaf bir boya olduğu için arka plandan ön plana doğru, açık renklerin üzerine koyu renklerin girilmesiyle sulu boya tekniğine benzer bir şekilde aşamalı olarak kullanılabilmesi.

    <hr />
1. Aşağıdaki şıklardan hangisi grafik tasarımında sık rastlanan Mondrian taslağını tanımlar?
    - A-) Harflerle bir tür bulmaca gibi oynanan bir görsel oyuna benzetilen tasarım türü.
    - **Cevap B-) Ressamın adını taşıyan onun kare ve dikdörtgen biçimlerine dayalı kompozisyonun oluştuğu tipografiyle birlikte görsel unsurların da vurgulandığı tasarım türüdür.**
    - C-) Yazının dışında hiç bir görsel imgenin yer almadığı tasarım türü.
    ...
    > **Açıklama:** Grafik tasarımında en sık rastlanan taslak türü, ressamın adını taşıyan onun kare ve dikdörtgen biçimlerine dayalı kompozisyonun oluştuğu tipografiyle birlikte görsel unsurların da vurgulandığı Mondrian taslaklarıdır.<br />Ressamın adını taşıyan onun kare ve dikdörtgen biçimlerine dayalı kompozisyonun oluştuğu tipografiyle birlikte görsel unsurların da vurgulandığı tasarım türüdür.
...
1. Farklı ağaç türlerinden (huş, kavak, çam, kayın vb.) elde edilen ağaç tabakalarının birleştirilmesiyle üretilen malzeme aşağıdakilerden hangisidir?
    ...
    > **Açıklama:** Bir diğer taraftan farklı ağaç türlerinden (huş, kavak, çam, kayın vb.) üretilebilen kontrplak ise ağaç tabakalarının birleştirilmesiyle oluşur. Kalınlıkları 6 mm ile 30 mm arasında değişir.<br />Kontraplak

    <hr />
1. Grafik tasarımında en sık rastlanan, ünlü ressamın adını taşıyan taslak türü aşağıdakilerden hangisidir?
    - A-) Dali
    - **Cevap B-) Mondrian**
    - C-) Munch
    - D-) Goya
    ...
    <hr />
1. Kâğıt, kumaş parçaları, fotoğraf ve farklı çeşitlikte malzemelerin kesilip yapıştırılarak bir araya getirilmesiyle oluşturulan görüntü tekniği aşağıdaki ifadelerden hangisidir?
    - A-) Serigrafi
    - B-) Gravür
    - C-) Litografi
    - D-) Mono tip
    ...
    > **Açıklama:** Kolaj, kâğıt, kumaş parçaları, fotoğraf ve farklı çeşitlikte malzemelerin kesilip yapıştırılarak bir araya getirilmesiyle oluşturulan bir görüntü tekniğidir.
...
1. Matematiksel formüllerle tanımlanan, çok sayıda farklı ve özgün nesneden oluşan, büyütülebilir ve küçültülebilir görüntüye ne ad verilir?
    ...
    <hr />
1. Postmodern sanat kapsamında kolaj temelinde gelişen uygulama aşağıdaki ifadelerden hangisidir?
    - A-) Serigrafi
    - B-) Asamblaj
    - C-) İllüstrasyon
    - **Cevap D-) Enstelasyon**
    ...
    <hr />
1. Sanat ve tasarım geliştirmek amacıyla yapılan ön çizimler veya taslak çizimlere verilen ad aşağıdakilerden hangisidir?
    - A-) İllüstrasyon
    - B-) Kolaj
    - C-) Efemera
    - D-) Tipografi
    ...
    <hr />
1. Sanat ve tasarım geliştirmek için yapılan ön çizimler veya taslak çizimlere ne ad verilir.
    - **Cevap A-) Eskiz**
    - B-) Görsel notlar
    - C-) Karalamalar
    - D-) İllüstrasyon
...
1. Saydam bir rengi diğer renkle kapatmanın mümkün olmadığı teknik aşağıdaki ifadelerden hangisidir?
    ...
    > **Açıklama:** Sulu boya çabuk çalışmayı gerektiren, transparan (saydam) bir rengi diğer renkle kapatmanın mümkün olmadığı bir tekniktir. Saydam olması nedeniyle sarı üzerine kırmızı boya sürüldüğünde sarı renk kaybolmaz ancak turuncu renge dönüşür..
...
1. Saydam olmayan boyalarla yapılan, bitkisel kökenli zamk ile su karışımının bağlayıcı olarak kullanılan, su bazlı olmasına rağmen kapatıcılığı belirgin boya türü aşağıdakilerden hangisidir?
    ...
    > **Açıklama:** “Guaj saydam olmayan boyalarla yapılan, bitkisel kökenli zamk ile su karışımının bağlayıcı olarak kullanıldığı bir boya türüdür” (Yılmaz, 2007, s. 47).<br />Guaj boya

    <hr />
1. Ses ve kamera hareketlerinin çekim öncesinde belirlendiği taslak çizimlere verilen ad aşağıdaki ifadelerden hangisidir?
    - A-) Ayrıntılı taslaklar
    - **Cevap B-) Storyboard**
    - C-) Sirk taslaklar
    - D-) Rebus taslaklar
    - E-) Çerçeve taslaklar

    > **Açıklama:** Sinema sanatında ilk yıllarda genellikle kâğıda taslak çizimlerle doğaçlama olarak üretilen görüntüler ilerleyen yıllarda görüntüyü oluşturan karelerin, ses ve kamera hareketlerinin çekim öncesinde belirlendiği taslak çizimlere dönüşmüştür.
...
1. İlk olarak Doğu’da Çin’de kaligrafi kullanımından kaynaklanan özelliği ile öne çıkan ve sonrasında dünyadaki kullanımı yaygınlaşan baskı türü aşağıdakilerden hangisidir?
    - A-) Serigrafi
    - B-) Çukur baskı
    - **Cevap C-) Ahşap/Tahta baskı (ağaç baskı)**
...
1. "............., kompozisyonda uzak yakın izlenimini yaratarak ögelerin birbiriyle ilişkisi üzerinden oluşan mekânda rengin, şeklin ya da boyutun birbirine göre düzenlenmesidir."<br />Yukarıdaki cümle hangi tasarım ögesinin tanımıdır?
    ...
    > **Açıklama:** TASARIMDA İLİŞKİSEL ÖGELER<br />Konum, kompozisyonda uzak yakın izlenimini yaratarak ögelerin birbiriyle ilişkisi üzerinden oluşan mekânda rengin, şeklin ya da boyutun birbirine göre düzenlenmesidir.
...
1. 1\. Görsel, kültürel, sembolik ve psikolojik özellikleriyle görsel manipülasyonlar yaratır.<br />2\. Duygusal tepkiler oluşturur.<br />3\. Nesnelerin görsel veya dokunsal bir örüntü yüzeyidir.<br />4\. Anlamı veya mesajı iletmeye yarar.<br />Renk ile ilgili yukarıdakilerden hangileri söylenebilir?
    ...
    > **Açıklama:** Sanatta ve tasarımda renk görsel, kültürel, sembolik ve psikolojik özellikleriyle görsel manipülasyonlar yaratmaya, duygusal tepkiler oluşturmaya, anlamı ya da mesajı iletmeye yarayan bir araçtır.

    <hr />
1. Aşağıdaki cümlede boş bırakılan yerlere uygun düşen sözcük grubu hangi seçenekte doğru olarak verilmiştir?<br />'Tasarımın temel ögeleri olan ........., çizgi, düzlem ve hacim, tasarımda ............ ögelerdir.'
    - A-) Nokta- ilişkisel
    - B-) Boşluk- kavramsal
    - **Cevap C-) Nokta- kavramsal**
    - D-) Nokta- görsel
    - E-) Boşluk- ilişkisel

    > **Açıklama:** TASARIMDA KAVRAMSAL ÖGELER<br />Tasarımın temel ögeleri olan nokta, çizgi, düzlem ve hacim tasarımda kavramsal ögelerdir.
...
1. Aşağıdaki cümledeki boşluğa uygun düşen sözcük hangi seçenekte verilmiştir?<br />'Düzlemlerin farklı açılarla bir araya gelerek oluşturduğu boşluklar .......... olarak tanımlanabilir.'
    ...
    > **Açıklama:** TASARIMDA KAVRAMSAL ÖGELER<br />Düzlemlerin farklı açılarla bir araya gelerek oluşturduğu boşluklar hacim olarak tanımlanabilir. Hacim uzamın ölçülebilir hâlidir. Ağırlığı ve yoğunluğu ile ölçülebilen bir kütle tarafından işgal edilen ya da düzlemler tarafından çevrelenen uzamın hacmi oluşturduğu söylenebilir.
...
1. Aşağıdakilerden hangisi grafik tasarımda kullanılan kavramsal öğelerden biri değildir?
    ...
    > **Açıklama:** Tasarımcılar çoğunlukla tasarımı görsel iletişimin aracı olan dile, tasarımın ögelerini ise alfabeye benzetir. Bu ögeler kavramsal (nokta, çizgi, düzlem, hacim)<br />Diğer öğeler ise görsel (biçim, şekil, form, boyut, oran-orantı, renk, ton, armoni, doku), ilişkisel (yön, konum, boşluk, leke) ve uygulamalı (temsil, anlam, içerik, görsel anlatı) olarak sınıflandırılabilir.

    <hr />
1. Aşağıdakilerden hangisi kompozisyonda uzak yakın izlenimini yaratarak ögelerin birbiriyle ilişkisi üzerinden oluşan mekânda rengin, şeklin ya da boyutun birbirine göre düzenlenmesidir?
    - A-) Yön
    - B-) Boşluk
    - **Cevap C-) Konum**
    - D-) Oran
    ...
    <hr />
1. Aşağıdakilerden hangisi tasarım ögeleri sınıflandırılırken kullanılan başlıklar arasında **yer almaz**?
    - A-) Kavramsal
    - **Cevap B-) İşitsel**
    - C-) Görsel
    - D-) İlişkisel
    ...
    > **Açıklama:** Tasarım dilinde çizgi, nokta, düzlem, hacim, biçim, boyut, renk, doku, yön, konum, boşluk, leke<br />gibi temeller tasarımın ögeleri olarak adlandırılır. Bunlar kavramsal, görsel, ilişkisel ve uygulamalı<br />ögeler olarak sınıflandırılabilir.

    <hr />
1. Aşağıdakilerden hangisi tasarımın görsel öğelerindendir?
    - **Cevap A-) Renk**
    - B-) nokta
    - C-) çizgi
    - D-) düzlem
    ...
    > **Açıklama:** görsel (biçim, şekil, form, boyut, oran-orantı, renk, ton, armoni, doku)

    <hr />
1. Aşağıdakilerden hangisi tasarımın ilişkisel öğelerinden değildir?
    - A-) yön
    - B-) konum
    - C-) boşluk
    - **Cevap D-) oran**
    ...
    > **Açıklama:** ilişkisel (yön, konum, boşluk, leke

    <hr />
1. Aşağıdakilerden hangisi tasarımın temel ögelerinden biri **değildir?**
    - A-) Nokta
    - B-) Çizgi
    - **Cevap C-) Zıtlık**
    - D-) Düzlem
    ...
    <hr />
1. Aşağıdakilerden hangisi tasarımın uygulamalı öğelerindendir?
    - A-) Renk
    - **Cevap B-) Temsil**
    - C-) Doku
    - D-) Boyut
    ...
    > **Açıklama:** uygulamalı (temsil, anlam, içerik, görsel anlatı)
...
1. Aşağıdakilerden hangisi, kütlenin kapladığı boşluk ya da hacim anlamına gelir?
    ...
    > **Açıklama:** Hacim kütlenin kapladığı boşluktur ya da oylumdur.

    <hr />
1. Aşağıdakilerden hangisini, tasarım ögesi olarak **adlandıramayız?**
    - **Cevap A-) Uzaklık**
    - B-) Renk
    - C-) Doku
    - D-) Yön
    ...
    <hr />
1. Bir rengin, kompozisyon içerisinde farklı değer ve yoğunluklarda tekrarlanması veya diğer renklerle birlikte düzenli olarak yer alması hangi kavramla ifade edilir?
    - A-) Çizgi
    - B-) Uzam
    - C-) Mekan
    - D-) Biçim
    ...
    <hr />
1. Düzlemlerin bir araya gelerek oluşturduğu boşluklar aşağıdakilerden hangisinde tanımlanabilir?
    - A-) Denge
    - **Cevap B-) Hacim**
    - C-) Biçim
    - D-) Çizgi
    ...
    <hr />
1. En koyu değer ile en açık değerin bir arada kullanılması aşağıdakilerden hangisini oluşturur?
    - A-) Armoni
    - B-) Hiyerarşi
    - C-) Koram
    - **Cevap D-) Chiaroscuro**
    ...
    > **Açıklama:** Koyu ve açık değerleri oluşturan ışık ve gölge sanat literatüründe Chiaroscuro ve tenebrism adıyla iki tarihsel dönemle tanımlanır. Chiaroscure, birbirine zıt olan en koyu değer ile en açık değerin bir arada kullanımıyla oluşur.

    <hr />
1. Grafik tasarımda birbirine kesişen yatay ve dikey açısal çizgilerden oluşan ızgaraya ne ad verilir?
    - A-) Video
    - B-) Sarmal
    - C-) Diagonal
    - **Cevap D-) Grid**
    ...
    <hr />
1. Göstergebilimin tanımı aşağıdakilerden hangisidir?
    - A-) örüntüde ne olduğunu, izleyiciye ne düşündürüp, hissettirdiği
    - B-) e sanatçı/ tasarımcının nesnesiyle nasıl ilişki kurduğu
    - C-) Alıcı ya da toplum açısından bilgiyi bir araya getirme olanağına sahip bir görsel dil
    - D-) şekillere yüklenen anlam ve onlara karşı ilk etapta verilen bilinçdışı tepkiler
    - **Cevap E-) Sanatçının ve izleyicinin görme biçimleri ve iki görme biçimi arasındaki dinamik ilişki**

    > **Açıklama:** Göstergebilim, yapıtın /görselin tanımlanması, sanatçının ve izleyicinin görme biçimleri ve iki görme biçimi arasındaki dinamik ilişki, etkileşim olarak tanımlanabilir.

    <hr />
1. Göstergebilimle ilgili verilen bilgilerden hangisi **yanlıştır**?
    - A-) İletişim için kullanılan her şeyin (sözcükler, görüntüler, trafik işaretleri, sesler gibi pek çok unsurun) incelenmesidir.
    - B-) Anlamlandırma ile ilgili her şeyi içine aldığı söylenebilir.
    - **Cevap C-) Bu bilimin temelinde bireysel inanışlar ve değerler vardır.**
    ...
    > **Açıklama:** TASARIMDA UYGULAMALI ÖGELER<br />Bu bilimin temelinde ortak değerler, toplumsal uzlaşmayla belirlenen kodlar yer alır. Kodlar toplumların kabul ettiği kuralların işaretlerinden oluşur. Daha önce kodlanmış bu işaretleri çözerek imge okunur.
...
1. Işığın nesneler üzerindeki aydınlatma derecesine ne denir?
    ...
    > **Açıklama:** TASARIMDA GÖRSEL ÖGELER<br />Işığın nesneler üzerindeki aydınlatma derecesi olarak tanımlanan ton renkler arasındaki geçişlerle oluşur.

    <hr />
1. Kompozisyon aşağıdakilerden hangisiyle tanımlanır?
    - A-) Tasarımın elemanlarının özgün yerleştirilmesi, düzenlenmesi
    - **Cevap B-) Bir sanat eserinde tüm görsel elemanların bütünlüğü geliştirici prensiplere göre özgün yerleştirilmesi**
    - C-) Tasarım elemanlarının bütünde görünüşü
    - D-) Maddesel olarak var olan üç boyutlu bir nesnenin ya da iki boyutlu düzlemde derinlik hissi yaratılması
    - E-) Kenarlarıyla ya da sınır çizgileriyle çevresinden ayrılarak öne çıkan alan
    ...
    <hr />
1. Malzemeyi ve fikri anlamlı bir bütüne dönüştürebilmek için söz konusu alfabeyi oluşturan...................... başvurulur.
    - A-) Düşünce biçimi
    - **Cevap B-) Tasarım ögelerine**
    - C-) Taslak metnine
    - D-) Düzenlenen etkinliklere
    - E-) Sosyal değişimlere

    > **Açıklama:** Tasarım ögelerine
...
1. Sanatta ve tasarımda, görsel, kültürel, sembolik ve psikolojik özellikleriyle görsel manipülasyonlar yaratmaya, duygusal tepkiler oluşturmaya, anlamı ya da mesajı iletmeye yarayan öğe, aşağıdakilerden hangisidir?
    ...
    > **Açıklama:** Sanatta ve tasarımda renk görsel, kültürel, sembolik ve psikolojik özellikleriyle görsel manipülasyonlar<br />yaratmaya, duygusal tepkiler oluşturmaya, anlamı ya da mesajı iletmeye yarayan bir araçtır.

    <hr />
1. Tasarımın ilkeleri, ............................ oluşturur.
    - A-) Soyut düşünmeyi
    - B-) Dokuyu
    - C-) Düzlem
    - **Cevap D-) Görsel algıyı**
    - E-) Organizasyonu

    > **Açıklama:** Görsel algıyı
...
1. "İnsanlar için görülür spektrum, ............. ışık ile kırmızı ışık arasındadır." Cümlesinde boşluğa aşağıdakilerden hangisi gelmelidir?
    ...
    <hr />
1. ..............., renk konusuyla ilgili bilinen ilk kitap olan De Coloribus’u yazmış olması nedeniyle renk teorisinin yaratıcısı olarak kabul edilebilir.<br />Yukarıdaki cümlede boş bırakılan yeri aşağıdakilerden hangisi doğru şekilde tamamlar?
    - A-) Pisagor
    - B-) Goethe
    - C-) Empedokles
    - D-) Newton
    ...
    > **Açıklama:** **Aristoteles**, renk konusuyla ilgili bilinen ilk kitap olan De Coloribus’u yazmış olması nedeniyle renk teorisinin yaratıcısı olarak kabul edilebilir

    <hr />
1. 1821’de keşfedilmesine rağmen, seri üretim ancak 1920’lerin başında<br />başlamış ve 20. yüzyılda keşfedilen pigmentler arasında en önemlisi, sanatçı kalitesinde mükemmel bir pigment olan renk aşağıdakilerden hangisidir?
    - A-) Kireç beyazı
    - **Cevap B-) Titanyum beyazı**
    - C-) Çinko beyazı
    - D-) Kobalt beyazı
    - E-) Kurşun beyazı

    > **Açıklama:** 1821’de keşfedilmesine rağmen, seri üretim ancak 1920’lerin başında<br />başlamıştır. 20. yüzyılda keşfedilen pigmentler arasında en önemlisi, sanatçı kalitesinde mükemmel bir pigment olan **titanyum beyazıdır**.

    <hr />
1. Aşağıdaki hangi renkler akromatiktir?
    - A-) Siyah, mavi ve gri
    - B-) Kırmızı, beyaz ve gri
    - C-) Mavi, beyaz ve sarı
    ...
    <hr />
1. Aşağıdaki renk çiftlerinden hangisi tamamlayıcı renk kontrastıdır?
    - A-) kırmızı- mavi
    - B-) kırmızı- turuncu
    - C-) sarı- yeşil
    - D-) mor- mavi
    ...
    > **Açıklama:** RENKLERİN SINIFLANDIRILMASI, "Pigment Renkleri" başlığını inceleyiniz.<br />Renk çarkında birbirinin tam zıttı olan iki renk tamamlayıcısı zıt, kontrasttır. Renk çemberindeki en yüksek kontrast biçimini temsil ederler. Seçilen renkler yan yana yerleştirildiğinde, renkler daha parlak ve daha yoğun görüneceklerdir. Bu aynı zamanda tamamlayıcı kontrast olarak da bilinir. Kontrast olan bu renklerin tonları da birbirine kontrasttır. Renk çemberinde birbirinin tam karşısında bulunan iki ton, tamamlayıcı renklerin en basit ve temel kullanımıdır.

    <hr />
1. Aşağıdakiler seçeneklerden hangisinde birincil renkler doğru şekilde verilmiştir?
    - **Cevap A-) sarı, kırmızı, mavi**
    - B-) sarı, yeşil, mor
    - C-) mavi, mor, kırmızı
    - D-) yeşil, mavi, sarı
    - E-) turuncu, kırmızı, mor

    > **Açıklama:** RENKLERİN SINIFLANDIRILMASI<br />Birincil Renkler<br />Kırmızı, sarı ve mavi renk çemberinde ana renklerdir. Ana renkler karıştırma gerektirmez. Görsel<br />olarak başka renklere parçalanamaz ya da tamamlayıcı parçalara indirgenemez. Ana renklerin her<br />biri birbirinden farklıdır çünkü hiçbir ortak yanları yoktur. Ana renkler olan sarı, kırmızı ve mavinin<br />karıştırılmasıyla oluşan diğer tüm renklerin, tonlarını (daha açık tonlar) ve gölgelerini (koyu tonlar) oluşturmak için beyaz veya siyah ile kullanılır.

    <hr />
1. Aşağıdakilerden hangisi 12 renkli daire ile birlikte ünlü renkli yıldız’ı, renk üzerine ders kitaplarında değişmez bir şekilde yer alan ve 1920’den günümüze kadar ren konusundaki yöntemleri geçerliliğini koruyan sanatçıdır?
    - A-) Faber Birren
    - B-) Michel-Eugène Chevreul
    - **Cevap C-) Johannes İtten**
    - D-) Philipp Otto Runge
    - E-) Albert Munsell

    > **Açıklama:** Tasarımcı, öğretmen, yazar, ressam ve teorisyen olan Johannes İtten’in, Tasarım eğitiminin zirvesi olan Bauhaus’ta 1920’den beri renk konusundaki<br />yöntemleri, bugün de geçerliliğini korumaktadır. İtten’in renk çemberi, tüm renk çemberlerinin en ünlülerinden biri olarak tanımlanabilir ve 12 renkli daire ile birlikte ünlü renkli yıldız’ı, renk üzerine ders kitaplarında değişmez bir şekilde yer alır

    <hr />
1. Aşağıdakilerden hangisi Akromatik için doğru ifadedir?
    - A-) Yalnızca bir renk tonuna sahip olmak
    - B-) Yalnızca iki renk tonuna sahip olmak
    - C-) Birçok renk tonuna sahiplik
    - **Cevap D-) Renksizlik, renk çemberinin bir parçası olmayan renkler**
    - E-) Renk tonu

    > **Açıklama:** Akromatik: Renksizlik, renk çemberinin bir parçası olmayan renkler

    <hr />
1. Aşağıdakilerden hangisi Nötr-Akromatik Renklerin özelliği **değildir**?
    - A-) Siyahlar ve beyazlar sadece ışık ortamında var olurlar
    - B-) Nötr renklerin doygunluğu düşüktür
    - C-) Siyah, beyaz ve gri renkler akromatiktir.
    - **Cevap D-) Renk çarkında yer alırlar**
    - E-) Siyah, beyaz ve siyah ile beyazın karıştırılmasından oluşan herhangi bir renk tonudur

    > **Açıklama:** Nötr-Akromatik Renkler Renk çarkında yer almazlar
...
1. Aşağıdakilerden hangisi camgöbeği (turkuaz), macenta, sarı ve siyah renklerini içeren dört renkli bir çıkarma işlemidir?
    ...
    > **Açıklama:** CMYK, Bu renk sistemine aynı zamanda dört renkli işlem de denir. Camgöbeği (turkuaz), macenta, sarı ve siyah renklerini içeren dört renkli bir çıkarma işlemidir
...
1. Aşağıdakilerden hangisi dijital renk sistemlerinden biri değildir?
    ...
    > **Açıklama:** SAYISAL VE BASKI ORTAMINDA RENK, "Dijital Renk Sistemleri" başlığını inceleyiniz.<br />RGB, CMYK, Pantone ve Hexachrome tasarımda en sık kullanılan renk sistemleridir.<br />“Lenticular”, “lenslerle ilgili” anlamına gelir ve derinlemesine görüntüleme ile boyut illüzyonu yaratan plastik lenslerdir.

    <hr />
1. Aşağıdakilerden hangisi kontrast renklerdir?
    - A-) mavi-yeşil
    - **Cevap B-) mavi-turuncu**
    - C-) turuncu-yeşil
    - D-) yeşil-sarı
    - E-) sarı-yeşil
...
1. Aşağıdakilerden hangisi sıcak renkler grubudur?
    - A-) Mavi, Turuncu, Sarı
    - B-) Kırmızı, Turuncu, lacivert
    - **Cevap C-) Kırmızı, Turuncu, Sarı**
    - D-) Kırmızı, mor, Sarı
    - E-) Mavi, mor, Sarı
...
1. Bir prizmadan kırılan güneş ışığında toplam kaç ana ve ara renk vardır?
    ...
    > **Açıklama:** Bir prizmadan kırılan güneş ışığında yedi ana renk vardır. Bu renkler Gökkuşağında da görülür (Görsel 6.6). Diğer renk çeşitleri bu yedi rengin karışmasından çıkar.<br />7
...
1. CMYK renkleri aşağıdakilerden hangisidir?
    ...
    > **Açıklama:** CMYK, Bu renk sistemine aynı zamanda dört renkli işlem de<br />denir. Camgöbeği (turkuaz), macenta, sarı ve siyah renklerini içeren<br />dört renkli bir çıkarma işlemidir (Görsel 6.42). Baskı için kullanılan<br />mürekkepler, yarım tonlu nokta deseni kullanarak arka planı (genellikle<br />kâğıdın beyazı olan) maskelediğinden veya eksilttiğinden,<br />işlemin “çıkartma” olduğu kabul edilir.<br />Cyan mavi , Magenta kırmızı, Yellow sarı, Key siyah

    <hr />
1. Cisimler ışığı geçirip geçirmemelerine göre de kaça ayrılırlar?
    - **Cevap A-) 3**
    - B-) 6
    - C-) 5
    - D-) 7
    ...
    > **Açıklama:** Cisimler ışığı geçirip geçirmemelerine göre de üçe ayrılırlar:<br />• Saydam: Işığı geçiren cisimler,<br />• Saydam olmayan: Işığı geçirmeyen cisimler ve<br />• Yarı saydam cisimler.<br />3
...
1. Gökkuşağı veya spektrumda, en kısa dalga boyu aralığına sahip olan renk aşağıdakilerden hangisidir?
    ...
    > **Açıklama:** RENK, "Işığı Renklerine Ayırmak" başlığını inceleyiniz.<br />KIRMIZI- ~ 700-635 nm<br />SARI- ~ 590-560 nm<br />YEŞİL- ~ 560-490 nm<br />MAVİ- ~ 490-450 nm<br />MOR- ~ 450-400 nm<br />Dalga boyu aralığı en fazla olan renk kırmızıdır. Dalga boyu aralığı en kısa olan renk ise mordur.
...
1. Gözün retina tabakasında bulunan konilerde hangi renk foto pigmentler veya renk algılama molekülleri bulunur?
    ...
    > **Açıklama:** Farklı koniler, farklı ışık dalga boyları tarafından etkinleştirilir. Koniler<br />uyarıldığında, beynin görsel korteksine sinyaller gönderirler, Konilerde, kırmızı, yeşil ve mavi olmak üzere üç tip foto pigmentler veya renk algılama molekülleri bulunur.

    <hr />
1. I- En sıcak renktir.<br />II- Gençliği, dinamizmi ve hareketi ifade eder.<br />III- Kişileri duygusal olarak mutlu, azimli ve kararlı yapar.<br />IV- Azmin ve gücün sembolü olarak kabul edilir.<br />Yukarıda psikolojik etkileri belirtilen renk aşağıdakilerden hangisidir?
    - A-) sarı
    - B-) turuncu
    - **Cevap C-) kırmızı**
    - D-) mor
    ...
    > **Açıklama:** RENKLERİN SINIFLANDIRILMASI, "Renk Algısı" başlığını inceleyiniz.<br />Kırmızı: Tarihin en eski rengi olan kırmızı renklerin arasında en güçlü olan renktir. En sıcak renk olan kırmızı; gençliği, dinamizmi ve hareketi ifade eder. Kişileri duygusal olarak mutlu, azimli ve kararlı yapar. Azmin ve gücün sembolü olarak kabul edilir.
...
1. I- Genellikle Avrupa’da kullanılan bir renk eşleştirme sistemidir.<br />II- Renkleri tarif etmek amacıyla geliştirilmiştir.<br />III- Günümüzde genellikle boya sektörü ve diğer sektörlerde de sıklıkla kullanılmaktadır.<br />Yukarıda özellikleri verilen kavram aşağıdakilerden hangisidir?
    ...
    > **Açıklama:** SAYISAL VE BASKI ORTAMINDA RENK, "Renk Kartelası (Çizelge)" başlığını inceleyiniz.<br />RAL genellikle Avrupa’da kullanılan bir renk eşleştirme sistemidir. Renkleri tarif etmek amacıyla<br />geliştirilmiş, günümüzde genellikle boya sektörü ve diğer sektörlerde de sıklıkla kullanılmaktadır.
...
1. I- Renk konusuyla ilgili bilinen ilk kitap olan De Coloribus’u yazmıştır bu nedenle renk<br />teorisinin yaratıcısı olarak kabul edilmektedir.<br />II- Tüm renklerin güneş ışığı, ateş ışığı, hava ve suyun farklı karışımlarından elde edildiğini yazmıştır.<br />III- Siyahların ve daha koyu tonların; güneş ışığı, ateş ışığı, hava ve su unsurlarından bir veya daha fazlasının eksikliğinin bir sonucu olduğunu ifade etmiştir.<br />IV- Temel renk paletinin kırmızı, sarı, mavi, yeşil, menekşe, beyaz, siyah ve kahverengiyi içerdiğini belirtmiştir.<br />Renkle ilgili yukarıda verilen bilgiler hangi teorisyene aittir?
    ...
    > **Açıklama:** RENK SİSTEMİNİN KÖKENLERİ, "Renkle İlgili Teorisyenler ve Teorileri" başlığını inceleyiniz.<br />Aristoteles (MÖ384–322)<br />Aristoteles, renk konusuyla ilgili bilinen ilk kitap olan De Coloribus’u yazmış olması nedeniyle renk<br />teorisinin yaratıcısı olarak kabul edilebilir. Tüm renklerin güneş ışığı, ateş ışığı, hava ve suyun farklı karışımlarından elde edildiğini yazmıştır. Siyahların ve daha koyu tonların, bu unsurlardan bir veya daha fazlasının eksikliğinin bir sonucudur. Aristoteles’in temel renk paleti, kırmızı, sarı, mavi, yeşil ve menekşe ile beyaz, siyah ve kahverengiyi içermektedir.
...
1. I-ton<br />II-değer<br />III-pigment<br />IV-doygunluk<br />Yukarıdakilerden hangileri fiziksel olarak rengin algılamasındaki temel niteliklerdendir?
    ...
    > **Açıklama:** RENKLERİN SINIFLANDIRILMASI, "Fiziksel Olarak Renk Algılaması" başlığını inceleyiniz.<br />Fiziksel olarak rengin algılamasında üç temel nitelik bulunur. Bunlar, 1.Temel renk (Hue): Rengin<br />kendisidir. 2.Doygunluk (Saturasyon, chroma): Rengin saflık derecelerini belirler ve rengin en doğru, doygun hâlidir. 3.Parlaklık (value): Işıkların yansıtma boyutudur. Renklerin açıklık veya koyuluğunun ölçümüdür.<br />Ton (Hue)<br />Rengin en saf hâlini tanımlayan bir terimdir; Genellikle “renk” kelimesi ile birbirinin yerine kullanılan “ton” terimi, belirli bir rengin ait olduğu aileyi ve tam doygunluğa sahip bir rengi ifade eder. Bir başka belirtmeyle ton, bir rengin kırmızı, turuncu, sarı, yeşil, mavi, mor olarak adı veya niteliğidir. Bir renk genellikle en belirgin veya baskın tonunun adıyla anılır. Renk çemberi 12 temel renk tonuna sahiptir. Ancak “Hue” her zaman yalnızca rengin adı anlamına gelir. Chroma, renk tonunun eş anlamlısıdır.<br />Değer (Value)<br />Değer, bir rengin açıklığını veya koyuluğunu ifade eder. Değer, bir kompozisyon içinde vurgu oluşturmak ve görsel hiyerarşi oluşturmak için önemli bir araçtır. Tonlar, en saf göründükleri yerde doğal bir değere sahiptir. Her tonda, koyu tonlardan açık tonlara kadar bir dizi değer elde edebilir. Beyaz, mümkün olan en yüksek değerdir. Siyah, mümkün olan en düşük değerdir. Bir renge, beyaz veya siyah eklemek, o rengin değerini değiştirir. Siyah ve beyaz renksiz değerler, siyah ve beyaz karışımı olan gri, orta bir değerdir.<br />Doygunluk, Kroma (Saturation)<br />Bir rengin “yoğunluğu” veya “kroma” olarak da adlandırılan doygunluğu bir rengin parlaklığını ve yoğunluğunu tanımlar. Bir renk tonuna sahip algılanan renkler kromatik renkler olarak algılanır. Bir rengin doygun görünüp görünmediği, yanında hangi renklerin bulunduğuna bağlı olacaktır.<br />Doygunluk terimi,<br />bir rengin saflığını ifade eder. Bir rengin doygunluğu azaldıkça renk griye döner. Bir rengi tamamen solgunlaştırılırsa, esasen griye döner. Parlaklık veya hafiflik, bir renge beyaz miktarını ekler. Ne kadar fazla parlaklık eklerseniz renk o kadar soluklaşır. Parlaklığı azaltırsanız, beyaz miktarı azaldıkça renk koyulaşır.

    <hr />
1. Michel-Eugène Chevreul' e göre rengin üç ana ögesi aşağıdakilerden hangisidir?
    - A-) fizik, fizyoloji ve psikoloji
    - B-) eş zamanlı, ardışık ve orantılı
    - C-) dalga boyu, frekans ve aralık
    - **Cevap D-) saflık, değer ve renk tonu**
    - E-) kroma, pigment ve emisyon

    > **Açıklama:** RENK SİSTEMİNİN KÖKENLERİ, "Renkle İlgili Teorisyenler ve Teorileri" başlığını inceleyiniz.<br />Michel-Eugène Chevreul (1786–1889) Goethe’nin çağdaşı olan Michel Eugene Chevreul, bir Fransız kimyagerdir. Rengin üç ana ögesini veya niteliğini ayırt etmiş ve tanımlamıştır. Üç ana öge; saflık (doygunluk), değer (parlaklık) ve renk tonudur.
...
1. Psikolojik olarak renklerin özelliklerine göre aşağıdakilerden hangisi asalet, zenginlik, lüks duygularını çağrıştıran, kişilerde hayal gücünü ve konsantrasyonu arttıran renktir?
    ...
    > **Açıklama:** Mor: Asalet, zenginlik, lüks duygularını çağrıştıran mor renk, hayal gücünü arttırır. Kişilerde konsantrasyonu arttıran, şevk veren bir renktir.

    <hr />
1. Psikolojik olarak renklerin özelliklerine göre aşağıdakilerden hangisi kişiler için otorite ve sonsuzluk sembolü olup ayrıca sezgilerin artmasına, kararları kolaylaştırmasına etki ederek düşüncenin rengi olarak kabul edilir?
    - A-) Yeşil
    - B-) Mor
    - C-) Mavi
    - **Cevap D-) Lacivert**
    ...
    > **Açıklama:** Lacivert: Bu renk sezgilerin artmasına, kararları kolaylaştırmaya<br />etkilidir. Düşüncenin rengi olarak kabul edilir. Kişiler için otorite ve sonsuzluk sembolüdür

    <hr />
1. Rengin ışıkla ilişkisini bilimsel anlamda ortaya koyan ilk bilim insanı aşağıdaki isimlerden hangisidir?
    - A-) Leonardo da Vinci
    - **Cevap B-) Isaac Newton**
    - C-) Moses Harris
    - D-) Michel-Eugène Chevreul
    - E-) Johann Wolfgang Von Goethe

    > **Açıklama:** GİRİŞ başlığını inceleyiniz.<br />Renk denen bu algının ışıkla ilişkili olduğunun da ne derece farkında olabilirler. Bilinen bir şey varsa karanlık bir ortamda hiçbir şeyin görülmediğidir. Onun için mağaralarda yapay ışık altında çizimlerini yapmışlardır. Bu çalışma biçimi her zaman için geçerlidir uygarlığın gelişmesi sonucu Neolitik Dönem, Antik Mezopotamya, Mısır, Yunanistan uygarlıklarının oluşumu ve gelişmesi sonucunda ilk defa Yunanlı düşünürlerce renk dediğimiz bu algının ana nedeninin ışık olduğu ele alınmıştır. Bu düşünceyle günümüze doğru geldiğimizde ilk olarak Isaac Newton tarafından bir sınıflama yapılmıştır. Isaac Newton’dan sonra konuyla ilgili teorisyenler, renkle ilgili teoriler geliştirmişler ve bunları uygulamaya koymuşlardır (s. 191). Newton ise kesinlikle renk teorisini kuran ve geliştiren ve renk çalışmasına bilimsel bir araştırma yöntemi getiren ilk kişidir (s. 199)

    <hr />
1. Renk teorisinin ilk verileri, eski Yunan filozofu ........... tarafından formüle edilmiştir<br />Yukarıdaki cümlede boş bırakılan yeri aşağıdakilerden hangisi doğru şekilde tamamlar?
    - A-) Leonardo da Vinci
    - B-) Pisagor
    - C-) Aristoteles
    - **Cevap D-) Empedokles**
    ...
    > **Açıklama:** Renk teorisinin ilk verileri, eski Yunan filozofu **Empedokles** tarafından formüle edilmiştir

    <hr />
1. İkincil (Ara) Renkler aşağıdakilerden hangisidir?
    - A-) Siyah, beyaz, gri
    - B-) Sarı, kırmızı, mavi
    - **Cevap C-) Yeşil, mor, turuncu**
    - D-) Turuncu, sarı, kırmızı
    - E-) Mor, kırmızı, mavi
...
1. Aşağıdakilerden hangisi Radyal denge özelliklerinden biri **değildir**?
    ...
    <hr />
1. Aşağıdakilerden hangisi görsel tasarımda bütünlük varyasyonlarından biridir?
    - A-) Derişik Bütünlük
    - **Cevap B-) Deneysel Bütünlük**
    - C-) Pratik Bütünlük
    - D-) Modernist Bütünlük
    - E-) Tipografik Bütünlük

    > **Açıklama:** Deneysel Bütünlük

    <hr />
1. Aşağıdakilerden hangisi görsel tasarımda bütünlüğü sağlayan ilkelerden biri **değildir**?
    - A-) Yakınlık
    - B-) Tekrar
    - **Cevap C-) Birleştiricilik**
    - D-) Boşluklar
    - E-) Hizalama

    > **Açıklama:** Birleştiricilik
...
1. Aşağıdakilerden hangisi görsel tasarımda bütünlüğü sağlayan ilkelerden biri değildir?
    ...
    > **Açıklama:** Konu: GÖRSEL TASARIMDA KOMPOZİSYON VE BÜTÜNLÜK<br />**GÖRSEL TASARIMDA BÜTÜNLÜĞÜ SAĞLAYAN İLKELER**<br />**YAKINLIK:** Görsel tasarım elemanları ve ilkeleri bütünlüğü sağlamak adına kullanıldığı pozisyona göre “Yakınlık” göstermelidir. Birlik kazanmanın ve ayrı ögeleri birbirine aitmiş gibi göstermenin en kolay yolu, basitçe ögeleri biçimsel olarak birbirine yaklaştırmaktır. Yakınlık ortak bir birleştirici faktördür. Örneğin bir dergi tasarımında veya resimli kitap tasarımında görsellerinin ve tipografinin birbirlerine yakınlık göstermesi; hem görsel birliği/bütünlüğü hem de okunurluğu sağlar.<br />**TEKRAR:** Görsel birlik/bütünlüğü sağlamak için değerli ve yaygın olarak kullanılan bir araç “Tekrardır”. Terimden de anlaşılacağı gibi parçaları birbiriyle ilişkilendirmek için tasarımın çeşitli bölümlerinde bir şey basitçe tekrarlanır. Tekrar eden öge hemen hemen her şey olabilir: Bir renk, bir şekil, bir doku, tipografi veya bir leke.<br />**DEVAMLILIK:** Bütünlüğü sağlamanın üçüncü bir yolu, oldukça açık olan yakınlık ve tekrardan daha incelikli bir araç olan “Devamlılıktır”. Devam, doğal olarak, bir şeyin “devam ettiği” anlamına gelir. Genellikle bir çizgi, kenar veya bir biçimden diğerine bir yön sağlar. İzleyicinin gözü bir ögeden diğerine sorunsuz bir şekilde taşınır. Göz temel olarak okuma alışkanlıklarının kazandırmış olduğu öğrenmeyle, soldan sağa ve yukarıdan aşağıya doğru bir yüzeyde takip sağlar. Gözün bu hareket alanları üzerinde devamlılık sağlanırsa tasarımın ulaştırmak istediği mesaj daha kolay algılanacaktır.<br />**HİZALAMA:** Bütünlüğü sağlamak adına önemli bir kavram her zaman hizalamayı kullanmaktır. “Hizalama” hedef kitleyle tasarımın arasındaki bağı kurmaya yardımcı olur. Gruplama ve dizi etkisi yaratır. Görsel parçalanmayı ve dağınıklığı azaltmaya yardımcı olur. Yönlendiricidir ve dikkat çekicidir. Özellikle metinlerde okunurluğu artırır. Abartılırsa yorucu ve statik bir etki yaratabilir.<br />**BOŞLUKLAR (ESPASLAR):** Tasarımda bütünlüğü sağlayan önemli bir etken de boşlukların(espaslardır) tasarımıdır. Bir tasarıma başlamadan önce ilk yüz yüze kaldığımız olgu boşlukların organizasyonudur. “Boşluklar”, diğer tasarım elamanları ve ilkeleriyle birlikte kullanıldığında tasarda organizasyonu ve gözün takibini sağlar. Gözler boşlukları takip eder ve bu alanlarda nefes alır. Okunurluğu ve imgeye konsantrasyonu artıran önemli bir etkendir. Boşluklar içerisinde eksenler, bordürler, çizgiler ve çerçeveler toparlayıcı ve bütünlüğü sağlayan özelliklere sahiptir. Yine boşluklar hareket ve vurgu yaratıcı bir katkıda sağlar.<br />Şekil- zemin ilişkisi Gestalt’ın görsel ilkelerinden birisidir.

    <hr />
1. Aşağıdakilerden hangisi görsel tasarımda bütünlüğü sağlayan varyasyonlardan biridir?
    - **Cevap A-) Deneysel Bütünlük**
    - B-) Serbest Bütünlük
    - C-) Merkezi Bütünlük
    - D-) Radyal Bütünlük
    - E-) Asimetrik Bütünlük

    > **Açıklama:** Görsel Tasarımda Bütünlük Varyasyonları<br />Bir kompozisyonda bütünlüğü sağlayan temel varyasyonlar 3 şekilde ele alınabilir: Durağan Bütünlük, Dinamik Bütünlük, Deneysel Bütünlük

    <hr />
1. Aşağıdakilerden hangisi görsel tasarımda gestaltizm ilkelerinden biri **değildir?**
    - A-) Benzerlik
    - B-) Yakınlık
    - **Cevap C-) Form**
    - D-) Şekil-Zemin İlişkisi
    - E-) Yön

    > **Açıklama:** Form

    <hr />
1. Aşağıdakilerden hangisi görsel tasarımdaki hiyerarşik düzenleme türlerinden biridir?
    - **Cevap A-) Takip Hiyerarşisi**
    - B-) Dinamik Hiyerarşi
    - C-) Bölgesel Hiyerarşi
    - D-) Statik Hiyerarşi
    - E-) Renk Hiyerarşisi
    ...
    <hr />
1. Aşağıdakilerden hangisi hedeflenen mesajın işlevine göre tasarım yüzeyinde takip içeren izafi çizgilerin doğrusal hareketlerine göre(düz, eğri, dalgalı, radial, konik, dikdörtgen vb. izafi çizgiler) tasarım elemanlarının hiyerarşik ilkeler ölçüsünde dizilmesini ifade eder?
    - **Cevap A-) Takip hiyerarşisi**
    - B-) Tipografik hiyerarşi
    - C-) Serbest hiyerarşi
    - D-) Merkezî hiyerarşi
    - E-) Boyutsal hiyerarşi

    > **Açıklama:** Takip Hiyerarşisi<br />Hedeflenen mesajın işlevine göre tasarım yüzeyinde takip içeren izafi çizgilerin<br />doğrusal hareketlerine göre(düz, eğri, dalgalı, radial, konik, dikdörtgen vb. izafi<br />çizgiler) tasarım elemanlarının hiyerarşik ilkeler ölçüsünde dizilmesini ifade eder.

    <hr />
1. Aşağıdakilerden hangisi mesajın izleyiciye en akıcı ve en estetik biçimde ulaşması için hedeflenen bir tasarım ilkesidir?
    - A-) Ritim
    - **Cevap B-) Vurgu**
    - C-) Denge
    - D-) Tekrar
    ...
    <hr />
1. Aşağıdakilerden hangisi tasarım yüzeyinde yer alan tasarım elemanlarının dairesel bir biçimde içten dışa ve dıştan içe bir şekilde tasarımın merkezine doğru yerleştirilmesi prensibine dayanan denge türüdür?
    - A-) Simetrik denge
    - B-) Asimetrik denge
    - **Cevap C-) Radyal denge**
    - D-) Optik denge
    - E-) Hiyerarşik denge

    > **Açıklama:** Radyal denge
...
1. Aşağıdakilerden hangisi özellikle reklam filmi ve jenerikleri ile etkileşimli tasarımlarda anime, zaman dilimi ve ses gibi tasarım elemanları arayüzlerde etkili bir hiyerarşi oluşturur?
    ...
    - **Cevap D-) Hareket, zamanlama ve işitsel hiyerarşi**
    - E-) Serbest hiyerarşi

    > **Açıklama:** **Hareket, zamanlama ve işitsel hiyerarşi**; özellikle reklam filmi ve jenerikleri ile etkileşimli tasarımlarda anime, zaman dilimi ve ses gibi tasarım elemanları arayüzlerde etkili bir hiyerarşi oluşturur

    <hr />
1. Aşağıdakilerden hangisi özellikle reklam filmi ve jenerikleri ile etkileşimli tasarımlarda, anime, zaman dilimi ve ses gibi tasarım elemanları arayüzlerde etkili bir hiyerarşi oluşturur?
    - A-) Tipografik hiyerarşi
    - B-) Kontrast hiyerarşi
    - C-) Boyutsal hiyerarşi
    - **Cevap D-) Hareket, zamanlama ve işitsel hiyerarşi**
    - E-) Serbest Hiyerarşi

    > **Açıklama:** Hareket, zamanlama ve işitsel hiyerarşi

    <hr />
1. Aşağıdakilerden verilen maddelerden hangisi görsel tasarımda kompozisyonun özelliklerinden biri değildir?
    - A-) Bir kompozisyon iki boyutlu, üç boyutlu veya zamansal olabilir.
    - **Cevap B-) İyi bir kompozisyon, hedef kitleyle iletişim kurmaz.**
    - C-) Mesajını en etkili bir şekilde iletir.
    - D-) Hedef kitleyi estetik ve tasarım olarak etkiler.
    - E-) Kalıcı bir etki bırakır ve sonuç olarak hafızaya yerleştirir.

    > **Açıklama:** Konu: GÖRSEL TASARIMDA KOMPOZİSYON VE BÜTÜNLÜK<br />**Kompozisyonun Özellikleri;** <br />* Bir kompozisyon iki boyutlu, üç boyutlu veya zamansal olabilir.<br />* İyi bir kompozisyon, tıpkı organik bir varlık gibi iletişim kurar.<br />* Kendine özgü veeşsiz bir deneyimi ifadeeder.<br />* Mesajını en etkili bir şekilde iletir .<br />* Hedef kitleyiestetik vetasarım olarak etkiler.<br />* Bir tasarımcı için, farklı parçalar arasında uyumlu bir birlik göstermeye yardımcı olur.<br />* Tasarım hiyerarşisi aracılığıyla hedef kitlenin dikkatini yönlendirmeye yardımcı olur ve onu ilgi alanına göre okumak için etkili bir düzen sunar.<br />* Sağlam bir kompozisyon, izleyicileri baştan çıkarır ve etkiler, onu tekrar tekrar izlemelerini sağlar.<br />* Kalıcı bir etki bırakır ve sonuç olarak hafızaya yerleştirir.<br />* Düzensiz ve kaotik düzenlenmiş parçalar, işlevini yerine getiremez veya iletişim kuramaz.<br />* Kompozisyonun sağladığı duygulanım ile mesajda netlik, görsel iletişimde belirleyici bir faktördür.<br />* Duyarlı bir tasarımcı kurduğu kompozisyonun bilincindedir ve dolayısıyla bu yeteneğine saygı duyulur.<br />* Grafik tasarımda tecrübe ve iyi kompozisyon kurgusu her grafik çalışmasının ön koşuludur (T.N.A.Graphic Design, 2011:150).<br />Özce; iyi bir kompozisyon, tıpkı organik bir varlık gibi iletişim kurar.
...
1. Denge çeşitleri içerisinde özellikle yazı tasarımı ve tipografide sıkça kullanılan denge türü aşağıdakilerden hangisidir?
    ...
    > **Açıklama:** Optik Denge

    <hr />
1. Gestalt ilkeleri hakkındaki “Sanat ve Görsel Algı: Yaratıcı Gözün Psikolojisi” isimli önemli kitabın yazarı aşağıdakilerden hangisidir?
    - A-) Max Wertheimer
    ...
    > **Açıklama:** Gestalt Teorisi ve İlkeleri birkaç yıl içinde geliştirilirken, kısmen Rudolf Arnheim’ın 1954 tarihli “Sanat ve Görsel Algı: Yaratıcı Gözün Psikolojisi” adlı kitabı sayesinde ön plana çıkmıştır . Bu kitap 20. yüzyılın olmazsa olmaz bir sanat kitabı hâline gelmiştir ve düzenli olarak üniversite ders metin listelerinde yer almaktadır.

    <hr />
1. Görsel tasarımda bütünlüğü sağlayan ilkelerden yönlendirici unsur aşağıdakilerden hangisidir?
    - A-) Yakınlık
    - B-) Tekrar
    - **Cevap C-) Devamlılık**
    - D-) Hizalama
    ...
    > **Açıklama:** İyi bir tasarımda yakınlık ve tekrar birleştirici bir unsurdur. **Devamlılık ise yönlendiricidir**

    <hr />
1. Hedef kitleyle tasarımın arasındaki bağı kurmaya yardımcı olur. Gruplama ve dizi etkisi yaratır. Görsel parçalanmayı ve dağınıklığı azaltmaya yardımcı olur. Yönlendiricidir ve dikkat çekicidir. Özellikle metinlerde okunurluğu artırır ifadeleri aşağıda verilen hangi "Kompozisyonda Bütünlük" ilkeleri için doğru seçenektir?
    - A-) Tekrar
    - B-) Boşluklar
    - C-) Yakınlık
    - D-) Devamlılık
    ...
    > **Açıklama:** HİZALAMA<br />Bütünlüğü sağlamak adına önemli bir kavram her zaman hizalamayı kullanmaktır. “Hizalama” hedef kitleyle tasarımın arasındaki bağı kurmaya yardımcı olur. Gruplama ve dizi etkisi yaratır. Görsel parçalanmayı ve dağınıklığı azaltmaya yardımcı olur. Yönlendiricidir ve dikkat çekicidir. Özellikle metinlerde okunurluğu artırır.

    <hr />
1. Mesajın gereksinimi durağanlık ve sakinlik üzerine kuruluysa ........, gerilim, heyecan ve aksiyon üzerine kuruluysa ........ kompozisyonlar işi kolaylaştıracaktır.<br />Yukarıdaki cümlede boş bırakılan yeri aşağıdakilerden hangisi doğru şekilde tamamlar?
    - A-) Ritim-asimetri
    - B-) Hareket-ritim
    - C-) Ritim-hareket
    - **Cevap D-) Simetrik-asimetrik**
    - E-) Asimetrik-simetrik

    > **Açıklama:** Mesajın gereksinimi durağanlık ve sakinlik üzerine kuruluysa **simetrik**, gerilim, heyecan ve aksiyon üzerine kuruluysa **asimetrik** kompozisyonlar işi kolaylaştıracaktır

    <hr />
1. Sanat ve tasarım tarihinde sanatçılar, tasarımcılar oran/orantı kavramlarıyla çokça uğraşmıştır. Bu<br />oranların en çok kullanılanı aşağıdakilerden hangisidir?
    - **Cevap A-) Altın Oran**
...
1. Özellikle sayısal tipografide bazı fontlarda yer alan ve fontların Türkçe harflerle olan uyum sorunları ....... dengeyle çözümlenir<br />Yukarıdaki cümlede boş bırakılan yeri aşağıdakilerden hangisi doğru şekilde tamamlar?
    ...
    > **Açıklama:** Özellikle sayısal tipografide bazı fontlarda yer alan ve fontların Türkçe harflerle olan uyum sorunları **optik** dengeyle çözümlenir
...
1. Özellikle tipografi kullanılan tasarımlarda vurgu tasarımın önemli bir parçasıdır. Aşağıdakilerden hangisi belirlenen metnin vurgulanması için kullanılan yöntemlerden biri değildir?
    - A-) Boşlukları tasarlamak.
    - B-) Bold ve sans serif yazı karakterleri.
    - C-) Yazı karakterini değiştirmek.
    - **Cevap D-) Görsel eklemek.**
    - E-) Bazı küçük harfleri büyük harflerle değiştirmek.

    > **Açıklama:** Konu: Görsel Tasarımda Hiyerarşi, Oran/ Orantı ve Vurgu / Vurgu<br />Vurgu mesajın izleyiciye en akıcı ve en estetik biçimde ulaşması için hedeflenen bir tasarım ilkesidir. Vurguyu oluşturmak için tasarımcının öncelikle tasarımın hedeflerini belirleyip ciddi bir planlama yapması gerekir. Bu planlama içerisinde tasarım hiyerarşisine göre belirlenen parçaların (tipografi, görsel, resimleme vs.) hangisinin ne şekilde vurgulandığı düşünülmelidir. Vurgu için renk ve kontrastlık en önemli silahlardan biridir. Yine boşlukların tasarlanması, çerçeveleme, kontrollü büyütme, deformasyon, diyagonalleştirme, dokusal varyasyonlar gibi yöntemlerde uygulanabilir. Vurgulanacak ögeyi altın oran varyasyonlarından birine göre de tasarlamak mesajın etkisini artıracaktır. Vurgu oluştururken birden fazla parçaya söz söyleme hakkı verirseniz tasarım kaotik bir boyut kazanır. Özellikle tipografi kullanılan tasarımlarda vurgu tasarımın önemli bir parçasıdır. Öncelikli belirlenen metinler hedef kitleye mesajı daha kolay ulaştırması için vurgulanır. **Boşlukları tasarlamak;** Bir başlığın üstüne veya altına bir satır veya yarım satır boşluk şeklinde dikey “beyaz” boşluk eklemek, onu çevreleyen ögelerden ayırarak vurgu oluşturur.<br />**Bold ve sans-serif(tırnaksız) yazı karakterleri;** kendi görsel vurgusunu yaratır. Univers gibi sans-serif yazı biçimleri bunun için iyidir çünkü tipik olarak kullanabileceğiniz çeşitli ağırlık kombinasyonlarına sahiptirler. Açık ile koyu, orta ile ekstra kalın vb. özelliklere sahiptir. Daha küçük kalın yazı boyutunun, daha büyük boyutta normal ağırlıklı yazı tipinden görsel olarak “daha ağır” olduğunu unutmamak gerekir.<br />**Yazı karakterini değiştirmek;** üçüncü bir yöntemdir. Örnek olarak, roman yazı karakterinden italik bir yazıya geçmek verilebilir. İtalikler, bir tasarıma gayriresmîlik, samimiyet ve hareket katar ayrıca metin içindeki anahtar ifadeleri vurgulamak için de etkilidir. Daha hassas biçimleri nedeniyle, gerektiğinde okunabilirlik için boyutu orantılı olarak arttırmak mümkündür.<br />**Bazı küçük harfleri büyük harflerle değiştirmek;** bir tasarıma form katabilir. Büyük harfler daha fazla harf aralığına ihtiyaç duyar ve bu nedenle daha fazla alan tüketir. Küçük büyük harfler daha da ince bir vurgu kayması sağlar (Dabner & Stewart & Vickress, 2017:89)

    <hr />
1. İyi bir tasarımda ........ ve ........birleştirici bir unsurdur<br />Yukarıdaki cümlede boş bırakılan yeri aşağıdakilerden hangisi doğru şekilde tamamlar?
    - A-) Devamlılık-hizalama
    - B-) Yalınlık-boşluklar
    - **Cevap C-) Yakınlık-tekrar**
    - D-) Tekrar-hizalama
    - E-) Hizalama-boşluklar

    > **Açıklama:** İyi bir tasarımda yakınlık ve tekrar birleştirici bir unsurdur

    <hr />
1. “Göz takıldığı tüm ekseni veya çizgiyi takip etmek ister. Sonuç olarak ortaya çıkan bütün gözü rahatlatır.” Tanım aşağıdaki Gestalt ilkelerinden hangisine aittir?
    - A-) Benzerlik
    - B-) Yakınlık
    - **Cevap C-) Yön**
    - D-) Tamamlama
    ...
    > **Açıklama:** Konu: GÖRSEL TASARIMDA GESTALT<br />Benzerlik: Nesnelerin bütün olarak algılanmasını sağlar. Benzer biçimler gözü benzer biçimde etkileyerek yüzey üzerinde bir bütünlük oluşturur.<br />Yakınlık: Birbirine yakın olarak yerleştirilmiş görsel elemanlar grup oluştururlar. Bu sayede yakınlık sayesinde göz bir diğer parçaya hareket etmekte zorlanmaz.<br />Yön: Göz takıldığı tüm ekseni veya çizgiyi takip etmek ister. Sonuç olarak ortaya çıkan bütün gözü rahatlatır.<br />Tamamlama: Göz eksik parçaları ve şekilleri tamamlamak ister. Aslında bütüne ulaşmak için parçaları yorumlar.<br />Şekil-Zemin İlişkisi: Göz şekilleri ve figürleri birbirinden ayırırken fondan(zemin) ayırmak ister (Ertan&Sansarcı, 2017:56).<br />Sadelik: Sadelik yaşam içerisinde çokça aranan bir olgudur. Sade yaşamak, giyinmek, konuşmak, yemek hep aranılan bir olgudur. Sadelik bütüne ulaşmak için gereksiz parçaların ayıklanması ve arındırılması temeline dayanır. Kısacası elemine etmek ve ayıklamak mesajın ortaya çıkmasındaki kaotik engellerin kaldırılmasını sağlar. Alman Mimar L. M. Rohe’un bir sözü “Less is More (Az, daima çoktur)” Gestaltın yalınlık ilkesini çok iyi anlatır.<br />Simetri: Simetri, gözü rahatlatırken dinlendirici bir algıda yaratır. Simetriyle oluşturulan parçalar bütünün organize edilmesinde oldukça kolaylık sağlar. Özellikle tasarıma yeni başlayanlar için problemsiz bir tasarım demektir.
...
1. 3- Değişik renk teknikleriyle yaratılan derinlik illüzyonuna atmosferik perspektif (hava perspektifi) denilmektedir. Aşağıdakilerden hangisi bu renk tekniklerinden **değildir?**
    - **Cevap A-) İkonik Perspektif**
    - B-) Prova sıcak-soğuk renk manipülasyonu
    - C-) Renk Saturasyonu
    - D-) Doku dereceleri
    - E-) Parlaklık dereceleri

    > **Açıklama:** Parlaklık dereceleri, doku dereceleri, renk saturasyonu ve sıcak-soğuk renk manipülasyonu gibi tekniklerle yaratılan derinlik illüzyonuna atmosferik perspektif (hava perspektifi) denilmektedir<br />(Seylan, 2019, s. 97).<br />İkonik Perspektif

    <hr />
1. 4- İnsan gözüne en yakın ve gerçekçi sonuçlar veren perspektif türü aşağıdakilerden **hangisidir?**
    - A-) İzometrik Perspektif
    - B-) Dimetrik Perspektif
    - **Cevap C-) Konik Perspektif**
    - D-) Trimetrik Perspektiff
    - E-) İkonik Perspektif

    > **Açıklama:** İnsan gözüne en yakın ve gerçekçi sonuçlar veren perspektif türü merkezî (konik) perspektiftir.<br />Konik Perspektif
...
1. 9- Yükselen virtüelliğe vurgu yapan Baudrillard’e göre günümüzde gerçeğin çok farklı bileşenler tarafından üretildiğinden ve bu sayede gerçeğin sonsuz sayıda yeniden üretiminin mümkün kılındığından bahseder. Aşağıdakilerden hangisi bu bileşenlerden **değildir?**
    - **Cevap A-) Görsel teknoloji**
    - B-) Minyatür hücreler
    - C-) Matrisler
    - D-) Bellekler
    - E-) Komut modelleri

    > **Açıklama:** Yükselen virtüelliğe vurgu yapan Baudrillard’e günümüzde gerçeğin artık **minyatür hücreler**, **matrisler,** **bellekler** ve **komut modeller**i tarafından üretildiğinden ve bu sayede gerçeğin sonsuz sayıda yeniden üretiminin mümkün kılındığından bahseder (Baudrillard, 2003). <br />Görsel teknoloji

    <hr />
1. 1-Dünyayı üç boyutlu olarak algılarız. Bu üç boyuttan birincisi genişlik ikincisi yükseklik üçüncüsü ise ………<br />Yukarıdaki cümlede boş bırakılan yere gelecek olan kavram aşağıdakilerden hangisidir?
    - A-) Boyut
    - **Cevap B-) Derinlik**
    - C-) Perspektif
    - D-) Uzam
...
1. |  |  |<br />| --- | --- |<br />| I. Solucan gözü ya da kuş gözü görünümü biçimde olabilir. | a. Tek kaçış noktalı perspektif |<br />| II. Çizilecek cisimlerin ufuk çizgisi­ne 90 derecelik açı ile dik düşen çizgileri dikey olarak çizilir. Bunun dışında kalan tüm çizgiler, ufuk çizgisi üzerindeki kaçış noktalarına doğru çizilir. | b. Üç kaçış noktalı perspektif |<br />| III. Çizilecek cisimlerin ufuk çizgisine paralel giden tüm çizgileri yatay olarak çizilir. Ufuk çizgisine 90 derecelik açı ile dik düşen çizgiler de dikey olarak çizilir. Bunun dışında kalan tüm çizgiler, ufuk çizgisi üzerindeki kaçış noktasına doğru çizilir. | c. Çift kaçış noktalı perspektif |<br />Aşağıdakilerden hangisi tabloda verilen çizim tekniklerinin doğru bir eşleştirmesidir?
    - A-) I-a, II-b, III-c
    - **Cevap B-) I-b, II-c, III-a**
    - C-) I-b, II-a, III-c
    - D-) I-c, II-b, III-a
    - E-) I-c, II-a, III-b

    > **Açıklama:** **Perspektif**<br />Doğru eşleştirme I-b, II-c, III-a biçimindedir.
...
1. Algı ya da üç boyutlu algı kavramı ile ilgili aşağıdakilerden hangisi ya da hangileri doğrudur?<br />1\. Algı kavramına köken olarak anlamak ve kavramak karşılık gelir.<br />2\. Dış dünyanın algılanışı fizyolojik olarak beş duyu organı aracılığıyla sinir sistemine iletilen verilerin iletilmesiyle gerçekleşir.<br />3\. Üç boyutlu algılama görsel algılamanın bir parçası olarak derinlik ve boyutsal algılama kavramla­rıyla ile ilişkilidir.<br />4\. İnsan dünyayı ve çevresini üç boyutlu olarak algılar. Söz konusu bu boyutlar uzunluk ve genişlik ile sınırlıdır.
    ...
    > **Açıklama:** **TASARIMDA ÜÇÜNCÜ BOYUT ALGISI VE YANILSAMA**<br />İlk üç madde doğrudur. İnsan dünyayı ve çevresini üç boyutlu olarak algılar. Söz konusu bu boyutlar uzunluk ve genişlik değil, genişlik, yükseklik ve derinliktir.

    <hr />
1. Arttırılmış gerçekliğe ilişkin aşağıda yer alan ifadelerden hangisi yanlıştır?
...
1. Aslında hareket etmeyen görüntülerin gözlerimizi hareket ettirdikçe hareket ediyor gibi algılanması ya da bazı görsellerde verilen boşluklarda gözlerimizin hareketi ile noktalar gördüğümüzü sanmamız aşağıdakilerden hangisi ile açıklanabilir?
    ...
    - B-) Eğik perspektif
    - **Cevap C-) Optik yanılsama**
    - D-) Konik perspektif
    - E-) Aksonometrik perspektif

    > **Açıklama:** **İKİ BOYUTLU YÜZEYLERDE ALGI YANILSAMASI**<br />Beynimizin üst üste binmiş nesneleri çözümlerken en üstteki nesneyi bize en yakın olarak algıladığını biliyoruz. Bu bilgiyi kullanarak beynimizi yanıltmak ve optik bir yanılsama oluşturmak mümkündür. Renk değerleri, açık koyu ilişkileri de optik yanılsamalar oluşturulurken kullanılır. Aslında hareket etmeyen görüntüler, gözlerimizi hareket ettirdikçe hareket ediyorlar gibi algılan­maktadır. Doğru yanıt C.

    <hr />
1. Avatar sözcüğünün etimolojik kökeni aşağıdakilerden hangisidir?
    - **Cevap A-) Hint mitolojisi**
    - B-) Yunan mitolojisi
    - C-) Kelt mitolojisi
    - D-) Sümer mitolojisi
    - E-) Cermen mitolojisi

    > **Açıklama:** Avatar: Etimolojik olarak Hint mitolojisinde tanrıların yeryüzündeki simgeleri anlamına gelen sözcük günümüz sosyal medya mecralarında insanları temsil eden küçük boyutlu görselleri ifade etmek için kullanılır.
...
1. Aşağıda boyut kavramına ilişkin verilen bilgilerden hangisi ya da hangileri **doğrudur**?<br />1\. Çizgi tek boyutludur.<br />2\. Kare genişliğe ve yüksekliğe sahip iki boyutlu bir şekildir.<br />3\. Küp genişliğe ve yüksekliğe sahip iki boyutlu bir cisimdir.<br />4\. İki boyutlu düzlemde üç boyut etkisi alabilmek için perspektif, ışık ya da gölge gibi yöntemler kullanılır.
    ...
    > **Açıklama:** Doğru yanıt D. Verilen ifadelerden I., II, ve IV madde doğrudur. III. maddede ise doğru yanıt küpün genişlik, yükseklik ve derinliğe sahip üç boyutlu bir cisim olması olacaktır.
...
1. Aşağıdaki ifadelerden hangisi “görüş hattı”nı doğru tanımlar?
    - **Cevap A-) Bakış noktasından ufuk çizgisine doğru baktığımız yöndür**
    - B-) Çizim yapmak için durulan sabit noktadır
    - C-) Ufuk çizgisinin diğer adıdır
    - D-) Bir perspektif türüdür
    - E-) Netlikle ilgili alanı niteler

    > **Açıklama:** Perspektif çizim yapabilmek için önce sabit bir noktada durmak gerekir. Durulan bu noktaya “bakış noktası” denir. Bakış noktasında durup çizilecek cisme bakan kişinin gerçek bakış noktası (gözleri) hizasından geçtiği varsayılan yatay çizgiye ise “ufuk çizgisi” denir. Bakış noktasından ufuk çizgisine doğru baktığımız yöne “görüş hattı” denir.
...
1. Aşağıdaki ifadelerden hangisi “ufuk çizgisi” için yanlıştır?
    ...
    - E-) Ufuk çizgisinin tam üzerindeki cisimlerin altı da üstü de görünmez
    ...
    <hr />
1. Aşağıdakilerden hangisi hava perspektifini yaratan tekniklerden biri değildir?
    - A-) Parlaklık dereceleri
    - B-) Doku dereceleri
    - C-) Renk saturasyonu
    - D-) Sıcak-soğuk renk manipülasyonu
    - **Cevap E-) Gölge yeri**
    ...
    <hr />
1. Aşağıdakilerden hangisi merceksi olarak da bilinen sanat formudur?
    - **Cevap A-) Agamograph**
    - B-) Lentiküler baskı
    - C-) Kâğıt Kesme
    - D-) Üç Boyutlu Cam Boyama
    - E-) Stereoskopik 3D
...
1. Aşağıdakilerden hangisi ona farklı açılardan baktığınızda değişen optik illüzyonlar yaratan bir sanat formu olarak ortaya çıkan ve kendi başına hareket eden ya da istenen etkiyi elde etmek için izleyicinin hareket etmesini gerektiren bir teknik olarak açıklanmaktadır?
    ...
    > **Açıklama:** TASARIMDA ÜÇÜNCÜ BOYUT VE TEKNİK UYGULAMA ALANLARI<br />Merceksi olarak da bilinen agamograph, ona farklı açılardan baktığınızda değişen optik illüzyonlar yaratan bir sanat formu olarak ortaya çıkmıştır. Bu sanat tarzı, kinetik sanat yapan ya da kendi başına hareket eden ya da istenen etkiyi elde etmek için izleyicinin hareket etmesini gerektiren Yaacov Agam adlı bir İsrailli sanatçının adını almıştır. Kinetik Sanat’a (ing. kinetic art) öncülük etmesiyle tanınan sanatçı, izleyicinin bakış açısına göre üç boyutun ön plana çıktığı eserlerinde ses ve ışığın da birlikte kullanmıştır.

    <hr />
1. Aşağıdakilerden hangisi perspektif çizimde bakış noktasından ufuk çizgisine doğru baktığımız yönü tanımlar?
    - A-) Bakış noktası
    - B-) Kaçış noktası
    - C-) Ufuk çizgisi
    - D-) İkonik perspektif
    ...
    > **Açıklama:** **Perspektif**<br />Bakış nokta­sından ufuk çizgisine doğru baktığımız yöne “görüş hattı” denir. Doğru yanıt E.
...
1. Gözlemci ve nesne arasındaki mesafe …………. ile ilişkili iken nesne, kişi ve mekanın yatay ve dikey eksende ölçüleri ve derinliği ……. ile ilişkilidir.<br />**Yukarıda verilen metindeki boşluklara sırasıyla aşağıdakilerden hangisi gelebilir?**
    - A-) Algı-tasarım
    - B-) Uzaklık algısı –boyutsal algılama
    - **Cevap C-) Derinlik algısı- boyutsal algılama**
    - D-) Görsel algı-derinlik algısı
    - E-) Boyutsal algılama-derinlik algısı

    > **Açıklama:** **TASARIMDA ÜÇÜNCÜ BOYUT ALGISI VE YANILSAMA**<br />**Derinlik algısı** gözlemci ile nesne arasındaki mesafe ile ilişkilidir. **Boyutsal algılama** ise nesne, kişi ve mekânın yatay ve dikey eksende ölçüleri ve derinliğiyle ilgilenir.
...
1. I.Üçüncü boyut etkisinin soyut sanatta çıkan en uç noktasıdır.<br />II.1960’larda ortaya çıkmıştır.<br />III.İkinci Dünya Savaşı sonrasında geçerli olan “post painterly” anlayışa karşıt olarak Avrupa’da ortaya çıkmış bir akımdır.<br />IV. Akım Neo Dadaist görüşün canlanmasını sağlamak için getirilen önerilerle başlamıştır.<br />Yukarıdaki ifadelerden **hangisi/hangileri** *optik sanatı* doğru tanımlar?
    ...
    > **Açıklama:** Batı sanatının Rönesans’tan beri iki boyutlu resim düzlemi içerisinde vermeye çalıştığı üçüncü boyut etkisinin soyut sanatta çıkan en uç noktası olan Optik Sanat ya da Op-Art ise 1960’larda ortaya çıkmıştır. Optik Sanat II. Dünya Savaşı sonrasında geçerli olan “post painterly” (geç resimsel) anlayışa karşıt olarak Avrupa’da ortaya çıkmış bir akımdır. Akımın ilk hareketi 1950’li yılların başlangıcında tek başına ya da grup hâlinde birkaç sanatçının soyut geometrik sanatta olduğu gibi ‘informel’in ötesine geçebilmek ve bir Neo Dadaist görüşün canlanmasını **önlemek** üzere getirdikleri önerilerle başlamıştır.
...
1. Sanal gerçeklik ile ilgili aşağıda verilen tanımlardan hangisi ya da hangileri doğrudur?<br />1\. Sanal gerçeklik bilgisayarlar aracılığıyla sayısal olarak tasarlanan üç boyutlu simülasyonların özel donanımlarla deneyimlenebildiği ortamlardır.<br />2\. Sanal gerçeklik gerçek bir hayatın bilgisayar tarafından üç boyutlu olarak oluşturulan kopyası anlamına gelir.<br />3\. Sanal gerçeklik insana gerçek yanılmasını en üst düzeyde yaşatan kurgusal ortamlardır
    ...
    > **Açıklama:** Gerçeklik ve Virtüellik Kavramları<br />Verilen tüm tanımlar sanal gerçekliğin tanımıdır. Doğru yanıt E.
...
1. Sosyal medya mecralarında insanları temsil eden küçük boyutlu görselleri ifade etmek için kullanılan etimolojik olarak Hint mitolojisinde tanrıların yeryüzündeki simgeleri anlamına gelen sözcük aşağıdakilerden hangisidir?
    ...
    > **Açıklama:** **Gerçeklik ve Virtüellik Kavramları**<br />Avatar: Etimolojik olarak Hint mitolojisinde tanrıların yeryüzündeki simgeleri anlamına gelen sözcük günümüz sosyal medya mecralarında insanları temsil eden küçük boyutlu görselleri ifade etmek için kullanılır. Dolayısıyla doğru yanıt C.
...
1. İnsan gözüne en yakın ve gerçekçi sonuçlar veren perspektif türü ………………………..perspektifdir.<br />Yukarıdaki cümlede boş bırakılan yeri aşağıdakilerden hangisi doğru olarak tamamlar?
    ...
    <hr />
1. ………………………………….. en basit düzeyde kullanıcılarına iki göz için farklı görüntü sinyallerinin gösterilmesiyle izlenilen görselin üç boyutlu şekilde algılanmasıdır.<br />Yukarıdaki cümlede boş bırakılan yeri aşağıdakilerden hangisi doğru tamamlar?
    - **Cevap A-) Stereoskopik 3D**
    - B-) Ames room
    - C-) Post painterly
    - D-) Avatar
    - E-) İki boyutlu tasarım
