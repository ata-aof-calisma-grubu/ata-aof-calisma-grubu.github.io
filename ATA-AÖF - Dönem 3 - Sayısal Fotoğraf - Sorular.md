...
1. <strong>Tamamlayıcı renkler olarak da bilinen ve birlikte kullanıldığında birbirlerinin g&uuml;c&uuml;n&uuml; artıran renkler aşağıdakilerden hangisidir?</strong>
    ...
    - E-) Koyu renkler
    <hr />
1. <strong>&Uuml;&ccedil;te bir kuralındaki &ccedil;izgilerle b&ouml;l&uuml;nen kadrajda ka&ccedil; tane kesişim noktası oluşmaktadır?</strong>
    - A-) 1
    - B-) 5
    - **Cevap C-) 4**
    - D-) 7
...
1. <strong>Işığın az olmasından kaynaklı ve renklerin algılayıcı tarafından tam olarak belirlenememesinden dolayı g&ouml;r&uuml;nt&uuml;de koyu alanlarda oluşan hatalı renkte pikselleşmeye ne ad verilir?</strong>
    - A-) Renk ısınması
    - B-) ISO
    - **Cevap C-) Renk g&uuml;r&uuml;lt&uuml;s&uuml;**
    - D-) Color code
    - E-) RGB
    <hr />
...
1. <strong>Aşağıdakilerden hangisi yaygın temel/tam enstantane duraklarından biri <u>değildir</u>?</strong>
    ...
    - **Cevap E-) 1/95 sn**
    <hr />
1. <strong>Optik &ccedil;apı en fazla 25 mm olan, 50 mm odak uzaklığında normal bir lensin diyafram a&ccedil;ıklığı en fazla ka&ccedil; f/ olur?</strong>
    - A-) f/4
    - **Cevap B-) f/2**
    - C-) f/0.5
    - D-) f/25
...
1. <strong>Manzara fotoğraf&ccedil;ılığında &ldquo;altın saat&rdquo; olarak ifade edilen zaman dilimi a</strong><strong>şağıdakilerden hangisidir?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi manzara fotoğraf&ccedil;ılığında kullanılan yardımcı ekipmanlardan <u>değildir</u>?</strong>
    - A-) Filtreler
    - B-) &Uuml;&ccedil;ayak
...
1. <strong>Full-frame olmayan, 1.5 &ccedil;arpanlı bir fotoğraf makinesinde kullanılacak 50mm sabit bir objektifin, mm cinsinden karşılık geldiği objektif aşağıdakilerden hangisidir?</strong>
    ...
    - **Cevap E-) 75**
    <hr />
1. <strong>Algılayıcı sens&ouml;r&uuml;n yanlış bir değerde olması, standartlardan &ccedil;ok daha az miktarda ışığa maruz bırakılması aşağıdakilerden hangisi ile a&ccedil;ıklanabilir?</strong>
    - A-) Full-frame
...
1. <strong>Fotoğraf makinelerinde doğru diyafram a&ccedil;ıklığı ve buna uygun d&uuml;şen &ouml;rt&uuml;c&uuml; enstantane hızını belirleyebilmek i&ccedil;in makine g&ouml;vdesinde bulunan ışığın miktarını hassas bi&ccedil;imde &ouml;l&ccedil;en d&uuml;zeneğe ne ad verilir?</strong>
    ...
    - E-) Viz&ouml;r
    <hr />
1. <strong>Fotoğraf makinelerinde 1/8000, 1/250, 1/60 gibi enstantane değerleri arasında bulunan, B &lsquo;Bulb&rsquo; se&ccedil;eneği bir fotoğraf &ccedil;ekimi sırasında hangi ama&ccedil;la kullanılır?</strong>
...
1. <strong>Aşağıdakilerden hangisi &ccedil;ekim aşamasında pozlama se&ccedil;enekleri arasında <u>yer almaz</u>?</strong>
    ...
    <hr />
1. <strong>Fotoğraf &ccedil;ekimi esnasında tercih edilmesi gereken, elde edilecek sayısal fotoğrafları g&ouml;r&uuml;nt&uuml; kaybına uğratmadan, gerekli d&uuml;zenlemeler yapılmasına imk&acirc;n sağlayan kayıt formatı aşağıdakilerden hangisidir?</strong>
    - A-) JPEG
    - **Cevap B-) RAW**
    - C-) PDF
    - D-) DOC
...
1. <strong>Aşağıdaki programlardan hangisi sayısal fotoğraf işleme programı <u>değildir</u>?</strong>
    ...
    - E-) Gimp
    <hr />
1. <strong>Aşağıdaki se&ccedil;eneklerden hangisi Adobe firması tarafından &uuml;retilen sayısal fotoğraf işleme programıdır?</strong>
    - **Cevap A-) Lightroom**
    - B-) AutoPano Giga
    - C-) Gimp
    - D-) Photomatix
    - E-) PhotoScape
    <hr />
1. <strong>Buna g&ouml;re aşağıda belirtilen marka ve uzantı ilişkilerinden hangisi doğru <u>değildir</u>?</strong>
    - A-) Canon - .cr2
    - B-) Nikon -.nef
    ...
    - E-) Fujifilm - .raf
    <hr />
1. <strong>Y&uuml;ksek dinamik aralık hangi fotoğraf t&uuml;r&uuml;n&uuml; ifade etmektedir?</strong>
    - A-) K&uuml;resel panaromik fotoğraf
    - B-) Hareketli fotoğraf
    - C-) Belgesel fotoğraf
    - **Cevap D-) HDR fotoğraf**
    - E-) Silindirik panaromik fotoğraf
    <hr />
1. <strong>Aşağıdakilerden hangisi Panaromik fotoğraf oluşturmak i&ccedil;in kullanılan bir programdır?</strong>
    - A-) İllustrat&ouml;r
    - B-) Corel DRAW
    - C-) InDesing
    - D-) Zbrush
...
1. <strong>Aşağıdakilerden hangisi piksel tabanlı bir sayısal fotoğraf işleme programdır?</strong>
    ...
    - E-) 3D Studio Max
    <hr />
1. <strong>Y&uuml;ksek &ccedil;&ouml;z&uuml;n&uuml;rl&uuml;kl&uuml; sayısal fotoğraflar &uuml;zerinde d&uuml;zenleme işlemi yapılırken ihtiya&ccedil; duyulan bilgisayar sistemleri se&ccedil;imi i&ccedil;in aşağıdakilerden hangisinin &ouml;nemi <u>yoktur</u>?</strong>
    - A-) Sabit s&uuml;r&uuml;c&uuml; hızı
    - B-) İşlemci hızı
    - C-) Ram kapasitesi
    - D-) Ekran boyutu
...
1. <strong>Aşağıdakilerden hangisi Ligtroom programının 5 temel d&uuml;zenleme mod&uuml;l&uuml;nden biri&nbsp;<u>değildir</u>?</strong>
    ...
    - E-) SlideShow
    <hr />
1. <strong>Aşağıdakilerden hangisi y&uuml;ksek &ccedil;&ouml;z&uuml;n&uuml;rl&uuml;kl&uuml; sayısal fotoğraf &ccedil;alışmaları yapılırken kullanılacak ekranlar i&ccedil;in &ouml;nemli olan unsurlardan biri <u>değildir</u>?</strong>
    - A-) Ekran boyutları
    - **Cevap B-) Ekran kasasının plastik malzemeden olması**
    - C-) Mat ekran kullanımı
    - D-) Ekranın kalibre edilmiş olması
    - E-) Orijinal renk g&ouml;sterim performansı
    <hr />
1. <strong>Gimp programının dosya uzantısı aşağıdakilerden hangisidir?</strong>
    ...
    - E-) .tiff
    <hr />
1. <strong>Sayısal fotoğraflarda &ouml;n g&ouml;r&uuml;len d&uuml;zenlemeler yapılırken, ekran &uuml;zerine d&uuml;şen yansımaları engellemek i&ccedil;in kullanılan aparat aşağıdakilerden hangisidir?</strong>
    - A-) Ekran kartı
    - B-) Colormetre
    ...
    <hr />
1. <strong>RAW formatında bir fotoğraf &uuml;zerinde &ouml;n g&ouml;r&uuml;len d&uuml;zenlemeler Photoshop programında uygulanmak istendiğinde ilk a&ccedil;ılan pencere aşağıdakilerden hangisidir?</strong>
    - A-) &Ccedil;alışma alanı
    - B-) Histogram paneli
...
1. <strong>Geniş alanların (360 derece a&ccedil;ıların dahi) g&ouml;r&uuml;nt&uuml;lenebilmesini sağlayan, &ccedil;eşitli sayısal fotoğraf işleme programları ile birden fazla fotoğrafın birleştirildiği fotoğraf tekniği aşağıdakilerden hangisidir?</strong><br />
    ...
    - E-) Kurgusal fotoğraf
    <hr />
1. <strong>Photoshop programı eklentisi olarak kullanılan Camera RAW ile sayısal fotoğraflar &uuml;zerinde aşağıdaki işlemlerin hangisi <u>yapılamaz</u>?</strong>
    - A-) Pozlama ayarı
    - B-) Kontrast ayarı
    - C-) Beyaz ayarı
    ...
    <hr />
## Unite 11
1. <strong>Aşağıdakilerden hangisi Photoshop programının &ldquo;tercihler&rdquo; men&uuml;s&uuml;n&uuml; a&ccedil;an komuttur?</strong>
    ...
    <hr />
1. <strong>Photoshop&rsquo;ta yeni dok&uuml;man a&ccedil;mak i&ccedil;in hangi komut kullanılır?</strong>
    - A-) Select / Inverse
    - B-) Layer/ New
    - C-) File / Save As
    - D-) Edit / Copy
    ...
    <hr />
1. <strong>Photoshop&rsquo;ta aşağıdaki se&ccedil;eneklerin hangisinde belirtilen m&uuml;dahaleler&rdquo;Edit&rdquo; men&uuml;s&uuml;n&uuml;n komutları ile yapılmaktadır?</strong>
    - A-) G&ouml;rseli farklı kaydetmek
...
1. <strong>Renkli bir g&ouml;rseli, renk değerleri bozulmadan siyah beyaza &ccedil;evirebilmek i&ccedil;in aşağıdaki komutlardan hangisi se&ccedil;ilmelidir?</strong>
    ...
    <hr />
1. <strong>Metinleri d&uuml;zenleyen komutları i&ccedil;eren photoshop men&uuml;s&uuml; aşağıdakilerden hangisidir?</strong>
    - **Cevap A-) Type men&uuml;s&uuml;**
    - B-) 3D men&uuml;s&uuml;
    - C-) Layer men&uuml;s&uuml;
    - D-) View men&uuml;s&uuml;
    - E-) Help men&uuml;s&uuml;
    <hr />
1. <strong>Photoshop&rsquo;ta &ldquo;Select&rdquo; men&uuml;s&uuml;nde bulunan &ldquo;Inverse&rdquo; komutunun işlevi aşağıdaki se&ccedil;eneklerin hangisinde doğru olarak belirtilmiştir?</strong>
    - A-) G&ouml;rselin tamamını se&ccedil;ili h&acirc;le getirmek i&ccedil;in kullanılır.
    - B-) Se&ccedil;im alanını, 3D bir nesne &uuml;zerine materyal olarak atar.
    - C-) Sa&ccedil;, t&uuml;y gibi g&ouml;rseller &uuml;zerinde ayrıntılı se&ccedil;im yaparak, istenilen alanlara ayrıntılı ve kolay m&uuml;dahale etmek i&ccedil;in kullanılır.
    - **Cevap D-) Se&ccedil;ili alan se&ccedil;imden &ccedil;ıkarılır ve se&ccedil;ili olmayan kısmın tamamı se&ccedil;ili h&acirc;le getirilir.**
    - E-) Se&ccedil;im alanına fare yardımı ile perspektif, b&uuml;kme, b&uuml;y&uuml;ltme-k&uuml;&ccedil;&uuml;ltme işlemleri uygulamak i&ccedil;in kullanılır.
    <hr />
1. <strong>Photoshop programında a&ccedil;ık olan g&ouml;rseli, tekrar &ldquo;Camera Raw&rdquo; penceresinde a&ccedil;mak ve Camera Raw se&ccedil;enekleri ile tekrar m&uuml;dahale etmek i&ccedil;in aşağıdaki komutlardan hangisi kullanılır?</strong>
    - A-) Last Filter
    ...
    <hr />
1. <strong>Photoshop&#39;ta &ccedil;alışma esnasında g&ouml;rsellere yapılan m&uuml;dahaleleri adım adım kaydederek daha sonra kaydedilen bu m&uuml;dahalelere geri d&ouml;n&uuml;p yapılan değişiklikleri iptal etme olanağı sunan panel aşağıdakilerden hangisidir?</strong>
    ...
    - E-) Adjusments paneli
    <hr />
1. <strong>Kontrol panelinin i&ccedil;eriği aşağıdaki se&ccedil;eneklerin hangisinde doğru olarak belirtilmiştir?</strong>
    - A-) T&uuml;m panellerin renk se&ccedil;enekleri
    - B-) Programın yardım se&ccedil;enekleri
    - C-) T&uuml;m yardımcı pencereler
    - **Cevap D-) Se&ccedil;ili olan aracın se&ccedil;enekleri**
    - E-) Programla ilgili t&uuml;m kısa yollar
    <hr />
1. <strong>Photoshop&rsquo;ta dok&uuml;man &uuml;zerinde yapılan m&uuml;dahaleler, farklı bir konumda ya da farklı bir isimle kaydetmek i&ccedil;in hangi kısa yol kullanılır?</strong>
    - A-) Control + Z
...
1. <strong>Aşağıdakilerden hangisi Photoshop men&uuml; &ccedil;ubuğunda bulunan men&uuml;lerden biridir?</strong>
    ...
    - **Cevap B-) Layer men&uuml;s&uuml;**
    - C-) Devolop men&uuml;s&uuml;
    - D-) SlideShow men&uuml;s&uuml;
    - E-) Print men&uuml;s&uuml;
    <hr />
1. <strong>Photoshop programında aşağıdaki komutlardan hangisi &ldquo;file&rdquo; men&uuml;s&uuml; i&ccedil;eriğindeki komutlar ile <u>ger&ccedil;ekleştirilemez</u>?</strong>
    - A-) Mevcut bir belgeyi a&ccedil;mak
    - B-) Mevcut projeyi varsayılan dosya bi&ccedil;iminde kaydetmek
    - C-) Mevcut projeyi farklı bir konumda kaydetmek
    - D-) Mevcut projeyi kapatmak
    - **Cevap E-) Mevcut projeye filtre uygulamak**
    <hr />
1. <strong>Aşağıda belirtilen &ldquo;Photoshop / Edit / Transform&rdquo; men&uuml;s&uuml; i&ccedil;eriğindeki komutlardan hangisinin g&ouml;revi <u>yanlıştır</u>?</strong>
    - A-) Rotate, se&ccedil;ili alanı/dok&uuml;manı d&ouml;nd&uuml;rmek i&ccedil;in kullanılır.
    - B-) Perspective, se&ccedil;ili alana/dok&uuml;mana perspektif d&uuml;zenlemeleri yapmak i&ccedil;in kullanılır.
    - C-) Rotate 180, dok&uuml;manı 180 derece d&ouml;nd&uuml;rmek i&ccedil;in kullanılır.
    - **Cevap D-) Warp: PDF (Taşınabilir Dosya Formatı) ayarlarını yapmak i&ccedil;in kullanılır.**
    - E-) Rotate 90 Clockwise, dok&uuml;manı saat y&ouml;n&uuml;nde 90 derece d&ouml;nd&uuml;rmek i&ccedil;in kullanılır.
    <hr />
1. <strong>Photoshop programında g&ouml;rseller &uuml;zerinde ayrıntılı renk ve ton d&uuml;zenlemelerinin yapıldığı men&uuml; aşağıdakilerden hangisidir?</strong>
    - **Cevap A-) Image men&uuml;s&uuml;**
    - B-) Select men&uuml;s&uuml;
    - C-) Type men&uuml;s&uuml;
    - D-) Window men&uuml;s&uuml;
    - E-) File men&uuml;s&uuml;
    <hr />
1. <strong>Photoshop&rsquo;ta &ccedil;alışmanın boyutlarını değiştirmek i&ccedil;in kullanılan komut aşağıdakilerden hangisidir?</strong>
    - A-) View / Proof Setup
    ...
    - E-) Edit / Copy
    <hr />
1. <strong>Photoshop&rsquo;ta kamera objektifinden kaynaklanan perspektif hatalarını d&uuml;zeltmek i&ccedil;in kullanılan komut penceresi aşağıdakilerden hangisidir?</strong>
    - A-) Sharpen Filter
    - B-) Liquify
    - C-) Canvas Filter
    - D-) Last Filter
    ...
    <hr />
1. <strong>Photoshop programında g&ouml;rseller &uuml;zerinde &ccedil;eşitli g&ouml;r&uuml;n&uuml;mler elde etmek i&ccedil;in kullanılan efektlerin bulunduğu men&uuml; aşağıdakilerden hangisidir?</strong>
    - A-) Image men&uuml;s&uuml;
    - B-) File men&uuml;s&uuml;
    - C-) Devolop men&uuml;s&uuml;
...
1. <strong>Photoshop&rsquo;ta &ccedil;alışılan g&ouml;rsel ya da tasarım &uuml;zerindeki katmanların, ayrı ayrı izlenebilmesini ve gerekli g&ouml;r&uuml;len ayarların uygulanabilmesini sağlayan panel aşağıdakilerden hangisidir?</strong> 
    ...
    - E-) Adjusments paneli
    <hr />
1. <strong>Photoshop&rsquo;ta &ldquo;Control + S&rdquo; kısayol komutunun işlevi aşağıdakilerin hangisidir?</strong>
    - A-) Se&ccedil;imin tersini se&ccedil;
    - B-) Adım adım ileri al
    - **Cevap C-) Değişiklikleri kaydet**
    - D-) T&uuml;m&uuml;n&uuml; se&ccedil;
    - E-) G&ouml;r&uuml;nt&uuml;y&uuml; %100 b&uuml;y&uuml;t
    <hr />
## Unite 12
...
1. <strong>Beyaz ışığın prizmadan ge&ccedil;irilmesiyle oluşan kırılmada hangi renkler g&ouml;r&uuml;lebilir?</strong>
    ...
    - E-) Yeşil, Mavi ve Mor
    <hr />
1. <strong>5500K değerinin altındaki renk sıcaklığı değerlerinde bulunan ışık, hangi renkleri i&ccedil;ermeye başlar?</strong>
    - A-) Mavi ve Tonlarını
...
1. <strong>Aşağıdakilerden hangisi doğal ışık kaynağıdır?</strong>
    ...
    - **Cevap E-) Ay ışığı**
    <hr />
1. <strong>Aşağıdakilerden hangisi renk sentezlerinin kullanım ama&ccedil;larından biri <u>değildir</u>?</strong>
...
III. Sarı<br />
IV. Yeşil<br />
<strong>Yukarıdakilerden hangisi ya da hangileri renk tayfında yer alır?</strong>
    - A-) I ve II
    - B-) III ve IV
    - C-) Yalnız III
...
1. <strong>Aşağıdakilerden hangisi rengin oluşabilmesi /g&ouml;r&uuml;lebilmesi i&ccedil;in gerekli olan ana unsurlardan biridir?</strong> 
    ...
    - E-) Renk paleti
    <hr />
1. <strong>Adını William Thompson&rsquo;ın soyadından alan renk sıcaklığı &ouml;l&ccedil;&uuml; birimi aşağıdakilerden hangisidir?</strong>
    - **Cevap A-) Kelvin**
    - B-) Kalori
    - C-) Derece
    - D-) İn&ccedil;
    - E-) Paskal
    <hr />
1. <strong>Kelvin cinsinden doğal g&uuml;n ışığının standart renk sıcaklığı aşağıdakilerden hangisidir?</strong>
    - A-) 2000K
    - B-) 2500K
    - C-) 3500K
    - **Cevap D-) 5500K**
    - E-) 7500K
    <hr />
1. <strong>Renk sentezlerinin / modellerinin renkleri tanımlamak i&ccedil;in kullandığı &uuml;&ccedil; ana unsur aşağıdakilerden hangisinde doğru verilmiştir?</strong>
    - **Cevap A-) Renk t&uuml;r&uuml; / doygunluk / parlaklık**
    - B-) Renk t&uuml;r&uuml; / prizma / doygunluk
    - C-) Renk t&uuml;r&uuml; / doygunluk / gramaj
    - D-) Saflık / doygunluk / matlık
    - E-) Saflık / doygunluk / siyah miktarı
    <hr />
1. <strong>Aşağıdakilerden hangisi cihaz bağımlı renk modellerinin &ouml;zellikleri arasında <u>yer almaz?</u></strong>
    - A-) Cihaz bağımlı renk modellerindeki renk alanları değişmez ve sabittir.
    - B-) Cihaz bağımlı renk modelleri CIE L*a*b renk modeli gibi renk modellerini i&ccedil;erir.
    - **Cevap C-) Cihaz bağımlı renk modelleri CIE XYZ gibi renk modellerini i&ccedil;erir.**
...
1. <strong>Aşağıdaki &ouml;zelliklerden hangisi toplamsal renk sentezinin &ouml;zelliklerinden biri&nbsp;<u>değildir</u>?</strong> 
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi &ccedil;ıkarımsal renk sentezini ifade eder?</strong>
    - A-) RGB
    - **Cevap B-) CMYK**
    - C-) CIE L*a*b
    - D-) CIE XYZ
...
1. <strong>Renk y&ouml;netiminin uygulanmasındaki en &ouml;nemli neden aşağıdakilerden hangisidir?</strong> 
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi g&ouml;r&uuml;lebilir renk spektrumunda daha geniş bir renk alanına sahiptir?</strong>
    - **Cevap A-) Film**
    - B-) Projekt&ouml;r
    - C-) Tarayıcı
    - D-) Monit&ouml;r
...
1. <strong>Aşağıdakilerin hangisinde fotoğraf makinelerinde bulunan beyaz ayarı se&ccedil;eneklerinin kullanımı <u>yanlıştır</u>?</strong> 
    ...
    - D-) Beyaz ayarında bulunan otomatik se&ccedil;eneği beyaz ayarını fotoğraf makinesinin yapması i&ccedil;in tercih edilir.
    - **Cevap E-) Beyaz ayarında bulunan Floresan se&ccedil;eneği tungsten sarı ampullerle aydınlatılan ortamlarda tercih edilir.**
    <hr />
1. <strong>Renk y&ouml;netimi iş akışı i&ccedil;inde, monit&ouml;rde yapılacak bir fotoğraf &ccedil;alışması i&ccedil;in aşağıdakilerden hangisinin d&uuml;zenlenmesine veya yapılmasına gerek <u>duyulmaz</u>?</strong>
    - A-) Monit&ouml;r kalibrasyonun yapılması
    - B-) Monit&ouml;r&uuml;n bulunduğu odanın duvar renklerinin dikkate alınması
    - C-) Monit&ouml;r&uuml;n bulunduğu odanın ışıklandırma koşulları
    - **Cevap D-) Monit&ouml;rde &ccedil;alışılacak fotoğrafın keskinliğinin artırılması**
    - E-) Monit&ouml;r&uuml;n aydınlık seviyesinin kontrol&uuml;
    <hr />
1. <strong>Bir monit&ouml;r&uuml;n kalibrasyonu yapılırken, kalibrasyon i&ccedil;in kullanılan colormetrenin (renk&ouml;l&ccedil;erin) nerede durması gerekmektedir?</strong>
    - A-) Monit&ouml;r&uuml;n altında
    - **Cevap B-) Monit&ouml;r&uuml;n tam ortasında ve ekrana tam olarak yapışmış olarak**
    - C-) Monit&ouml;r&uuml;n yaklaşık 20 cm uzağında
    - D-) Monit&ouml;r&uuml;n sağ &uuml;st k&ouml;şesinde
    - E-) Monit&ouml;r&uuml;n sol alt k&ouml;şesinde
    <hr />
1. <strong>Bir monit&ouml;r&uuml;n kalibrasyonunu yapmak i&ccedil;in kullanılacak cihaz / donanım aşağıdakilerden hangisidir?</strong>
    - A-) Renk paleti
    - **Cevap B-) Colormetre (renk&ouml;l&ccedil;er)**
    - C-) Pozometre
    - D-) Başka bir bilgisayar
    - E-) Başka bir monit&ouml;r
    <hr />
1. <strong>Kalibrasyon i&ccedil;in kullanılan colormetre cihazları / donanımları aşağıdaki işlemlerden hangisini ger&ccedil;ekleştirir?</strong>
    - A-) Monit&ouml;r&uuml;n yaydığı zararlı ışığı &ouml;nler.
    - B-) Monit&ouml;r&uuml;n hız performansını &ouml;l&ccedil;er.
    - C-) Monit&ouml;r&uuml;n kullanım s&uuml;resini hesaplar.
    - **Cevap D-) Monit&ouml;r &uuml;zerinden renk &ouml;l&ccedil;&uuml;mleri yapar.**
    - E-) Monit&ouml;r&uuml;n fazla ısınmasını &ouml;nler.
    <hr />
1. <strong>Monit&ouml;r kalibrasyonunun hangi aralıklarla yapılması &ouml;nerilir?</strong>
    - A-) Yılda bir kez
    - B-) İki yılda bir
...
1. <strong>Aşağıdakilerden hangisi monit&ouml;r kalibrasyonunda &ouml;ncelikli ve ilk olarak yapılması gereken bir işlemdir?</strong> 
    ...
    - D-) Bilgisayara kurulan, colormetre programının a&ccedil;ılması
...
1. <strong>Aşağıdakilerden hangisi RGB renk modeline dayalı renk alanlarındandır?</strong>
    ...
    - E-) CIE L*C*H*
    <hr />
1. <strong>İn&ccedil; başına d&uuml;şen piksel sayısı aşağıdaki terimlerden hangisi ile ifade edilir?</strong>
    - A-) DPI
    - **Cevap B-) PPI**
    - C-) Piksel
    - D-) RGB
...
1. <strong>M&uuml;rekkep p&uuml;sk&uuml;rtmeli bir yazıcıdan yeterli kalitede bir baskı almak i&ccedil;in aşağıdaki &ouml;zelliklerden hangisine <u>gerek duyulmaz</u>?</strong>
    ...
    - C-) Yazıcının p&uuml;sk&uuml;rtt&uuml;ğ&uuml; m&uuml;rekkep damlacığı sayısı
    - **Cevap D-) Yazıcının ağırlığı**
    - E-) Kullanılan k&acirc;ğıdın &ouml;zellikleri
    <hr />
