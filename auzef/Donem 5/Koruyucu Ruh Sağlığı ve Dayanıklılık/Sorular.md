...
1. Büyüme ve gelişmeyle ilgili aşağıdakilerden hangisi <u>yanlıştır</u>?
    ...
    - D-) Ebeveynlerinin gebelik döneminde içinde bulundukları sosyal çevre bebeğin psikolojik gelişiminde etkilidir.
    - E-) Her insanın büyüme ve gelişimi doğum öncesi dönemden başlar.

    > **Açıklama:** İnsanlarda beyin gelişimi ve sinir hücrelerinin esnekliği <b>diğer canlılardan daha uzun sürer</b>. Bu nedenle esnekliğin kısa sürdüğü ifadesi yanlıştır.

    <hr />

### 1.2. Koruyucu Ruh Sağlığının Tanımı ve Bileşenleri

1. Koruyucu ruh sağlığı ve bileşenleri için aşağıdakilerden hangisi <u>söylenemez</u>?
    - A-) Koruyucu ruh sağlığı, ruh sağlığı hizmetlerinin önemli bir bileşenidir.
    - B-) Birincil ve ikincil koruma özellikle çocuklarda çok önemlidir.
    - C-) Çocuk gelişimi uzmanları koruyucu ruh sağlığının her aşamasında etkin rol alabilirler.
    - D-) Koruyucu ruh sağlığı çalışmaları tedavi edici yaklaşımlara kıyasla daha kolay, ucuz ve etkili olabilirler.
    - **Cevap E-) Koruyucu ruh sağlığı <u>yalnızca</u> hastalıkların ortaya çıkmamasını hedefler.**
...
1. Aşağıdakilerden hangisi birincil veya ikincil bir koruyucu ruh sağlığı önlemi veya örneği <u>değildir</u>?
    ...
    - D-) Erken çocuklukta otizm taraması yapmak
    - E-) Davranış sorunları olan çocukları tanı ve tedavi için yönlendirmek
...
1. Aşağıdakinin hangisinin normal gelişen sağlıklı çocuklarda koruyucu ruh sağlığı önlemi olması <u>beklenmez</u>?
    ...
    - **Cevap D-) Rehabilitasyon programları oluşturmak**
    - E-) Sağlıklı beslenme ve uyku hijyeni
...
1. Çocuklarda koruyucu ruh sağlığı ve dayanıklılığın gelişmesi açısından aşağıdakilerden hangisi çocuk gelişim uzmanının işlevlerinden birisi olması <u>beklenmez</u>?
    ...
    - D-) Gelişimsel veya davranışsal sorunu olan çocukların eğitim ve rehabilitasyonunda yer almak
    - **Cevap E-) Çocuklarda psikiyatrik bozuklukların tedavisini gerçekleştirmek**

    > **Açıklama:** Çocuk gelişim uzmanlarının görevleri arasında sağlıklı gebelikle ilgili eğitici programlar düzenlemek, taramalar yapmak ve rehabilitasyonda yer almak gibi koruyucu ve destekleyici işlevler bulunsa da, <b>psikiyatrik bozuklukların tedavisini gerçekleştirmek</b> (ilaç tedavisi dahil) beklenmez.

    <hr />

### 1.3. Çocukluk ve Ergenlik Döneminde Koruyucu Ruh Sağlığının Önemi

1. Çocuk gelişiminde kritik ve hassas dönemlerle ilgili olarak aşağıdakilerden hangisi <u>söylenemez</u>?
    - A-) Çocuk gelişimi ve ruh sağlığı alanında çalışan uzmanlar kritik ve hassas dönemleri iyi bilmelidir.
    - B-) Kritik dönemler aniden başlayıp bitme eğilimindedirler.
    - C-) Bebeklik dönemi güvenli bağlanma için kritik dönemdir.
    - **Cevap D-) Hassas dönemdeki eksiklerin yerine konulması <u>mümkün değildir</u>.**
    - E-) Erken çocukluk dönemi öz kontrol becerilerinin kazanılmasında hassas dönemdir.
...
1. Aşağıdaki ifadelerden hangisi çocukluk ve ergenlik dönemi ruh sağlığı sorunlarının etkileri hakkında <u>söylenemez</u>?
    ...
    - D-) Erken yaşta başlayan psikiyatrik bozukluklar, ilerideki yaşamda da devam edebilir.
    - E-) Yüksek oranda tedavi edilmemiş ruhsal bozukluklarla ilişkilidir.
...
1. Beynin en esnek olduğu, çevresel faktörlerin etkisine ve yeni tecrübelere en açık olunan dönemlerin <u>\_\_\_\_\_\_\_\_\_</u> olduğu bilinmektedir. Yukarıdaki boşluğa getirilebilecek en uygun ifade aşağıdakilerden hangisidir?
    ...
    > **Açıklama:** Beynin en esnek olduğu, çevresel faktörlerin etkisine ve yeni tecrübelere en açık olunan dönemlerin <b>doğum öncesi ve erken çocukluk yılları</b> olduğu bilinmektedir.

    <hr />

### 1.4. Psikolojik Dayanıklılığın Tanımı ve Önemi

1. Psikolojik dayanıklılık hakkında aşağıdakilerden hangisi <u>söylenemez</u>?
    - A-) Psikolojik dayanıklılığın gelişmesi için bireyin birtakım zorluklarla karşılaşması gerekir.
    - B-) Psikolojik dayanıklılık zaman içinde gelişen, değişen, öğrenilen bir durumdur.
    - C-) Psikolojik dayanıklılık, kişinin zorluklarla başa çıkabilme kapasitesini tanımlar.
    - **Cevap D-) Psikolojik dayanıklılık genetik faktörlere bağlıdır ve <u>değiştirilemez</u>.**
    - E-) Dayanıklılık, zorluk öncesi durumuna dönebilme kapasitesini ifade eder.
...
1. <u>\_\_\_\_\_\_\_\_\_</u>, bir kişinin zorluklarla başa çıkabilme, adaptasyon gösterebilme ve zorluk öncesi durumuna dönebilme kapasitesini tanımlar. Yukarıdaki cümlede boş bırakılan yere hangisinin gelmesi en uygundur?
    ...
    - D-) Nörolojik dayanıklılık
    - E-) Koruyucu ruh sağlığı
...
1. Aşağıdakilerden hangisi ruh sağlığı veya dayanıklılık açısından koruyucu faktörlerden biri <u>değildir</u>?
    ...
    - D-) İnanç sahibi olmak
    - **Cevap E-) Sosyal medya kullanımı**

    > **Açıklama:** Güçlü aile ve sosyal bağlar, spor/sanat ve inanç sahibi olmak koruyucu faktörlerdir. <b>Sosyal medya kullanımı</b> ise genellikle ruh sağlığı ve dayanıklılık açısından <b>risk faktörleri</b> arasında değerlendirilir.
...
1. Doğum öncesi dönemde bebeğin büyüme ve gelişimi açısından aşağıdakilerden hangisi <u>doğru değildir</u>?
    ...
    - **Cevap D-) Beyin gelişimi açısından gebeliğin son aylarına kadar önemli bir gelişme olmaz.**
    - E-) Bebeğin gelişimi genetik ve çevresel faktörlerden etkilenir.

    > **Açıklama:** <b>Beyin gelişimi gebeliğin ilk haftalarından itibaren başlar</b> ve doğuma kadar devam eder. Bu dönemde hızlı ve karmaşık bir süreç yaşanır ve çevresel etkilere son derece açıktır, bu nedenle son aylara kadar gelişme olmaz ifadesi doğru değildir.
...
1. Plansız/istenmeyen gebelikler hakkında yukarıdakilerden hangileri <u>söylenemez</u>?<br />I. Sadece Batı toplumlarında önemli bir sorun olarak görülmektedir.<br />II. Erken yaşta başlayan cinsellik, evlilik dışı ilişkiler, etkili aile planlaması yöntemlerinin kullanılmaması gibi faktörler istenmeyen gebeliklerin önemli sebepleri arasındadır.<br />III. Anne ve bebek açısından birçok olumsuz durumla ilişkilidir.<br />IV. Bir gebelik başlangıçta istenmeyen bir gebelikse her zaman bu şekilde sonlanır.
    ...
    > **Açıklama:** Plansız gebelikler <b>sadece Batı toplumlarında değil, küresel bir sorun olarak</b> karşımıza çıkmaktadır (I. söylenemez). Ayrıca, başlangıçta beklenmeyen bir gebelik, ilerleyen zamanlarda istenen bir gebeliğe dönüşebilmektedir (IV. söylenemez). Diğer ifadeler ise doğrudur.

    <hr />

### 2.4. Ebeveyn Psikopatolojisi

1. Aşağıdakilerden hangileri gebelik döneminde koruyucu ruh sağlığı açısından <u>riskli durumlar</u> arasında yer almaktadır?<br />I. İstenmeyen gebelik olması<br />II. Annenin fiziksel ve/ya ruhsal sağlık durumunun iyi olması<br />III. Eşler arasındaki ilişki ve uyumun iyi olması<br />IV. Gebelikte sigara-alkol kullanımının olması
    - A-) II, III ve IV
    - B-) I ve II
    - C-) I ve III
    - **Cevap D-) I ve IV**
    ...
    > **Açıklama:** <b>İstenmeyen gebelik olması</b> ve <b>gebelikte sigara-alkol kullanımının olması</b>, anne ve bebek açısından birçok olumsuz sonuçla ilişkili olan risk faktörleridir. II ve III numaralı maddeler ise sağlıklı gelişim için <b>koruyucu faktörlerdir</b>.

    <hr />

### 2.5. Beslenme

1. Gebelikte beslenme ihtiyacı ve alışkanlıkları hakkında hangileri <u>söylenemez</u>?<br />I. Gebelikte demir ihtiyacının artmasına bağlı olarak demir eksikliği görülebilir.<br />II. Gebelikte az miktarda sigara veya alkol kullanmanın bir sakıncası yoktur.<br />III. Folik asit desteği nöral tüp defektlerinin önlenmesinde önemlidir.<br />IV. Gebelikte annenin günlük besin ve kalori ihtiyacı artmaz.
    - A-) I ve III
    - B-) II ve III
    - C-) I ve IV
    - **Cevap D-) II ve IV**
    ...
    > **Açıklama:** Gebelikte <b>bazal metabolizma normalin %20’si kadar artar</b>, bu nedenle annenin günlük besin ve kalori ihtiyacı artar (IV. söylenemez). Ayrıca <b>gebelikte sigara ve alkol için güvenilir bir kullanım miktarı bulunmamaktadır</b>, bu nedenle az miktarda kullanımın sakıncası yoktur ifadesi yanlıştır (II. söylenemez).

    <hr />

### 2.6. Sigara, Alkol ve Madde Kullanımı

1. Gebelikte sigara-alkol-madde kullanımıyla ilgili olarak aşağıdakilerden hangisi <u>doğru değildir</u>?
    - A-) Sigara kullanımı çocukta ileriki yıllarda davranım bozukluğu riskini ciddi olarak artırır.
    - **Cevap B-) Az miktarda ve kontrollü şekilde sigara-alkol kullanmanın sakıncası yoktur.**
    - C-) Gelişmiş ülkelerde fetal alkol sendromu genetik olmayan zihinsel yetersizliğin en önemli sebebidir.
    - D-) Sigara ve alkol kullanımı bebekte kalıcı bedensel ve ruhsal sorunlara yol açabilir.
    - E-) Gebelikte sigara-alkol-madde kullanımı çocuk ihmal ve istismarı olarak görülebilir.
...
1. Aşağıdakilerden hangisi gebelikte sigara-alkol kullanımının sonuçlarından biri olarak <u>beklenmez</u>?
    ...
    - **Cevap D-) Şişman bebek**
    - E-) Davranış problemleri

    > **Açıklama:** Gebelikte sigara ve alkol kullanımı, plasentayı besleyen damarlarda daralmaya neden olarak bebeğin doku ve organlarına yeterli oksijenin ulaşmasını engeller. Bu durum <b>gelişme geriliği, düşük doğum ağırlığı</b> ve erken doğum gibi sonuçlarla ilişkilidir, bu nedenle 'Şişman bebek' beklenmez.

    <hr />

### 2.7. Doğum Şekli

1. Doğum şekli ve anne-bebeğin ruh-beden sağlığı arasındaki muhtemel ilişkiler hakkında yukarıdakilerden hangileri <u>söylenebilir</u>?<br />I. Normal yolla doğan bebekler doğum esnasında “dozunda ve başa çıkılabilir” bir stresle mücadele ederek sezaryenle doğan bebeklere kıyasla ruhsal açıdan daha dayanıklı bireyler olabilir.<br />II. Normal doğumda doğum sonrası iyileşme, sezaryene oranla daha hızlıdır.<br />III. Sezaryen ameliyatı geçiren annelerde emzirme güçlüğü oranları daha düşük olarak saptanmıştır.<br />IV. Normal yolla doğan bebekler, doğum kanalından geçerken bağırsakları için gerekli olan mikropları annenin doğum kanalından edinebilir.
    - **Cevap A-) I, II ve IV**
    - B-) II, III ve IV
    - C-) I ve II
    - D-) I, II ve III
...
1. Aşağıdakilerden hangisi sağlıklı çocuk gelişimi açısından gebelik dönemindeki <u>koruyucu faktörler</u> arasında yer <u>almaz</u>?
    ...
    - D-) Düzenli beslenme
    - E-) Sigara ve alkolün bırakılması

    > **Açıklama:** Sezaryen doğum, gerekli durumlarda hayat kurtarıcı bir cerrahi işlem olsa da, normal doğuma kıyasla bebeğin ruhsal ve fiziksel sağlığı açısından tartışmalı etkileri bulunmaktadır. Bu nedenle, <b>Sezaryen yolla doğum</b> koruyucu bir faktör olarak kabul edilmez.

    <hr />

### 2.8. Doğum Öncesi Bakım

1. Aşağıdakilerin hangisi veya hangileri doğum öncesi bakımın amaçları arasındadır?<br />I. Bebeğin biyolojik büyüme ve gelişiminin yakın takibini sağlar.<br />II. Anne adayının gebelik hakkındaki bilgilerini arttırmayı, doğrularını pekiştirmeyi, yanlış alışkanlık ve tutumlarını düzeltmeyi ve kaygılarını azaltmayı hedefler.<br />III. Ebeveynleri annelik ve babalık rollerine hazırlamayı amaçlar.
    - A-) Yalnız I
    - B-) I ve III
    - **Cevap C-) I, II ve III**
    - D-) II ve III
...
1. Aşağıdakilerden hangisi ülkemizde gebelerde rutin olarak uygulanan doğum öncesi bakımın bileşenlerinden biri <u>değildir</u>?
    ...
    - **Cevap D-) Annedeki psikiyatrik sorunları tedavi etmek**
    - E-) Anne-bebek bağlanmasını, gebelik uyumunu takip etmek
...
1. Aşağıdakilerden hangisi gebelik öncesinde veya sürecinde yapılması gereken bir koruyucu ruh sağlığı önlemi/uygulamasıdır?
    ...
    - D-) Ebeveyndeki psikiyatrik sorunların tedavi edilmesi
    - **Cevap E-) Hepsi**
...
1. Dört yaşındaki oğlunda birtakım davranışsal ve gelişimsel sorunlar için size başvuran bir annenin üç aylık hamile olduğunu öğrendiniz. Çocuk gelişim uzmanı olarak aşağıdakilerden hangisi bu olguda ve annede yapmanız gerekenlerden biri <u>değildir</u>?
    ...
    - **Cevap D-) Davranışsal sorunlara yönelik ilaç tedavisi başlamak**
    - E-) Şimdiki gebelikle ilgili doğum öncesi bakımların yapılıp yapılmadığını sormak

    > **Açıklama:** Çocuk gelişim uzmanlarının işlevi, danışmanlık ve destekleyici programları yürütmek ve tarama yapmaktır. <b>Davranışsal sorunlara yönelik ilaç tedavisi başlamak</b>, çocuk ve ergen psikiyatrisi uzmanının görevidir, çocuk gelişim uzmanının işlevi olması beklenmez.

    <hr />

## Ünite 3

### 3.1. Bağlanmanın Tanımı ve Önemi

1. Bağlanmayı, bebekle bakım veren arasındaki güvene dayalı güçlü bir duygusal bağ olarak tanımlayan, “bağlanma teorisinin” kurucusu bilim insanı aşağıdakilerden hangisidir?
    - A-) Mary Ainsworth
    - **Cevap B-) John Bowlby**
    - C-) Sigmund Freud
    - D-) Eric Ericson
...
1. Bağlanma ile ilgili olarak aşağıdakilerden hangisi doğru değildir?
    ...
    - **Cevap D-) Bebekler anneden başka kimseye bağlanamaz.**
    - E-) Biyolojik ve çevresel birçok faktör bağlanmayı etkiler.
...
1. Bağlanma ile ilgili aşağıdakilerden hangisi yanlıştır?
    ...
    - D-) Gebeliğin yirmi altıncı haftasında bebeğin algılama, tepki ve yakalama yeteneği ile annenin duygularına yanıt verdiği bilinmektedir.
    - E-) Anne ve bebek arasındaki erken sosyal ve duygusal etkileşim, bireyin hayat boyu diğer insanlarla ilişki kurma biçimini de şekillendirir.

    > **Açıklama:** Bağlanma, anne ve bebek arasında süreğenlik gösteren <b>çift yönlü bir uyumu</b> gerektirir. Annenin bebeğe bağlanmasının düzeyi, bebeğin anneye olan bağlanmasını etkiler. Bu nedenle, 'Bağlanma tek taraflı bir süreçtir' ifadesi yanlıştır.

    <hr />

### 3.2. Bağlanma Süreçleri

1. Aşağıdakilerden hangisi anne ve bebek arasındaki güvenli bağlanmanın gerçekleştiği “kritik dönem” olarak bilinir?
...
1. Bağlanmanın tam olarak biçimlenmesi ….. aylar arasındaki dönemde gerçekleşir. Bu dönemde anneden ayrılmayla görülen huzursuzluk azalır, çocuk annesiyle kısa süreli ayrılık dönemleri yaşasa da annesinin eninde sonunda geri döneceğini bilir. Yukarıdaki boşluğa aşağıdakilerden hangisi gelmelidir?
    ...
    > **Açıklama:** Bağlanmanın tam olarak biçimlenmesi <b>18 ila 24. aylar arasındaki dönemde</b> (Dördüncü Aşama) gerçekleşir. Bu dönemde çocuk anneden ayrılmayla görülen huzursuzluk azalır çünkü annesinin geri döneceğini bilir.

    <hr />

### 3.3. Bağlanma Çeşitleri

1. Bebeğin, yabancı birisinin varlığında ve yokluğunda annenin varlığına ve yokluğuna verdiği tepkiyi gözlemleyerek “bağlanma” süreçlerini anlamaya çalışan test aşağıdakilerden hangisidir?
    - A-) Bağlanma Testi
...
1. Aşağıdakilerden hangisi yabancı durum testinin aşamalarından biri değildir?
    ...
    - D-) Anne odadan tekrar ayrılır, bebek odada yalnız kalır
    - **Cevap E-) Bebek odadan çıkarılır**
...
1. Yabancı durum (ortam) testinde, anneden ayrılmaya aşırı tepki gösteren, anneyle kavuşmaya ise öfkeli ve reddedici tepki gösteren bebeğin bağlanma tipi aşağıdakilerden hangisidir?
    ...
    - C-) Sorunsuz bağlanma
    - D-) Dezorganize bağlanma
    - E-) Güvensiz-kaçıngan bağlanma

    > **Açıklama:** Güvensiz/anksiyöz/kararsız bağlanan çocukların ayrılma anında aşırı üzüldüğü, anneleri geri döndüğünde ise anneye karşı <b>öfkeli ve reddedici davrandıkları</b> gözlemlenmiştir.

    <hr />

### 3.7. Bağlanma ve Psikopatoloji

1. Bağlanma bozukluklarıyla ilgili olarak aşağıdakilerden hangisi doğrudur?
    - A-) Çocukluk ve erişkin dönemde birçok psikiyatrik bozukluğun gelişiminde önemlidir.
    - B-) Ebeveyndeki psikiyatrik bozukluklar bağlanma bozukluğu için risk faktörüdür.
    - C-) Bağlanma bozukluğu olan küçük çocuklar otizmi olan bir çocuk gibi görünebilirler.
    - D-) Bağlanma bozukluğu olan çocuklar erken ve uygun müdahale ile normale dönebilirler.
    - **Cevap E-) Hepsi.**
...
1. Güvenli bağlanmanın ruh sağlığı açısından koruyucu etki ve mekanizmalarıyla ilgili olarak aşağıdakilerden hangisi doğru değildir?
    ...
    - D-) Keşfetme duygusu ve davranışını pekiştirir.
    - **Cevap E-) Psikolojik dayanıklılık gelişiminde bir etkisi yoktur.**
...
1. Aşağıdakilerden hangisi bebeğin bakımındaki ihmalle ilgili psikiyatrik bozukluk ya da sorunlardan biri değildir?
    ...
    - **Cevap D-) Otizm spektrum bozuklukları**
    - E-) Kendine ve etrafa zarar verme davranışları
...
1. 18 aylık kızını ‘hiç konuşmadığı ve kendisiyle pek ilişki kurmadığı’ şikâyetiyle size getiren bir anne ile ilgili olarak aşağıdakilerden hangisini yapmanız beklenmez?
    ...
    - **Cevap D-) Bebekte bir sorun olmadığı konusunda anneye güvence vermek**
    - E-) Bir çocuk psikiyatrisine yönlendirmek

    > **Açıklama:** Çocuğun hiç konuşmaması ve ilişki kuramaması ciddi bir gelişimsel sorun göstergesidir (otizm spektrum bozukluğu veya tepkisel bağlanma bozukluğu gibi). Uzman olarak, bu belirtiler karşısında <b>bebekte bir sorun olmadığı konusunda anneye güvence vermek</b> beklenmez; tam tersine, detaylı öykü (A, B, C) alınmalı ve tanı/tedavi için çocuk psikiyatrisine (E) yönlendirilmelidir.

    <hr />

### 3.8. Bebeklik Döneminde Koruyucu Ruh Sağlığı Girişimleri

1. Aşağıdakilerden hangisi bebeklik dönemindeki koruyucu ruh sağlığı önlemi veya girişimi olarak düşünülemez?
    - A-) Anne-bebek ilişkisini güçlendirmek
    - B-) Dil gelişimi için bebeğe ninni veya şarkı söylemek
    - C-) Emzirmeyi teşvik etmek
    - **Cevap D-) Yabancı dil öğrenmesi için bebeğe İngilizce çizgi film seyrettirmek**
    - E-) Ebeveyne oyun ve iletişim becerileri konusunda yardım etmek

    > **Açıklama:** Koruyucu ruh sağlığı açısından, özellikle dil gelişimi için kritik olan ilk yıllarda, televizyon veya ekran maruziyetinin sınırlanması önerilir. Küçük çocuklar için konuşma ve dil, ancak gerçek bir deneyimin parçasıysa anlamlıdır. Dolayısıyla, <b>yabancı dil öğrenmesi için bebeğe İngilizce çizgi film seyrettirmek</b>, koruyucu ruh sağlığı önlemi olarak düşünülemez.

    <hr />

### 3.9. Koruyucu Ruh Sağlığı ve Dayanıklılık Açısından Anne Sütü ve Emzirme

1. Emzirme ile ilgili olarak aşağıdakilerden hangisi doğrudur?
    - A-) Güvenli bağlanmanın gelişmesinde önemlidir.
    - B-) Annelik duygusunun gelişmesinde önemlidir.
    - C-) Emzirme annede oksitosin salınımını uyarır.
    - D-) Zekâ gelişiminde önemlidir.
    - **Cevap E-) Hepsi.**

    > **Açıklama:** Emzirme, anne ile bebek arasındaki güvenli bağlanmanın en önemli ve etkili araçlarından biridir (A). Emzirme ve dokunma gibi etkileşimler sırasında oksitosin hormonunun salınımıyla annede ebeveynlik duygusu (B) gelişir. Anne sütü alan bebeklerin daha büyük beyin hacmine sahip oldukları ve zekâ düzeylerinin daha iyi olduğu bilinmektedir (D). Bu nedenle hepsi doğrudur.

    <hr />

## Ünite 4

### 4.1. Erken Çocukluk Döneminin Genel Gelişimsel Özellikleri

1. Aşağıdakilerden hangisi erken çocukluk döneminin özelliklerinden biri <u>değildir</u>?
    - A-) Merak ve keşfetme
    - B-) Görerek öğrenme
    - C-) Kız-erkek ayrımını yapabilme
    - D-) Büyükleri taklit etme
    - **Cevap E-) Nasihat yoluyla öğrenme**
...
1. Cinsel kimlik gelişimi ve çocukluk dönemi hakkında aşağıdakilerden hangisi doğrudur?
    ...
    - D-) Erkek çocuklar için babanın varlığı özellikle önemlidir.
    - **Cevap E-) Hepsi.**

    > **Açıklama:** Erken çocukluk döneminde kız-erkek ayrımını yapabilme, cinsel kimliğin büyük ölçüde gelişmesi, ebeveyn tutumlarının önemi ve erkek çocuklar için babanın varlığının önemi gibi tüm ifadeler doğrudur.

    <hr />

### 4.2. Erken Çocukluk Döneminde Ailenin Rolü ve Yaygın Ebeveyn Tutumları

1. Ebeveyn tutum ve davranışlarının koruyucu ruh sağlığı ve dayanıklılık açısından önemi/etkisi hakkında aşağıdakilerden hangisi doğrudur?
    - A-) Ebeveynler olumlu veya olumsuz örnek olabilirler.
    - B-) Aşırı koruyucu ebeveyn tipi dayanıklılık gelişimini zorlaştırabilir.
    - C-) İlgisiz, sorumsuz ebeveyn çocukta riskli alışkanlıkların gelişmesini kolaylaştırır.
    - D-) Ebeveyn tutum ve davranışları psikiyatrik bir sorunun ortaya çıkışını kolaylaştırabilir.
    - **Cevap E-) Hepsi**
...
1. Aşağıdaki yaygın ebeveyn tutumlarından hangisi psikolojik dayanıklılıkla <u>olumlu yönde</u> ilişkilidir?
    ...
    - D-) Otoriter- katı kuralcı aile
    - E-) Aşırı koruyucu aile
...
1. Aşağıdakilerden hangisi olumlu ebeveynlik tutumlarından biridir?
    ...
    - D-) Çocukların isteklerini merkeze almak
    - E-) Yarışmacı ve rekabetçi bir tutum sergilemek
...
1. Erken çocukluk döneminde, koruyucu ruh sağlığı ve dayanıklılık açısından en uygun aile tipi aşağıdakilerden hangisi olabilir?
    ...
    - E-) Kararsız ve tutarsız aile

    > **Açıklama:** Sevgiye dayalı, hoşgörülü, destekleyici ve sınırları belli aile modeli, ebeveynlik tutumları içinde en sağlıklı ve etkili olandır. Bu ailelerde yetişen çocuklar, ileride öz denetimi yüksek, duygu düzenlemesini uygun şekilde yapabilen, sorunlarla etkin şeklide başa çıkabilen ve ruhsal açıdan dayanıklı bireyler olarak yetişir.

    <hr />

### 4.3. Erken Çocukluk Döneminde Koruyucu Ruh Sağlığı ve Dayanıklılık

1. Koruyucu ruh sağlığı açısından önemli olan aşağıdaki beceri veya durumlardan hangisi erken çocuklukla ilgili <u>değildir</u>?
    - A-) Dürtü ve öfke kontrolü
    - B-) Zevk erteleme
    - **Cevap C-) Güvenli bağlanma**
    - D-) Empati
    - E-) Problem çözme
...
1. Psikolojik dayanıklılığın gelişmesi açısından aşağıdakilerden hangisi altı yaşındaki bir çocukta ailenin yapması <u>beklenilen bir durum değildir</u>?
    ...
    - D-) Çocuğa tarihimizden kahramanlık hikâyeleri okumak
    - E-) Çocuğun ağaca tırmanmaya çalışmasına izin vermek
...
1. Aşağıdakilerden hangisi erken çocukluk dönemindeki koruyucu ruh sağlığı önlemlerinden biri <u>değildir</u>?
    ...
    - D-) Uyku ve beslenme alışkanlıklarına dikkat etmek
    - E-) Ciddi düzeyde dürtü ve davranış sorunu olan çocukları tedavi için yönlendirmek
...
1. 4-5 yaş grubu çocukların olduğu bir anaokulunda koruyucu ruh sağlığı projesi geliştirmeniz ve uygulamanız isteniyor. Aşağıdakilerden hangisini bu bağlamda yapmanız beklenmez?
    ...
    - **Cevap D-) Davranışsal ve gelişimsel problemleri olan çocuklara tanı koymak**
    - E-) Gelişimsel sorunları olan çocuklara test uygulamak
...
1. Aşağıdaki psikiyatrik bozukluklardan hangisi erken çocukluk döneminde kazanılmaya başlamış olması beklenilen empati becerisinin gelişmemiş olmasıyla karekterizedir?
    ...
    - **Cevap D-) Antisosyal kişilik bozukluğu**
    - E-) Şizofreni
...
1. Erken çocukluk döneminde koruyucu ruh sağlığı ve dayanıklılık açısından önemli becerilerin kazanılması ve gelişmesi açısından hangisi <u>söylenemez</u>?
    ...
    - D-) Pek çok tutum ve becerinin kazanılabilmesi açısından hassas bir dönemdir.
    - E-) Anne baba başta olmak üzere güzel örnek teşkil eden çevre bu becerilerin kazanılmasında oldukça önemlidir.
...
1. Öz denetim becerilerinin kazanılması açısından hassas dönem olarak tanımlanan en erken gelişimsel dönem hangisidir?
    ...
    > **Açıklama:** Öz kontrol becerilerinin (öfke ve dürtü kontrolü, zevk erteleme gibi) öğrenilmeye ve kazanılmaya başlanması açısından <b>erken çocukluk dönemi (yani altı yaş öncesi) hassas dönemdir</b>. Okul öncesi dönem, erken çocukluk dönemini ifade eder.

    <hr />

## Ünite 5

### 5.2. Koruyucu Ruh Sağlığı ve Dayanıklılık Açısından Okul Çağı

1. Ruh sağlığı ve dayanıklılık açısından aşağıdakilerden hangisi okul çağı kazanımları arasında yer alır?
    - A-) İletişim becerileri
    - B-) Sorumluluk duygusu
    - C-) Sağlıklı yaşam alışkanlıkları
    - D-) Baş etme becerileri
    - **Cevap E-) Hepsi**
...
1. Okul çağı çocuğu ve bu dönemdeki koruyucu ruh sağlığı becerileri için hangisi <u>söylenemez</u>?
    ...
    - D-) Çocuğun yeni görev ve sorumluluklarla tanıştığı, toplum tarafından kendinden beklenen ödevlerin arttığı dönemidir.
...
1. Akademik başarının ruh sağlığı açısından koruyucu olmasında aşağıdakilerden hangisinin rolü olması <u>beklenmez</u>?
    ...
    - D-) Akademik olarak başarılı çocuklar doğrudan veya dolaylı olarak riskli ortamlardan uzak dururlar.
    - E-) Akademik başarı koruyucu bir faktör olan aile desteğini yansıtan bir faktör olabilir.
...
1. Öz güven hakkında aşağıdakilerden hangisi doğrudur?
    ...
    - **Cevap D-) Sağlıklı öz güven ruh sağlığı açısından koruyucudur.**
    - E-) Bir çocuğun öz güvenini geliştirmek için akademik olarak başarılı olmasını sağlamak gerekir.
...
1. Öz güven ve sağlıklı öz güven hakkında aşağıdakilerden hangisi <u>söylenemez</u>?
    ...
    - D-) Akademik başarı sağlıklı öz güvenin bir bileşenidir.
    - E-) Sağlıklı öz güven bir sonuçtur.
...
### 5.3.1. Okula Başlama ve Uyum Süreci ile İlişkili Problemler ve Koruyucu Ruh Sağlığı

1. Okula başlamak ve uyum süreci ile ilgili aşağıdakilerden hangisi doğru <u>değildir</u>?
    - A-) Okul ortamı, çocuğun alıştığı aile ortamının dışına çıkarak yeni bir sosyal çevre edinmesinin ilk adımıdır.
    - B-) Okula başlama, çocukta okulla ilişkili kaygı ve korkuların oluşmasına neden olabilir.
    - **Cevap C-) Okula başlamak çocuklar için her zaman keyifli bir olaydır.**
    - D-) Okula uyumla ilişkili güçlüklere ve hatta okul fobisi, okul reddi gibi durumlarla sonuçlanabilir.
    - E-) Bu durum çocuğun daha sonraki okul yaşantısını, eğitim ve mesleki hayatını etkileyebilir.
...
### 5.3.2. Özel Gereksinimli Çocuklar ve Koruyucu Ruh Sağlığı

1. Aşağıdakilerden hangisi özel gereksinimli çocuk olarak düşünülemez?
    - A-) Fiziksel engelli çocuk
    - B-) Otizm spektrum bozukluğu olan çocuk
    - C-) Özgül öğrenme bozukluğu olan çocuk
...
1. Aşağıdaki nörogelişimsel bozukluklardan hangisi için okul ortamında veya okul dışında çocuğa yönelik özel eğitim veya farklı programlar (örneğin kaynaştırma veya özel eğitim sınıfı) uygulanması genellikle <u>gerekmez</u>?
    ...
    - **Cevap E-) Tik bozukluğu**

    > **Açıklama:** Tik bozukluğu, nörogelişimsel bir bozukluk olmasına rağmen, genellikle akademik ve sosyal işlevselliği diğer gelişimsel bozukluklar (Zihinsel yetersizlik, ÖÖB, OSB) kadar doğrudan ve şiddetli etkilemez, bu nedenle özel eğitim veya farklı programlar uygulanması genellikle gerekmez.

    <hr />

### 5.3.3. Dikkat Eksikliği ve Hiperaktivite Bozukluğu ve Koruyucu Ruh Sağlığı

1. Aşağıdakilerden hangisi dikkat eksikliği hiperaktivite bozukluğunun ruh sağlığı ve dayanıklılık açısından oluşturduğu risklerden biri <u>değildir</u>?
    - **Cevap A-) Enerjik olma**
    - B-) Akademik başarısızlık
    - C-) Ebeveyn tükenmişliği
    - D-) Akran ilişkilerinde sorunlar
    - E-) Riskli davranışlar

    > **Açıklama:** Dikkat eksikliği ve hiperaktivite bozukluğunun (DEHB) semptomlarından biri aşırı hareketlilik olsa da, 'Enerjik olma' durumu bozukluğun doğrudan bir riski veya olumsuz sonucu olarak değil, bir belirtisi olarak kabul edilir. Akademik başarısızlık, ebeveyn tükenmişliği, akran sorunları ve riskli davranışlar ise DEHB’nin ciddi ruh sağlığı riskleridir.

    <hr />

### 5.3.4. Özgül Öğrenme Bozukluğu ve Koruyucu Ruh Sağlığı

1. I. Akademik zorluklar<br />II. Düşük benlik saygısı<br />III. Arkadaşları tarafından kabul görmeme, dışlanma<br />IV. Alkol madde kullanımı<br />Yukarıdakilerden hangisi ya da hangileri özgül öğrenme bozukluğu olan bir çocuğun okul çağında yaşaması muhtemel zorluklar arasında yer almaktadır?
    - A-) II, III ve IV
    - **Cevap B-) I, II ve III**
    - C-) Yalnız I
    - D-) I ve II
...
### 6.3. Ergenlik Döneminde Duygusal Gelişim

1. Ergenlik döneminin genel özellikleriyle ilgili hangisi <u>söylenemez</u>?
    ...
    - **Cevap D-) Artan bilişsel gelişim duyguların farkındalığını ve denetimini sağlayamaya yardımcı olur.**
    - E-) Bu dönemde üreme yeteneği kazanır ve cinsel gelişim tamamlanır.

    > **Açıklama:** Ergenlik döneminde bilişsel gelişim artsa da, artan bilişsel gelişim <b>her zaman</b> duyguların farkındalığını ve denetimini sağlamaya yardımcı olmaz. Aksine, cinsel arzu ve isteklerin yoğunluğuna rağmen dürtü kontrolü becerisi sıklıkla yeterince gelişmemiştir.

    <hr />

### 6.7. Ergenlik Döneminde Medya ve İnternet Kullanımı

1. Ergenlik döneminde önemli bir sorun olan bağımlılık; kısa veya uzun vadedeki olumsuz ve zararlı etkileri ve sonuçlarına rağmen bir maddeyi kullanmaya veya bir davranışı/alışkanlığı yapmaya devam etmek olarak tanımlanabilir. Bu tanıma göre aşağıdakilerden hangisi veya hangileri bağımlılık sorunu olarak tanımlanabilir?<br />I. Zamanının çoğunu bilgisayarda oyun oynayarak geçirdiği için okul başarısı ve sosyal ilişkileri bozulan ama bir türlü bilgisayardan vazgeçemeyen ergen<br />II. Arkadaşının ısrarı üzerine ilk defa sigara içmeyi deneyen ergen<br />III. Sürekli ders çalıştığı için sosyal aktivitelere pek katılamayan ergen
    - **Cevap A-) Yalnız I**
    - B-) I ve III
    - C-) I ve II
    - D-) Yalnız II
    ...
    > **Açıklama:** Tanıma göre bağımlılık, olumsuz sonuçlara rağmen devam eden kompulsif kullanımı/davranışı ifade eder. Sadece I. maddedeki ergen, okul başarısı ve sosyal ilişkileri bozulmasına rağmen <b>vazgeçemediği</b> için bağımlılık tanımına uyar. II. madde denemeyi, III. madde ise bağımlılık yerine yüksek bir çalışma tutumunu ifade eder.

    <hr />

### 6.8. Ergenlik Döneminde Sigara-Alkol-Madde Bağımlılığı

1. Ergenlik döneminde sigara, alkol madde kullanımına karşı en az düzeyde koruyucu faktör olduğu söylenebilir?
    ...
    - D-) İletişim kendini ifade etme ve hayır deme becerileri
...
1. Ergenlik döneminde alkol-madde kullanımı / bağımlılığı açısından aşağıdakilerden hangisi <u>doğru değildir</u>?
    ...
    - D-) Madde kullanımı mevcut psikiyatrik bozuklukların tedavisini zora sokar.
    - E-) Çocuk gelişim uzmanları erken yaşta duygusal/davranışsal problemleri tespit ederek gerekli tedavilere yönlendirmelidir.

    > **Açıklama:** Madde kullanımını ilk defa deneyen ergenlerin <b>birçoğu bağımlılık sorunu yaşamaz</b>. Ancak, çocukluk çağı psikiyatrik bozuklukları (DEHB gibi) madde bağımlılığı riskini artırır.

    <hr />

### 6.9. Ergenlik Döneminde Cinsellik

1. Ergenlik döneminde cinselliği ve psikososyal açıdan riskli kılan sebepler arasında aşağıdakilerden hangisi <u>yer almaktadır</u>?<br />I. Ergenler biyolojik/fizyolojik olarak cinselliğe hazır olabilseler de cinselliğin bilişsel, duygusal ve sosyal boyutlarında yeterince olgunlaşmış değillerdir.<br />II. Ergenlik döneminde cinsel arzu ve isteklerin yoğunluğuna karşın, bu dürtüleri kontrol becerisi sıklıkla yeterince gelişmemiştir.<br />III. Ergen gebelikleri hem anne hem de bebek sağlığı açısından riskli durumlardır.<br />IV. Ergenlerin cinsel davranışlarla ilişkili riskler konusunda erişkinlerle yeteri düzeyde bilgi ve beceriye sahiptirler.
    - A-) I ve IV
    - B-) I, II ve IV
    - **Cevap C-) I, II ve III**
    - D-) II, III ve IV
    ...
    > **Açıklama:** Ergenlikte cinselliği riskli kılan faktörler arasında biyolojik olgunluğa rağmen bilişsel/duygusal olgunluğun eksikliği (I), dürtü kontrolünün yetersizliği (II) ve ergen gebeliklerinin taşıdığı riskler (III) yer alır. Ergenler, riskler konusunda <b>yeterli bilgi ve beceriye sahip değildirler</b> (IV yanlıştır).

    <hr />

### 6.10. Ergenlik Döneminde Psikiyatrik Bozukluklar ve İntihar Davranışları

1. Ergenlik döneminde ruh sağlığı ve dayanıklılık açısından koruyucu beceri ve özelliklerin kazanılması için en uygun dönemdir ifadesi hakkında aşağıdakilerden hangisi doğrudur?
    - A-) Kesinlikle doğrudur, çünkü ergenlik dönemi hızlı gelişimin yaşandığı en uygun dönemdir.
    - **Cevap B-) Yanlıştır, bu dönem ruhsal sorunların ortaya çıkışı için riskli bir dönemdir ancak en uygun dönem erken çocukluk çağıdır.**
    - C-) Kısmen doğrudur, bazı beceriler için uygundur ancak çoğu beceri okul çağında kazanılır.
    - D-) Bu ifade, ergenlik döneminde edinilen bilgi ve becerilerin kalıcı olmasından dolayı doğrudur.
    - E-) Koruyucu ruh sağlığı çalışmaları bu dönemde zorunlu olarak uygulanmalıdır.
...
1. Aşağıdakilerden hangisi ergenlik döneminde karşılaşılabilecek problemlerdendir?
    ...
    - **Cevap C-) Hepsi**
    - D-) Patolojik internet kullanımı
    - E-) Ebeveynlerle çatışma
...
1. Aşağıdakilerden hangisi ergenlik döneminde intihar girişimleri için bir risk faktörü değildir?
    ...
    - D-) Yakın arkadaşının intihar sonucu ölmesi
    - **Cevap E-) Psikiyatrik muayene esnasında intihar düşüncesi olup olmadığı hakkında soru sormak**
...
1. Ergenlik döneminde görülen riskli bir davranış <u>değildir</u>?
    ...
    - C-) Sigara kullanmak
    - **Cevap D-) Derslerine düzenli çalışmamak**
    - E-) Şiddet içeren davranışlarda bulunmak
...
1. Aşağıdaki psikiyatrik bozukluklardan hangisinin ilk olarak ergenlik döneminde ortaya çıkması <u>beklenmez</u>?
    ...
    - E-) Alkol-madde kullanım bozuklukları
...
1. Aşağıdakilerden hangisi ergenlik döneminde önemli bir koruyucu ruh sağlığı uygulaması olabilir?
    ...
    - D-) Ergenleri sanatsal faaliyetlere yönlendirmek
    - **Cevap E-) Hepsi**

    > **Açıklama:** Ergenlik döneminde psikiyatrik sorunların önlenmesi ve koruyucu özelliklerin desteklenmesi için <b>güvenli sosyal çevre</b> oluşturmak, spor, sivil toplum faaliyetleri ve sanatsal faaliyetler gibi pozitif sosyal ve yapılandırılmış aktivitelere yönlendirmek kritik öneme sahiptir. Bu nedenle hepsi önemli koruyucu uygulamalardır.

    <hr />

## Ünite 7

### 7.2. İnternet ve Medyanın İçine Doğmak

1. Çocuk ve ergenlerin psikososyal ve ruhsal sağlıklarını olumsuz etkileyen aşağıdaki faktörlerden hangisi 40 yıl öncesine kıyasla <u>günümüze özgü</u> bir risk faktörüdür?
    - A-) Aile içi şiddet
...
1. Aşağıdakilerden hangisi aşırı medya ve internet kullanımının olumsuz bedensel ve ruhsal sonuçlarından biri <u>olamaz</u>?
    ...
    - D-) Sosyal izolasyon
    - **Cevap E-) Uzaktaki gelişmeleri takip etme**

    > **Açıklama:** Popüler kültürün olumsuz etkileri, siber zorbalık, fiziksel hareketsizlik ve sosyal izolasyon, aşırı medya/internet kullanımının olumsuz sonuçlarıdır. <b>Uzaktaki gelişmeleri takip etme</b>, internetin faydalı bir yönü olup, olumsuz bir sonuç olarak değerlendirilemez.

    <hr />

### 7.3. Değişen Beslenme Alışkanlıkları

1. I. Depresyon ve anksiyete bozuklukları<br />II. Şizofreni<br />III. Özgül öğrenme bozukluğu<br />IV. Yeme bozuklukları ve obezite<br />Doğrudan modern yaşama tarzıyla ilişkili risk faktörlerinden dolayı yukarıdaki psikiyatrik bozukluklardan hangilerinin geçmişe kıyasla günümüzde daha fazla görüldüğünü söylemek mümkündür?
    - A-) III – IV
    - B-) I – II
    - C-) I – III
    - D-) II – IV
    ...
    > **Açıklama:** Modern yaşam tarzının getirdiği stres, hareketsizlik ve beslenme alışkanlıkları gibi risk faktörleri nedeniyle <b>Depresyon ve anksiyete bozuklukları</b> (I) ile <b>Yeme bozuklukları ve obezitenin</b> (IV) sıklığının günümüzde geçmişe göre arttığı bildirilmektedir.

    <hr />

### 7.4. Değişen Aile Yapısı ve Yalnızlaşma

1. Günümüz modern yaşam tarzının ruh sağlığı üzerindeki olası etkileri ile ilgili aşağıdakilerden hangisi <u>söylenemez</u>?
    - **Cevap A-) Modern yaşam tarzıyla ilişkili riskler çocuklarda erişkinlere kıyasla daha az etkilidir.**
    - B-) Modern yaşam tarzı ruh sağlığı açısında çok yönlü etkileri olan birçok risk faktörü içermektedir.
    - C-) Ruh sağlığı açısından koruyucu olan bir takım faktörler modern yaşam tarzında azalmış veya kaybolmuş olabillir.
    - D-) Modern yaşam tarzıyla ilişkili imkan olarak görülen birçok durum aslında ruh sağlığı açısından önemli riskler taşıyor olabilir.
    - E-) Depresyon ve anksiyete bozuklukları başta olmak üzere birçok psikiyatrik bozukluğun sıklığı modern toplumlarda giderek artmaktadır.
...
1. Aşağıdakilerden hangisi günümüzde gençlerin karşılaştığı önemli bedensel veya ruhsal problem sebepleri veya kaynakları arasında yer alır?
    ...
    - **Cevap B-) hepsi**
    - C-) Fiziksel hareketsizlik
    - D-) eğitim alanındaki yüksek performans beklentileri
    - E-) Aile ve Sosyal destek sistemlerinin zayıflaması

    > **Açıklama:** Modern yaşam tarzı risk faktörleri; inanç ve değerler sistemindeki zayıflama, fiziksel hareketsizlik, eğitim alanındaki yüksek performans beklentileri ve aile/sosyal destek sistemlerinin zayıflaması gibi birçok durumu içermektedir. Bu nedenle <b>hepsi</b> önemli problem sebepleri veya kaynakları arasında yer alır.

    <hr />

## Ünite 8

### 8.1. Akran Zorbalığının Tanımı

1. I. Güç dengesizliği bulunan kişiler arasında olması<br />II. Zamansal süreklilik özelliği taşıması<br />III. Kasıtlı olarak karşı tarafa zarar vermek amacıyla yapılması<br />IV. Sadece fiziksel saldırganlık olarak gerçekleşmesi<br />Saldırgan bir davranışın zorbalık olarak tanımlanması için yukarıdaki özelliklerin hangilerini taşıması gerekir?
    - A-) I, II ve IV
    - B-) II, III ve IV
    - C-) II ve III
    - **Cevap D-) I, II ve III**
...
1. Kendisinden fiziksel ya da psikolojik olarak daha güçlü olanların zorbalık içeren söz ve eylemlerine uğrayan kişiye ….. denir. Yukarıdaki cümlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?
    ...
    > **Açıklama:** Kendisinden fiziksel ya da psikolojik olarak daha güçlü olanların zorbalık içeren söz ve eylemlerine uğrayan kişiye <b>kurban</b> denir. Zorbalık, <b>güç dengesizliği</b> ile karakterizedir.

    <hr />

### 8.2. Katılımcı Rolleri ve İlişkili Özellikler

1. Zorba-kurbanlarla ilgili aşağıdakilerden hangisi <u>doğru değildir</u>?
    ...
    > **Açıklama:** Zorba-kurbanlar, hem zorbalık yapan hem de maruz kalan kişilerdir. Zorba-kurbanların özellikleri <b>zorba ve kurbanların özelliklerinin bir karışımıdır</b>, bu nedenle sadece kurbanların sosyal davranış kalıplarıyla benzerlik göstermesi doğru değildir.

    <hr />

### 8.3. Zorbalığın Türleri

1. Aşağıdaki zorbalık türlerinden hangisi kızlarda erkeklerden daha fazla görülmektedir?
    - A-) Sözel zorbalık
    - B-) Fiziksel zorbalık
    - **Cevap C-) İlişkisel zorbalık**
    - D-) Cinsel zorbalık
    - E-) Siber zorbalık
...
1. <u>…..</u> zorbalık en yaygın görülen ancak en çok gözden kaçan zorbalık türüdür. Yukarıdaki cümlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?
    ...
    > **Açıklama:** <b>Sözel zorbalık</b>, en yaygın görülen, ancak en çok gözden kaçan zorbalık türüdür.

    <hr />

### 8.5. Akran Zorbalığının Belirtileri

1. I. Okula gitmek istememe veya okul başarısında düşme<br />II. Vücudunda veya eşyalarında darp veya fiziksel hasar izleri<br />III. Mutsuzluk, içine kapanıklık, davranış sorunları<br />IV. Arkadaşlarından ayrılamama<br />Yukarıdakilerden hangileri akran zorbalığına maruz kalan okul çağı çocuklarda zorbalıkla ilişkili belirtilerden olabilir?
    - A-) I ve II
    - B-) II, III ve IV
    - C-) III ve IV
    - **Cevap D-) I, II ve III**
    ...
    > **Açıklama:** Zorbalığa maruz kalan çocuklarda okula gitmek istememe (I), vücutta veya eşyalarda darp izleri (II) ve mutsuzluk/içe kapanıklık/davranış sorunları (III) sık görülen belirtilerdir. Arkadaşlarından ayrılamama (IV), doğrudan zorbalık belirtisi olarak kabul edilmez.

    <hr />

### 8.6. Akran Zorbalığında Risk Faktörleri ve Koruyucu Faktörler

1. Akran zorbalığında zorba (zorbalık yapan) ve/veya kurban (zorbalığa maruz kalan) olmakla ilişkili risk faktörleri hakkında hangisi <u>söylenemez</u>?
...
1. Bir okulda koruyucu ruh sağlığı kapsamında akran zorbalığı mağduru olma riski olan öğrenciler belirlenecek ve onlarla çalışmalar yapılacaktır. Aşağıdakilerden seçeneklerden hangisi diğerlerine göre zorbalığa uğramak bakımından daha <u>düşük risk altındadır</u>?
    ...
    - D-) 10 yaşında cinsel kimlik karmaşası yaşayan kız öğrenci
    - E-) 9 yaşında geçmişte zorbalığa uğramış erkek öğrenci

    > **Açıklama:** Obez olmak, gelişimsel gerilik, düşük özsaygı ve geçmişte kurban olmak zorbalığa uğrama riskini artırır. <b>Özsaygısı yüksek kız öğrenci</b>, psikolojik dayanıklılık ve özgüven koruyucu faktörler olduğu için diğerlerine göre daha düşük risk altındadır.

    <hr />

### 8.7. Akran Zorbalığının Sonuçları

1. Akran zorbalığının mağdur üzerinde meydana gelen etkileri ile ilgili olarak aşağıdakilerden hangisi <u>doğru değildir</u>?
    - A-) Akran mağduriyeti ile düşük benlik saygısı arasındaki çift yönlü bir ilişki vardır.
    - B-) Zorbalığa maruz kalan çocuklarda içe yönelim sorunlarının dışa vurum sorunlarının sıklığında da artış görülür.
    - C-) Erişkin yaşamda alkol ve madde bağımlılığı çocukken zorbalığa maruz kalma ile ilişkilendirilmiştir.
    - **Cevap D-) Zorbalık mağdurlarının erişkin yaşamda çocuklarına aşırı müdahale etmeleri, çocuklarının zorbalığı maruz kalmasını engeller.**
    - E-) Zorbalık mağdurlarında erişkin yaşamlarında anksiyete ve depresyon ortaya çıkma ihtimali artmıştır.

    > **Açıklama:** Zorbalık mağdurlarında içe yönelim (anksiyete, depresyon) ve dışa vurum (madde kullanımı) sorunları artar. Zorbalık mağdurlarının aşırı müdahale etmesinin, çocuğun zorbalığa maruz kalmasını engellediği şeklinde kesin bir bilgi bulunmamaktadır; <b>aşırı koruyucu-kollayıcı ebeveynlik</b> aksine kurban olmak için risk faktörü olabilir.

    <hr />

### 8.8. Koruyucu Ruh Sağlığı Açısından Akran Zorbalığı

1. I. Akran zorbalığının önlenebilmesi için öğretmenlerin ve okul çalışanlarının zorbalığa dair farkındalıklarının yüksek olması gerekmektedir.<br />II. Zorbalığa maruz kalma bakımından yüksek riskli çocuklar belirlenerek okuldan uzaklaştırılmaları sağlanmalıdır.<br />III. Öğrencilerin iletişim becerilerini geliştirmeye, kendilerini ve hissettikleri duyguları sözlü olarak ifade edebilmelerine yönelik çalışmalar yapılmalıdır.<br />Zorbalığı önleme çalışmaları ile ilgili yukardakilerden hangileri doğrudur?
    - A-) II ve III
    - **Cevap B-) I ve III**
    - C-) I, II ve III
    - D-) Yalnız II
    ...
    > **Açıklama:** Zorbalığın önlenmesinde öğretmen/okul çalışanlarının farkındalığı (I) ve öğrencilerin iletişim, kendini ifade etme becerilerini geliştirme çalışmaları (III) önemlidir. Zorbalığa maruz kalan çocukların okuldan uzaklaştırılması (II) <b>doğru bir yaklaşım değildir</b>.

    <hr />

## Ünite 9

### 9.1. Okul Ruh Sağlığı

1. I. Çocuk ve ergenlerde görülen psikososyal problemler çok sık görülmesi nedeniyle tüm dünyada büyük bir önem kazanmıştır.<br />II. Tedavi edilmemiş ruhsal bozukluklar yüksek oranda okul bırakma, suç işleme, işsizlik, madde kullanımı ve aile işlevlerinde bozulma gibi önemli psikososyal problemlere yol açmaktadır.<br />III. Okul ruh sağlığı hizmetleri; ruh sağlığının geliştirilmesi, korunması ve ruh sağlığında bozulmalar olduğu takdirde müdahalede bulunulması ile ilgili okul hizmetlerin tamamını kapsamaktadır.<br />IV. Çocukluk çağı ruh sağlığı bozuklukları sık görülmesi nedeniyle okul koruyucu ruh sağlığı müdahaleleri büyük bir öneme sahiptir.<br />Yukarıdaki ifadelerden hangileri doğrudur?
    - A-) I, II
    - B-) I, II, III
    - **Cevap C-) I, II, III, IV**
    - D-) II, III, IV
...
1. “Koruyucu okul ruh sağlığı programları iki ana başlık altında ele alınabilir. <u>…..</u> koruyucu programlarda herhangi bir seçim yapmaksızın belirli bir bölgedeki tüm çocuk veya ergenler programa dâhil edilir. <u>…..</u> koruyucu programlarda ise belirlenmiş bir toplulukta riskli grup belirlenerek bu grup için koruyucu programlar uygulanır.”<br />Yukarıdaki metinde boş bırakılan yerlere sırasıyla aşağıdakilerden hangisi getirilmelidir?
    ...
    - D-) Hedef grup / Evrensel
    - E-) Riskli grup / Evrensel
...
1. Aşağıdakilerden hangisi koruyucu okul ruh sağlığı çalışmalarında evrensel programların hedef grup programlarına kıyasla farklılık veya avantajlarından birisi <u>değildir</u>?
    ...
    - D-) Evrensel programlar henüz risk altında olmayan ancak gelecekte belirti geliştirebilecek gençlere müdahale imkânı sağlayabilir.
    - E-) Evrensel programlarda örneklem seçimi olmadığı için damgalama en aza indirgenmiş olmaktadır.
...
1. İyi bir koruyucu ruh sağlığı programı için aşağıdakilerden hangisi <u>söylenemez</u>?
    ...
    - D-) Uygulanacağı coğrafi bölgenin kültür ve yaşam tarzına uygun olmalıdır.
    - **Cevap E-) Ruh sağlığı sorunları ortaya çıktıktan sonra uygulanmalıdır.**
...
1. I. Koruyucu ruh sağlığı müdahaleleri ile psikiyatrik bozuklukların görülme sıklığı azaltılmaktadır.<br />II. Bazı psikiyatrik bozuklukların görülme yaşının gecikmesine büyük katkı sağlamaktadır.<br />III. Psikiyatrik bozuklukların tedavi maliyetini artırmaktadır.<br />Yukarıdakilerden hangisi veya hangileri koruyucu okul ruh sağlığı müdahalelerinin, psikiyatrik bozuklukların önlenmesi konusundaki katkıları arasında yer almaktadır?
    ...
    > **Açıklama:** Koruyucu ruh sağlığı müdahaleleri, psikiyatrik bozuklukların görülme sıklığını azaltır (I) ve görülme yaşının gecikmesine katkı sağlar (II). İyi bir şekilde uygulandığında bu programlar maliyeti <b>artırmak yerine azaltabilir</b> (III yanlıştır).

    <hr />

### 9.3. Depresyon ve Anksiyete Bozuklukları İçin Koruyucu Ruh Sağlığı Uygulamaları

1. ….. programı, Dünya Sağlık Örgütünün kanıta dayalı koruyucu ruh sağlığı ve dayanıklılık programı olarak kabul ettiği neredeyse tek programdır. Etkinliği birçok çalışmayla gösterilmiştir. Birçok koruyucu ruh sağlığı programının aksine etkinliği yaş, cinsiyet, programın uygulanma süresi gibi farklı değişkenlere göre değişmemektedir. Yukarıdaki boşluğa aşağıdakilerden hangisi gelmelidir?
    - **Cevap A-) FRIENDS**
    ...
    > **Açıklama:** <b>FRIENDS programı</b>, Dünya Sağlık Örgütünün kanıta dayalı koruyucu ruh sağlığı ve dayanıklılık programı olarak kabul ettiği neredeyse tek programdır. Bu program, depresif ve anksiyete bozuklukları için uygulanır.

    <hr />

### 9.4. Alkol ve Madde Kullanım Bozukluğu

1. Alkol ve madde kullanım bozuklukları için okul koruyucu ruh sağlığı müdahaleleri ile ilgili olarak aşağıdakilerden hangisi doğrudur?
    - **Cevap A-) Bu müdahaleler, çocuğun madde ile karşılaşabileceği kritik dönemlerden önce uygulanmalı. Çocuk ve ergeni maddeyle karşılaşabileceği ortamlara karşı hazır olmasını ve uygun baş etme becerilerinin gelişimine olanak sağlamalıdır.**
    - B-) Çok az sayıda okul personeli ile uygulanmalı ve personele çok az bir eğitim verildikten sonra hemen başlanılmalıdır.
    - C-) Sadece bilgi verici bir program olmalı.
    - D-) Programın bitiminden sonra takip ve destek seansları gibi ek seanslar olmamalı.
    - E-) Sosyal becerileri ve duygudurum düzenleme becerilerini artırmak bu programlar için önemli değildir.

    > **Açıklama:** Alkol ve madde kullanım bozukluklarına yönelik koruyucu programlar, çocuğun maddeyle karşılaşabileceği <b>kritik dönemlerden önce uygulanmalı</b> ve uygun baş etme becerilerinin gelişimine olanak sağlamalıdır. Programlar sadece bilgi verici olmamalı; rol oynama, küçük grup aktiviteleri ve tartışma gibi interaktif katılım sağlamalıdır.

    <hr />

### 9.6. Koruyucu Ruh Sağlığı Açısından Kronik Hastalıklar

1. I. Çocuk ve ergenlerin %25’i bir kronik hastalığa sahip olmakta ve yine %10’unda bu hastalıklar günlük yaşam becerilerini şiddetli bir şekilde etkilemektedir.<br />II. Kronik hastalık sürecinde çocuk ve ergenler, duygusal, davranışsal ve eğitimsel problemler sıklıkla yaşamaktadır.<br />III. Hastalıkla ilgili sık hastane ziyaretleri, beklenmedik hastane yatışları özellikle çocuk veya ergenin günlük yaşam rutinlerine devam edememesine aynı zamanda okul devamsızlıklarına yol açmaktadır.<br />Kronik hastalıklarla ilgili yukarıdaki ifadelerden hangisi/hangileri doğrudur?
    - A-) I, II
    - **Cevap B-) I, II, III**
    - C-) II, III
    - D-) Yalnız I
...
1. Çocukluk dönemi kronik hastalıklar ve psikososyal etkileriyle ilgili aşağıdaki ifadelerden hangisi <u>doğru değildir</u>?
    ...
    - **Cevap E-) Kronik hastalığı olan çocukların hastalığın türü ve etkisinden bağımsız olarak günlük yaşam aktivitelerine katılmaları sınırlandırılmalıdır**

    > **Açıklama:** Kronik hastalığı olan çocukların, hastalığın türü ve etkisinden bağımsız olarak günlük yaşam aktivitelerine katılmalarının <b>sınırlandırılması doğru değildir</b>. Koruyucu ruh sağlığı, aksine, özel gereksinimlerine uygun aktivitelere katılımlarını desteklemeyi hedefler.

    <hr />

### 9.7. Koruyucu Ruh Sağlığı Açısından Gelişimsel Bozukluklar

1. Aşağıdakilerden hangisi bir gelişimsel bozukluk <u>değildir</u>?
    ...
    > **Açıklama:** DEHB, Özgül Öğrenme Güçlüğü, Tik Bozukluğu ve Otizm Spektrum Bozukluğu nörogelişimsel bozukluklardır. <b>Şizofreni</b> ise genellikle ergenlik veya erişkinlik döneminde ortaya çıkan major bir psikiyatrik bozukluktur, gelişimsel bozukluk kategorisinde yer almaz.
...
1. Cinsel istismarla ilgili olarak aşağıdakilerden hangisi <u>yanlıştır</u>?
    - A-) Cinsel istismara uğrayan çocuklarda depresyon, anksiyete, disosiyatif bozukluklar görülebilir.
    - **Cevap B-) Cinsel istismar nadir bir durumdur ve olaylara önemli bir kısmı açığa çıkmaktadır.**
    - C-) Cinsel istismar çocukluk çağı travmalarının en yaygın türlerindendir.
    - D-) Cinsel istismar bireysel ve toplumsal açıdan ağır sonuçları olan önemli bir halk sağlığı sorunudur.
    - E-) Cinsel istismar cinsel içerikli mesajlaşma (sexting) şeklinde de olabilir.

    > **Açıklama:** Cinsel istismar <b>nadir bir durum değildir</b> ve maalesef olayların <b>önemli bir kısmı açığa çıkmamaktadır</b>. İstismar, yaygın bir halk sağlığı sorunudur ve cinsel içerikli mesajlaşma (sexting) şeklinde de olabilir.

    <hr />

### 10.1.2. İhmal

1. “…… çocuğun bakımından sorumlu kişiler tarafından çocuğun ihtiyaçlarının yeterince sağlanamaması sonucu fiziksel ve ruhsal sağlık bakımından zarara uğradığı <u>pasif bir eylemsizlik</u> durumudur.”<br />Yukarıdaki boşluğa aşağıdakilerden hangisinin gelmesi en uygundur?
    - **Cevap A-) İhmal**
    - B-) Kaza
    - C-) İstismar
    - D-) Travma
    ...
    > **Açıklama:** Çocuğun ihtiyaçlarının yeterince sağlanmaması sonucu fiziksel ve ruhsal sağlık bakımından zarara uğradığı <b>pasif bir eylemsizlik durumu</b> <b>İhmal</b> olarak tanımlanır. İhmal, bir eylemsizlik olarak görülse de sonuçları çok büyük bir eylemdir ve bir travma türüdür.
...
1. Çocukluk çağı travmalarının gelişim dönemlerine göre etkileri ile ilgili aşağıdaki ifadelerden hangileri doğrudur?
    ...
    - **Cevap D-) 0-3 yaş döneminde travmaya maruz kalan çocuklarda uyku problemleri gece korkuları oyunlarında travmatik temalar görülebilir**
...
1. Çocuklar, <u>…..</u> yaşından sonra yaşadıkları travmatik olayı daha iyi hatırlıyor olsalar bile dil gelişimlerini tam olarak tamamlamadıkları için kendilerini tam olarak ifade edemeyebilirler. Yukarıdaki boşluğa aşağıdakilerden hangisi gelmelidir?
    ...
    > **Açıklama:** Çocuklar, <b>3 yaşından</b> sonra yaşadıkları travmatik olayı daha iyi hatırlıyor olsalar bile, dil gelişimlerini tam olarak tamamlamadıkları için kendilerini tam olarak ifade edemeyebilirler.

    <hr />

### 10.3. Travmanın Etkileri

1. I. Kişinin yaşamsal bütünlüğünü tehdit etmesi veya bozması<br />II. Kişiyi baş edilebilir ölçüde zorlaması<br />III. Kişide belirgin korku, dehşet, çaresizlik hissine yol açması<br />IV. Kişinin kendi baş etme mekanizmaları ile başa çıkamayacak düzeyde olması<br />Yukarıdakilerden hangileri “ruhsal travma“nın özellikleri arasında yer alır?
    - A-) I, II
    - B-) I ve III
    - C-) II ve III
    - **Cevap D-) I, III ve IV**
...
1. Aşağıdakilerden hangisi yaşamsal bir olayın ruhsal bir travma olarak değerlendirmesi için gerekli özelliklerden <u>değildir</u>?
    ...
    - D-) olağandışı duruma bağlı olarak gelişmesi
    - E-) ani başlangıçlı olması
...
1. Aşağıdaki çocukluk çağı psikiyatrik bozukluklarından hangisi belirli bir çevresel sebebe bağlı olarak gelişen ve koruyucu ruh sağlığı önlemleriyle önlenmesi belli ölçüde mümkün olan bir durumdur?
    ...
    - **Cevap E-) Travma sonrası stres bozukluğu**

    > **Açıklama:** Otizm, Şizofreni ve Bipolar bozukluk, biyolojik/genetik yatkınlığın ağır bastığı nörogelişimsel/psikotik bozukluklardır. <b>Travma sonrası stres bozukluğu (TSSB)</b> ise belirli bir çevresel travmatik olaya bağlı olarak geliştiği için koruyucu ruh sağlığı önlemleriyle önlenmesi <b>belli ölçüde mümkün</b> olan bir durumdur.

    <hr />

### 10.4. Travmaya Karşı Koruyucu Ruh Sağlığı Müdahaleleri

1. I. Birincil koruma, travma yaşanmadan önce alınan önlemleri kapsar.<br />II. İkincil koruma, travmayla karşılaştıktan sonra kronikleşmesini önlemek için yapılan müdahalelerdir.<br />III. Üçüncül korumaya travma sonrası ruh sağlığı sorunları kronikleşen hastaların rehabilitasyon hizmetlerini içermektedir.<br />Yukarıdaki ifadelerden hangisi/hangileri doğrudur?
    - **Cevap A-) I, II, III**
    - B-) I, II
    - C-) Yalnız II
    - D-) II, III
...
1. Aşağıdaki ifadelerden hangisi doğrudur?
    ...
    - D-) Birincil koruyucu müdahale programlara genellikle ergenlik döneminde başlanılmalı.
    - E-) Aileye yönelik psikoeğitim programlarında yalnızca çocukluk çağı travmaları ile ilgili kavramlar anlatılmalı.
...
1. Çocukluk çağı travmaları ile ilgili çok boyutlu birincil koruyucu program hazırlarken programa aşağıdakilerden hangisinin dâhil edilmesi gereklidir?
    ...
    - C-) Ebeveyn
    - D-) Potansiyel istismarcı
    - **Cevap E-) Hepsi**

    > **Açıklama:** Çocukluk çağı travmalarının önlenmesine yönelik <b>çok boyutlu</b> birincil koruyucu programlar, çocuk/ergen, öğretmen/okul personeli, ebeveyn ve potansiyel istismarcı gibi <b>tüm bileşenlerin</b> dâhil edilmesini gereklidir.
