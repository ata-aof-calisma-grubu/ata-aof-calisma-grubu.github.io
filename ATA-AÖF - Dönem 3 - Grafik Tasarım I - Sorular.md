# Grafik Tasarım I (Dönem 3) - Tüm Sorular

## Unite 1
1. **Aşağıdakilerden hangisi doğal olmayan, sonradan öğrendiğimiz yeteneklerdendir?**
    - A-) Konuşmak
    - B-) Görmek
    - C-) Yürümek
    - **Cevap D-) Okumak**
    - E-) Duymak
    <hr/>
1. **Aşağıdakilerin hangisinde iletişim ile ilgili gelişmeler tarihsel (kronolojik) sıra ile verilmiştir?**
    - A-) Konuşmak - Görsel imgeler oluşturmak - Yazmak - Görmek ve duymak
...
1. **Aşağıdakilerden hangisi mağara resimleriyle bilinen, başlıca yerlerden biri değildir?**
    ...
    <hr/>
1. **Aşağıdakilerden hangisi yazı öncesine ait bir görsel iletişim formudur?**
    - A-) Hiyeroglif
    - B-) Meteoroglif
    - C-) Noraglif
    - D-) Terraglif
    - **Cevap E-) Petroglif**
    <hr/>
1. **Aşağıdakilerden hangisi fonetik alfabenin önemli avantajlarından biridir?**
    - A-) Fonetik alfabede hesap kayıtlarının daha kolay tutulması
    - B-) Fonetik alfabe ile daha kazançlı ticaret yapılabilmesi
    - **Cevap C-) Fonetik alfabeyi okuma ve yazmayı öğrenmenin daha kolay olması**
...
1. 8\. yüzyılın sonlarında küçük (miniskül) harfler ortaya çıkmış ve Frenk İmparatoru Şarlman (Charlamagne) tarafından resmî yazı biçimi olarak ilan edilmiştir.**Aşağıdakilerden hangisi küçük harflerin ortaya çıkmasının önemli nedenlerinden biridir?**
    ...
    - **Cevap D-) Küçük harflerin daha kolay ve hızlı okunup yazılabilmesi**
    - E-) Küçük harflerin halk tarafından daha çok seviliyor olması
    <hr/>
1. **Aşağıdakilerden hangisi sanayi devrimi sonrasında ortaya çıkan görsel iletişim ve grafik tasarım mecralarından biri değildir?**
    - **Cevap A-) Matbaa**
    - B-) Afiş
    - C-) Günlük Gazete
    - D-) Dergi
    - E-) İnternet Sitesi
    <hr/>
1. **Aşağıdakilerden hangisi görsel iletişimcilerin iletişim kurmak için ihtiyaç duyduğu görsel öğelerden biri değildir?**
    - A-) Renk
    - **Cevap B-) Müzik**
    - C-) İmge
    - D-) İşaret
    - E-) Piktogram
    <hr/>
1. **1980’li yılların sonunda postmodernizmin de etkileri ile birlikte yazı karakteri tasarımında büyük bir artış olmuştur. Bu artışın ortaya çıkmasında en önemli etken aşağıdakilerden hangisidir?**
    ...
    <hr/>
1. **Aşağıdakilerden hangisi görsel iletişim ve grafik tasarımında işaret olarak tanımlanamaz?**
    - A-) @
    - B-) ?
    - C-) →
    - D-) #
    - **Cevap E-) 9/11**
    <hr/>
1. **Gutenberg tarafından icat edilen baskı teknolojisinin günümüzdeki ismi aşağıdakilerden hangisidir?**
    - A-) Ofset baskı
    - B-) Tifdruk baskı
    - C-) Flekso baskı
    - **Cevap D-) Tipo baskı**
    - E-) Serigrafi baskı
    <hr/>
1. **Tipografi, aşağıdaki grafik tasarım elemanlarından hangisi ile ilişkilidir?**
    - A-) Şekil
    - **Cevap B-) Yazı**
    - C-) İmge
    - D-) Simge
    - E-) İşaret
    <hr/>
1. **Kayalara ve taşlara çizilen imge aşağıdakilerden hangisidir?**
    - **Cevap A-) Petroglif**
    - B-) Geograf
    - C-) Nazka çizgiler
    - D-) Hiyeroglif
    - E-) Fonetik
    <hr/>
1. **Günümüzde kullanılan Latin Alfabesi'nin kökeni aşağıdakilerden hangisidir?**
    - A-) Kiril Alfabesi
...
1. **Aşağıdakilerden hangisi sözlü iletişimin avantajlarından biri değildir?**
    ...
    <hr/>
1. **Aşağıdakilerden hangisi insanların görsel iletişime ihtiyaç duymasının temel sebeplerinden biridir?**
    - A-) Sözlü iletişimin zor olması
    - B-) İnsanların henüz konuşmayı öğrenmemiş olması
    - C-) Sözlü bilgilerin daha az dikkat çekmesi
    - **Cevap D-) Sözlü bilginin yeterince kalıcı olmaması**
    - E-) Sözlü bilgilerin daha çok dikkat çekmesi
    <hr/>
1. **Aşağıdakilerden hangisi günümüze kadar ulaşan en önemli yer resimleri (geoglif) olarak bilinmektedir?**
    - A-) İnka Çizgileri, İnka Çölü, İnca
    - **Cevap B-) Nazka Çizgileri, Nazka Çölü, Peru**
    - C-) Terra Çizgileri, Terranaum Çölü, Uruguay
    - D-) Petra Çizgileri, Petra Çölü, Kanada
    - E-) Sahra Çizgileri, Sahra Çölü, Sudan
    <hr/>
1. **Sosyal medya fenomeni olan bir kişi, günlük yaşamında aşağıdaki imgelerden hangisiyle sık sık karşılaşır?**
    - A-) Minyatür
    - **Cevap B-) Fotoğraf**
    - C-) İllüstrasyon
    - D-) Gravür baskı resim
    - E-) Ahşap baskı resim
    <hr/>
1. **Johannes Gutenberg tarafından icat edilen baskı teknolojisinin günümüzdeki adı aşağıdakilerden hangisidir?**
    - A-) Taş baskı
    - B-) Hiyeroglif
    - **Cevap C-) Tipo baskı**
    - D-) Petroglif
    - E-) Ofset baskı
    <hr/>
1. **Aşağıdakilerden hangisi farklı dilleri konuşan insanların bir arada bulunduğu mekânlarda oldukça önemli yönlendirme ve bilgilendirme işlevini yerine getiren evrensel simgelerdir?**
    - **Cevap A-) Piktogram**
    - B-) Yazı
    - C-) İmge
    - D-) Tipografi
    ...
    <hr/>
## Unite 2
1. **Üzerine baskı yapılabilen çok sayıda malzemenin her birine verilen isim aşağıdakilerden hangisidir?**
    - A-) Baskı Sonrası Malzemesi
    - **Cevap B-) Baskı Altı Malzemesi**
    - C-) Baskı İşletim Malzemesi
    - D-) Baskı Düzenleme Malzemesi
    - E-) Baskı Öncesi Malzemesi
    <hr/>
1. **Bir kâğıdın kıvrım yerlerinin birbirine karşılıklı ve ters yönde paralel gelecek şekilde katlanmasıyla oluşan katlama biçimine ne isim verilir?**
    - A-) Bohça Kırım
    - B-) Rulo Kırım
    - **Cevap C-) Akordeon Katlama**
    - D-) Fransız Usulü Katlama
    - E-) İçine Katlama
    <hr/>
1. **Kitabın formalarının ya da sayfalarının güçlü bir tutkalla birbirine tutturulması ve kapağın da aynı tutkalla yapıştırılmasıyla oluşan ciltleme çeşidi aşağıdakilerden hangisidir?**
    - A-) Sıvama Cilt
    - B-) Esnek Cilt
    - C-) Basit Cilt
    - D-) İngiliz Cilt
...
1. Matbaa baskısında bir deseni ya da yazıyı mürekkep kullanmadan kabartıp çıkıntılı veya girintili hale getirme işlemine ne isim verilir?
    ...
    - E-) Şömiz
    <hr/>
1. **Açıklamak, örneklendirmek ya da süslemek amaçlı yapılan resimlendirme çalışmasına ne ad verilir?**
    - A-) Kaligrafi
    - B-) Fotomontaj
    - C-) Graffiti
    ...
    - E-) Goblen
    <hr/>
1. **İki veya daha fazla malzeme ya da bunlardan alınmış parçaları bir araya getirip yeni bir görsel oluşturma tekniğine ne adı verilir.**
    - A-) Poster
    - **Cevap B-) Kolaj**
    - C-) Kaligrafi
    - D-) Monokrom
    - E-) Perforaj
    <hr/>
1. **Kesik uçlu kalem, divit veya fırça ile harflerin değişen çizgi kalınlıkları ve uzunluklarıyla yazılması esasına dayanan el yazısı yazma sanatına ne ad verilir?**
    - **Cevap A-) Kaligrafi**
    - B-) Grafiti
    - C-) Filigran
    - D-) Font
    - E-) Tipografi
    <hr/>
1. **Bir veya birden fazla renk arasında aşamalı geçişler oluşturularak yapılan renk dolgusu biçimine verilen isim aşağıdakilerden hangisidir?**
    - A-) Monokrom
    - **Cevap B-) Degrade**
    - C-) Serif
    - D-) İdeogram
    - E-) Rezolasyon
    <hr/>
1. **Kitap kapaklarının dış etkenlerden zarar görmemesi için üzerine giydirilen kâğıt kap aşağıdaki hangi isimle adlandırılır?**
    - **Cevap A-) Şömiz**
    - B-) Perforaj
    - C-) Punto
    - D-) Mizanpaj
    - E-) Pilyaj
    <hr/>
1. **Bitmap tabanlı görüntüleri oluşturan her bir küçük kareye verilen isim aşağıdakilerden hangisidir?**
    - A-) İkon
    - B-) Grid
    - C-) Piktogram
    - **Cevap D-) Piksel**
    - E-) Tipo
    <hr/>
1. **Piksellerin bir araya gelmesiyle meydana gelen görüntülere ne ad verilir?**
    - **Cevap A-) Bitmap**
    - B-) Vektör
    - C-) Degrade
    - D-) Nokta
    - E-) Çizgi
    <hr/>
1. **İnç başına düşen nokta sayısını ifade eden kavram aşağıdakilerden hangisidir?**
    - A-) EPS
    - B-) GIF
    - C-) TIFF
    - **Cevap D-) DPI**
    - E-) PDF
    <hr/>
1. **Sayfalarda yer alan basılı bilgilerin ciltleme esnasında kaybolmaması için kenardan bırakılan boşluğa ne ad verilir?**
    - **Cevap A-) Cilt payı**
    ...
    - E-) Rezolasyon
    <hr/>
1. **Görsellerin herhangi bir renk kaybına uğramadan depolanmasını sağlayan sürekli dosya formatı aşağıdakilerden hangisidir?**
    - A-) PDF
    - B-) PSD
    - **Cevap C-) TIFF**
    - D-) GIF
    - E-) EPS
    <hr/>
1. **Bir nesnenin taşıdığı özellikleri en basit, en yalın hâline indirgeyerek anında tanınacak biçimde temsil edilmesini sağlayan grafik unsuru aşağıdakilerden hangisidir?**
    - A-) İllüstrasyon
    - **Cevap B-) İkon**
    - C-) İdeogram
    - D-) Gofre
    - E-) Grid
    <hr/>
1. **Bir veya birden fazla renk arasında aşamalı geçişler oluşturularak yapılan renk dolgusuna ne ad verilir?**
    - **Cevap A-) Degrade**
    - B-) Complementer Renk
    - C-) Ara Renk
    - D-) Ana Renk
    - E-) Renk Çemberi
    <hr/>
1. Bir grafik tasarımı meydana getiren görsel ve tipografik unsurlar etrafında boş alanlar bırakmak ……………………….. olarak tanımlanır.<br />**Cümlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?**
    - A-) pasparu
    - B-) serigrafi
    - **Cevap C-) beyaz alan**
    - D-) degrade
    - E-) mürekkepsiz alan
    <hr/>
1. **Tasarımcının yaptığı çalışmalarından oluşturduğu kişisel bir tanıtım albümüne ne ad verilir?**
    - A-) Kaligrafi
    - B-) Otobiyografi
    - C-) Grafiti
    - D-) Ajanda
    - **Cevap E-) Portfolyo**
    <hr/>
1. **Dijital ortamdaki bir görüntünün çözünürlüğünü belirleyen temel etmen aşağıdakilerden hangisidir?**
    - A-) Punto büyüklüğü
    - B-) Grid sayısı
    ...
    - E-) Renk sayısı
    <hr/>
1. **Ülkemizde resmî yazışmalarda ve fotokopi makinelerinde kullanılan A4 kâğıt boyutunun eni ve boyu aşağıdakilerden hangisidir?**
    - A-) 841 x 1189 mm
    - B-) 297 x 420 mm
    - C-) 114 x 162 mm
    - D-) 148 x 210 mm
    ...
    <hr/>
## Unite 3
1. **Hâlihazırda var olan bir şeyi çizmek değil, tasarım fikirleri üretebilen zihinsel bir değişim sürecine dâhil olmak aşağıdakilerden hangisini ifade eder?**
    - A-) Tasarım araştırmalarını
    - B-) Brief hazırlamayı
    - C-) Üretim aşamasını
    - **Cevap D-) Eskiz sürecini**
    - E-) Bilgisayar ortamında çalışmayı
    <hr/>
1. **Tasarım projesinde konseptin belirlenmesi ile ilgili aşağıdaki ifadelerden hangisi söylenemez?**
...
1. I. Müşterinin hakkında net bir resim sunar.<br />II. Eksik veya hatalı olması proje hedeflerinden uzaklaştırır.<br />III. Müşteriyi düşünmeye yönlendirir.<br />**Yukarıdakilerden hangisi ya da hangileri tasarımda “Yaratıcı Brief’” ile ilgilidir?**
    ...
    - **Cevap E-) I, II ve III**
    <hr/>
1. **"Merak etme, sıradanlaşmış ve akla ilk gelen ifadelerden kaçınmayla kendini belli etmeye başlar.” cümlesinde aşağıdakilerden hangisi ifade edilmektedir?**
    - A-) Hayalcilik
    - B-) Öykünmecilik
    - **Cevap C-) Yaratıcılık**
    - D-) Pratiklik
    - E-) Yetenek
    <hr/>
1. .............................. ortaya atılan fikirleri topluca görmemizi sağlayan bir araç olup içeriği; metinler, görsel unsurlar ve bu unsurlar arasındaki yönlendirmelerden oluşur.<br />**Cümlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?**
    - **Cevap A-) Moodboard**
    - B-) Brief
    - C-) Taslak
    - D-) Tasarım
...
1. **Aşağıdakilerden hangisi tasarım alanlarında yaratıcılığı etkileyen faktörlerden biri değildir?**
    ...
    - E-) Bilgi
    <hr/>
1. **Olgunlaşmaya bırakılan tasarım fikirlerine sonradan tekrar dönülen düşünme tekniği aşağıdakilerden hangisidir?**
...
1. I. Konuya yaklaşım biçimi<br />II. Tasarımcıların biyografileri<br />III. Ürün veya hizmetin analizi<br />**Yukarıdakilerden hangisi ya da hangileri tasarım araştırmalarının içeriğinde yer almalıdır?**
    ...
    - E-) I, II ve III
    <hr/>
1. **Yaratıcı Brief içinde aşağıdakilerden hangisi yer almaz?**
    - A-) Rakipler
    - **Cevap B-) Eskizler**
...
1. **Aşağıdakilerden hangisi yaratıcı bir tasarımın özelliklerinden biri değildir?**
    ...
    <hr/>
1. **Tasarım ekibinin tüm üyelerinin katıldığı bir tartışma ortamı sayesinde rafine bir fikrin ortaya çıkartılmasını sağlayan yaratıcı düşünme yöntemi aşağıdakilerden hangisidir?**
    - A-) Kuluçka Yöntemi
    - B-) Not Alma Yöntemi
    - **Cevap C-) Beyin Fırtınası Yöntemi**
    - D-) Sentez Yöntemi
...
1. I. Projenin Ana Hedefi<br />II. Hedef kitle<br />III. Kullanılması düşünülen mecralar<br />**Başarılı olarak değerlendirilebilecek bir brief’in içeriğinde yukarıdakilerden hangisi ya da hangileri olmalıdır?**
    ...
    - **Cevap E-) I ,II ve III**
    <hr/>
1. Tasarımda yeni birlikteliklere yol açmak için kullanılan yöntemlerden biri tesadüfiliğin kullanımıdır.<br />**Yukarıda belirtilen yöntem hangi düşünme biçimi içinde değerlendirilebilir?**
    - A-) Olgunlaştırmaya bırakarak düşünme
    - B-) Görsel incelemelerle düşünme
    - C-) Dikey düşünme
    - **Cevap D-) Kapsamlı düşünme**
    - E-) Not alarak düşünme
    <hr/>
1. Eskizler temel kavrama uygun olmak üzere daha rahat başlayabilir. Ardından kompozisyon ve layout üzerinde çalışılır. Yön seçildikten sonra konsept daha detaylı eskizler ile geliştirilebilir.<br />**Yukarıda belirtilen çalışmalar yaratıcı sürecin hangi aşamasında gerçekleştirilir?**
    - A-) Araştırma
    - **Cevap B-) Tasarım**
    - C-) Düzeltme
    - D-) Üretim
    - E-) Takip
    <hr/>
1. **Aşağıdakilerden hangisi grafik tasarımı sürecindeki yaratıcı briefin içeriğinde yer almaz?**
...
1. **Tasarım fikri nedir?**
    ...
    <hr/>
1. **Aşağıdakilerden hangisi Tasarım Odaklı Düşünme Modeli'nin temel faydalarından biridir?**
    - A-) İlerleyebilecek ve önceki aşamaları geride bırakabilecek, mantıklı, baştan sona bir model sunar.
    - **Cevap B-) Kazanılan bilgiyi yinelemeli sürece geri besleyebilir.**
    - C-) Son bir tasarım ile kullanıcıların karşılaşacakları tüm sorunları ve kusurları önceden tespit edilebilir.
    - D-) Sıralı akışıyla akıl karışıklıklarını giderir.
    - E-) Sorunları hemen çözmeye yardımcı olur.
    <hr/>
1. **Tasarım fikri için aşağıdakilerden hangisi söylenemez?**
    ...
    <hr/>
1. **Aşağıdakilerden hangisi tasarım fikrinin aşamalarından biri değildir?**
    - A-) Empati
    - **Cevap B-) Kavrama**
    - C-) Fikirleştirme
    - D-) Prototipleme
    - E-) Test etme
    <hr/>
1. **Aşağıdakilerden hangisi derin dalış metodu aşamalarından biri değildir?**
    - A-) Anlama
    - B-) Gözlemleme
    - C-) Görselleştirme
    - **Cevap D-) Anket Yapma**
    - E-) Uygulama
    <hr/>
1. “En yaygın prototipleme tekniklerinden biri “………………….” yöntemidir”<br />**Boş bırakılan yere aşağıdaki seçeneklerden hangisi getirilmelidir?**
    - A-) Güzel ve Çirkin
    - **Cevap B-) Oz Büyücüsü**
    ...
    - E-) Batman
    <hr/>
1. **Rittel, çok boyutlu ve son derece karmaşık sorunları tanımlamak için aşağıdaki teorilerden hangisini ortaya atmıştır?**
    - A-) Derin Dalış
    - B-) Beş Aşamalı Düşünce Fikri
    - **Cevap C-) Olası En Kötü Problem**
    - D-) Prototipleme
    - E-) Soyut Düşünce
    <hr/>
1. **Çift Elmas modeli hangi modeli örnek almıştır?**
    - A-) İleri-Geri
    - B-) Düşün-Uygula
    ...
    <hr/>
1. Tasarım odaklı düşünme bize ………………. düşünmek ve aynı zamanda problem çözmede biraz daha derine inmek için bir araç sunar.<br />**Cümlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?**
    - A-) çizginin ötesi
    ...
    - E-) sınırlı
    <hr/>
1. **Tasarım odaklı düşünme sürecinin ilk aşaması aşağıdakilerden hangisidir?**
    - A-) Fikir bulma
    - B-) Test etme
    - C-) Tekrarlama
    - **Cevap D-) Empati**
    - E-) Kavrama
    <hr/>
1. **Kullanıcı ihtiyaçlarının incelendiği tasarım aşaması aşağıdakilerden hangisidir?**
    - **Cevap A-) Empati**
    - B-) Tanımlama
    - C-) Fikirleştirme
    - D-) Prototipleme
    - E-) Test etme
    <hr/>
1. **Tasarımı ilk kez "bir düşünce biçimi" olarak tanımlayan bilim adamı aşağıdakilerden hangisidir?**
    - A-) Horst Rittel
    - B-) Peter Rowe
    ...
    - E-) Steve Jobs
    <hr/>
1. **"Doğru sorunu bulmak" ve "doğru çözümü bulmak" olmak üzere iki aşamadan oluşan tasarım fikri modeli aşağıdakilerden hangisidir?**
    - A-) İnsan Merkezli Tasarım Modeli
    - B-) Derin Dalış Modeli
    - C-) Geleneksel Tasarım Modeli
    - D-) Soyut Düşünce Modeli
    - **Cevap E-) Çift Elmas Modeli**
    <hr/>
1. **Derin Dalış Modeli'nin temel işlevi aşağıdakilerden hangisidir?**
    - A-) Hedef kitlenin özelliklerinin anlaşılmasını kolaylaştırmak
    - B-) Tasarımların prototiplerinin oluşturulmasını sağlamak
    - C-) Tasarımların test edilmesini sağlamak
    - D-) Düşük fiyatlı ürünlerin tasarlanmasını sağlamak
    - **Cevap E-) Tasarımcıların etkin bir şekilde fikir üretebilmelerini sağlamak**
    <hr/>
1. **Uzaklaşma-Yakınlaşma Modeli'ne dayanan tasarım yaklaşımı aşağıdakilerden hangisidir?**
    - A-) Prototipleme
    - B-) İnsan-Merkezli Tasarım
    - C-) Geleneksel Tasarım Modeli
    - **Cevap D-) Çift Elmas Modeli**
    - E-) Derin Dalış Modeli
    <hr/>
1. **Dünyayı diğer insanların gözünden görme, onların gördüklerini görme, hissettiklerini hissetme ve her şeyi olduğu gibi deneyimleme yeteneğine ne ad verilir?**
    - A-) Test etme
    - B-) Prototipleme
    - C-) Fikirleştirme
    - D-) Tanımlama
    - **Cevap E-) Empati**
    <hr/>
1. **Aşağıdakilerden hangisi çift elmas diyagramının aşamalarından biri değildir?**
    - A-) Keşfetme
    - B-) Tanımla
    - C-) Geliştirme
    - D-) Uygulama
    - **Cevap E-) Çözümleme**
    <hr/>
1. …………. aşaması, ekipteki tasarımcıların eldeki sorunu çözmek için özellikler, işlevler ve diğer ögeleri oluşturmak için harika fikirler toplamasına yardımcı olmaktadır.<br />**Cümlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?**
    - A-) Test etme
    - B-) Fikirleştirme
    - **Cevap C-) Tanımlama**
    - D-) Yapılandırma
    - E-) Kavrama
    <hr/>
1. **Bir grubu etkin olarak problem çözebilecekleri ve fikir üretebilecekleri bir duruma hızlıca dâhil etmek amacıyla kullanılan tasarım fikri modeli aşağıdakilerden hangisidir?**
    ...
    <hr/>
## Unite 5
1. **Aşağıdakilerden hangisi grafik bir simge değildir?**
    ...
    - E-) Hiyeroglif
    <hr/>
1. **Aşağıdakilerden hangisi piktogram değildir?**
    - A-) Hastane tabelası
    - B-) Afet toplanma alanı tabelası
    - **Cevap C-) Otoyol kilometre bilgi tabelası**
    - D-) Alt geçit tabelası
    - E-) Tuvalet tabelası
    <hr/>
1. **Aşağıdakilerden hangisi modern grafik tasarım tarihindeki ilk logo tasarımcılarından biridir?**
    ...
    - E-) Ivan Chermayeff
    <hr/>
1. **Araştırmaya göre bir logoya bakıldığında izleyici ilk hangi noktaya odaklanmaktadır?**
    - A-) Sol baş
    - **Cevap B-) Orta**
    - C-) Sağ baş
    - D-) Sol alt
    - E-) Sağ alt
    <hr/>
1. ……………. sadece harf veya sözcüklerden oluşur.<br />**Cümlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?**
    - A-) Logo
    - B-) Amblem
    - C-) Piktogram
    - D-) Simge
    - **Cevap E-) Logotype**
    <hr/>
1. Logo tasarımında beyin fırtınası düşüncenin …………………………… dönüşmesi sürecidir.<br />**Yukarıda boş bırakılan alana aşağıdaki ifadelerden hangisinin yerleştirilmesi uygundur?**
    - A-) ‘söz'
    ...
    - E-) ‘müzik’
    <hr/>
1. **Logo tasarımında zıtlık oluştururken hangi tasarım ilkesine dikkat edilmelidir?**
    - A-) Hareket
    - B-) Renk
    - C-) Oran-orantı
    - **Cevap D-) Boşluk**
    - E-) Hiyerarşi
    <hr/>
1. **Bir logonun kullanım bilgisi oluşturulurken aşağıdakilerden hangisine yer verilmez?**
    ...
    <hr/>
1. **Aşağıdakilerden hangisi logo tasarımında dikkat edilmesi gereken bir nokta değildir?**
    ...
    - E-) Denge.
    <hr/>
1. **Önemli logo tasarımcıları hangi özellikleri ile bilinir?**
    ...
    <hr/>
1. **Bir biçimin grafik simge olabilmesi için taşıması gereken özellik aşağıdakilerden hangisidir?**
    - A-) Düşük fiyatlı olması
    - B-) Özgün olması
    - C-) Dikkat çekici olması
    - **Cevap D-) Tekrar edilebilir olması**
    - E-) Siyah beyaz renklerde olması
    <hr/>
1. **Logo tasarımının dayandığı temel ilke aşağıdakilerden hangisidir?**
    - **Cevap A-) Yalınlık**
    - B-) Dikkat çekici olmak
    - C-) Denge
    - D-) Yaratıcılık
    - E-) İşlevsellik
    <hr/>
1. **Kamusal alanda düzen ve yönlendirmeyi sağlayan grafik simgeler aşağıdakilerden hangisidir?**
    - A-) Amblem
    - **Cevap B-) Piktogram**
    - C-) Logo
    - D-) Logotype
    - E-) Afiş
    <hr/>
1. **Şekil ve yazı içeren logo tasarımlarında en iyi algılanan hizalama biçimi aşağıdakilerden hangisidir?**
    - A-) Soldan
    - B-) Sağdan
    - **Cevap C-) Ortadan**
    - D-) İki yana yaslı
    - E-) Simetrik
    <hr/>
1. **Ticari ürün veya hizmetleri temsil eden ve bir sözcük barındırmayan soyut veya somut simgelere verilen ad aşağıdakilerden hangisidir?**
    - A-) Sembol
    - **Cevap B-) Amblem**
    - C-) Eskiz
    - D-) Peyzaj
    - E-) Natürmort
    <hr/>
1. **Aşağıdakilerden hangisi uygulama aşamasında seçilen logolardan dikkat edilmesi gereken noktalardan biri değildir?**
    - A-) Denge
    - B-) Renk
    - C-) İçeriğe Uygunluk
    - D-) Tipografik Uygunluk
    - **Cevap E-) Ekonomiklik**
    <hr/>
1. **Araştırmaya göre şekil ve yazının beraber kullanıldığı logolarda en etkili yerleşim aşağıdakilerden hangisidir?**
    ...
    <hr/>
## Unite 6
1. **Aşağıdakilerden hangisi tarihsel süreçte taşınabilir ilk kitap formudur?**
    - A-) Birleştirilmiş bambu çubuklar.
    - B-) Yazıtlar.
    - C-) Papirüs ruloları.
    - **Cevap D-) Kil tabletler.**
    - E-) Elektronik tabletler.
    <hr/>
1. **Aşağıdakilerden hangisi "kitap" kelimesinin etimolojik kökeninde bulunmamaktadır?**
    - A-) Yazılı şey
    - B-) Belge
    - **Cevap C-) Söz**
    - D-) Raptetme
    - E-) Bağlama
    <hr/>
1. **Kâğıt nerede bulunmuş ve geliştirilmiştir?**
    - **Cevap A-) Çin**
    - B-) Hindistan
    - C-) İran
    - D-) İngiltere
    - E-) İtalya
    <hr/>
1. **Noktalama işaretleri kitap okumadaki hangi değişiklik ile ortaya çıkmıştır?**
    - A-) Kitapların basımında matbaanın kullanılması
    - **Cevap B-) Kitapların sesli okunmasından, sessiz okumaya geçilmesi**
    - C-) El yazmalarında kâğıdın parşömenin yerini alması
    - D-) Kitabın sayfalar birleştirilerek kodeks formuna dönüşmesi
    - E-) Kitabın taşınabilir nesnelere dönüşmesi
    <hr/>
1. **Aşağıdakilerden hangisi sert kapak ile karton kapak arasındaki farklardan biridir?**
    ...
    <hr/>
1. **Hangisi geleneksel ciltlerde bulunan bir eleman değildir?**
    - A-) Kapak
    - B-) Sırt
    - C-) Yan kağıtlar
    - D-) Dikilmiş formalar
    - **Cevap E-) Spiral tel**
    <hr/>
1. **Aşağıdakilerden hangisi ızgara sisteminin sayfa tasarımındaki önemini ifade etmektedir?**
    - **Cevap A-) Izgara sistemi kitabın sayfa tasarımının bir bütünlük içerisinde oluşturulması için son derece önemlidir.**
    - B-) Izgara sistemi pratik bir düzenleme sağlar.
    - C-) Izgara sistemi tüm yüzey tasarımlarında kullanılabilir.
...
1. I. Kitabın okuma yönü tasarımın akışını belirler.<br />II. Kitabın sayfa tasarımında göz yukarıdan aşağıya doğru bir hareket izler<br />III. Kitabın tasarımında sayfalar bir bütün olarak tasarlanmalıdır.<br />**Yukarıdakilerden hangisi ya da hangileri kitabın okunma ilkelerindendir?**
    ...
    - E-) Yalnız I
    <hr/>
1. **Kitap tasarımında yazı tipi seçimi yapılırken dikkat edilmesi gereken hususlardan biri aşağıdakilerden hangisidir?**
    ...
    <hr/>
1. **Tasarım süreci ve olasılık üzerine aşağıdakilerden hangisi yalnıştır?**
    ...
    <hr/>
1. **Tarihsel süreç içerisinde kitapların gelişimini etkileyen en önemli olay aşağıdakilerden hangisidir?**
    - A-) Kâğıdın icadı
    ...
    <hr/>
1. **Kitabın kapağını korumak ya da tasarımını tamamlamak amacıyla kullanılan yapısal tasarım elemanı aşağıdakilerden hangisidir?**
    - A-) Sırt
    - B-) Spiral tel
    - C-) Cilt
    - D-) Ayraç
    - **Cevap E-) Şömiz**
    <hr/>
1. **Kitap kapağı tasarımlarında tipografik olarak en fazla ön plana çıkması gereken unsur aşağıdakilerden hangisidir?**
    - A-) Yazarın adı
    - B-) Yayınevinin adı
    - **Cevap C-) Kitabın adı**
    - D-) Basım yılı
...
1. **Kitap kapağı tasarım sürecinde soldan sağa doğru** **öğelerin sıralanış biçimi aşağıdakilerden hangisidir?**
    ...
    - **Cevap D-) Arka kapak-Sırt-Ön kapak**
    - E-) Ön kapak-Arka kapak
    <hr/>
1. **Bir kitabın koruyucusu olan ve aynı zamanda okuyucuyla iletişim kuran ilk tasarım ögesi aşağıdakilerden hangisidir?**
    - **Cevap A-) Kapak**
    - B-) Ayraç
    - C-) Sayfalar
    - D-) Sırt
    - E-) Cilt
    <hr/>
1. **Aşağıdakilerden hangisi birden fazla ikiye katlanmış kâğıdın iç içe geçmesiyle oluşturulmasına ne ad verilir?**
    - **Cevap A-) Forma**
    - B-) Spiral
    - C-) Tipografi
    - D-) İzgara
    - E-) Sırt
    <hr/>
1. **Kitap tasarımında uzun yazı bloklarında aşağıdakilerden hangisi okumayı kolaylaştırır?**
    - A-) İtalik (yatık) yazı kullanımı
    - B-) Kalın (bold) yazı kullanımı
    - C-) Yazı kullanımında harf aralarının normalden açık olması
    - D-) Yazı kullanımında harf aralarının normalden kapalı olması
    - **Cevap E-) Tırnaklı yazı tiplerinin tercih edilmesi**
    <hr/>
1. **Kitapta sayfa tasarımında denge aşağıdakilerden hangisi ile ilgilidir?**
    - A-) Yazı tipi
    - B-) Izgara sistemi
    - C-) Görsel kullanımı
    ...
    - E-) Cilt tercihi
    <hr/>
1. **Matbaa öncesi dönemdeki ilk kitap formları aşağıdakilerden hangisidir?**
    - A-) İllüstrasyon
    - **Cevap B-) Yazıt**
    - C-) Kodeks
    - D-) Rulo
...
1. I. Denge<br />II. Boşluk<br />III. Hiyerarşi<br />**Yukarıdakilerden hangisi ya da hangileri kitap tasarımında dikkate alınmalıdır?**
    ...
    - **Cevap E-) I, II ve III**
    <hr/>
1. **Bir kitabın okunurluğunu etkileyen tipografik özelliklerle ilgili aşağıdaki ifadelerden hangisi yanlıştır?**
    - A-) Izgara sistemi hem yazınsal hem de görsel ögelerin düzenlenmesi için bir kılavuzdur.
    - B-) Seçilen yazı tipinin harf, kelime ve satır arası boşlukları okunurluğu etkiler.
    - **Cevap C-) Uzun yazı bloklarında okunurluğu kolaylaştırmak için çoğunlukla tırnaksız yazı tipleri tercih edilir.**
    - D-) Ders kitaplarında farklı genişliklerde çoklu sütunlar tercih edilir.
    - E-) Tasarımda bütünlüğü sağlamak için fotoğraf, illüstrasyon, tablo vb. görüntüler, metin içerisinde ızgara sistemine uygun şekilde yerleştirilir.
    <hr/>
## Unite 7
1. **Aşağıdakilerden hangisi süreli yayın çeşitlerinden biridir?**
    - A-) Kitap
    - B-) Ansiklopedi
    - C-) Katalog
    ...
    - E-) Broşür
    <hr/>
1. **Aşağıdaki gazete formatlarından boyutları en büyük olan hangisidir?**
    - **Cevap A-) Broadsheet**
    - B-) Tabloid
    - C-) Kompakt
    - D-) Berliner
    - E-) Midi
    <hr/>
1. **Aşağıdakilerden hangisi gazetenin özelliklerinden biri değildir?**
    ...
    <hr/>
1. “Sayfanın basılmış bölümünün dışında kalan kenar boşluklarına ………………… adı verilir”.<br />**Cümlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?**
    - A-) Traj
    - **Cevap B-) Marj**
    - C-) Dekupe
    - D-) Lejant
    - E-) Gabarit
    <hr/>
1. **Yılın gün, hafta, ay gibi bölümlerinden başka; bayram, yıl dönümü, belli günleri ve birtakım astronomi, meteoroloji, istatistik bilgileri, bir yıl içerisinde gerçekleşen önemli olayları gösteren kitap biçimindeki süreli yayına ne ad verilir?**
    - A-) Yıllık rapor
    - B-) Takvim
    - **Cevap C-) Almanak**
    - D-) Bülten
    - E-) Magazin
    <hr/>
1. **Aşağıdakilerden hangisi süreli yayının özelliklerinden biri değildir?**
    - A-) Periyodik olması
    ...
    <hr/>
1. **Ülkemizdeki şirketlerin ve kurumların hazırlanmakla yükümlü oldukları süreli yayın hangisidir?**
    - A-) Yıllık
    - B-) Bülten
    - C-) Almanak
    - **Cevap D-) Faaliyet raporu**
    - E-) Magazin
    <hr/>
1. **Ülkemizde resmî ve ticari hayatın düzenlenmesi amacıyla kullanılan takvim hangisidir?**
    - A-) Hicri Takvim
    ...
    - E-) Celali Takvim
    <hr/>
1. **Aşağıdakilerden hangisi “Magazin Dergilerinin” özelliklerinden biri değildir?**
    ...
    <hr/>
1. “Özel veya resmî kurum, kuruluş veya yetkili kişilerce herhangi bir durumla ilgili olarak yayımlanan duyuru”.<br />**Yukarıda tanımı yapılan süreli yayın hangisidir?**
    - A-) Almanak
    - B-) Takvim
    - C-) Faaliyet Raporu
    - **Cevap D-) Bülten**
    - E-) Magazin
    <hr/>
1. **Yayın hayatına 2017'de başlayan ve her ay bir yayın yapan derginin Nisan 2020 tarihli yayını için verilmesi gereken "Cilt" ve "Sayı" numaraları aşağıdakilerden hangisidir?**
    - A-) Cilt 3, Sayı 1
    - B-) Cilt 3, Sayı 2
    - C-) Cilt 3, Sayı 3
    ...
    - E-) Cilt 4, Sayı 3
    <hr/>
1. **Aşağıdakilerden hangisi süreli yayın çeşitlerinden biri değildir?**
    - A-) Gazete
    - B-) Dergi
    - C-) Takvim
    - D-) Faaliyet raporu
    - **Cevap E-) Kitap**
    <hr/>
1. **Osmanlı İmparatorluğu’nda yayımlanan ilk bilimsel nitelikli süreli yayın aşağıdakilerden hangisidir?**
    - **Cevap A-) Takvim-i Vakayi gazetesi**
    - B-) Ceride-i Havadis gazetesi
    - C-) Hâkimiyet-i Milliye gazetesi
    - D-) Servet-i Fünûn dergisi
    - E-) Vakâyî-i Giridiye gazetesi
    <hr/>
1. **Gazetelerde manşetten sonra ikinci derecede önemli sayılan çarpıcı başlığa ne ad verilir?**
    - A-) Künye
    - B-) Tiraj
    - C-) Marj
    - **Cevap D-) Sürmanşet**
    - E-) Dekroşe
    <hr/>
1. **Gazetenin yayımlandığı gün kaç adet basıldığını belirten baskı sayısına verilen isim aşağıdakilerden hangisidir?**
    - **Cevap A-) Tiraj**
    - B-) Marj
    - C-) Lejant
    - D-) Gabarit
    - E-) Dekupe
    <hr/>
1. **Gazetenin birinci sayfasında duyurulan bir haber eğer iç sayfalarda devam ediyorsa buna ne ad verilir?**
    - A-) Marj
    - B-) Lejant
    - C-) Gabarit
    - D-) Dekupe
    - **Cevap E-) Amors**
    <hr/>
1. **Gazete baskıya gitmeden önce en son gelen, en taze haber için sayfada bırakılan boşluk aşağıdakilerden hangisidir?**
    - A-) Tashih
    - B-) Spot
    - C-) Espas payı
    - D-) Amors
    - **Cevap E-) Stop press**
    <hr/>
1. **Gazetenin yayımlandığı gün kaç adet basıldığını belirten baskı sayısı aşağıdakilerden hangisidir?**
    - A-) Marj
    - B-) Mizanpaj
    - **Cevap C-) Tiraj**
    - D-) Lejant
    - E-) Dekroşe
    <hr/>
1. **Kurumların bir hesap dönemindeki ticari ve mali faaliyetlerini kapsayan yayın türü aşağıdakilerden hangisidir?**
    - A-) Bülten
    - B-) Magazin
    - C-) Hakemli dergiler
    - **Cevap D-) Faaliyet raporu**
    - E-) Takvim
    <hr/>
1. **Aşağıdakilerden hangisi süreli yayınların özelliklerinden biridir?**
    - A-) Yayın hayatına hangi tarihte son vereceği bellidir.
    - B-) Genellikle tarihî vakalarla ilgili bilgi verir.
    - **Cevap C-) Baskı tarihi ve sayısı içerir.**
    - D-) Özel sektör tarafından yayımlanır.
    - E-) Cilt hâline getirilerek arşivlenir.
    <hr/>
1. **Gazetelerin yılının, sayısının, sahibinin, genel yayın yönetmeninin, iletişim bilgilerinin, basım ve yayım gibi bilgilerinin yazıldığı kısma verilen isim aşağıdakilerden hangisidir?**
    - A-) Spot
    - B-) Lejant
    - C-) Marj
    - **Cevap D-) Künye**
    - E-) Sürmanşet
    <hr/>
1. Bu tür dergilerdeki makaleler, yazarın meslektaşları (aynı konuda uzman olan kişiler) tarafından incelenerek ve onaylanarak resmî bir düzeltme işleminden geçirilerek yayımlanır.<br />**Bahsedilen dergi türü aşağıdakilerden hangisidir?**
    - A-) Popüler dergi
