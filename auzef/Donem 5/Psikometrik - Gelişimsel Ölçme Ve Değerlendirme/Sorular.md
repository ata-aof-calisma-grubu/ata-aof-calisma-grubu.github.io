...
1. Aşağıdakilerden hangisi psikolojik testlerin işlevlerinden biri <u>değildir</u>?
...
1. Ölçme ve değerlendirmede psikometrik yaklaşımın temel amacı nedir?
...
1. Aşağıdaki ölçeklerden hangisi üzerinde tüm matematiksel işlemlerin yapılabildiği, en gelişmiş ölçektir?
    - A-) Nominal (Sınıflama)
    - B-) Ordinal (Sıralama)
...
1. Çocuklarda ölçme işlemi için yukarıdakilerden hangileri doğrudur?
...
2. Ölçme işlemi öncesinde yapılması gerekenler hangileridir?
...
2. Aşağıdakilerden hangileri çocukların ölçme ve değerlendirmesinde erişkinlerden farklı olarak dikkate alınmalıdır?
...
1. Gözlemcinin sürece aktif biçimde katıldığı, olaylara ya da etkileşimlere doğrudan dahil olduğu gözlem yöntemi aşağıdakilerden hangisidir?
...
1. Doğal ortamda gelişen, ön hazırlık yapılmadan gerçekleştirilen ve hangi konuların ele alınacağının görüşme sırasında şekillendiği psikolojik değerlendirme yöntemi aşağıdakilerden hangisidir?
    - A-) Yaratıcı drama
...
1. Değerlendirmede çocukla ilgili eski kayıtları ve değerlendirme raporlarını bulup onları kullanan bir ruh sağlığı uzmanı hangi değerlendirme yöntemini kullanmış olur?
    - A-) Görüşme
    - B-) Katılımlı gözlem
...
1. Hangi testler için yaş normlarının mevcut olması önemlidir?
    - A-) Likert tipi ölçekler
...
1. Sınıf normları hangi amaçla kullanılır?
...
1. Yukarıdakilerden hangileri bir ölçüm aracının güvenirlik analizi yöntemlerindendir?
I. İç tutarlılık
II. Yüzdelik normlar
III. Faktör analizi
IV. Paralel formlar
...
1. Ölçeğin yapı geçerliği için hangi hesaplama yapılır?
...
1. Aşağıdakilerden hangisi ölçeğin kullanım rahatlığı ile ilgili <u>değildir</u>?
    - A-) Kolay uygulanması
    - B-) Kolay puanlanması
    - C-) Ucuz olması
...
3. Aşağıdakilerden hangileri çocukların ölçme ve değerlendirmesinde erişkinlerden farklı olarak dikkate alınmalıdır?
I. Ölçüm aracının geçerli olması
II. Ebeveynlerinden bilgi alınması
III. Oyun ve hikaye gibi yöntemler kullanılması
IV. Etiketleyici bir dil kullanılmaması
...
1. Çocukların psikolojik değerlendirmesi ile ilgili aşağıdaki ifadelerden hangisi doğrudur?
...
1. Psikolojik değerlendirmede, çocuklar minik yetişkinler olarak görülmemeli; gelişimsel özellikleri dikkate alınarak yaklaşılmalıdır. Bu ilke, aşağıdakilerden hangisinin önemini vurgular?
...
1. Ölçüm öncesi yapılacak işlem hakkında neden bilgi verilmelidir?
...
3. Çocuklarda ölçme işlemi sırasında çocuğun ölçüme uyumunun artırılabilmesi için yukarıdakilerden hangileri yapılabilir?
...
1. Çocukların psikolojik değerlendirmesi ile ilgili aşağıdaki ifadelerden hangileri yanlıştır?
...
1. Çocuğun gelişimsel değerlendirmesinde yapılacak hatanın fark edilebilmesi için ne yapılmalıdır?
...
1. Çocuklarda ölçme işlemi için aşağıdakilerden hangisi doğrudur?
...
1. Psikolojik değerlendirme sürecinde 'Teste Yumuşak Geçiş Yapılması'nın temel amacı nedir?
...
1. Değerlendiricinin çocukla spontane olarak oyun oynayarak çocuğu gözlemlediği değerlendirme yöntemine verilen ad aşağıdakilerden hangisidir?
...
1. Ölçme ve değerlendirme raporları için hangisi yanlıştır?
...
1. Adli psikolojik değerlendirme raporlarının temel özelliklerinden biri <u>değildir</u>?
...
1. Psikoeğitsel raporlar, aşağıdakilerden hangisine özellikle odaklanır?
...
1. Değerlendirme raporunun tanımlayıcı bilgiler kısmında hangi bilgi <u>bulunmaz</u>?
...
1. Psikolojik değerlendirme raporlarının 'Geçmiş Bilgisi' bölümünde hangi bilgi bulunur?
...
1. Aşağıdakilerden hangisi değerlendirme raporunun 'Bulgular ve Yorumlar' kısmında yer alması gereken bir bilgidir?
...
1. Değerlendirme raporunun en önemli ve kendi içinde bir bütün teşkil etmesi gereken kısmı hangisidir?
...
1. Aşağıdakilerden hangisi, test seçimi sırasında etik olarak dikkat edilmesi gereken bir ilkedir?
...
1. Ölçme ve değerlendirme konusunda etik çalışan bir uygulayıcı hangisini yapar?
...
1. Ölçme ve değerlendirme yapan biri etik olarak hangi yeterliliği taşımalıdır?
...
1. Psikolojik test sonuçları yorumlanırken hangi ilke esastır?
...
1. Değerlendirme raporunun içeriği konusunda aileye geribildirim verilirken öncelikli olarak neye dikkat edilmelidir?
...
1. Normal gelişim ile ilgili aşağıdaki ifadelerden hangisi doğrudur?
...
1. Aşağıdakilerden hangisi gelişimsel bir sorunu <u>değildir</u>?
    - A-) Gelişim gecikmesi
...
1. Aşağıdakilerden hangisi gelişimsel değerlendirmenin amaçlarından biri <u>değildir</u>?
...
1. Aşağıdakilerden hangisi Küme Etmeni Kuramına göre zekanın kapsamına giren becerilerdendir?
    - A-) Akıcı zeka
...
1. Aşağıdakilerden hangisi Gardner’in Çoklu Zekâ Kuramında yer alan zekâ alanlarından biridir?
    - A-) Kristalize zekâ
    - B-) Algısal Hız
    - C-) Sayısal yetenek
...
2. Aşağıdakilerden hangileri Gardner’in Çoklu Zekâ Kuramında yer alan zekâ alanlarındandır?
I. Kristalize zekâ
...
1. Aşağıdakilerden hangisi zekanın ölçülmesi konusunda doğrudur?
...
1. Aşağıdakilerden hangisi Wechsler Çocuklar için Zeka Ölçeği-R’ın alt testlerinden <u>değildir</u>?
    - A-) Sözcük bulma
    - B-) Küplerle desen
    - C-) Şifre
    - D-) Labirentler
...
1. Aşağıdakilerden hangisi dikkat eksikliği hiperaktivite bozukluğu (DEHB)’nun değerlendirilmesinde kullanılan ölçeklerden <u>değildir</u>?
...
1. Aşağıdakilerden hangisi dikkat testidir?
    - A-) Tematik Algı Testi
...
1. Dağıtıcıları görmezden gelip belli bir uyarana odaklanabilmeye verilen ad aşağıdakilerden hangisidir?
    - A-) Sürdürülen dikkat
    - B-) Bölünmüş dikkat
    - C-) Görsel bellek
    - D-) Dikkati kaydırma
...
1. Aşağıdakilerden hangisi dil-konuşma testidir?
...
1. Aşağıdaki ölçeklerden hangisi otizm spektrum bozukluklarının değerlendirmesinde kullanılan ölçeklerden biri <u>değildir</u>?
...
1. Aşağıdakilerden hangisi Metropolitan Okul Olgunluğu Testi hakkında doğru bilgidir?
...
1. Aşağıdakilerden hangisi Özgül Öğrenme Güçlüğü Test Bataryasının değerlendirdiği becerilerden <u>değildir</u>?
    - A-) Okuma
    - B-) Yazma
